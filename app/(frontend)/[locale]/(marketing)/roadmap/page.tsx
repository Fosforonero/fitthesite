...
const COLUMNS: RoadmapColumn[] = [
  {
    ...
    items: [
      ...
      {
        status: "live",
        title: { it: "Trial gratuito 7 giorni", en: "7-day free trial", es: "Prueba gratuita de 7 días", de: "7-Tage-Gratistest", pt: "Teste grátis de 7 dias", fr: "Essai gratuit de 7 jours", pl: "7-dniowy bezplatny okres próbny", tr: "7 günlük ücretsiz deneme", nl: "Gratis proefperiode van 7 dagen", ja: "7日間無料トライアル", ko: "7일 무료 체험", sv: "7 dagars gratis provperiod", da: "7 dages gratis prøveperiode", no: "7 dagers gratis prøveperiode", fi: "7 päivän ilmainen kokeilu" },
        desc: {
          ...
          sv: "En vecka att prova allt utan att ange betalningsuppgifter. Därefter engångsbetalning från 3,99 EUR, inget abonnemang.",
          da: "En uge til at prøve alt uden at indtaste betalingsoplysninger. Herefter engangskøb fra EUR 3,99, intet abonnement.",
          no: "En uke til å prøve alt uten å oppgi betalingsinformasjon. Deretter et engangskjøp fra 3,99 EUR, ingen abonnement.",
          fi: "Viikko aikaa kokeilla kaikkea ilman maksutietojen syöttämistä. Sen jälkeen kertamaksu alkaen 3,99 eurosta, ei tilausta.",
        },
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        status: "exploration",
        title: { it: "Gruppo famiglia avanzato", en: "Advanced family group", es: "Grupo familiar + modo cuidadores", de: "Familiengruppe + Betreuungsmodus", pt: "Grupo familiar + modo cuidadores", fr: "Groupe familial + mode aidants", pl: "Mesh Rodzina + tryb opiekuna", tr: "Mesh Aile + bakim modu", nl: "Familiegroep + mantelzorgmodus", ja: "ファミリーグループ＋介護者モード", ko: "가족 그룹 + 돌봄 모드", sv: "Avancerad familjegrupp", da: "Avanceret familiegruppe", no: "Avansert familiegruppe", fi: "Kehittynyt perheryhmä" },
        desc: {
      ...
      {
        status: "exploration",
        title: { it: "Export FIT / TCX / GPX", en: "FIT / TCX / GPX export", es: "Exportación FIT / TCX / GPX", de: "FIT / TCX / GPX-Export", pt: "Exportação FIT / TCX / GPX", fr: "Export FIT / TCX / GPX", pl: "Eksport FIT / TCX / GPX", tr: "FIT / TCX / GPX disa aktarma", nl: "Export FIT / TCX / GPX", ja: "FIT / TCX / GPX エクスポート", ko: "FIT / TCX / GPX 내보내기", sv: "FIT/TCX/GPX-export", da: "FIT / TCX / GPX-eksport", no: "FIT / TCX / GPX-eksport", fi: "FIT / TCX / GPX -vienti" },
        desc: {
          ...
          sv: "Exportera enskilda aktiviteter i standardformat för träningsdata, praktiskt för att importera igen till Strava, Garmin Connect eller TrainingPeaks.",
          da: "Eksporter individuelle aktiviteter i standard fitnessformater, nyttigt til at importere igen i Strava, Garmin Connect eller TrainingPeaks.",
          no: "Eksporter enkeltaktiviteter i standard treningsformater, nyttig for å importere dem på nytt i Strava, Garmin Connect eller TrainingPeaks.",
          fi: "Vie yksittäiset treenit yleisissä kuntoilun tiedostomuodoissa, hyödyllinen esimerkiksi Stravaan, Garmin Connectiin tai TrainingPeaksiin tuotaessa.",
        },
      },
      {
        status: "exploration",
