    ...
    items: [
      {
        ...
        desc: {
          ...
          pl: "Odczytuje kroki, tetno, fazy snu, kalorie, dystans, treningi, SpO₂ z dowolnego zródla zapisujacego dane do Health Connect.",
          tr: "Health Connect'e yazan her kaynaktan adim, kalp hizi, uyku evre, kalori, mesafe, antrenman, SpO₂ verilerini okur.",
    ...
    items: [
      {
        ...
        desc: {
          ...
          pl: "Aplikacja na iPhone juz dostepna w App Store: odczytuje Apple Health oraz zawiera pomost przesylajacy dane Galaxy Watch i pierscienia Colmi do Apple Health. Dostepna, we wszystkich sklepach Unii Europejskiej.",
          tr: "iPhone uygulamasi App Store'da yayinda: Apple Health'ten okuma yapiyor ve Galaxy Watch ile Colmi yüzük verilerini Apple Health'e aktaran bir köprü içeriyor. Avrupa Birligi'ndeki tüm magazalar dahil olmak üzere kullanilabilir.",
    ...
    items: [
      ...
      },
      {
        ...
        desc: {
          ...
          pl: "Eksport TCX i GPX dla pojedynczej aktywnosci jest juz dostepny jako funkcja Pro (Ustawienia > Eksportuj, udostepnianie). Format FIT wciaz czeka: sprawdzamy licencje formatu, zanim go dodamy.",
          tr: "TCX ve GPX disa aktarma antrenman basina zaten Pro özellik olarak yayinda (Ayarlar > Disa Aktar, paylasim). FIT formati hala bekliyor: eklemeden önce format lisansini inceliyoruz.",
...
const HERO_COPY: Record<string, LocalizedText> = {
  ...
  disclaimerBody: {
    it: "Le date \"Q3 / Q4 2026\" indicano la finestra di rilascio target. Alcune integrazioni dipendono da approvazioni partner (es. Garmin Developer Program) e possono slittare. Aggiorniamo questa pagina ogni sprint: se vedi qualcosa di obsoleto, scrivici.",
    en: "The \"Q3 / Q4 2026\" dates indicate target release windows. Some integrations depend on partner approvals (e.g. Garmin Developer Program) and may slip. We update this page each sprint: if anything looks stale, tell us.",
    es: "Las fechas \"Q3 / Q4 2026\" indican ventanas de lanzamiento objetivo. Algunas integraciones dependen de aprobaciones de partners (por ejemplo, Garmin Developer Program) y pueden retrasarse. Actualizamos esta página cada sprint: si ves algo desactualizado, escríbenos.",
    de: "Die Termine \"Q3 / Q4 2026\" geben die geplanten Veröffentlichungsfenster an. Einige Integrationen hängen von Partnergenehmigungen ab (z. B. Garmin Developer Program) und können sich verschieben. Wir aktualisieren diese Seite bei jedem Sprint: Wenn etwas veraltet wirkt, sag uns Bescheid.",
    pt: "As datas \"Q3 / Q4 2026\" indicam janelas de lançamento previstas. Algumas integrações dependem de aprovações de parceiros (ex. Garmin Developer Program) e podem atrasar. Atualizamos esta página a cada sprint: se algo parecer desatualizado, nos avise.",
    fr: "Les dates \"T3 / T4 2026\" indiquent des fenêtres de sortie cibles. Certaines intégrations dépendent d'approbations partenaires (ex. Garmin Developer Program) et peuvent glisser. Nous mettons à jour cette page à chaque sprint : si quelque chose semble obsolète, dites-le-nous.",
    pl: "Daty \"Q3 / Q4 2026\" oznaczaja docelowe okna wydania. Niektóre integracje zaleza od zatwierdzen partnerów (np. Garmin Developer Program) i moga sie przesunac. Aktualizujemy te strone co sprint: jesli cos wyglada na nieaktualne, daj nam znac.",
    tr: "\"Q3 / Q4 2026\" tarihleri hedef yayin pencerelerini gösterir. Bazi entegrasyonlar ortak onaylarina baglidir (örn. Garmin Developer Program) ve kayabilir. Bu sayfayi her sprintte güncelliyoruz: eskimis bir sey görürsen bize yaz.",
    nl: "De data \"Q3 / Q4 2026\" geven de beoogde releaseperiode aan. Sommige integraties zijn afhankelijk van goedkeuring door partners (bijv. Garmin Developer Program) en kunnen uitlopen. We werken deze pagina elke sprint bij: als iets verouderd lijkt, laat het ons weten.",
    ja: "「2026年第3四半期/第4四半期」という表記は、リリース予定の目安時期を示すものです。一部の連携機能はパートナーの承認(Garmin Developer Programなど)に依存しており、予定が後ろ倒しになる可能性があります。このページはスプリントごとに更新していますが、内容が古いと感じた場合はぜひご連絡ください。",
    ko: "\"2026년 3분기/4분기\"라는 표기는 목표 출시 시기를 의미합니다. 일부 연동 기능은 파트너 승인(예: Garmin Developer Program)에 따라 달라지며 일정이 늦어질 수 있습니다. 이 페이지는 매 스프린트마다 업데이트합니다. 내용이 오래된 것 같다면 알려주세요.",
    sv: "Datumen \"Q3/Q4 2026\" anger planerade lanseringsfönster. Vissa integrationer beror på godkännanden från partners (t.ex. Garmin Developer Program) och kan förskjutas. Vi uppdaterar den här sidan varje sprint: säg till om något verkar inaktuellt.",
    da: "Datoerne \"Q3/Q4 2026\" angiver forventede udgivelsesvinduer. Nogle integrationer afhænger af godkendelser fra partnere (f.eks. Garmin Developer Program) og kan blive forsinket. Vi opdaterer denne side hver sprint: hvis noget virker forældet, så sig til.",
    no: "Datoene «Q3 / Q4 2026» angir forventede lanseringsvinduer. Noen integrasjoner er avhengige av godkjenning fra partnere (f.eks. Garmin Developer Program) og kan bli forsinket. Vi oppdaterer denne siden hver sprint: hvis noe ser utdatert ut, si ifra.",
    fi: "\"Q3/Q4 2026\" -päivämäärät ovat tavoitteellisia julkaisuaikatauluja. Osa integraatioista riippuu kumppaneiden hyväksynnöistä (esim. Garmin Developer Program) ja voi siirtyä myöhemmäksi. Päivitämme tätä sivua jokaisen sprintin jälkeen – jos jokin tieto vaikuttaa vanhentuneelta, kerro meille.",
  },
  gdprLinkText: {
