...
export async function generateMetadata({
  ...
  const descriptions: Record<Locale, string> = {
    it: "Cosa è già live in produzione, cosa arriva nei prossimi 30 giorni, cosa è pianificato e cosa stiamo esplorando. Roadmap aggiornata in chiaro, senza marketing-speak.",
    en: "What's already shipping, what's coming in the next 30 days, what is planned, and what we're exploring. A clear roadmap updated regularly without marketing-speak.",
    es: "Qué está ya disponible, qué llega en los próximos 30 días, qué está planificado y qué estamos explorando. Una roadmap clara y actualizada sin lenguaje de marketing.",
    de: "Was bereits verfügbar ist, was in den nächsten 30 Tagen kommt, was geplant ist und was wir erkunden. Eine klare Roadmap, regelmäßig aktualisiert ohne Marketing-Sprech.",
    pt: "O que já está em produção, o que chega nos próximos 30 dias, o que está planejado e o que estamos explorando. Um roadmap claro e atualizado, sem linguagem de marketing.",
    fr: "Ce qui est déjà en production, ce qui arrive dans les 30 prochains jours, ce qui est planifié et ce que nous explorons. Une feuille de route claire et régulièrement mise à jour, sans jargon marketing.",
    pl: "Co już działa w produkcji, co pojawi się w ciągu najbliższych 30 dni, co jest planowane oraz co badamy. Przejrzysta roadmapa, regularnie aktualizowana, bez marketingowego żargonu.",
    tr: "Şu anda yayında olanlar, önümüzdeki 30 günde gelecekler, planlananlar ve keşfettiklerimiz. Düzenli güncellenen, pazarlama dili içermeyen net bir yol haritası.",
    nl: "Wat al live is, wat de komende 30 dagen verschijnt, wat gepland is en wat we verkennen. Een heldere roadmap, regelmatig bijgewerkt, zonder marketingpraat.",
    ja: "すでに本番稼働中の機能、今後30日に登場するもの、計画中の機能、そして検討中の方向性。マーケティング表現なしで定期的に更新する明快なロードマップ。",
    ko: "이미 프로덕션에 출시된 기능, 앞으로 30일 내 출시될 기능, 계획된 기능, 그리고 검토 중인 방향. 마케팅 표현 없이 정기적으로 업데이트하는 명확한 로드맵.",
    sv: "Vad som redan är live, vad som kommer de närmaste 30 dagarna, vad som är planerat och vad vi utforskar. En tydlig roadmap utan marknadsföringsprat, uppdaterad regelbundet.",
    da: "Hvad der allerede er live, hvad der kommer de næste 30 dage, hvad der er planlagt, og hvad vi udforsker. Et tydeligt roadmap uden markedsføringssnak, opdateret jævnligt.",
    no: "Hva som allerede er live, hva som kommer de neste 30 dagene, hva som er planlagt, og hva vi utforsker. Et tydelig veikart uten markedsføringsprat, oppdatert jevnlig.",
    fi: "Mikä on jo julkaistu, mitä tulee seuraavan 30 päivän aikana, mitä on suunnitteilla ja mitä tutkimme. Selkeä tiekartta ilman markkinointipuhetta, säännöllisesti päivitetty.",
  };
...
const COLUMNS: RoadmapColumn[] = [
    ...
    items: [
      {
        ...
        title: {
          ...
          pl: "Health Connect od początku do końca",
          tr: "Health Connect uç uca",
        ...
        desc: {
          it: "Lettura di passi, BPM, sonno con fasi, calorie, distanza, allenamenti, SpO₂ da qualunque sorgente che scriva su Health Connect.",
          en: "Reads steps, heart rate, sleep stages, calories, distance, workouts, SpO₂ from any source that writes to Health Connect.",
          es: "Lee pasos, frecuencia cardíaca, fases del sueño, calorías, distancia, entrenamientos, SpO₂ desde cualquier fuente que escriba en Health Connect.",
          de: "Liest Schritte, Herzfrequenz, Schlafphasen, Kalorien, Distanz, Trainings, SpO₂ aus jeder Quelle, die Daten in Health Connect schreibt.",
          pt: "Lê passos, frequência cardíaca, fases do sono, calorias, distância, treinos, SpO₂ de qualquer fonte que grave dados no Health Connect.",
          fr: "Lit les pas, la fréquence cardiaque, les phases du sommeil, les calories, la distance, les séances d'entraînement, SpO₂ depuis toute source qui écrit dans Health Connect.",
          pl: "Odczytuje kroki, tętno, fazy snu, kalorie, dystans, treningi, SpO₂ z dowolnego źródła zapisującego dane do Health Connect.",
          tr: "Health Connect'e yazan her kaynaktan adım, kalp hızı, uyku evreleri, kalori, mesafe, antrenman, SpO₂ verilerini okur.",
          nl: "Stappen, BPM, slaap met fases, calorieën, afstand, trainingen, SpO₂ uitlezen vanuit elke bron die naar Health Connect schrijft.",
          ja: "Health Connectに書き込むあらゆるソースから、歩数・BPM・睡眠フェーズ・カロリー・距離・ワークアウト・SpO₂を読み取ります。",
          ko: "Health Connect에 데이터를 쓰는 모든 소스에서 걸음 수, BPM, 수면 단계, 칼로리, 거리, 운동, SpO₂를 읽습니다.",
          sv: "Läser steg, puls, sömnstadier, kalorier, distans, träningspass, SpO2 från alla källor som skriver till Health Connect.",
          da: "Læser skridt, puls, søvnstadier, kalorier, distance, træningspas, SpO2 fra enhver kilde, der skriver til Health Connect.",
          no: "Leser skritt, puls, søvnstadier, kalorier, distanse, treningsøkter, SpO2 fra alle kilder som skriver til Health Connect.",
          fi: "Lukee askeleet, sykkeen, unen vaiheet, kalorit, matkan, treenit, SpO2:nin mistä tahansa lähteestä, joka kirjoittaa dataa Health Connectiin.",
        },
      },
      {
        status: "live",
        ...
        desc: {
          ...
          pl: "Galaxy Watch 4/5/6/7/Ultra przez Samsung Health → Health Connect. Konfiguracja w 5 minut, typowe opóźnienie 5-15 minut.",
      ...
      },
      {
        ...
        desc: {
          ...
          es: "Descarga una copia de las principales categorías de datos asociadas a tu cuenta en un formato legible y portátil.",
          de: "Lade eine Kopie der wichtigsten Datenkategorien deines Kontos in einem lesbaren und portablen Format herunter.",
          pt: "Baixe uma cópia das principais categorias de dados associadas à sua conta em formato legível e portátil.",
          fr: "Téléchargez une copie des principales catégories de données associées à votre compte dans un format lisible et portable.",
          pl: "Pobierz kopię głównych kategorii danych powiązanych z Twoim kontem w czytelnym i przenośnym formacie.",
          tr: "Hesabınızla ilişkili ana veri kategorilerinin bir kopyasını okunabilir ve taşınabilir formatta indirin.",
          nl: "Download een kopie van de belangrijkste gegevenscategorieën gekoppeld aan je account in een leesbaar en overdraagbaar formaat.",
          ja: "アカウントに関連付けられた主要なデータカテゴリのコピーを、読みやすく移植可能な形式でダウンロード。",
          ko: "계정에 연결된 주요 데이터 카테고리의 사본을 읽기 쉽고 이식 가능한 형식으로 다운로드.",
          sv: "Ladda ner en kopia av de viktigaste datakategorierna kopplade till ditt konto i ett läsbart och portabelt format.",
          da: "Download en kopi af de vigtigste datakategorier knyttet til din konto i et læsbart og overførbart format.",
          no: "Last ned en kopi av de viktigste datakategoriene knyttet til kontoen din i et lesbart og portabelt format.",
          fi: "Lataa kopio tiliisi liittyvistä tärkeimmistä tietoluokista luettavassa ja siirrettävässä muodossa.",
        },
      },
      {
        status: "live",
        ...
        desc: {
          ...
          tr: "Haftalık öne çıkartılanlar, kalp hızı eşikleri ve senkronizasyon hatırlatıcıları için planlanmış bildirimler (opt-in, asla pazarlama).",
  ...
  },
  {
    ...
    title: { it: "In rilascio prossimo sprint", en: "Shipping next sprint", es: "Disponible en el próximo sprint", de: "Veröffentlichung im nächsten Sprint", pt: "Lançamento no próximo sprint", fr: "Disponible au prochain sprint", pl: "Wydanie w następnym sprincie", tr: "Sonraki sprintte yayınlanacak", nl: "Binnenkort in de volgende sprint", ja: "次のスプリントでリリース予定", ko: "다음 스프린트에 출시 예정", sv: "Lanseras nästa sprint", da: "Klar til lancering næste sprint", no: "Lanseres neste sprint", fi: "Julkaistaan seuraavassa sprintissä" },
    caption: {
      ...
      pl: "Już w wewnętrznym buildzie lub prywatnej becie, szacowany czas 30 dni jeśli testy wytrzymają.",
      tr: "Zaten dahili derlemede veya özel betada, testler başarılı olursa tahmini süre 30 gün.",
    ...
    items: [
      {
        status: "live",
        title: { it: "App iOS (Apple Salute)", en: "iOS app (Apple Health)", es: "App iOS (HealthKit)", de: "iOS-App (Apple Health)", pt: "App iOS (Apple Health)", fr: "App iOS (Apple Santé)", pl: "Aplikacja iOS (Apple Health)", tr: "iOS uygulaması (Apple Health)", nl: "iOS-app (Apple Gezondheid)", ja: "iOSアプリ（Apple ヘルス）", ko: "iOS 앱 (Apple 건강)", sv: "iOS-app (Apple Health)", da: "iOS-app (Apple Health)", no: "iOS-app (Apple Health)", fi: "iOS-sovellus (Apple Health)" },
        desc: {
          it: "App per iPhone già live sull'App Store: legge Apple Salute e include un ponte che porta in Apple Salute i dati di Galaxy Watch e anello Colmi. Disponibile, incluse tutte le storefront dell'Unione Europea.",
          en: "iPhone app live on the App Store: reads Apple Health, plus a bridge that brings Galaxy Watch and Colmi ring data into Apple Health. Available, including all European Union storefronts.",
          es: "App para iPhone ya disponible en el App Store: lee HealthKit y añade un puente que lleva los datos de Galaxy Watch y el anillo Colmi a HealthKit. Disponible, incluidas todas las tiendas de la Unión Europea.",
          de: "iPhone-App live im App Store: liest aus Apple Health und bringt über eine Brücke Galaxy-Watch- und Colmi-Ring-Daten in Apple Health. Verfügbar, einschließlich aller Storefronts der Europäischen Union.",
          pt: "App para iPhone já disponível na App Store: lê o Apple Health e inclui uma ponte que leva os dados do Galaxy Watch e do anel Colmi para o Apple Health. Disponível, incluindo todas as lojas da União Europeia.",
          fr: "Application iPhone en ligne sur l'App Store : lit Apple Santé et intègre un pont qui apporte les données Galaxy Watch et de la bague Colmi dans Apple Santé. Disponible, y compris dans toutes les boutiques de l'Union européenne.",
          pl: "Aplikacja na iPhone już dostępna w App Store: odczytuje Apple Health oraz zawiera pomost przesyłający dane Galaxy Watch i pierścienia Colmi do Apple Health. Dostępna we wszystkich sklepach Unii Europejskiej.",
          tr: "iPhone uygulaması App Store'da yayında: Apple Health'ten okuma yapıyor ve Galaxy Watch ile Colmi yüzük verilerini Apple Health'e aktaran bir köprü içeriyor. Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere kullanılabilir.",
          nl: "iPhone-app live in de App Store: leest Apple Gezondheid uit en bevat een brug die Galaxy Watch- en COLMI-ringdata naar Apple Gezondheid brengt. Beschikbaar, inclusief alle winkels van de Europese Unie.",
          ja: "iPhone用アプリはApp Storeで公開中：Apple ヘルスを読み取り、Galaxy WatchおよびCOLMIリングのデータをApple ヘルスに連携するブリッジ機能も搭載。EU域内を含め利用可能です。",
          ko: "iPhone 앱이 App Store에 정식 출시됨: Apple 건강 데이터를 읽고, Galaxy Watch 및 COLMI 링 데이터를 Apple 건강으로 연결하는 브리지도 포함. EU 지역을 포함하여 이용 가능합니다.",
          sv: "iPhone-appen är live i App Store: läser Apple Health samt har en brygga som för in data från Galaxy Watch och Colmi-ringar i Apple Health. Tillgänglig, inklusive samtliga butiker inom EU.",
          da: "iPhone-appen er live i App Store: læser Apple Health og har en bro, der bringer data fra Galaxy Watch og Colmi-ring ind i Apple Health. Tilgængelig, inklusive alle butikker i EU.",
          no: "iPhone-appen er live i App Store: leser Apple Health og har en bro som henter data fra Galaxy Watch og Colmi-ring inn i Apple Health. Tilgjengelig, inkludert alle butikker i EU.",
          fi: "iPhone-sovellus on julkaistu App Storessa: lukee Apple Healthia ja sisältää sillan, joka tuo Galaxy Watchin ja Colmi-sormuksen tiedot Apple Healthiin. Saatavilla, mukaan lukien kaikki EU:n kaupat.",
        },
      },
      {
        status: "in-progress",
        title: { it: "Landing Pixel Watch dedicata", en: "Dedicated Pixel Watch landing", es: "Página dedicada a Pixel Watch", de: "Dedizierte Pixel Watch Landing Page", pt: "Landing page dedicada ao Pixel Watch", fr: "Page dédiée au Pixel Watch", pl: "Dedykowana strona dla Pixel Watch", tr: "Pixel Watch'a özel açılış sayfası", nl: "Speciale Pixel Watch-landingspagina", ja: "Pixel Watch専用ランディングページ", ko: "Pixel Watch 전용 랜딩 페이지", sv: "Egen landningssida för Pixel Watch", da: "Dedikeret Pixel Watch-landingsside", no: "Egen landingsside for Pixel Watch", fi: "Oma Pixel Watch -sivu" },
        desc: {
          ...
          pl: "Dedykowana strona /sync/pixel-watch z przewodnikiem konfiguracji specyficznym dla Pixel Watch i rozwiązywaniem problemów Fitbit → Health Connect.",
          tr: "Pixel'e özgü kurulum kılavuzu ve Fitbit → Health Connect sorun giderme içeren özel /sync/pixel-watch sayfası.",
      ...
      },
      {
        ...
        desc: {
          ...
          pl: "Wdrożenie krok po kroku w aplikacji do włączenia mostu Fitbit → Health Connect z automatyczną weryfikacją uprawnień.",
          tr: "Fitbit → Health Connect köprüsünü etkinleştirmek için otomatik izin kontrolü ile adım adım uygulama içi başlangıç.",
      ...
      {
        status: "in-progress",
        title: { it: "Attività mensile e annuale", en: "Monthly and yearly activity", es: "Actividad mensual y anual", de: "Monatliche und jährliche Aktivität", pt: "Atividade mensal e anual", fr: "Activité mensuelle et annuelle", pl: "Aktywność miesięczna i roczna", tr: "Aylık ve yıllık aktivite", nl: "Maandelijkse en jaarlijkse activiteit", ja: "月次・年次アクティビティ", ko: "월간 및 연간 활동", sv: "Månads- och årsaktivitet", da: "Månedlig og årlig aktivitet", no: "Månedlig og årlig aktivitet", fi: "Kuukausi- ja vuositason aktiivisuus" },
        desc: {
          ...
          pl: "Agregacje czasowe poza tygodniem: miesięczna mapa ciepła, roczne podsumowania na trening, porównanie rok do roku.",
          tr: "Haftanın ötesinde zaman toplamları: aylık ısı haritası, antrenman bazlı yıllık toplamlar, yıllık karşılaştırma.",
      ...
      {
        status: "in-progress",
        title: { it: "IAP server-side verification", en: "Server-side IAP verification", es: "Verificación de compra en el servidor", de: "Serverseitige IAP-Verifizierung", pt: "Verificação de compra server-side", fr: "Vérification des achats côté serveur", pl: "Weryfikacja zakupów po stronie serwera", tr: "Sunucu taraflı satın alma doğrulaması", nl: "IAP-verificatie aan serverzijde", ja: "サーバーサイドIAP検証", ko: "서버 사이드 IAP 검증", sv: "Serverbaserad IAP-verifiering", da: "Server-side verificering af køb i appen", no: "Serverside-verifisering av kjøp i appen", fi: "Palvelinpuolen IAP-vahvistus" },
        desc: {
          ...
          pl: "Backendowa walidacja Play Billing przez Supabase Edge Functions, aby zapobiec oszustwom zwrotów i włączyć bezpieczne licencje na wiele urządzeń.",
          tr: "İade dolandırıcılığını önlemek ve güvenli çoklu cihaz lisanslaması sağlamak için Supabase Edge Functions aracılığıyla Play Billing arka uç doğrulaması.",
      ...
      {
        status: "in-progress",
        title: { it: "Pressione arteriosa + glicemia", en: "Blood pressure + glucose", es: "Presión arterial + glucosa", de: "Blutdruck + Blutzucker", pt: "Pressão arterial + glicemia", fr: "Tension artérielle + glycémie", pl: "Ciśnienie krwi + glukoza", tr: "Tansiyon + glikoz", nl: "Bloeddruk + bloedsuiker", ja: "血圧 + 血糖値", ko: "혈압 + 혈당", sv: "Blodtryck + blodsocker", da: "Blodtryk + blodsukker", no: "Blodtrykk + blodsukker", fi: "Verenpaine + verensokeri" },
        desc: {
          ...
          pl: "Odczyt ciśnienia (Withings BPM, most Omron HC) i glukozy (Libre LinkUp tam gdzie dostępne przez HC) z dedykowanymi wykresami.",
          tr: "Tansiyon okuma (Withings BPM, Omron HC köprüsü) ve glikoz (HC üzerinden mevcut olduğunda Libre LinkUp), özel grafiklerle.",
  ...
  },
  {
    ...
    title: { it: "Integrazioni OAuth native", en: "Native OAuth integrations", es: "Integraciones OAuth nativas", de: "Native OAuth-Integrationen", pt: "Integrações OAuth nativas", fr: "Intégrations OAuth natives", pl: "Natywne integracje OAuth", tr: "Yerel OAuth entegrasyonları", nl: "Native OAuth-integraties", ja: "ネイティブOAuth連携", ko: "네이티브 OAuth 연동", sv: "Inbyggda OAuth-integrationer", da: "Native OAuth-integrationer", no: "Native OAuth-integrasjoner", fi: "Natiivit OAuth-integraatiot" },
    caption: {
      ...
      pl: "Integracje wymagające oficjalnego OAuth i zatwierdzenia przez partnera. Daty zależą od ich procesów.",
      tr: "Resmi OAuth ve ortak onayı gerektiren entegrasyonlar. Tarihler ortakların süreçlerine göre değişebilir.",
    ...
    items: [
      {
        ...
        desc: {
          ...
          pl: "Body Battery, Training Load, Recovery Time, Stress Score, szczegółowy GPS. Oczekiwanie na zatwierdzenie przez Garmin Developer Program.",
          tr: "Body Battery, Training Load, Recovery Time, Stress Score, ayrıntılı GPS. Garmin Developer Program onayı bekleniyor.",
      ...
      },
      {
        ...
        desc: {
          ...
          pl: "Recovery Pro, Nightly Recharge, ZoneOptimizer i tętno co sekundę z pasków H10. Fale beta tylko na zaproszenie.",
          tr: "Recovery Pro, Nightly Recharge, ZoneOptimizer ve H10 göğüs bantlarından saniyede bir kalp hızı. Yalnızca davetli beta dalgaları.",
      ...
      },
      {
        ...
        desc: {
          ...
          pl: "Readiness, Activity, nocny HRV, temperatura ciała. Szczególnie przydatne w połączeniu z Galaxy Watch lub Garmin.",
          tr: "Readiness, Activity, gece HRV değeri, vücut sıcaklığı. Galaxy Watch veya Garmin ile birlikte kullanıldığında özellikle yararlı.",
      ...
      },
      {
        ...
        desc: {
          ...
          pl: "Szczegółowe EKG + wykrywanie migotania przedsionków, Sleep Mat z fazami, Pulse Wave Velocity, długoterminowe trendy składu ciała.",
          tr: "Ayrıntılı EKG + AFib tespiti, fazları olan Sleep Mat, Nabız Dalgası Hızı, uzun vadeli vücut kompozisyonu trendleri.",
  ...
  {
    id: "future",
    kicker: { it: "Future · Esplorazione", en: "Future · Exploration", es: "Futuro · Exploración", de: "Future · Erkundung", pt: "Future · Exploração", fr: "Future · Exploration", pl: "Przyszłość · Eksploracja", tr: "Gelecek · Keşif", nl: "Toekomst · Verkenning", ja: "未来 · 探索", ko: "미래 · 탐색", sv: "Framtid · Utforskas", da: "Fremtid · Udforskes", no: "Fremtid · Utforskning", fi: "Tulevaisuus · Selvityksessä" },
    title: { it: "Sul tavolo, da validare con voi", en: "On the table, to validate with you", es: "En estudio, para validar contigo", de: "Auf dem Tisch, mit euch zu validieren", pt: "Em análise, para validar com você", fr: "Sur la table, à valider avec vous", pl: "Na stole, do walidacji razem z wami", tr: "Masada, sizinle doğrulamak için", nl: "Op de agenda, te valideren met jullie", ja: "検討中、皆さんと一緒に検証したい", ko: "검토 중, 여러분과 함께 검증할 예정", sv: "På bordet, ska valideras tillsammans med dig", da: "På bordet – skal valideres sammen med dig", no: "På bordet, til vurdering sammen med deg", fi: "Harkinnassa – sinä olet mukana päättämässä" },
    caption: {
      ...
      pl: "Kierunki, które badamy. Wyślij nam opinię, aby pomóc ustalić priorytety.",
      tr: "İncelediğimiz yönler. Önceliklendirmemize yardımcı olmak için geri bildirim gönderin.",
    ...
    items: [
      {
        ...
        desc: {
          ...
          pl: "OAuth Coros Open API i Wahoo Cloud API dla pokrycia kolarstwa i ultra-wytrzymałości. Obecnie mierzymy zapotrzebowanie.",
          tr: "Bisiklet ve ultra dayanıklılık kapsamı için Coros Open API ve Wahoo Cloud API OAuth. Şu an talebi ölçüyoruz.",
      ...
      },
      {
        ...
        desc: {
          ...
          pl: "Udostępnianie panelu rodzinie, ze szczegółowymi uprawnieniami dla każdej metryki i natychmiastowym cofnięciem dostępu.",
          tr: "Ailenle panel paylaşımı, metrik bazında ayrıntılı izinler ve anında iptal olanağı.",
      ...
      {
        status: "exploration",
        title: { it: "Export FIT", en: "FIT export", es: "Exportación FIT", de: "FIT-Export", pt: "Exportação FIT", fr: "Export FIT", pl: "Eksport FIT", tr: "FIT dışa aktarma", nl: "Export FIT", ja: "FIT エクスポート", ko: "FIT 내보내기", sv: "FIT-export", da: "FIT-eksport", no: "FIT-eksport", fi: "FIT-vienti" },
        desc: {
          it: "L'export TCX e GPX per singola attività è già live come funzione Pro (Impostazioni > Esporta, condivisione). Il formato FIT resta in attesa: stiamo verificando la licenza del formato prima di aggiungerlo.",
          en: "TCX and GPX export per workout already ships as a Pro feature (Settings > Export, share sheet). FIT is still pending: we're reviewing the format's license before adding it.",
          es: "La exportación TCX y GPX por actividad ya está disponible como función Pro (Ajustes > Exportar, hoja de compartir). El formato FIT sigue pendiente: estamos revisando la licencia del formato antes de añadirlo.",
          de: "Der TCX- und GPX-Export pro Aktivität ist bereits als Pro-Funktion live (Einstellungen > Export, Teilen-Menü). Das FIT-Format ist noch offen: Wir prüfen aktuell die Lizenz des Formats, bevor wir es hinzufügen.",
          pt: "A exportação TCX e GPX por atividade já está disponível como recurso Pro (Configurações > Exportar, menu de compartilhamento). O formato FIT ainda está pendente: estamos analisando a licença do formato antes de adicioná-lo.",
          fr: "L'export TCX et GPX par activité est déjà disponible en fonctionnalité Pro (Paramètres > Exporter, partage). Le format FIT reste en attente : nous examinons la licence du format avant de l'ajouter.",
          pl: "Eksport TCX i GPX dla pojedynczej aktywności jest już dostępny jako funkcja Pro (Ustawienia > Eksportuj, udostępnianie). Format FIT wciąż czeka: sprawdzamy licencję formatu, zanim go dodamy.",
          tr: "TCX ve GPX dışa aktarma antrenman başına zaten Pro özellik olarak yayında (Ayarlar > Dışa Aktar, paylaşım). FIT formatı hala bekliyor: eklemeden önce format lisansını inceliyoruz.",
          nl: "TCX- en GPX-export per activiteit is al live als Pro-functie (Instellingen > Exporteren, deelvenster). Het FIT-formaat staat nog open: we bekijken de licentie van het formaat voordat we het toevoegen.",
          ja: "TCXとGPXのアクティビティ単位エクスポートは、Proの機能としてすでに公開されています（設定 > エクスポート、共有シート）。FIT形式は保留中です。追加する前にフォーマットのライセンスを確認しています。",
          ko: "TCX 및 GPX 활동별 내보내기는 이미 Pro 기능으로 제공됩니다 (설정 > 내보내기, 공유 시트). FIT 형식은 아직 보류 중입니다. 추가하기 전에 형식 라이선스를 검토하고 있습니다.",
          sv: "TCX- och GPX-export per aktivitet är redan en Pro-funktion (Inställningar > Exportera, delningsmeny). FIT-formatet väntar fortfarande: vi granskar formatets licens innan vi lägger till det.",
          da: "TCX- og GPX-eksport pr. aktivitet er allerede en Pro-funktion (Indstillinger > Eksporter, delingsmenu). FIT-formatet afventer stadig: vi gennemgår formatets licens, før vi tilføjer det.",
          no: "TCX- og GPX-eksport per aktivitet er allerede en Pro-funksjon (Innstillinger > Eksporter, delingsmeny). FIT-formatet venter fortsatt: vi vurderer lisensen for formatet før vi legger det til.",
          fi: "TCX- ja GPX-vienti treeneittäin on jo Pro-ominaisuus (Asetukset > Vie, jakovalikko). FIT-muoto on yhä kesken: tarkistamme muodon lisenssin ennen sen lisäämistä.",
        },
      },
      {
        status: "exploration",
        title: { it: "Watch app companion", en: "Watch app companion", es: "App companion para el reloj", de: "Watch Companion-App", pt: "App companion para o relógio", fr: "Application companion pour la montre", pl: "Aplikacja towarzysząca dla zegarka", tr: "Saat eşlik uygulaması", nl: "Watch companion-app", ja: "Watchコンパニオンアプリ", ko: "Watch 컴패니언 앱", sv: "Kompletterande klockapp", da: "Companion-app til smartwatch", no: "Companion-app for smartklokke", fi: "Kellosovellus" },
        desc: {
          ...
          pl: "Kafelek Wear OS i tarcza zegarka Galaxy z codziennymi podsumowaniami (kroki vs cel, HR, status synchronizacji) bezpośrednio na nadgarstku.",
          tr: "Wear OS kutucuğu ve Galaxy saat kadranı ile günlük öne çıkanlar (hedefe göre adımlar, HR, senkronizasyon durumu) doğrudan bileğinizde.",
...
const HERO_COPY: Record<string, LocalizedText> = {
  jsonLdName: { it: "Roadmap FitMesh Sync", en: "FitMesh Sync Roadmap", es: "Roadmap FitMesh Sync", de: "FitMesh Sync Roadmap", pt: "Roadmap FitMesh Sync", fr: "Feuille de route FitMesh Sync", pl: "Roadmapa FitMesh Sync", tr: "FitMesh Sync Yol Haritası", nl: "FitMesh Sync Roadmap", ja: "FitMesh Sync ロードマップ", ko: "FitMesh Sync 로드맵", sv: "FitMesh Sync Roadmap", da: "FitMesh Sync Roadmap", no: "FitMesh Sync-veikart", fi: "FitMesh Sync -tiekartta" },
  breadcrumb: { it: "Roadmap", en: "Roadmap", es: "Roadmap", de: "Roadmap", pt: "Roadmap", fr: "Feuille de route", pl: "Roadmapa", tr: "Yol haritası", nl: "Roadmap", ja: "ロードマップ", ko: "로드맵", sv: "Roadmap", da: "Roadmap", no: "Veikart", fi: "Tiekartta" },
  kicker: { it: "Roadmap pubblica", en: "Public roadmap", es: "Roadmap pública", de: "Öffentliche Roadmap", pt: "Roadmap pública", fr: "Feuille de route publique", pl: "Publiczna roadmapa", tr: "Herkese açık yol haritası", nl: "Publieke roadmap", ja: "公開ロードマップ", ko: "공개 로드맵", sv: "Offentlig roadmap", da: "Offentlig roadmap", no: "Offentlig veikart", fi: "Julkinen tiekartta" },
  h1Prefix: { it: "Cosa è vivo, cosa arriva, ", en: "What's live, what's next, ", es: "Qué está disponible, qué llega, ", de: "Was live ist, was als Nächstes kommt, ", pt: "O que já está disponível, o que vem a seguir, ", fr: "Ce qui est en ligne, ce qui arrive, ", pl: "Co jest już dostępne, co nadchodzi, ", tr: "Neyin yayında olduğu, sırada ne olduğu, ", nl: "Wat er al is, wat eraan komt, ", ja: "今動いているもの、次に来るもの、", ko: "지금 제공되는 기능, 다음 계획, ", sv: "Vad som är live, vad som är på gång, ", da: "Det der er live, det der er på vej, ", no: "Hva som er live, hva som kommer, ", fi: "Mikä toimii jo, mikä on seuraavana, " },
  h1Accent: { it: "cosa stiamo esplorando.", en: "what we're exploring.", es: "qué estamos explorando.", de: "was wir erkunden.", pt: "o que estamos explorando.", fr: "ce que nous explorons.", pl: "co badamy.", tr: "neyi keşfettiğimiz.", nl: "wat we aan het onderzoeken zijn.", ja: "検討中のこと。", ko: "그리고 검토 중인 것들.", sv: "vad vi utforskar.", da: "og det vi undersøger.", no: "hva vi utforsker.", fi: "mitä selvitämme parhaillaan." },
  heroParagraph: {
    ...
    pl: "Przejrzysta roadmapa, aktualizowana co sprint. Zero marketingowego żargonu: tylko rzeczywisty status każdej integracji i funkcji, z datami ETA tam gdzie je znamy, i szczerością tam gdzie nie.",
    tr: "Her sprintte güncellenen net bir yol haritası. Pazarlama dili yok: sadece her entegrasyon ve özelliğin gerçek durumu, elimizde olduğunda ETA tarihleriyle, olmadığında ise dürüstlükle.",
  ...
  disclaimerKicker: { it: "Disclaimer", en: "Disclaimer", es: "Aviso", de: "Haftungsausschluss", pt: "Aviso", fr: "Avertissement", pl: "Zastrzeżenie", tr: "Uyarı", nl: "Disclaimer", ja: "免責事項", ko: "유의사항", sv: "Ansvarsfriskrivning", da: "Forbehold", no: "Ansvarsfraskrivelse", fi: "Huomautus" },
  disclaimerBody: {
    it: "Le tempistiche indicate rappresentano stime di sviluppo. Alcune integrazioni dipendono da approvazioni partner (es. Garmin Developer Program) e possono subire variazioni. Aggiorniamo questa pagina ogni sprint: se vedi qualcosa di obsoleto, scrivici.",
    en: "The timelines shown represent development estimates. Some integrations depend on partner approvals (e.g. Garmin Developer Program) and schedules may shift. We update this page each sprint: if anything looks stale, tell us.",
    es: "Los plazos indicados representan estimaciones de desarrollo. Algunas integraciones dependen de aprobaciones de partners (por ejemplo, Garmin Developer Program) y pueden retrasarse. Actualizamos esta página cada sprint: si ves algo desactualizado, escríbenos.",
    de: "Die angegebenen Zeitpläne stellen Entwicklungsschätzungen dar. Einige Integrationen hängen von Partnergenehmigungen ab (z. B. Garmin Developer Program) und können sich verschieben. Wir aktualisieren diese Seite bei jedem Sprint: Wenn etwas veraltet wirkt, sag uns Bescheid.",
    pt: "Os prazos indicados representam estimativas de desenvolvimento. Algumas integrações dependem de aprovações de parceiros (ex. Garmin Developer Program) e podem atrasar. Atualizamos esta página a cada sprint: se algo parecer desatualizado, nos avise.",
    fr: "Les délais indiqués représentent des estimations de développement. Certaines intégrations dépendent d'approbations partenaires (ex. Garmin Developer Program) et peuvent glisser. Nous mettons à jour cette page à chaque sprint : si quelque chose semble obsolète, dites-le-nous.",
    pl: "Przedstawione terminy stanowią szacunki rozwojowe. Niektóre integracje zależą od zatwierdzeń partnerów (np. Garmin Developer Program) i mogą ulec przesunięciu. Aktualizujemy tę stronę co sprint: jeśli coś wygląda na nieaktualne, daj nam znać.",
    tr: "Belirtilen zaman çizelgeleri geliştirme tahminleridir. Bazı entegrasyonlar ortak onaylarına bağlıdır (örn. Garmin Developer Program) ve kayabilir. Bu sayfayı her sprintte güncelliyoruz: eskimiş bir şey görürsen bize yaz.",
    nl: "De getoonde data geven de beoogde ontwikkelingsperiode aan. Sommige integraties zijn afhankelijk van goedkeuring door partners (bijv. Garmin Developer Program) en kunnen uitlopen. We werken deze pagina elke sprint bij: als iets verouderd lijkt, laat het ons weten.",
    ja: "記載されたスケジュールは開発の見込みです。一部の連携機能はパートナー企業の承認（Garmin Developer Programなど）に依存しており、予定が変更される可能性があります。このページはスプリントごとに更新していますが、内容が古いと感じた場合はぜひご連絡ください。",
    ko: "표시된 일정은 개발 예상 시점입니다. 일부 연동 기능은 파트너 승인(예: Garmin Developer Program)에 따라 일정이 늦어질 수 있습니다. 이 페이지는 매 스프린트마다 업데이트합니다. 내용이 오래된 것 같다면 알려주세요.",
    sv: "De angivna tidsramarna anger planerade utvecklingsfönster. Vissa integrationer beror på godkännanden från partners (t.ex. Garmin Developer Program) och kan förskjutas. Vi uppdaterar den här sidan varje sprint: säg till om något verkar inaktuellt.",
    da: "De angivne tidsplaner angiver forventede udviklingsvinduer. Nogle integrationer afhænger af godkendelser fra partnere (f.eks. Garmin Developer Program) og kan blive forsinket. Vi opdaterer denne side hver sprint: hvis noget virker forældet, så sig til.",
    no: "De oppgitte tidslinjene angir forventede utviklingsvinduer. Noen integrasjoner er avhengige av godkjenning fra partnere (f.eks. Garmin Developer Program) og kan bli forsinket. Vi oppdaterer denne siden hver sprint: hvis noe ser utdatert ut, si ifra.",
    fi: "Ilmoitetut aikataulut ovat tavoitteellisia kehitysaikatauluja. Osa integraatioista riippuu kumppaneiden hyväksynnöistä (esim. Garmin Developer Program) ja voi siirtyä myöhemmäksi. Päivitämme tätä sivua jokaisen sprintin jälkeen – jos jokin tieto vaikuttaa vanhentuneelta, kerro meille.",
  },
  gdprLinkText: {
    ...
    pl: "RODO i dane fitness: gdzie trafiają dane Twojego smartwatcha",
    tr: "GDPR ve fitness verileri: akıllı saat verileriniz nereye gidiyor",
  ...
  ctaHeading: { it: "Manca qualcosa che ti serve?", en: "Missing something you need?", es: "¿Falta algo que necesitas?", de: "Fehlt dir etwas, das du brauchst?", pt: "Falta algo que você precisa?", fr: "Il manque quelque chose dont vous avez besoin ?", pl: "Brakuje czegoś, czego potrzebujesz?", tr: "İhtiyacın olan bir şey mi eksik?", nl: "Mis je iets wat je nodig hebt?", ja: "欲しい機能が見つかりませんか?", ko: "필요한 기능이 없나요?", sv: "Saknar du något du behöver?", da: "Mangler du noget, du har brug for?", no: "Savner du noe du trenger?", fi: "Puuttuuko jokin tarvitsemasi ominaisuus?" },
  ctaBody: {
    ...
    pl: "Prośby użytkowników wpływają na priorytety kolejnych sprintów. Napisz nam, co chciałbyś zobaczyć i dlaczego: czytamy wszystko.",
    tr: "Kullanıcı talepleri bir sonraki sprint önceliklerini belirler. Ne görmek istediğinizi ve nedenini yazın: her şeyi okuyoruz.",
  ...
  ctaSuggestButton: { it: "Suggerisci una feature", en: "Suggest a feature", es: "Sugiere una función", de: "Feature vorschlagen", pt: "Sugerir uma funcionalidade", fr: "Suggérer une fonctionnalité", pl: "Zasugeruj funkcję", tr: "Bir özellik öner", nl: "Stel een functie voor", ja: "機能をリクエストする", ko: "기능 제안하기", sv: "Föreslå en funktion", da: "Foreslå en funktion", no: "Foreslå en funksjon", fi: "Ehdota ominaisuutta" },
  ctaIntegrationsButton: { it: "Vedi tutte le integrazioni", en: "See all integrations", es: "Ver todas las integraciones", de: "Alle Integrationen ansehen", pt: "Ver todas as integrações", fr: "Voir toutes les intégrations", pl: "Zobacz wszystkie integracje", tr: "Tüm entegrasyonları gör", nl: "Bekijk alle integraties", ja: "連携機能一覧を見る", ko: "모든 연동 기능 보기", sv: "Se alla integrationer", da: "Se alle integrationer", no: "Se alle integrasjoner", fi: "Katso kaikki integraatiot" },
};
...
const STATUS_BADGE: Record<RoadmapStatus, { it: string; en: string; es: string; de: string; pt: string; fr: string; pl: string; tr: string; nl: string; ja: string; ko: string; sv: string; da: string; no: string; fi: string; color: string }> = {
  live: { it: "Live", en: "Live", es: "Disponible", de: "Live", pt: "Disponível", fr: "Disponible", pl: "Live", tr: "Yayında", nl: "Live", ja: "稼働中", ko: "실시간", sv: "Live", da: "Live", no: "Live", fi: "Käytössä", color: "#31E981" },
  ...
  planned: { it: "Pianificato", en: "Planned", es: "Planificado", de: "Geplant", pt: "Planejado", fr: "Planifié", pl: "Zaplanowane", tr: "Planlanmış", nl: "Gepland", ja: "計画済み", ko: "예정됨", sv: "Planerad", da: "Planlagt", no: "Planlagt", fi: "Suunnitteilla", color: "#38BDF8" },
  exploration: { it: "Esplorazione", en: "Exploring", es: "Exploración", de: "Erkundung", pt: "Em exploração", fr: "En exploration", pl: "Eksploracja", tr: "Keşfediliyor", nl: "Verkenning", ja: "検討中", ko: "탐색 중", sv: "Utforskas", da: "Udforskes", no: "Under utforskning", fi: "Selvityksessä", color: "#A78BFA" },
};
