...
const COLUMNS: RoadmapColumn[] = [
  {
    ...
    items: [
      ...
      {
        status: "live",
        title: { it: "Export GDPR — JSON + CSV", en: "GDPR export — JSON + CSV", es: "Exportación GDPR: JSON + CSV", de: "DSGVO-Export — JSON + CSV", pt: "Exportação LGPD/GDPR — JSON + CSV", fr: "Export RGPD — JSON + CSV", pl: "Eksport RODO — JSON + CSV", tr: "KVKK/GDPR dışa aktarma — JSON + CSV", nl: "GDPR-export — JSON + CSV", ja: "GDPRエクスポート — JSON + CSV", ko: "GDPR 내보내기 — JSON + CSV", sv: "GDPR-export – JSON + CSV", da: "GDPR-eksport – JSON + CSV", no: "GDPR-eksport -- JSON + CSV", fi: "GDPR-vienti – JSON + CSV" },
        desc: {
          ...
          pl: "Pobierz wszystkie swoje dane jednym kliknięciem w czytelnym i przenośnym formacie. Prawo do przenoszenia danych zgodnie z RODO Art. 20.",
          tr: "Tüm verilerini tek tıklama ile okunabilir ve taşınabilir formatta indir. GDPR Madde 20 kapsamında veri taşınabilirlik hakkı.",
