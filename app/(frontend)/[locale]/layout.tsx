...
export async function generateMetadata({
  ...
  const descriptions: Record<Locale, string> = {
    it: 'FitMesh Sync sincronizza Galaxy Watch e Wear OS con una dashboard premium: passi, battito, sonno, calorie. Privacy-first, zero tracker pubblicitari.',
    en: 'FitMesh Sync syncs Galaxy Watch and Wear OS data to a premium dashboard: steps, heart rate, sleep, calories. Privacy-first. No ad trackers.',
    es: 'FitMesh Sync sincroniza Galaxy Watch y Wear OS con un panel premium: pasos, frecuencia cardíaca, sueño, calorías. Privacidad primero, sin rastreadores publicitarios.',
    de: 'FitMesh Sync synchronisiert Galaxy Watch und Wear OS mit einem Premium-Dashboard: Schritte, Herzfrequenz, Schlaf. Datenschutz zuerst, keine Werbetracker.',
    pt: 'FitMesh Sync sincroniza Galaxy Watch e Wear OS com um painel premium: passos, frequência cardíaca, sono, calorias. Privacidade primeiro, sem rastreadores publicitários.',
    fr: 'FitMesh Sync synchronise Galaxy Watch et Wear OS vers un dashboard premium : pas, pouls, sommeil, calories. Confidentialité d\'abord, aucun traceur publicitaire.',
    pl: 'FitMesh Sync synchronizuje Galaxy Watch i Wear OS z premium panelem: kroki, tętno, sen, kalorie. Prywatność na pierwszym miejscu. Bez trackerów reklamowych.',
    tr: 'FitMesh Sync, Galaxy Watch ve Wear OS verilerini premium bir panele yansıtır: adımlar, kalp atışı, uyku, kalori. Gizlilik öncelikli. Reklam izleyicisi yok.',
    nl: 'FitMesh Sync spiegelt Galaxy Watch en Wear OS data naar een premium dashboard: stappen, hartslag, slaap, calorieën. Privacy-first. Geen advertentietrackers.',
    ...
    sv: 'FitMesh Sync speglar data från Galaxy Watch och Wear OS till en premium dashboard: steg, puls, sömn, kalorier. Integritet först. Inga annonsspårare.',
    da: 'FitMesh Sync spejler data fra Galaxy Watch og Wear OS til et premium dashboard: skridt, puls, søvn, kalorier. Privatliv først. Ingen annoncetrackere.',
    no: 'FitMesh Sync speiler data fra Galaxy Watch og Wear OS til et premium dashbord: skritt, puls, søvn, kalorier. Personvern først. Ingen annonsesporere.',
    fi: 'FitMesh Sync peilaa Galaxy Watchin ja Wear OS:n tiedot premium-koontinäyttöön: askeleet, syke, uni, kalorit. Yksityisyys edellä. Ei mainosseurantaa.',
  };
