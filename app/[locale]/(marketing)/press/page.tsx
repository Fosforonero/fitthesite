...
const COPY = {
  it: {
    ...
    keyFacts: [
      ...
      { label: "Pricing", value: "Free tier + Pro €3.99 acquisto unico o €1.19/6 mesi" },
  ...
  en: {
    ...
    keyFacts: [
      ...
      { label: "Pricing", value: "Free tier + Pro €3.99 one-time or €1.19/6mo" },
