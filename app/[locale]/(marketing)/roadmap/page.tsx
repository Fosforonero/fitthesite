...
const COLUMNS: RoadmapColumn[] = [
  {
    id: "now",
    kicker: { it: "Now · In produzione", en: "Now · Shipping" },
    title: { it: "Vivo e in mano agli utenti", en: "Live with users today" },
    caption: {
    ...
    items: [
      ...
      {
        status: "live",
        title: { it: "Samsung Health + Galaxy Watch", en: "Samsung Health + Galaxy Watch" },
        desc: {
      ...
      {
        status: "live",
        title: { it: "Export GDPR — JSON + CSV", en: "GDPR export — JSON + CSV" },
        desc: {
  ...
  {
    id: "next-30",
    kicker: { it: "Next · 30 giorni", en: "Next · 30 days" },
    title: { it: "In rilascio prossimo sprint", en: "Shipping next sprint" },
    caption: {
    ...
    items: [
      ...
      {
        status: "in-progress",
        title: { it: "Fitbit — guida setup completa", en: "Fitbit — full setup guide" },
        desc: {
      ...
      {
        status: "in-progress",
        title: { it: "IAP server-side verification", en: "Server-side IAP verification" },
        desc: {
      ...
      {
        status: "in-progress",
        title: { it: "Pressione arteriosa + glicemia", en: "Blood pressure + glucose" },
        desc: {
  ...
  },
  {
    ...
    items: [
      {
        status: "planned",
        title: { it: "Garmin Health API — OAuth", en: "Garmin Health API — OAuth" },
        desc: {
      ...
      {
        status: "planned",
        title: { it: "Polar Accesslink — OAuth", en: "Polar Accesslink — OAuth" },
        desc: {
      ...
      {
        status: "planned",
        title: { it: "Oura Ring — OAuth", en: "Oura Ring — OAuth" },
        desc: {
      ...
      {
        status: "planned",
        title: { it: "Withings — OAuth", en: "Withings — OAuth" },
        desc: {
  ...
  {
    id: "future",
    kicker: { it: "Future · Esplorazione", en: "Future · Exploration" },
    title: { it: "Sul tavolo, da validare con voi", en: "On the table, to validate with you" },
    caption: {
    ...
    items: [
      {
        status: "exploration",
        title: { it: "Coros e Wahoo", en: "Coros and Wahoo" },
        desc: {
      ...
      {
        status: "exploration",
        title: { it: "Family group + caregiver mode", en: "Family group + caregiver mode" },
        desc: {
      ...
      {
        status: "exploration",
        title: { it: "Watch app companion", en: "Watch app companion" },
        desc: {
...
const STATUS_BADGE: Record<RoadmapStatus, { it: string; en: string; color: string }> = {
  live: { it: "Live", en: "Live", color: "#31E981" },
  "in-progress": { it: "In sviluppo", en: "In progress", color: "#21E6C1" },
  planned: { it: "Pianificato", en: "Planned", color: "#38BDF8" },
  exploration: { it: "Esplorazione", en: "Exploring", color: "#A78BFA" },
};
...
export default async function RoadmapPage({
  ...
  const itemListLd = {
    ...
    "@type": "ItemList",
    name: t("Roadmap FitMesh Sync", "FitMesh Sync Roadmap"),
    url: `${SITE_URL}${path}`,
  ...
  return (
    <>
      ...
      <Breadcrumbs
        items={[{ name: t("Roadmap", "Roadmap"), path }]}
        locale={lc}
      />
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-12">
        <p className="text-[10px] uppercase tracking-[0.22em] text-brand-aqua font-semibold">
          {t("Roadmap pubblica", "Public roadmap")}
        </p>
        <h1 className="mt-3 font-display text-display-xl font-semibold tracking-tightest text-text-primary max-w-3xl">
          {t("Cosa è vivo, cosa arriva, ", "What's live, what's next, ")}
          <span className="text-brand-gradient">
            {t("cosa stiamo esplorando.", "what we're exploring.")}
          </span>
        </h1>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pt-4 pb-20 text-center">
        <h2 className="font-display text-display font-semibold tracking-tightest text-text-primary">
          {t("Manca qualcosa che ti serve?", "Missing something you need?")}
        </h2>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          >
            {t("Suggerisci una feature", "Suggest a feature")}
          </a>
          <Link
