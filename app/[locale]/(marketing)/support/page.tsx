...
const FAQ_IT = [
  ...
  { q: "Funziona con Xiaomi Mi Watch / Smart Band / Redmi Watch?", a: "Sì. Apri Mi Fitness → Profilo → Privacy → Health Connect → autorizza. FitMesh Sync legge passi, battito medio, sonno, calorie e distanza. SpO₂ e HRV nightly non sono esposti dalla Mi Fitness al momento. Vedi la pagina Device supportati per la guida completa." },
  { q: "Funziona con Amazfit / Zepp / Huawei / Garmin / Fitbit / Pixel Watch?", a: "Sì, tutti quelli con companion app che supporta Health Connect funzionano: Zepp App (Amazfit), Huawei Health, Garmin Connect, Fitbit, Polar Flow, Withings Health Mate. Il livello di dettaglio varia per brand — vedi la pagina Device supportati per i dettagli." },
  { q: "Ho una Mi Band vecchia (1-6). Funziona?", a: "Le Mi Band 1-6 non scrivono su Health Connect e Mi Fitness non le supporta più. Esiste una soluzione community: Gadgetbridge (app open-source) che si collega in BT e può esportare verso Health Connect. È community, non garantiamo stabilità." },
  ...
  { q: "Dove sono salvati i miei dati?", a: "Su server EU (Frankfurt). I tuoi dati non lasciano mai l'Unione Europea. Backup automatici giornalieri, retention 7 giorni. Solo tu vedi i tuoi record — garantito a livello database, non solo applicazione." },
...
const FAQ_EN = [
  ...
  { q: "Does it work with Xiaomi Mi Watch / Smart Band / Redmi Watch?", a: "Yes. Open Mi Fitness → Profile → Privacy → Health Connect → authorize. FitMesh Sync reads steps, average heart rate, sleep, calories and distance. SpO₂ and nightly HRV are not currently exposed by Mi Fitness. See the Supported devices page for the full guide." },
  { q: "Does it work with Amazfit / Zepp / Huawei / Garmin / Fitbit / Pixel Watch?", a: "Yes — every device whose companion app supports Health Connect is supported: Zepp App (Amazfit), Huawei Health, Garmin Connect, Fitbit, Polar Flow, Withings Health Mate. Detail level varies by brand — see the Supported devices page for specifics." },
  { q: "I have an older Mi Band (1-6). Does it work?", a: "Mi Bands 1-6 don't write to Health Connect and Mi Fitness no longer supports them. There is a community solution: Gadgetbridge (open-source app) connects via Bluetooth and can export to Health Connect. It's a community tool — we cannot guarantee stability." },
  ...
  { q: "Where is my data stored?", a: "On EU servers (Frankfurt). Your data never leaves the European Union. Automatic daily backups, 7-day retention. Only you see your records — guaranteed at the database level, not just the application." },
