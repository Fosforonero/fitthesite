...
const FAQ_IT = [
  ...
  { q: "Posso usare il mio server?", a: "Sì. Il backend è open e basato su Node.js + SQLite (~500 righe di codice). Cambia l'URL del server nelle impostazioni dell'app e i dati vanno dove vuoi tu." },
...
const FAQ_EN = [
  ...
  { q: "Can I use my own server?", a: "Yes. The backend is open and based on Node.js + SQLite (~500 lines of code). Change the server URL in the app settings and your data goes wherever you want." },
