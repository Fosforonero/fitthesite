/**
 * POST /api/v1/oauth/dexcom/refresh — token refresh server-side.
 *
...
export async function POST(req: Request): Promise<Response> {
  ...
  try {
    const resp = await refreshDexcomToken(refresh_token);
    return jsonOk({
    ...
    console.error("[dexcom/refresh] unexpected error:", err);
