/**
 * POST /api/v1/oauth/mapmy/refresh — token refresh server-side.
 *
...
export async function POST(req: Request): Promise<Response> {
  ...
  try {
    const resp = await refreshMapMyToken(refresh_token);
    return jsonOk({
    ...
    console.error("[mapmy/refresh] unexpected error:", err);
