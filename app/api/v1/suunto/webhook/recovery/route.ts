 ...
 *
 * Suunto chiama questo endpoint quando nuovi dati recovery sono disponibili.
...
export async function POST(req: Request): Promise<Response> {
  ...
  if (v.ok) {
    ...
    console.log("[suunto/webhook/recovery] verified:", raw.slice(0, 200));
  } else {
    console.warn("[suunto/webhook/recovery] unverified webhook ignored:", v.reason);
  }
