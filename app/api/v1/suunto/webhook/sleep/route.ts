 ...
 *
 * Suunto chiama questo endpoint quando nuovi dati sleep sono disponibili.
...
export async function POST(req: Request): Promise<Response> {
  ...
  if (v.ok) {
    ...
    console.log("[suunto/webhook/sleep] verified:", raw.slice(0, 200));
  } else {
    console.warn("[suunto/webhook/sleep] unverified webhook ignored:", v.reason);
  }
