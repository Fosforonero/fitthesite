...
const T = {
  ...
  es: {
    ...
    submit: "Avísame al lanzar en iOS",
    submitting: "Enviando...",
    successTitle: "¡Estás en la lista!",
    successText:
      "Te escribo en cuanto la versión iOS esté disponible: los founders reciben acceso primero.",
  ...
  de: {
    ...
    submit: "Beim iOS-Launch benachrichtigen",
    submitting: "Wird gesendet...",
    successTitle: "Du bist auf der Liste!",
    successText:
      "Ich schreibe dir, sobald die iOS-Version verfügbar ist: Founder erhalten zuerst Zugang.",
  ...
  pt: {
    ...
    submit: "Me avise no lançamento do iOS",
    submitting: "Enviando...",
    successTitle: "Você está na lista!",
    successText:
      "Te mando um e-mail assim que a versão iOS estiver disponível: os founders recebem acesso primeiro.",
  ...
  fr: {
    ...
    submit: "Me prévenir au lancement iOS",
    submitting: "Envoi en cours...",
    successTitle: "Vous êtes sur la liste!",
    successText:
      "Je vous écris dès que la version iOS est disponible: les founders reçoivent l'accès en premier.",
