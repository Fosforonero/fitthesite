      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="text-sm">
          ...
          <ul className="space-y-2.5">
            ...
            <li>
              <Link href={`/${locale}/beta`} className="text-accent hover:text-accent/80 transition font-medium">
                {locale === "it" ? "Beta · 100 founder gratis" : "Beta · 100 founders free"}
              </Link>
            </li>
            ...
            <li><Link href={`/${locale}/field-notes`} className="text-text-secondary hover:text-text-primary transition">Field Notes</Link></li>
