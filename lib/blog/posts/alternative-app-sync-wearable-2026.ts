  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        nl: "FitMesh Sync is gratis tijdens de beta voor de eerste 100 founders. Werkt vandaag met alle wearables die naar Health Connect schrijven.",
        ja: "FitMesh Syncは最初の100人のファウンダー向けにベータ期間中は無料です。今日Health Connectに書き込むすべてのウェアラブルで動作します。",
        ko: "FitMesh Sync는 처음 100명의 파운더를 위해 베타 기간 동안 무료입니다. 오늘날 Health Connect에 쓰는 모든 웨어러블과 작동합니다.",
      },
      ctaLabel: {
        it: "Entra in beta",
        en: "Join beta",
