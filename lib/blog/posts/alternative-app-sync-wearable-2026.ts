  ...
  body: [
    ...
    },
    {
      ...
      items: {
        ...
        nl: [
          "**FitMesh Sync**: leest van Health Connect (elke ondersteunde Android wearable) en OAuth-routekaart voor Garmin/Polar/Oura/Withings/Strava in 2026. Webdashboard + Android-app. Eenmalige prijs.",
        ...
        ja: [
          "**FitMesh Sync**: Health Connectから読み取り（サポートされているすべてのAndroidウェアラブル）、2026年のGarmin/Polar/Oura/Withings/StravaのOAuthロードマップ。Webダッシュボード + Androidアプリ。買い切り価格。",
        ...
        ko: [
          "**FitMesh Sync**: Health Connect에서 읽기(지원되는 모든 Android 웨어러블), 2026년 Garmin/Polar/Oura/Withings/Strava OAuth 로드맵. 웹 대시보드 + Android 앱. 일회성 가격.",
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è gratis per i primi 1000 founder: Pro a vita. Funziona oggi con tutti i wearable che scrivono su Health Connect.",
        en: "FitMesh Sync is free for the first 1,000 founders: lifetime Pro. Works today with all wearables writing to Health Connect.",
        es: "FitMesh Sync es gratis para los primeros 1000 founders: Pro de por vida. Funciona hoy con todos los wearables que escriben en Health Connect.",
        de: "FitMesh Sync ist für die ersten 1000 Founder kostenlos: lebenslang Pro. Funktioniert heute mit allen Wearables, die in Health Connect schreiben.",
        pt: "FitMesh Sync é grátis para os primeiros 1000 founders: Pro vitalício. Funciona hoje com todos os wearables que escrevem no Health Connect.",
        fr: "FitMesh Sync est gratuit pour les 1000 premiers founders : Pro à vie. Fonctionne dès aujourd'hui avec tous les appareils connectés qui écrivent dans Health Connect.",
        pl: "FitMesh Sync jest bezpłatny dla pierwszych 1000 founderów: dożywotnie Pro. Działa dziś ze wszystkimi urządzeniami wearable zapisującymi do Health Connect.",
        tr: "FitMesh Sync ilk 1000 kurucu için ücretsiz: ömür boyu Pro. Bugün Health Connect'e yazan tüm giyilebilirlerle çalışır.",
        nl: "FitMesh Sync is gratis voor de eerste 1000 founders: levenslang Pro. Werkt vandaag met alle wearables die naar Health Connect schrijven.",
        ja: "FitMesh Syncは最初の1000名のfounderに無料：永久版Pro。今日Health Connectに書き込むすべてのウェアラブルで動作します。",
        ko: "FitMesh Sync는 처음 1000명의 founder에게 무료: 평생 Pro. 오늘날 Health Connect에 쓰는 모든 웨어러블과 작동합니다.",
      },
      ctaLabel: {
        it: "Entra in beta",
        en: "Join beta",
