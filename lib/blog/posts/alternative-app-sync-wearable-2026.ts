  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        fr: "FitMesh Sync est gratuit au téléchargement pour tout le monde ; les 1000 premiers founders reçoivent en plus le Pro à vie gratuit. Fonctionne dès aujourd'hui avec tous les appareils connectés qui écrivent dans Health Connect.",
        pl: "FitMesh Sync jest bezpłatny do pobrania dla każdego; pierwsi 1000 founderów otrzymuje dodatkowo dożywotnie Pro za darmo. Działa dziś ze wszystkimi urządzeniami wearable zapisującymi do Health Connect.",
        tr: "FitMesh Sync herkes için ücretsiz indirilebilir; ilk 1000 kurucu ayrıca ömür boyu ücretsiz Pro kazanır. Bugün Health Connect'e yazan tüm giyilebilirlerle çalışır.",
        nl: "FitMesh Sync is voor iedereen gratis te downloaden; de eerste 1000 founders krijgen ook levenslang Pro gratis. Werkt vandaag met alle wearables die naar Health Connect schrijven.",
        ja: "FitMesh Syncは誰でも無料でダウンロードでき、最初の1000名のfounderにはさらに永久版Proも無料で付与されます。今日Health Connectに書き込むすべてのウェアラブルで動作します。",
        ko: "FitMesh Sync는 누구나 무료로 다운로드할 수 있으며, 처음 1000명의 founder에게는 평생 Pro도 무료로 제공됩니다. 오늘날 Health Connect에 쓰는 모든 웨어러블과 작동합니다.",
      },
      ctaLabel: {
        it: "Entra in beta",
        en: "Join beta",
