...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        it: [
          "**FitMesh Sync**: legge da Health Connect su Android e da Apple Salute su iPhone, con OAuth già attivo per Garmin, Polar e Withings (Oura in arrivo). Strava è ad accesso limitato: la lettura funziona per chi è già connesso, nuove connessioni richiedono l'approvazione di Strava. Dashboard web inclusa. Pricing one-shot.",
        ...
        en: [
          "**FitMesh Sync**: reads from Health Connect on Android and Apple Health on iPhone, with live OAuth already active for Garmin, Polar and Withings (Oura coming soon). Strava has limited access: reading works for accounts already connected, new connections require Strava's approval. Web dashboard included. One-shot pricing.",
        ...
        es: [
          "**FitMesh Sync**: lee desde Health Connect en Android y Apple Salud en iPhone, con OAuth ya activo para Garmin, Polar y Withings (Oura próximamente). Strava tiene acceso limitado: la lectura funciona para quienes ya están conectados, las nuevas conexiones requieren la aprobación de Strava. Panel web incluido. Pago único.",
        ...
        pt: [
          "**FitMesh Sync**: lê do Health Connect no Android e do Apple Saúde no iPhone, com OAuth já ativo para Garmin, Polar e Withings (Oura em breve). O Strava tem acesso limitado: a leitura funciona para quem já está conectado, novas conexões dependem da aprovação da Strava. Painel web incluído. Compra única.",
        ...
        pl: [
          "**FitMesh Sync**: odczytuje z Health Connect na Androidzie i Apple Zdrowie na iPhonie, z już aktywnym OAuth dla Garmin, Polar i Withings (Oura wkrótce). Strava ma ograniczony dostęp: odczyt działa dla już połączonych kont, nowe połączenia wymagają zatwierdzenia przez Stravę. Panel web w zestawie. Jednorazowa płatność.",
        ...
        tr: [
          "**FitMesh Sync**: Android'de Health Connect'ten, iPhone'da Apple Sağlık'tan okur; Garmin, Polar ve Withings için OAuth zaten aktif (Oura yakında). Strava'da erişim sınırlıdır: okuma zaten bağlı hesaplar için çalışır, yeni bağlantılar Strava'nın onayına tabidir. Web paneli dahil. Tek seferlik fiyatlandırma.",
        ...
        nl: [
          "**FitMesh Sync**: leest van Health Connect op Android en Apple Gezondheid op iPhone, met al actieve OAuth voor Garmin, Polar en Withings (Oura komt binnenkort). Strava heeft beperkte toegang: lezen werkt voor reeds gekoppelde accounts, nieuwe koppelingen vereisen goedkeuring van Strava. Webdashboard inbegrepen. Eenmalige prijs.",
        ...
        ja: [
          "**FitMesh Sync**: AndroidではHealth Connect、iPhoneではApple ヘルスケアから読み取り、Garmin、Polar、WithingsのOAuthはすでに有効（Ouraは近日公開）。Stravaはアクセスが限定的です：読み取りはすでに接続済みのアカウントで機能しますが、新規接続にはStravaの承認が必要です。ウェブダッシュボード付き。買い切り価格。",
        ...
        ko: [
          "**FitMesh Sync**: Android에서는 Health Connect, iPhone에서는 Apple 건강 앱에서 읽어옵니다. Garmin, Polar, Withings OAuth는 이미 활성화되어 있습니다(Oura는 출시 예정). Strava는 접근이 제한적입니다: 이미 연결된 계정은 읽기가 작동하지만, 새로운 연결은 Strava의 승인이 필요합니다. 웹 대시보드 포함. 일회성 가격.",
