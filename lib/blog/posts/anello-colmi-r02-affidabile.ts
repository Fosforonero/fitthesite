...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "FitMesh legge l'anello via Bluetooth e mostra tutto nell'app insieme allo smartwatch, senza doppi conteggi.",
    ],
    en: [
      ...
      "FitMesh reads the ring over Bluetooth and shows everything in the app alongside your smartwatch, with no double counting.",
    ],
    es: [
      ...
      "FitMesh lee el anillo por Bluetooth y lo muestra todo en la app junto a tu smartwatch, sin conteos duplicados.",
    ],
    de: [
      ...
      "FitMesh liest den Ring per Bluetooth aus und zeigt alles in der App neben deiner Smartwatch an, ohne Doppelzählungen.",
    ],
    pt: [
      ...
      "O FitMesh lê o anel via Bluetooth e mostra tudo no app junto com o seu smartwatch, sem contagens duplicadas.",
    ],
    fr: [
      ...
      "FitMesh lit la bague via Bluetooth et affiche tout dans l'app aux côtés de votre montre connectée, sans double comptage.",
    ],
  },
  body: [
    {
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "Il limite del Colmi R02 non sono i sensori, è dove finiscono i dati. Di serie restano chiusi nell'app del produttore, isolati da tutto il resto. FitMesh Sync risolve questo: si collega all'anello via Bluetooth diretto, ne scarica passi, frequenza cardiaca, SpO2, sonno con fasi, stress e livello di batteria, e li mostra nell'app accanto ai dati del tuo smartwatch. Un solo posto dove guardare i trend. Su Android l'app è già disponibile sul Play Store: legge la piattaforma salute del telefono e, in più, legge l'anello Colmi direttamente via Bluetooth. L'app iOS è disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea. I dati restano sul tuo account, su server in Europa, non sui server del produttore dell'anello. Per la panoramica completa c'è la [guida completa all'anello Colmi](/it/blog/colmi-ring-fitmesh); per il sonno, [come tracciare il sonno con l'anello](/it/blog/tracciare-sonno-anello); e per capire l'indice di stress, [cosa significa l'HRV e i suoi valori](/it/blog/hrv-cose-significato-valori).",
        en: "The Colmi R02's limit is not its sensors, it is where the data ends up. Out of the box it stays locked in the manufacturer's app, cut off from everything else. FitMesh Sync fixes that: it connects to the ring over direct Bluetooth, pulls steps, heart rate, SpO2, sleep with stages, stress and battery level, and shows them in the app next to your smartwatch data. One place to watch the trends. On Android the app is already on the Play Store: it reads the phone's health platform and, on top of that, reads the Colmi ring directly over Bluetooth. The iOS app is available on the App Store, including all European Union storefronts. Your data stays on your account, on servers in Europe, not on the ring maker's servers. For the full overview see the [complete Colmi ring guide](/en/blog/colmi-ring-fitmesh); for sleep, [how to track sleep with the ring](/en/blog/tracciare-sonno-anello); and to make sense of the stress index, [what HRV means and its values](/en/blog/hrv-cose-significato-valori).",
        es: "El límite del Colmi R02 no son sus sensores, es dónde acaban los datos. De serie se quedan encerrados en la app del fabricante, aislados de todo lo demás. FitMesh Sync resuelve esto: se conecta al anillo por Bluetooth directo, descarga pasos, frecuencia cardíaca, SpO2, sueño con fases, estrés y nivel de batería, y los muestra en la app junto a los datos de tu smartwatch. Un único sitio donde mirar las tendencias. En Android la app ya está disponible en el Play Store: lee la plataforma de salud del teléfono y, además, lee el anillo Colmi directamente por Bluetooth. La app iOS ya está disponible en la App Store, incluidas todas las tiendas de la Unión Europea. Tus datos se quedan en tu cuenta, en servidores en Europa, no en los servidores del fabricante del anillo. Para la panorámica completa está la [guía completa del anillo Colmi](/es/blog/colmi-ring-fitmesh); para el sueño, [cómo registrar el sueño con el anillo](/es/blog/tracciare-sonno-anello); y para entender el índice de estrés, [qué significa la HRV y sus valores](/es/blog/hrv-cose-significato-valori).",
        de: "Die Grenze des Colmi R02 sind nicht seine Sensoren, sondern wo die Daten landen. Ab Werk bleiben sie in der App des Herstellers eingeschlossen, abgeschnitten von allem anderen. FitMesh Sync löst das: es verbindet sich per direktem Bluetooth mit dem Ring, holt Schritte, Herzfrequenz, SpO2, Schlaf mit Phasen, Stress und Akkustand und zeigt sie in der App neben den Daten deiner Smartwatch. Ein einziger Ort, um die Trends zu betrachten. Auf Android ist die App bereits im Play Store: sie liest die Gesundheitsplattform des Telefons und darüber hinaus den Colmi Ring direkt per Bluetooth. Die iOS-App ist jetzt im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union. Deine Daten bleiben in deinem Konto, auf Servern in Europa, nicht auf den Servern des Ringherstellers. Für den vollständigen Überblick gibt es den [kompletten Ratgeber zum Colmi Ring](/de/blog/colmi-ring-fitmesh); für den Schlaf [wie du den Schlaf mit dem Ring aufzeichnest](/de/blog/tracciare-sonno-anello); und um den Stressindex zu verstehen, [was HRV bedeutet und seine Werte](/de/blog/hrv-cose-significato-valori).",
        pt: "O limite do Colmi R02 não são os sensores, é onde os dados vão parar. De fábrica eles ficam presos no app do fabricante, isolados de todo o resto. O FitMesh Sync resolve isso: conecta-se ao anel via Bluetooth direto, baixa passos, frequência cardíaca, SpO2, sono com fases, estresse e nível de bateria, e mostra tudo no app ao lado dos dados do seu smartwatch. Um único lugar para acompanhar as tendências. No Android, o app já está disponível na Play Store: lê a plataforma de saúde do telefone e, além disso, lê o anel Colmi diretamente via Bluetooth. O app iOS já está disponível na App Store, incluindo todas as lojas da União Europeia. Os seus dados ficam na sua conta, em servidores na Europa, não nos servidores do fabricante do anel. Para a visão completa, há o [guia completo do anel Colmi](/pt/blog/colmi-ring-fitmesh); para o sono, [como monitorar o sono com o anel](/pt/blog/tracciare-sonno-anello); e para entender o índice de estresse, [o que significa a HRV e seus valores](/pt/blog/hrv-cose-significato-valori).",
        fr: "La limite du Colmi R02, ce ne sont pas ses capteurs, c'est là où finissent les données. D'origine, elles restent enfermées dans l'application du fabricant, coupées de tout le reste. FitMesh Sync règle cela : il se connecte à la bague en Bluetooth direct, récupère les pas, la fréquence cardiaque, la SpO2, le sommeil avec ses phases, le stress et le niveau de batterie, et les affiche dans l'app à côté des données de votre montre connectée. Un seul endroit pour suivre les tendances. Sur Android, l'application est déjà sur le Play Store : elle lit la plateforme de santé du téléphone et, en plus, lit la bague Colmi directement en Bluetooth. L'app iOS est désormais disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne. Vos données restent sur votre compte, sur des serveurs en Europe, pas sur les serveurs du fabricant de la bague. Pour un tour d'horizon complet, il y a le [guide complet de la bague Colmi](/fr/blog/colmi-ring-fitmesh) ; pour le sommeil, [comment suivre le sommeil avec la bague](/fr/blog/tracciare-sonno-anello) ; et pour comprendre l'indice de stress, [ce que signifie la HRV et ses valeurs](/fr/blog/hrv-cose-significato-valori).",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge l'anello via Bluetooth e mostra passi, sonno, battito, SpO2 e stress nell'app, insieme allo smartwatch, senza doppi conteggi. L'app Android è disponibile ora; l'app iOS è disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea. I primi 1000 iscritti founder (entro il 31 luglio 2026) hanno ottenuto il piano Pro a vita gratis; dopo, una prova completa di 14 giorni e poi un unico abbonamento Pro.",
        en: "FitMesh Sync reads the ring over Bluetooth and shows steps, sleep, heart rate, SpO2 and stress in the app, alongside your smartwatch, with no double counting. The Android app is available now; the iOS app is available on the App Store, including all European Union storefronts. The first 1000 founder members (by July 31, 2026) got the Pro plan free for life; after that, a full 14-day trial and then a single Pro subscription.",
        es: "FitMesh Sync lee el anillo por Bluetooth y muestra pasos, sueño, pulso, SpO2 y estrés en la app, junto a tu smartwatch, sin conteos duplicados. La app Android está disponible ahora; la app iOS ya está disponible en la App Store, incluidas todas las tiendas de la Unión Europea. Los primeros 1000 inscritos (hasta el 31 de julio de 2026) consiguieron el plan Pro gratis de por vida. Después, una prueba completa de 14 días y luego eliges cómo seguir con Pro: la suscripción por 1,19 € cada seis meses, como un café cada seis meses, o el desbloqueo de por vida por 3,99 € en Android y 4,99 € en iPhone, menos que una pizza. Pagar poco mantiene la app viva y tus datos en servidores en Europa.",
        de: "FitMesh Sync liest den Ring per Bluetooth aus und zeigt Schritte, Schlaf, Puls, SpO2 und Stress in der App, neben deiner Smartwatch, ohne Doppelzählungen. Die Android-App ist ab sofort verfügbar; die iOS-App ist im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union. Die ersten 1000 Mitglieder (bis 31. Juli 2026) haben den Pro-Plan lebenslang gratis erhalten. Danach eine vollständige 14-Tage-Testphase und dann entscheidest du, wie es mit Pro weitergeht: das Abo für 1,19 € alle sechs Monate, weniger als ein Kaffee alle sechs Monate, oder die lebenslange Freischaltung für 3,99 € auf Android und 4,99 € auf iPhone, weniger als eine Pizza. Ein kleiner Betrag hält die App am Leben und deine Daten auf Servern in Europa.",
        pt: "O FitMesh Sync lê o anel via Bluetooth e mostra passos, sono, batimentos, SpO2 e estresse no app, junto com o seu smartwatch, sem contagens duplicadas. O app Android já está disponível; o app iOS já está disponível na App Store, incluindo todas as lojas da União Europeia. Os primeiros 1000 inscritos (até 31 de julho de 2026) ganharam o plano Pro vitalício de graça. Depois, um teste completo de 14 dias e então você escolhe como continuar com o Pro: a assinatura por 1,19 € a cada seis meses, como um café a cada seis meses, ou o desbloqueio vitalício por 3,99 € no Android e 4,99 € no iPhone, menos que uma pizza. Pagar pouco mantém o app vivo e os seus dados em servidores na Europa.",
        fr: "FitMesh Sync lit la bague via Bluetooth et affiche les pas, le sommeil, la fréquence cardiaque, la SpO2 et le stress dans l'application, aux côtés de votre montre connectée, sans double comptage. L'application Android est disponible dès maintenant ; l'application iOS est disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne. Les 1000 premiers inscrits (jusqu'au 31 juillet 2026) ont obtenu le plan Pro à vie gratuitement. Ensuite, un essai complet de 14 jours, puis vous choisissez comment continuer avec Pro : l'abonnement à 1,19 € tous les six mois, moins qu'un café tous les six mois, ou le déverrouillage à vie à 3,99 € sur Android et 4,99 € sur iPhone, moins qu'une pizza. Payer peu garde l'application en vie et vos données sur des serveurs en Europe.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "Installi FitMesh Sync su Android dal Play Store, crei l'account e aggiungi l'anello: l'app lo trova via Bluetooth e ne scarica i dati direttamente, senza bisogno dell'app del produttore. Da quel momento vedi passi, sonno, battito, SpO2 e stress nell'app. L'app iOS è disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea. Per i passaggi in dettaglio c'è la [guida alla configurazione del Colmi R02](/it/blog/colmi-r02-setup).",
        en: "You install FitMesh Sync on Android from the Play Store, create your account and add the ring: the app finds it over Bluetooth and pulls the data directly, with no need for the manufacturer's app. From then on you see steps, sleep, heart rate, SpO2 and stress in the app. The iOS app is available on the App Store, including all European Union storefronts. For step-by-step setup see the [Colmi R02 setup guide](/en/blog/colmi-r02-setup).",
        es: "Instalas FitMesh Sync en Android desde el Play Store, creas la cuenta y añades el anillo: la app lo encuentra por Bluetooth y descarga los datos directamente, sin necesidad de la app del fabricante. A partir de ese momento ves pasos, sueño, pulso, SpO2 y estrés en la app. La app iOS ya está disponible en la App Store, incluidas todas las tiendas de la Unión Europea. Para los pasos en detalle está la [guía de configuración del Colmi R02](/es/blog/colmi-r02-setup).",
        de: "Du installierst FitMesh Sync auf Android aus dem Play Store, erstellst dein Konto und fügst den Ring hinzu: die App findet ihn per Bluetooth und holt die Daten direkt, ohne die App des Herstellers. Ab dann siehst du Schritte, Schlaf, Puls, SpO2 und Stress in der App. Die iOS-App ist jetzt im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union. Für die Schritte im Detail gibt es den [Ratgeber zur Einrichtung des Colmi R02](/de/blog/colmi-r02-setup).",
        pt: "Você instala o FitMesh Sync no Android pela Play Store, cria a conta e adiciona o anel: o app o encontra via Bluetooth e baixa os dados diretamente, sem precisar do app do fabricante. A partir desse momento, você vê passos, sono, batimentos, SpO2 e estresse no app. O app iOS já está disponível na App Store, incluindo todas as lojas da União Europeia. Para os passos em detalhe, há o [guia de configuração do Colmi R02](/pt/blog/colmi-r02-setup).",
        fr: "Vous installez FitMesh Sync sur Android depuis le Play Store, créez votre compte et ajoutez la bague : l'application la trouve en Bluetooth et récupère les données directement, sans avoir besoin de l'application du fabricant. À partir de là, vous voyez les pas, le sommeil, la fréquence cardiaque, la SpO2 et le stress dans l'app. L'app iOS est désormais disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne. Pour les étapes en détail, il y a le [guide de configuration du Colmi R02](/fr/blog/colmi-r02-setup).",
      },
    },
  ],
  related: [
