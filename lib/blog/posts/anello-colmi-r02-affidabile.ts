  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        en: "FitMesh Sync reads the ring over Bluetooth and shows steps, sleep, heart rate, SpO2 and stress in the web panel, alongside your smartwatch, with no double counting. The Android app is available now, web dashboard included; the iOS app is available on the App Store, including all European Union storefronts. The first 1000 founder members (by July 31, 2026) got the Pro plan free for life; after that, a full 14-day trial and then a single Pro subscription.",
        es: "FitMesh Sync lee el anillo por Bluetooth y muestra pasos, sueño, pulso, SpO2 y estrés en el panel web, junto a tu smartwatch, sin conteos duplicados. La app Android está disponible ahora, con el panel web incluido; la app iOS ya está disponible en la App Store, incluidas todas las tiendas de la Unión Europea. Los primeros 1000 inscritos (hasta el 31 de julio de 2026) consiguieron el plan Pro gratis de por vida. Después, una prueba completa de 14 días y luego eliges cómo seguir con Pro: la suscripción por 1,19 € cada seis meses, como un café cada seis meses, o el desbloqueo de por vida por 3,99 € en Android y 4,99 € en iPhone, menos que una pizza. Pagar poco mantiene la app viva y tus datos en servidores en Europa.",
        de: "FitMesh Sync liest den Ring per Bluetooth aus und zeigt Schritte, Schlaf, Puls, SpO2 und Stress im Web-Panel, neben deiner Smartwatch, ohne Doppelzählungen. Die Android-App ist ab sofort verfügbar, mit integriertem Web-Dashboard; die iOS-App ist im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union. Die ersten 1000 Mitglieder (bis 31. Juli 2026) haben den Pro-Plan lebenslang gratis erhalten. Danach eine vollständige 14-Tage-Testphase und dann entscheidest du, wie es mit Pro weitergeht: das Abo für 1,19 € alle sechs Monate, weniger als ein Kaffee alle sechs Monate, oder die lebenslange Freischaltung für 3,99 € auf Android und 4,99 € auf iPhone, weniger als eine Pizza. Ein kleiner Betrag hält die App am Leben und deine Daten auf Servern in Europa.",
