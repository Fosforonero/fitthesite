...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge l'anello via Bluetooth e mostra passi, sonno, battito, SpO2 e stress nel pannello web, insieme allo smartwatch, senza doppi conteggi. L'app Android è disponibile ora, con la dashboard web inclusa; l'app iOS è disponibile sull'App Store negli store supportati fuori dall'Unione Europea, con il rollout nei 27 paesi UE in corso. I primi 1000 iscritti ottengono il piano Pro a vita gratis; dopo, una prova completa di 14 giorni e poi un unico abbonamento Pro.",
        en: "FitMesh Sync reads the ring over Bluetooth and shows steps, sleep, heart rate, SpO2 and stress in the web panel, alongside your smartwatch, with no double counting. The Android app is available now, web dashboard included; the iOS app is available on the App Store in supported storefronts outside the European Union, with the rollout in the 27 EU countries in progress. The first 1000 members get the Pro plan free for life; after that, a full 14-day trial and then a single Pro subscription.",
        es: "FitMesh Sync lee el anillo por Bluetooth y muestra pasos, sueño, pulso, SpO2 y estrés en el panel web, junto a tu smartwatch, sin conteos duplicados. La app Android está disponible ahora, con el panel web incluido; la app iOS ya está disponible en la App Store en las tiendas compatibles fuera de la Unión Europea, y el despliegue en los 27 países de la UE está en curso. Los primeros 1000 inscritos consiguen el plan Pro gratis de por vida. Después, una prueba completa de 14 días y luego eliges cómo seguir con Pro: la suscripción por 1,19 € cada seis meses, como un café cada seis meses, o el desbloqueo de por vida por 3,99 € en Android y 4,99 € en iPhone, menos que una pizza. Pagar poco mantiene la app viva y tus datos en servidores en Europa.",
        de: "FitMesh Sync liest den Ring per Bluetooth aus und zeigt Schritte, Schlaf, Puls, SpO2 und Stress im Web-Panel, neben deiner Smartwatch, ohne Doppelzählungen. Die Android-App ist ab sofort verfügbar, mit integriertem Web-Dashboard; die iOS-App ist im App Store in den unterstützten Storefronts außerhalb der Europäischen Union verfügbar, der Rollout in den 27 EU-Ländern läuft bereits. Die ersten 1000 Mitglieder erhalten den Pro-Plan lebenslang gratis. Danach eine vollständige 14-Tage-Testphase und dann entscheidest du, wie es mit Pro weitergeht: das Abo für 1,19 € alle sechs Monate, weniger als ein Kaffee alle sechs Monate, oder die lebenslange Freischaltung für 3,99 € auf Android und 4,99 € auf iPhone, weniger als eine Pizza. Ein kleiner Betrag hält die App am Leben und deine Daten auf Servern in Europa.",
        pt: "O FitMesh Sync lê o anel via Bluetooth e mostra passos, sono, batimentos, SpO2 e estresse no painel web, junto com o seu smartwatch, sem contagens duplicadas. O app Android já está disponível, com o painel web incluído; o app iOS já está disponível na App Store nas lojas compatíveis fora da União Europeia, com o lançamento nos 27 países da UE em andamento. Os primeiros 1000 inscritos ganham o plano Pro vitalício de graça. Depois, um teste completo de 14 dias e então você escolhe como continuar com o Pro: a assinatura por 1,19 € a cada seis meses, como um café a cada seis meses, ou o desbloqueio vitalício por 3,99 € no Android e 4,99 € no iPhone, menos que uma pizza. Pagar pouco mantém o app vivo e os seus dados em servidores na Europa.",
        fr: "FitMesh Sync lit la bague via Bluetooth et affiche les pas, le sommeil, la fréquence cardiaque, la SpO2 et le stress dans le panneau web, aux côtés de votre montre connectée, sans double comptage. L'application Android est disponible dès maintenant, tableau de bord web inclus ; l'application iOS est disponible sur l'App Store dans les boutiques prises en charge en dehors de l'Union européenne, et le déploiement dans les 27 pays de l'UE est en cours. Les 1000 premiers inscrits obtiennent le plan Pro à vie gratuitement. Ensuite, un essai complet de 14 jours, puis vous choisissez comment continuer avec Pro : l'abonnement à 1,19 € tous les six mois, moins qu'un café tous les six mois, ou le déverrouillage à vie à 3,99 € sur Android et 4,99 € sur iPhone, moins qu'une pizza. Payer peu garde l'application en vie et vos données sur des serveurs en Europe.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "Installi FitMesh Sync su Android dal Play Store, crei l'account e aggiungi l'anello: l'app lo trova via Bluetooth e ne scarica i dati direttamente, senza bisogno dell'app del produttore. Da quel momento vedi passi, sonno, battito, SpO2 e stress nel pannello web, accessibile da qualsiasi browser con lo stesso account. L'app iOS è disponibile sull'App Store negli store supportati fuori dall'Unione Europea; il rollout nei 27 paesi UE è in corso. Per i passaggi in dettaglio c'è la [guida alla configurazione del Colmi R02](/it/blog/colmi-r02-setup).",
        en: "You install FitMesh Sync on Android from the Play Store, create your account and add the ring: the app finds it over Bluetooth and pulls the data directly, with no need for the manufacturer's app. From then on you see steps, sleep, heart rate, SpO2 and stress in the web panel, reachable from any browser with the same account. The iOS app is available on the App Store in supported storefronts outside the European Union; the rollout in the 27 EU countries is in progress. For step-by-step setup see the [Colmi R02 setup guide](/en/blog/colmi-r02-setup).",
        es: "Instalas FitMesh Sync en Android desde el Play Store, creas la cuenta y añades el anillo: la app lo encuentra por Bluetooth y descarga los datos directamente, sin necesidad de la app del fabricante. A partir de ese momento ves pasos, sueño, pulso, SpO2 y estrés en el panel web, accesible desde cualquier navegador con la misma cuenta. La app iOS ya está disponible en la App Store en las tiendas compatibles fuera de la Unión Europea; el despliegue en los 27 países de la UE está en curso. Para los pasos en detalle está la [guía de configuración del Colmi R02](/es/blog/colmi-r02-setup).",
        de: "Du installierst FitMesh Sync auf Android aus dem Play Store, erstellst dein Konto und fügst den Ring hinzu: die App findet ihn per Bluetooth und holt die Daten direkt, ohne die App des Herstellers. Ab dann siehst du Schritte, Schlaf, Puls, SpO2 und Stress im Web-Panel, von jedem Browser mit demselben Konto erreichbar. Die iOS-App ist jetzt im App Store in den unterstützten Storefronts außerhalb der Europäischen Union verfügbar; der Rollout in den 27 EU-Ländern läuft bereits. Für die Schritte im Detail gibt es den [Ratgeber zur Einrichtung des Colmi R02](/de/blog/colmi-r02-setup).",
        pt: "Você instala o FitMesh Sync no Android pela Play Store, cria a conta e adiciona o anel: o app o encontra via Bluetooth e baixa os dados diretamente, sem precisar do app do fabricante. A partir desse momento, você vê passos, sono, batimentos, SpO2 e estresse no painel web, acessível de qualquer navegador com a mesma conta. O app iOS já está disponível na App Store nas lojas compatíveis fora da União Europeia; o lançamento nos 27 países da UE está em andamento. Para os passos em detalhe, há o [guia de configuração do Colmi R02](/pt/blog/colmi-r02-setup).",
        fr: "Vous installez FitMesh Sync sur Android depuis le Play Store, créez votre compte et ajoutez la bague : l'application la trouve en Bluetooth et récupère les données directement, sans avoir besoin de l'application du fabricant. À partir de là, vous voyez les pas, le sommeil, la fréquence cardiaque, la SpO2 et le stress dans le panneau web, accessible depuis n'importe quel navigateur avec le même compte. L'app iOS est désormais disponible sur l'App Store dans les boutiques prises en charge en dehors de l'Union européenne ; le déploiement dans les 27 pays de l'UE est en cours. Pour les étapes en détail, il y a le [guide de configuration du Colmi R02](/fr/blog/colmi-r02-setup).",
      },
    },
  ],
  related: [
