...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge l'anello via Bluetooth e mostra passi, sonno, battito, SpO2 e stress nel pannello web, insieme allo smartwatch, senza doppi conteggi. L'app Android è disponibile ora, con la dashboard web inclusa; l'app iOS è disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea. I primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ottenuto il piano Pro a vita gratis; dopo, una prova completa di 14 giorni e poi un unico abbonamento Pro.",
        en: "FitMesh Sync reads the ring over Bluetooth and shows steps, sleep, heart rate, SpO2 and stress in the web panel, alongside your smartwatch, with no double counting. The Android app is available now, web dashboard included; the iOS app is available on the App Store, including all European Union storefronts. The first 1000 founder members (program closed as of July 31, 2026) got the Pro plan free for life; after that, a full 14-day trial and then a single Pro subscription.",
        es: "FitMesh Sync lee el anillo por Bluetooth y muestra pasos, sueño, pulso, SpO2 y estrés en el panel web, junto a tu smartwatch, sin conteos duplicados. La app Android está disponible ahora, con el panel web incluido; la app iOS ya está disponible en la App Store, incluidas todas las tiendas de la Unión Europea. Los primeros 1000 inscritos (programa cerrado desde el 31 de julio de 2026) consiguieron el plan Pro gratis de por vida. Después, una prueba completa de 14 días y luego eliges cómo seguir con Pro: la suscripción por 1,19 € cada seis meses, como un café cada seis meses, o el desbloqueo de por vida por 3,99 € en Android y 4,99 € en iPhone, menos que una pizza. Pagar poco mantiene la app viva y tus datos en servidores en Europa.",
        de: "FitMesh Sync liest den Ring per Bluetooth aus und zeigt Schritte, Schlaf, Puls, SpO2 und Stress im Web-Panel, neben deiner Smartwatch, ohne Doppelzählungen. Die Android-App ist ab sofort verfügbar, mit integriertem Web-Dashboard; die iOS-App ist im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union. Die ersten 1000 Mitglieder (Programm seit dem 31. Juli 2026 geschlossen) haben den Pro-Plan lebenslang gratis erhalten. Danach eine vollständige 14-Tage-Testphase und dann entscheidest du, wie es mit Pro weitergeht: das Abo für 1,19 € alle sechs Monate, weniger als ein Kaffee alle sechs Monate, oder die lebenslange Freischaltung für 3,99 € auf Android und 4,99 € auf iPhone, weniger als eine Pizza. Ein kleiner Betrag hält die App am Leben und deine Daten auf Servern in Europa.",
        pt: "O FitMesh Sync lê o anel via Bluetooth e mostra passos, sono, batimentos, SpO2 e estresse no painel web, junto com o seu smartwatch, sem contagens duplicadas. O app Android já está disponível, com o painel web incluído; o app iOS já está disponível na App Store, incluindo todas as lojas da União Europeia. Os primeiros 1000 inscritos (programa encerrado desde 31 de julho de 2026) ganharam o plano Pro vitalício de graça. Depois, um teste completo de 14 dias e então você escolhe como continuar com o Pro: a assinatura por 1,19 € a cada seis meses, como um café a cada seis meses, ou o desbloqueio vitalício por 3,99 € no Android e 4,99 € no iPhone, menos que uma pizza. Pagar pouco mantém o app vivo e os seus dados em servidores na Europa.",
        fr: "FitMesh Sync lit la bague via Bluetooth et affiche les pas, le sommeil, la fréquence cardiaque, la SpO2 et le stress dans le panneau web, aux côtés de votre montre connectée, sans double comptage. L'application Android est disponible dès maintenant, tableau de bord web inclus ; l'application iOS est disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne. Les 1000 premiers inscrits (programme clos depuis le 31 juillet 2026) ont obtenu le plan Pro à vie gratuitement. Ensuite, un essai complet de 14 jours, puis vous choisissez comment continuer avec Pro : l'abonnement à 1,19 € tous les six mois, moins qu'un café tous les six mois, ou le déverrouillage à vie à 3,99 € sur Android et 4,99 € sur iPhone, moins qu'une pizza. Payer peu garde l'application en vie et vos données sur des serveurs en Europe.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        fr: "Vous installez FitMesh Sync sur Android depuis le Play Store, créez votre compte et ajoutez la bague : l'application la trouve en Bluetooth et récupère les données directement, sans avoir besoin de l'application du fabricant. À partir de là, vous voyez les pas, le sommeil, la fréquence cardiaque, la SpO2 et le stress dans le panneau web, accessible depuis n'importe quel navigateur avec le même compte. L'app iOS est désormais disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne. Pour les étapes en détail, il y a le [guide de configuration du Colmi R02](/fr/blog/colmi-r02-setup).",
      },
    },
  ],
  related: [
