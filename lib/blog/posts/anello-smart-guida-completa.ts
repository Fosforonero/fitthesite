  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        nl: "FitMesh Sync is in private beta. De eerste 1.000 aanmeldingen krijgen 1 jaar Pro gratis, inclusief multi-apparaat samenvoeging van ring en smartwatch in een enkel dashboard. Meld je nu aan om je plek te bewaren.",
        ja: "FitMesh Syncはプライベートベータ中です。最初の1,000人の登録者は、一つのダッシュボードでリングとスマートウォッチのマルチデバイス統合を含む1年間のProを無料で利用できます。今すぐ登録して枠を確保してください。",
        ko: "FitMesh Sync는 비공개 베타 중입니다. 처음 1,000명의 가입자는 단일 대시보드에서 링과 스마트워치의 멀티 기기 통합을 포함한 1년 Pro를 무료로 받습니다. 지금 가입하여 자리를 확보하세요.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        nl: "Het hangt af van het model. Sommige premium ringen vereisen een abonnement om geavanceerde functies te ontgrendelen; goedkope ringen doorgaans niet. Met FitMesh Sync stromen je ringgegevens naar een enkel dashboard, en de beta bevat 1 jaar Pro gratis voor vroege aanmeldingen.",
        ja: "モデルによって異なります。一部のプレミアムリングは高度な機能のロックを解除するためにサブスクリプションを必要とします。格安リングは通常必要ありません。FitMesh Syncを使えばリングデータが一つのダッシュボードに流れ込み、ベータでは早期登録者に1年間のProを無料で提供しています。",
        ko: "모델에 따라 다릅니다. 일부 프리미엄 링은 고급 기능을 잠금 해제하기 위해 구독이 필요합니다. 저렴한 링은 보통 필요하지 않습니다. FitMesh Sync를 사용하면 링 데이터가 단일 대시보드로 흘러 들어가며, 베타는 조기 가입자에게 1년 Pro를 무료로 포함합니다.",
      },
    },
    {
      q: {
