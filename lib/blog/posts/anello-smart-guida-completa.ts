  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders obtiennent le Pro à vie gratuit, incluant la fusion multi-appareils de bague et montre connectée dans un seul tableau de bord. Inscrivez-vous maintenant pour conserver votre place.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów otrzymuje dożywotnie Pro za darmo, w tym łączenie wielu urządzeń (pierścień + smartwatch) w jednym panelu. Zarejestruj się teraz, by zachować swoje miejsce.",
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu ömür boyu Pro'yu ücretsiz alır, tek bir panelde yüzük ve smartwatch çoklu cihaz birleştirmesi dahil. Yerinizi korumak için şimdi kaydolun.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders krijgen levenslang Pro gratis, inclusief multi-apparaat samenvoeging van ring en smartwatch in een enkel dashboard. Meld je nu aan om je plek te bewaren.",
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounderは永久版Proを無料で利用でき、一つのダッシュボードでリングとスマートウォッチのマルチデバイス統合も含まれます。今すぐ登録して枠を確保してください。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder는 평생 Pro를 무료로 받으며, 단일 대시보드에서 링과 스마트워치의 멀티 기기 통합도 포함됩니다. 지금 가입하여 자리를 확보하세요.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        fr: "Cela dépend du modèle. Certaines bagues premium nécessitent un abonnement pour débloquer les fonctions avancées; les bagues abordables généralement non. Avec FitMesh Sync, les données de votre bague affluent dans un seul tableau de bord, et les 1000 premiers founders obtiennent le Pro à vie gratuit.",
        pl: "To zależy od modelu. Niektóre pierścienie premium wymagają subskrypcji, by odblokować zaawansowane funkcje; tanie pierścienie zazwyczaj nie. Z FitMesh Sync dane z pierścienia trafiają do jednego panelu, a pierwszych 1000 founderów otrzymuje dożywotnie Pro za darmo.",
        tr: "Modele bağlıdır. Bazı premium yüzükler gelişmiş özellikleri açmak için abonelik gerektirir; uygun fiyatlı yüzükler genellikle gerektirmez. FitMesh Sync ile yüzük verileriniz tek bir panele akar ve ilk 1000 kurucu ömür boyu Pro'yu ücretsiz alır.",
        nl: "Het hangt af van het model. Sommige premium ringen vereisen een abonnement om geavanceerde functies te ontgrendelen; goedkope ringen doorgaans niet. Met FitMesh Sync stromen je ringgegevens naar een enkel dashboard, en de eerste 1000 founders krijgen levenslang Pro gratis.",
        ja: "モデルによって異なります。一部のプレミアムリングは高度な機能のロックを解除するためにサブスクリプションを必要とします。格安リングは通常必要ありません。FitMesh Syncを使えばリングデータが一つのダッシュボードに流れ込み、最初の1000名のfounderは永久版Proを無料で利用できます。",
        ko: "모델에 따라 다릅니다. 일부 프리미엄 링은 고급 기능을 잠금 해제하기 위해 구독이 필요합니다. 저렴한 링은 보통 필요하지 않습니다. FitMesh Sync를 사용하면 링 데이터가 단일 대시보드로 흘러 들어가며, 처음 1000명의 founder는 평생 Pro를 무료로 받습니다.",
      },
    },
    {
      q: {
