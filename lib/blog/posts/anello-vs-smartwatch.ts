...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile su Google Play. I primi 1000 founder ricevono il Pro a vita gratis, incluso l'accesso alla fusione multi-device anello e smartwatch. Iscriviti ora per tenere il posto.",
        en: "FitMesh Sync is available on Google Play. The first 1,000 founders get lifetime Pro free, including access to ring and smartwatch multi-device fusion. Sign up now to keep your spot.",
        es: "FitMesh Sync está disponible en Google Play. Los primeros 1000 founders obtienen el Pro de por vida gratis, incluido el acceso a la fusión multidispositivo de anillo y smartwatch. Apúntate ahora para reservar tu lugar.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder erhalten lebenslang Pro kostenlos, inklusive Zugang zur Multi-Device-Datenzusammenführung von Ring und Smartwatch. Jetzt anmelden und Platz sichern.",
        pt: "FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders recebem o Pro vitalício grátis, incluindo acesso à fusão multidispositivo de anel e smartwatch. Inscreva-se agora para garantir seu lugar.",
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders obtiennent le Pro à vie gratuit, avec accès à la fusion multi-appareils bague et montre connectée. Inscrivez-vous maintenant pour garder votre place.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów otrzymuje dożywotnie Pro za darmo, w tym dostęp do wielourządzeniowej fuzji pierścienia i smartwatcha. Zapisz się teraz, aby zachować miejsce.",
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu ömür boyu Pro'yu ücretsiz alır, yüzük ve akıllı saat çoklu cihaz birleşimine erişim dahil. Şimdi kaydol ve yerini koru.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders krijgen levenslang Pro gratis, inclusief toegang tot ring- en smartwatch multi-apparaatfusie. Meld je nu aan om je plek te bewaren.",
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounderは永久版Proを無料で利用でき、リングとスマートウォッチのマルチデバイス融合へのアクセスも含まれます。今すぐ登録して枠を確保してください。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder는 평생 Pro를 무료로 받으며, 링과 스마트워치 멀티 기기 융합 접근도 포함됩니다. 지금 등록하여 자리를 확보하세요.",
      },
      ctaLabel: {
