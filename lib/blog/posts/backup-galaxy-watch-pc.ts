...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        it: [
          "**Per dashboard**: FitMesh Sync legge da Health Connect e mostra tutto nell'app.",
        ...
        en: [
          "**For a dashboard**: FitMesh Sync reads from Health Connect and shows everything in the app.",
        ...
        es: [
          "**Para un panel**: FitMesh Sync lee desde Health Connect y muestra todo en la app.",
        ...
        de: [
          "**Für ein Dashboard**: FitMesh Sync liest aus Health Connect und zeigt alles in der App.",
        ...
        pt: [
          "**Para um painel**: FitMesh Sync lê do Health Connect e mostra tudo no app.",
        ...
        fr: [
          "**Pour un tableau de bord** : FitMesh Sync lit depuis Health Connect et affiche tout dans l'application.",
        ...
        pl: [
          "**Panel**: FitMesh Sync odczytuje z Health Connect i pokazuje wszystko w aplikacji.",
        ...
        tr: [
          "**Panel için**: FitMesh Sync, Health Connect'ten okur ve her şeyi uygulamada gösterir.",
        ...
        nl: [
          "**Voor een dashboard**: FitMesh Sync leest van Health Connect en toont alles in de app.",
        ...
        ja: [
          "**ダッシュボード用**: FitMesh SyncはHealth Connectから読み取り、アプリにすべてを表示します。",
        ...
        ko: [
          "**대시보드용**: FitMesh Sync는 Health Connect에서 읽어 앱에 모든 것을 표시합니다.",
    ...
    },
    {
      type: "cta",
      title: {
        it: "Cerchi una dashboard pronta per i dati Galaxy Watch?",
        en: "Looking for a ready dashboard for Galaxy Watch data?",
        es: "¿Buscas un panel listo para los datos del Galaxy Watch?",
        de: "Suchst du ein fertiges Dashboard für Galaxy Watch-Daten?",
        pt: "Procurando um painel pronto para os dados do Galaxy Watch?",
        fr: "Vous cherchez un tableau de bord prêt pour les données du Galaxy Watch ?",
        pl: "Czy szukasz panelu kontrolnego dla danych Galaxy Watch?",
        tr: "Araştırmalarınız için uygun bir veri Galaxy Watch panosu arıyorsunuz?",
        nl: "Op zoek naar een kant-en-klaar dashboard voor Galaxy Watch-gegevens?",
        ja: "Galaxy Watchデータのすぐに使えるダッシュボードをお探しですか？",
        ko: "Galaxy Watch 데이터를 위한 바로 사용 가능한 대시보드를 찾고 있나요?",
      },
      body: {
        it: "FitMesh Sync legge da Samsung Health via Health Connect e mostra passi, BPM, sonno e allenamenti nell'app. Setup di 30 secondi sul telefono.",
        en: "FitMesh Sync reads from Samsung Health via Health Connect and shows steps, HR, sleep and workouts in the app. 30-second phone setup.",
        es: "FitMesh Sync lee de Samsung Health a través de Health Connect y muestra pasos, frecuencia cardíaca, sueño y entrenamientos en la app. Configuración en 30 segundos desde el teléfono.",
        de: "FitMesh Sync liest aus Samsung Health über Health Connect und zeigt Schritte, Herzfrequenz, Schlaf und Trainings in der App. Einrichtung in 30 Sekunden auf dem Telefon.",
        pt: "FitMesh Sync lê do Samsung Health via Health Connect e mostra passos, frequência cardíaca, sono e treinos no app. Configuração em 30 segundos no celular.",
        fr: "FitMesh Sync lit depuis Samsung Health via Health Connect et affiche pas, fréquence cardiaque, sommeil et séances d'entraînement dans l'application. Configuration en 30 secondes sur le téléphone.",
        pl: "FitMesh Sync odczytuje z Samsung Health przez Health Connect i wyświetla kroki, BPM, sen i treningi w aplikacji. Konfiguracja w 30 sekund na telefonie.",
        tr: "FitMesh Sync KVKK'ye uygun olarak Samsung Health üzerinden Health Connect ile ve gösterir pasları, BPM, uyku ve egzersizleri uygulamada. Telefondan 30 saniye setup'u.",
        nl: "FitMesh Sync leest van Samsung Health via Health Connect en toont stappen, hartslag, slaap en trainingen in de app. Instelling in 30 seconden op de telefoon.",
        ja: "FitMesh SyncはHealth Connect経由でSamsung Healthから読み取り、歩数、心拍数、睡眠、ワークアウトをアプリに表示します。スマートフォンで30秒でセットアップ。",
        ko: "FitMesh Sync는 Health Connect를 통해 Samsung Health에서 읽어 걸음 수, 심박수, 수면, 운동을 앱에 표시합니다. 휴대폰에서 30초 설정.",
      },
      ctaLabel: {
