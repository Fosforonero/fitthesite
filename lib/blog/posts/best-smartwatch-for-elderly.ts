...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "Tra le opzioni che semplificano questo c'è FitMesh Sync: aggrega dati da Galaxy Watch e altri wearable in una dashboard web accessibile da browser. Utile per caregiver che vogliono una vista unificata senza aprire multiple app.",
        ...
        pl: "Miedzy opcjami upraszczającymi to proces znajduje się FitMesh Sync: łączy dane z Galaxy Watch oraz inne wearable w interfejsie użytkownika dostępny przez przeglądarki. Wydatny dla opiekunów, którzy chcą mieć unifikowaną widoczność bez otwierania wielu aplikacji.",
        tr: "Tra seçeneklerin bu olan FitMesh Sync: Galaxy Watch verilerini ve diğer giyilebilir cihazlar toplar ve bunları erişilebilir bir web tabanlı panelde sunar. Bakıcıların birden fazla uygulamayı açmadan tek bir yerden tüm bilgiye ulaşmasını sağlar.",
