...
export const post: BlogPost = {
  ...
  secondaryKeywords: {
    ...
    de: [
      "beste Smartwatch für Senioren 2026",
      "Smartwatch für Senioren mit Gesundheitsüberwachung",
      "Smartwatch Sturzerkennung Senioren",
      "Smartwatch für Senioren mit Herzproblemen",
      "einfache Smartwatch für Senioren",
],
    es: [
      "mejor smartwatch para personas mayores 2026",
      "smartwatch para mayores con monitoreo de salud",
      "smartwatch detección de caídas mayores",
      "smartwatch para mayores con problemas cardíacos",
      "smartwatch fácil de usar para mayores",
    ],
  },
  metaDescription: {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "Tra le opzioni che semplificano questo c'è FitMesh Sync: aggrega dati da Galaxy Watch e altri wearable nell'app. Utile per caregiver che vogliono una vista unificata senza aprire multiple app.",
        en: "Among the options that simplify this is FitMesh Sync: it aggregates data from Galaxy Watch, and other wearables in the app. Useful for caregivers who want a unified view without opening multiple apps.",
        es: "Entre las opciones que lo simplifican está FitMesh Sync: agrega datos de Galaxy Watch y otros wearables en la app. Útil para cuidadores que quieren una vista unificada sin abrir varias apps.",
        de: "Eine Option, die dies vereinfacht, ist FitMesh Sync: Es bündelt Daten von Galaxy Watch und anderen Wearables in der App. Nützlich für Betreuungspersonen, die eine einheitliche Übersicht haben möchten, ohne mehrere Apps zu öffnen.",
        pt: "Entre as opções que simplificam isso está o FitMesh Sync: ele agrega dados do Galaxy Watch e outros wearables no aplicativo. Útil para cuidadores que querem uma visão unificada sem abrir vários aplicativos.",
        fr: "Parmi les options qui simplifient cela figure FitMesh Sync: il agrège les données de Galaxy Watch et d'autres wearables dans l'application. Utile pour les aidants qui souhaitent une vue unifiée sans ouvrir plusieurs applications.",
        pl: "Miedzy opcjami upraszczającymi to proces znajduje się FitMesh Sync: łączy dane z Galaxy Watch oraz inne wearable w aplikacji. Wydatny dla opiekunów, którzy chcą mieć unifikowaną widoczność bez otwierania wielu aplikacji.",
        tr: "Tra seçeneklerin bu olan FitMesh Sync: Galaxy Watch verilerini ve diğer giyilebilir cihazlar toplar ve bunları uygulamada sunar. Bakıcıların birden fazla uygulamayı açmadan tek bir yerden tüm bilgiye ulaşmasını sağlar.",
        nl: "Een van de opties die dit vereenvoudigt is FitMesh Sync: het verzamelt gegevens van Galaxy Watch en andere wearables in de app. Handig voor verzorgers die een geünificeerd overzicht willen zonder meerdere apps te openen.",
        ja: "これを簡素化するオプションの一つがFitMesh Syncです：Galaxy Watchやその他のウェアラブルからのデータをアプリに集約します。複数のアプリを開かずに統一された画面を望む介護者に役立ちます。",
        ko: "이를 단순화하는 옵션 중 하나가 FitMesh Sync입니다: Galaxy Watch 및 기타 웨어러블의 데이터를 앱에 집계합니다. 여러 앱을 열지 않고 통합된 보기를 원하는 보호자에게 유용합니다.",
      },
      ctaLabel: {
