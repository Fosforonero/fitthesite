...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile ora su Android e su iPhone (live sull'App Store, incluse tutte le storefront dell'Unione Europea), con dashboard web inclusa. I primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ricevuto il Pro a vita gratis; oggi c'è una prova completa di 14 giorni, poi lo tieni con un piccolo abbonamento o con lo sblocco a vita (circa un caffè ogni sei mesi, o meno di una pizza). Scaricala oggi e inizia a costruire uno storico che sopravvive al prossimo cambio di orologio.",
        en: "FitMesh Sync is available now on Android and on iPhone (live on the App Store, including all European Union storefronts), with the web dashboard included. The first 1,000 founder sign-ups (program closed as of July 31, 2026) got lifetime Pro free; today there is a full 14-day trial, then you keep it with a small subscription or a one-time lifetime unlock (about a coffee every six months, or less than a pizza). Download it today and start building a history that survives your next change of watch.",
        es: "FitMesh Sync ya está disponible en Android y en iPhone (activo en la App Store, incluidas todas las tiendas de la Unión Europea), con el panel web incluido. Los primeros 1000 registrados founder (programa cerrado desde el 31 de julio de 2026) consiguieron el Pro de por vida gratis; hoy hay una prueba completa de 14 días, y luego lo mantienes con una pequeña suscripción o con el desbloqueo de por vida (como un café cada seis meses, o menos que una pizza). Descárgala hoy y empieza a construir un historial que sobreviva a tu próximo cambio de reloj.",
        de: "FitMesh Sync ist ab sofort für Android und für iPhone verfügbar (im App Store live, einschließlich aller Storefronts der Europäischen Union), inklusive Web-Dashboard. Die ersten 1.000 founder-Anmeldungen (Programm seit dem 31. Juli 2026 geschlossen) haben Pro lebenslang gratis erhalten; heute gibt es eine volle 14-tägige Testphase, und anschließend behältst du es mit einem kleinen Abo oder der einmaligen Freischaltung fürs Leben (weniger als ein Kaffee alle sechs Monate oder weniger als eine Pizza). Lade sie dir noch heute herunter und beginne einen Verlauf aufzubauen, der deinen nächsten Uhrenwechsel übersteht.",
        pt: "O FitMesh Sync já está disponível no Android e no iPhone (ativo na App Store, incluindo todas as lojas da União Europeia), com o painel web incluído. Os primeiros 1000 inscritos founder (programa encerrado desde 31 de julho de 2026) ganharam o Pro vitalício de graça; hoje há uma avaliação completa de 14 dias e, em seguida, você o mantém com uma pequena assinatura ou com o desbloqueio vitalício (como um café a cada seis meses, ou menos que uma pizza). Baixe-o hoje e comece a construir um histórico que sobrevive à sua próxima troca de relógio.",
        fr: "FitMesh Sync est disponible dès maintenant sur Android et sur iPhone (actif sur l'App Store, y compris dans toutes les boutiques de l'Union européenne), avec le tableau de bord web inclus. Les 1000 premiers inscrits founder (programme clos depuis le 31 juillet 2026) ont obtenu le Pro à vie gratuitement ; aujourd'hui, il y a un essai complet de 14 jours, puis vous le gardez avec un petit abonnement ou un déblocage à vie en un seul paiement (moins qu'un café tous les six mois, ou moins qu'une pizza). Téléchargez-la dès aujourd'hui et commencez à bâtir un historique qui survit à votre prochain changement de montre.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "L'app Android è disponibile ora con dashboard web inclusa. I primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ricevuto il Pro a vita gratis. Oggi c'è una prova completa di 14 giorni, poi tieni FitMesh con un piccolo abbonamento (circa un caffè ogni sei mesi) o con lo sblocco a vita (meno di una pizza). Non c'è un piano gratuito permanente; il prezzo aggiornato per il tuo Paese è mostrato nell'app.",
        en: "The Android app is available now with the web dashboard included. The first 1,000 founder sign-ups (program closed as of July 31, 2026) got lifetime Pro free. Today there is a full 14-day trial, then you keep FitMesh with a small subscription (about a coffee every six months) or a one-time lifetime unlock (less than a pizza). There is no permanent free plan; the current price for your country is shown in the app.",
        es: "La app de Android ya está disponible con el panel web incluido. Los primeros 1000 registrados founder (programa cerrado desde el 31 de julio de 2026) recibieron el Pro de por vida gratis. Hoy hay una prueba completa de 14 días, y luego mantienes FitMesh con una pequeña suscripción (como un café cada seis meses) o con el desbloqueo de por vida (menos que una pizza). No hay un plan gratuito permanente; el precio actualizado para tu país se muestra en la app.",
        de: "Die Android-App ist ab sofort verfügbar, inklusive Web-Dashboard. Die ersten 1.000 founder-Anmeldungen (Programm seit dem 31. Juli 2026 geschlossen) haben Pro lebenslang gratis erhalten. Heute gibt es eine volle 14-tägige Testphase, und anschließend behältst du FitMesh mit einem kleinen Abo (weniger als ein Kaffee alle sechs Monate) oder der einmaligen Freischaltung fürs Leben (weniger als eine Pizza). Es gibt keinen dauerhaft kostenlosen Tarif; der aktuelle Preis für dein Land wird in der App angezeigt.",
        pt: "O app de Android já está disponível com o painel web incluído. Os primeiros 1000 inscritos founder (programa encerrado desde 31 de julho de 2026) receberam o Pro vitalício de graça. Hoje, há uma avaliação completa de 14 dias e, em seguida, você mantém o FitMesh com uma pequena assinatura (como um café a cada seis meses) ou com o desbloqueio vitalício (menos que uma pizza). Não existe um plano gratuito permanente; o preço atualizado para o seu país aparece no app.",
        fr: "L'application Android est disponible dès maintenant, avec le tableau de bord web inclus. Les 1000 premiers inscrits founder (programme clos depuis le 31 juillet 2026) ont reçu le Pro à vie gratuitement. Aujourd'hui, il y a un essai complet de 14 jours, puis vous gardez FitMesh avec un petit abonnement (moins qu'un café tous les six mois) ou un déblocage à vie en un seul paiement (moins qu'une pizza). Il n'y a pas de forfait gratuit permanent ; le prix à jour pour votre pays est affiché dans l'application.",
      },
    },
    {
      q: {
