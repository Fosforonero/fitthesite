...
export const post: BlogPost = {
  ...
  tldr: {
    ...
    pt: [
      ...
      "Ele reúne marcas diferentes em um único painel sem duplicatas: via Health Connect no Android, Apple Health no iPhone (em breve) e o anel Colmi por Bluetooth.",
    ...
    fr: [
      ...
      "Il réunit des marques différentes dans un seul tableau de bord dédoublonné : via Health Connect sur Android, Apple Health sur iPhone (à venir) et la bague Colmi par Bluetooth.",
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        pt: "O FitMesh Sync já está disponível no Android, com o painel web incluído. Os primeiros 1000 inscritos founder ganham o Pro vitalício de graça; depois, há uma avaliação completa de 14 dias e, em seguida, você o mantém com uma pequena assinatura ou com o desbloqueio vitalício (como um café a cada seis meses, ou menos que uma pizza). A versão para iPhone está a caminho: entre na beta para tê-la no lançamento e começar a construir um histórico que sobrevive à sua próxima troca de relógio.",
        fr: "FitMesh Sync est disponible dès maintenant sur Android, avec le tableau de bord web inclus. Les 1000 premiers inscrits founder obtiennent le Pro à vie gratuitement ; ensuite, il y a un essai complet de 14 jours, puis vous le gardez avec un petit abonnement ou un déblocage à vie en un seul paiement (moins qu'un café tous les six mois, ou moins qu'une pizza). La version iPhone arrive : rejoignez la bêta pour l'avoir dès le lancement et commencer à bâtir un historique qui survit à votre prochain changement de montre.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        pt: "Sim. No Android o FitMesh lê os dados via Health Connect, no qual a maioria dos apps dos fabricantes escreve, e lê o anel Colmi diretamente por Bluetooth. Assim, marcas diferentes convergem no mesmo painel, sem duplicatas. No iPhone a versão que está por vir vai escrever no Apple Health.",
        fr: "Oui. Sur Android, FitMesh lit les données via Health Connect, dans lequel la plupart des applications de fabricants écrivent, et lit la bague Colmi directement par Bluetooth. Des marques différentes convergent ainsi dans le même tableau de bord, dédoublonnées. Sur iPhone, la version à venir écrira dans Apple Health.",
      },
    },
    {
      q: {
