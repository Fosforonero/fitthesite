...
export const post: BlogPost = {
  ...
  body: [
    ...
    // --- CTA ---
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile su Google Play. I primi 1000 founder ricevono il Pro a vita gratis, incluso l'accesso alla funzione anello Colmi non appena rilasciata. Iscriviti entro il 31 luglio 2026 per tenere il posto.",
        ...
        es: "FitMesh Sync está disponible en Google Play. Los primeros 1000 founders obtienen el Pro de por vida gratis, incluido el acceso a la función del anillo Colmi en cuanto esté disponible. Regístrate ahora para reservar tu lugar.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder erhalten lebenslang Pro kostenlos, einschließlich Zugang zur Colmi-Ring-Funktion, sobald diese verfügbar ist. Melde dich jetzt an, um deinen Platz zu sichern.",
        pt: "O FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders recebem o Pro vitalício grátis, incluindo acesso à função do anel Colmi assim que for lançada. Inscreva-se agora para garantir sua vaga.",
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders obtiennent le Pro à vie gratuit, incluant l'accès à la fonctionnalité bague Colmi dès sa disponibilité. Inscrivez-vous maintenant pour garder votre place.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów otrzymuje dożywotnie Pro za darmo, w tym dostęp do funkcji pierścienia Colmi od razu po jej wydaniu. Zapisz się teraz, aby zachować swoje miejsce.",
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu ömür boyu Pro'yu ücretsiz alır, Colmi yüzük özelliğine çıkar çıkmaz erişim dahil. Yerinizi ayırtmak için şimdi kaydolun.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders krijgen levenslang Pro gratis, inclusief toegang tot de Colmi ring-functie zodra die beschikbaar is. Meld je nu aan om je plek te reserveren.",
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounderは永久版Proを無料で利用でき、Colmiリング機能のリリース時のアクセスも含まれます。今すぐ登録してスポットを確保しましょう。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder는 평생 Pro를 무료로 받으며, Colmi 링 기능이 출시되는 즉시 이용할 수 있는 접근권도 포함됩니다. 지금 등록하여 자리를 확보하세요.",
      },
      ctaLabel: {
