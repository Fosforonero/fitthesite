...
export const post: BlogPost = {
  ...
  tldr: {
    ...
    nl: [
      ...
      "Nachtelijke data (HRV, SpO2, slaapfasen) verschijnen elke ochtend automatisch na de eerste synchronisatie.",
    ],
    ja: [
      ...
      "夜間データ（HRV、SpO2、睡眠ステージ）は初回同期後、毎朝自動的に取得されます。",
    ],
    ko: [
      ...
      "야간 데이터(HRV, SpO2, 수면 단계)는 첫 번째 동기화 후 매일 아침 자동으로 업데이트됩니다.",
    ],
  },
  body: [
    // --- WHAT'S IN THE BOX ---
    ...
    },
    {
      ...
      items: {
        ...
        nl: [
          ...
          "**Volgende synchronisaties**: toekomstige synchronisaties verlopen automatisch elke keer dat de ring binnen bereik van je telefoon is. Je hoeft niets handmatig te doen.",
        ],
        ja: [
          ...
          "**その後の同期**：以降の同期は、リングがスマートフォンの範囲内にあるたびに自動的に行われます。手動での操作は不要です。",
        ],
        ko: [
          ...
          "**이후 동기화**: 링이 휴대폰 범위 내에 있을 때마다 자동으로 동기화됩니다. 수동으로 아무것도 할 필요가 없습니다.",
        ],
      },
    },
    {
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "La connessione Bluetooth tra FitMesh Sync e l'anello Colmi avviene su Android, dove i dati vengono raccolti e caricati sul tuo account FitMesh. Una volta che i dati sono nel tuo account, però, li puoi vedere ovunque: l'app FitMesh per iPhone (iOS) è live sull'App Store negli store supportati al di fuori dell'Unione Europea (il rilascio nei 27 paesi UE è in corso), con il ponte opzionale verso Apple Salute.",
        en: "The Bluetooth connection between FitMesh Sync and the Colmi ring happens on Android, where the data is collected and uploaded to your FitMesh account. Once the data is in your account, however, you can access it anywhere: the FitMesh app for iPhone (iOS) is live on the App Store in supported storefronts outside the European Union (EU rollout is in progress), with the optional Apple Health bridge included.",
        es: "La conexión Bluetooth entre FitMesh Sync y el anillo Colmi se realiza en Android, donde los datos se recopilan y se suben a tu cuenta FitMesh. Una vez que los datos están en tu cuenta, puedes acceder a ellos desde cualquier lugar: la app FitMesh para iPhone (iOS) ya está disponible en App Store en las tiendas compatibles fuera de la Unión Europea (el despliegue en los 27 países de la UE está en curso), con el puente opcional hacia Apple Health incluido.",
        de: "Die Bluetooth-Verbindung zwischen FitMesh Sync und dem Colmi Ring läuft über Android, wo die Daten erfasst und in dein FitMesh-Konto hochgeladen werden. Sind die Daten einmal in deinem Konto, kannst du sie überall abrufen: Die FitMesh-App für iPhone (iOS) ist live im App Store in unterstützten Stores außerhalb der Europäischen Union (die Einführung in den 27 EU-Ländern läuft), inklusive der optionalen Apple-Health-Anbindung.",
        pt: "A conexão Bluetooth entre o FitMesh Sync e o anel Colmi acontece no Android, onde os dados são coletados e enviados para a sua conta FitMesh. Uma vez que os dados estão na sua conta, você pode acessá-los de qualquer lugar: o app FitMesh para iPhone (iOS) já está disponível na App Store nas lojas compatíveis fora da União Europeia (o lançamento nos 27 países da UE está em andamento), com a integração opcional com o Apple Health incluída.",
        fr: "La connexion Bluetooth entre FitMesh Sync et la bague Colmi s'effectue sur Android, où les données sont collectées et téléversées sur votre compte FitMesh. Une fois les données dans votre compte, vous pouvez y accéder partout: l'application FitMesh pour iPhone (iOS) est disponible sur l'App Store dans les magasins pris en charge en dehors de l'Union européenne (le déploiement dans les 27 pays de l'UE est en cours), avec le pont optionnel vers Apple Health inclus.",
        pl: "Połączenie Bluetooth między FitMesh Sync a pierścieniem Colmi odbywa się na Androidzie, gdzie dane są zbierane i przesyłane na konto FitMesh. Gdy dane znajdą się na koncie, możesz uzyskać do nich dostęp z dowolnego miejsca: aplikacja FitMesh na iPhone'a (iOS) jest już dostępna w App Store w obsługiwanych sklepach poza Unią Europejską (wdrożenie w 27 krajach UE jest w toku), wraz z opcjonalnym mostem do Apple Health.",
        tr: "FitMesh Sync ile Colmi yüzüğü arasındaki Bluetooth bağlantısı Android'de gerçekleşir; veriler burada toplanır ve FitMesh hesabınıza yüklenir. Veriler hesabınıza girdikten sonra her yerden erişebilirsiniz: iPhone için FitMesh uygulaması (iOS) Avrupa Birliği dışındaki desteklenen mağazalarda App Store'da yayında (27 AB ülkesinde dağıtım sürüyor), isteğe bağlı Apple Health köprüsü dahil.",
        nl: "De Bluetooth-verbinding tussen FitMesh Sync en de Colmi ring verloopt via Android, waar de data wordt verzameld en geüpload naar je FitMesh-account. Zodra de data in je account staat, kun je er overal bij: de FitMesh-app voor iPhone (iOS) is live in de App Store in ondersteunde winkels buiten de Europese Unie (de uitrol in de 27 EU-landen is bezig), inclusief de optionele Apple Health-brug.",
        ja: "FitMesh Sync と Colmi リングの Bluetooth 接続は Android 上で行われ、データが収集されて FitMesh アカウントにアップロードされます。データがアカウントに入ると、どこからでもアクセスできます。iPhone 用 FitMesh アプリ（iOS）は欧州連合（EU）域外の対応ストアで App Store にて配信中です（EU加盟27カ国への展開は準備中です）。オプションの Apple ヘルス連携も含まれます。",
        ko: "FitMesh Sync와 Colmi 링 사이의 Bluetooth 연결은 Android에서 이루어지며, 데이터가 수집되어 FitMesh 계정에 업로드됩니다. 데이터가 계정에 들어오면 어디서든 접근할 수 있습니다. iPhone용 FitMesh 앱（iOS）은 유럽연합（EU） 역외의 지원되는 스토어에서 App Store를 통해 이용 가능합니다（EU 27개국 배포는 진행 중입니다）. 선택적 Apple Health 브리지도 포함됩니다.",
      },
    },
    {
      type: "callout",
      ...
      body: {
        it: "Se usi iPhone, configura l'anello Colmi tramite FitMesh Sync su un dispositivo Android (il tuo, o quello di un familiare). I dati vengono caricati sul tuo account FitMesh e sono già accessibili dall'app iOS di FitMesh Sync, live sull'App Store. In aggiunta, il ponte opzionale verso Apple Salute ti permetterà di far confluire le metriche dell'anello (sonno, battito, SpO2) direttamente nell'app Salute di Apple. L'app iOS è disponibile negli store supportati al di fuori dell'Unione Europea; il rilascio nei 27 paesi UE è in corso.",
        en: "If you use iPhone, set up the Colmi ring via FitMesh Sync on an Android device (yours or a family member's). The data is uploaded to your FitMesh account and is already accessible from the FitMesh Sync iOS app, live on the App Store. Additionally, the optional Apple Health bridge lets ring metrics (sleep, heart rate, SpO2) flow directly into Apple's Health app. The iOS app is available in supported storefronts outside the European Union; EU rollout is in progress.",
        es: "Si usas iPhone, configura el anillo Colmi a través de FitMesh Sync en un dispositivo Android (el tuyo o el de un familiar). Los datos se suben a tu cuenta FitMesh y ya están accesibles desde la app iOS de FitMesh Sync, disponible en App Store. Además, el puente opcional hacia Apple Health permite que las métricas del anillo (sueño, frecuencia cardíaca, SpO2) lleguen directamente a la app Salud de Apple. La app iOS está disponible en las tiendas compatibles fuera de la Unión Europea; el despliegue en los 27 países de la UE está en curso.",
        de: "Wenn du ein iPhone verwendest, richte den Colmi Ring über FitMesh Sync auf einem Android-Gerät ein (deinem eigenen oder dem eines Familienmitglieds). Die Daten werden in dein FitMesh-Konto hochgeladen und sind bereits über die FitMesh Sync iOS-App abrufbar, live im App Store. Zusätzlich ermöglicht die optionale Apple-Health-Anbindung, dass die Ringmetriken (Schlaf, Herzfrequenz, SpO2) direkt in die Apple-Health-App fließen. Die iOS-App ist in unterstützten Stores außerhalb der Europäischen Union verfügbar; die Einführung in den 27 EU-Ländern läuft.",
        pt: "Se você usa iPhone, configure o anel Colmi via FitMesh Sync em um dispositivo Android (o seu ou de um familiar). Os dados são enviados para a sua conta FitMesh e já ficam acessíveis pelo app iOS do FitMesh Sync, disponível na App Store. Além disso, a integração opcional com o Apple Health permite que as métricas do anel (sono, frequência cardíaca, SpO2) cheguem diretamente ao app Saúde da Apple. O app iOS está disponível nas lojas compatíveis fora da União Europeia; o lançamento nos 27 países da UE está em andamento.",
        fr: "Si vous utilisez un iPhone, configurez la bague Colmi via FitMesh Sync sur un appareil Android (le vôtre ou celui d'un proche). Les données sont téléversées sur votre compte FitMesh et sont déjà accessibles depuis l'application iOS de FitMesh Sync, disponible sur l'App Store. De plus, le pont optionnel vers Apple Health permet aux métriques de la bague (sommeil, fréquence cardiaque, SpO2) d'arriver directement dans l'application Santé d'Apple. L'application iOS est disponible dans les magasins pris en charge en dehors de l'Union européenne ; le déploiement dans les 27 pays de l'UE est en cours.",
        pl: "Jeśli używasz iPhone'a, skonfiguruj pierścień Colmi przez FitMesh Sync na urządzeniu z Androidem (swoim lub rodziny). Dane zostaną przesłane na konto FitMesh i są już dostępne w aplikacji iOS FitMesh Sync, dostępnej w App Store. Dodatkowo opcjonalny most do Apple Health pozwala metrykom pierścienia (sen, tętno, SpO2) trafiać bezpośrednio do aplikacji Zdrowie Apple. Aplikacja iOS jest dostępna w obsługiwanych sklepach poza Unią Europejską; wdrożenie w 27 krajach UE jest w toku.",
        tr: "iPhone kullanıyorsanız, Colmi yüzüğünü bir Android cihazda (sizin veya bir aile üyenizin) FitMesh Sync aracılığıyla kurun. Veriler FitMesh hesabınıza yüklenir ve FitMesh Sync iOS uygulaması üzerinden zaten erişilebilir durumdadır, App Store'da yayında. Ayrıca isteğe bağlı Apple Health köprüsü, yüzük metriklerinin (uyku, kalp atış hızı, SpO2) doğrudan Apple Sağlık uygulamasına akmasını sağlar. iOS uygulaması Avrupa Birliği dışındaki desteklenen mağazalarda mevcuttur; 27 AB ülkesinde dağıtım sürmektedir.",
        nl: "Als je een iPhone gebruikt, stel de Colmi ring in via FitMesh Sync op een Android-apparaat (van jezelf of een familielid). De data wordt geüpload naar je FitMesh-account en is al toegankelijk via de FitMesh Sync iOS-app, live in de App Store. Bovendien laat de optionele Apple Health-brug ringmeetwaarden (slaap, hartslag, SpO2) direct doorstromen naar de Apple Gezondheid-app. De iOS-app is beschikbaar in ondersteunde winkels buiten de Europese Unie; de uitrol in de 27 EU-landen is bezig.",
        ja: "iPhone を使っている場合は、Android デバイス（自分のもの、または家族のもの）で FitMesh Sync を通じて Colmi リングを設定してください。データは FitMesh アカウントにアップロードされ、FitMesh Sync の iOS アプリ（App Store で配信中）からすでにアクセスできます。さらに、オプションの Apple ヘルス連携により、リングのメトリクス（睡眠、心拍数、SpO2）が直接 Apple のヘルスアプリに流れ込みます。iOS アプリは欧州連合（EU）域外の対応ストアで利用可能です（EU加盟27カ国への展開は準備中です）。",
        ko: "iPhone을 사용하는 경우, Android 기기（자신의 것 또는 가족의 것）에서 FitMesh Sync를 통해 Colmi 링을 설정하세요. 데이터는 FitMesh 계정에 업로드되며 FitMesh Sync iOS 앱（App Store에서 이용 가능）을 통해 이미 접근할 수 있습니다. 또한 선택적 Apple Health 브리지를 통해 링 측정값（수면, 심박수, SpO2）이 Apple 건강 앱으로 직접 전달됩니다. iOS 앱은 유럽연합（EU） 역외의 지원되는 스토어에서 이용 가능합니다（EU 27개국 배포는 진행 중입니다）.",
      },
    },
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "La connessione Bluetooth tra FitMesh Sync e l'anello Colmi richiede Android. Una volta configurato su Android, però, i dati vengono caricati sul tuo account FitMesh e sono già visibili anche su iPhone tramite l'app iOS di FitMesh, live sull'App Store negli store supportati al di fuori dell'Unione Europea (il rilascio nei 27 paesi UE è in corso), oltre che facoltativamente su Apple Salute. Se usi solo iPhone, ti basterà un dispositivo Android (anche non tuo) per l'abbinamento iniziale dell'anello.",
        en: "The Bluetooth connection between FitMesh Sync and the Colmi ring requires Android. Once set up on Android, however, the data is uploaded to your FitMesh account and is already viewable on iPhone through the FitMesh iOS app, live on the App Store in supported storefronts outside the European Union (EU rollout is in progress), as well as optionally in Apple Health. If you only have an iPhone, you'll just need an Android device (even a borrowed one) for the ring's initial pairing.",
        es: "La conexión Bluetooth entre FitMesh Sync y el anillo Colmi requiere Android. Una vez configurado en Android, los datos se suben a tu cuenta FitMesh y ya se pueden ver en iPhone a través de la app iOS de FitMesh, disponible en App Store en las tiendas compatibles fuera de la Unión Europea (el despliegue en los 27 países de la UE está en curso), además de, opcionalmente, en Apple Health. Si solo tienes iPhone, te bastará un dispositivo Android (aunque no sea tuyo) para el emparejamiento inicial del anillo.",
        de: "Die Bluetooth-Verbindung zwischen FitMesh Sync und dem Colmi Ring erfordert Android. Nach der Einrichtung auf Android werden die Daten in dein FitMesh-Konto hochgeladen und sind bereits auf dem iPhone über die FitMesh iOS-App abrufbar, live im App Store in unterstützten Stores außerhalb der Europäischen Union (die Einführung in den 27 EU-Ländern läuft), sowie optional in Apple Health. Wenn du nur ein iPhone hast, brauchst du für die erste Kopplung des Rings lediglich ein Android-Gerät (auch ein geliehenes).",
        pt: "A conexão Bluetooth entre o FitMesh Sync e o anel Colmi requer Android. Uma vez configurado no Android, os dados são enviados para a sua conta FitMesh e já ficam visíveis no iPhone pelo app iOS do FitMesh, disponível na App Store nas lojas compatíveis fora da União Europeia (o lançamento nos 27 países da UE está em andamento), além de, opcionalmente, no Apple Health. Se você usa apenas iPhone, basta um dispositivo Android (mesmo emprestado) para o pareamento inicial do anel.",
        fr: "La connexion Bluetooth entre FitMesh Sync et la bague Colmi nécessite Android. Une fois configurée sur Android, les données sont téléversées sur votre compte FitMesh et sont déjà consultables sur iPhone via l'application iOS FitMesh, disponible sur l'App Store dans les magasins pris en charge en dehors de l'Union européenne (le déploiement dans les 27 pays de l'UE est en cours), ainsi que, en option, dans Apple Health. Si vous n'avez qu'un iPhone, il vous suffit d'un appareil Android (même emprunté) pour l'appairage initial de la bague.",
        pl: "Połączenie Bluetooth między FitMesh Sync a pierścieniem Colmi wymaga Androida. Po skonfigurowaniu na Androidzie dane są jednak przesyłane na Twoje konto FitMesh i są już widoczne na iPhonie w aplikacji iOS FitMesh, dostępnej w App Store w obsługiwanych sklepach poza Unią Europejską (wdrożenie w 27 krajach UE jest w toku), a opcjonalnie także w Apple Health. Jeśli masz tylko iPhone'a, wystarczy urządzenie z Androidem (nawet pożyczone) do wstępnego sparowania pierścienia.",
        tr: "FitMesh Sync ile Colmi yüzüğü arasındaki Bluetooth bağlantısı Android gerektirir. Android'de kurulumdan sonra veriler FitMesh hesabınıza yüklenir ve iPhone'da da FitMesh iOS uygulaması üzerinden görüntülenebilir; uygulama Avrupa Birliği dışındaki desteklenen mağazalarda App Store'da yayında (27 AB ülkesinde dağıtım sürüyor), isteğe bağlı olarak Apple Health üzerinden de erişilebilir. Sadece iPhone kullanıyorsanız, yüzüğün ilk eşleştirmesi için (ödünç alınan biri dahil) bir Android cihaza ihtiyacınız olacaktır.",
        nl: "De Bluetooth-verbinding tussen FitMesh Sync en de Colmi ring vereist Android. Eenmaal ingesteld op Android worden de data geüpload naar je FitMesh-account en zijn ze al te bekijken op iPhone via de FitMesh iOS-app, live in de App Store in ondersteunde winkels buiten de Europese Unie (de uitrol in de 27 EU-landen is bezig), en optioneel ook in Apple Health. Heb je alleen een iPhone, dan heb je enkel een Android-toestel nodig (ook geleend) voor het eerste koppelen van de ring.",
        ja: "FitMesh Sync と Colmi リングの Bluetooth 接続には Android が必要です。ただし、Android で設定した後は、データは FitMesh アカウントにアップロードされ、FitMesh iOS アプリ（欧州連合（EU）域外の対応ストアで App Store にて配信中、EU加盟27カ国への展開は準備中）を通じて iPhone でもすでに確認でき、オプションで Apple ヘルスにも連携できます。iPhone しかお持ちでない場合は、リングの最初のペアリングに Android 端末（借り物でも可）が必要になります。",
        ko: "FitMesh Sync와 Colmi 링 사이의 Bluetooth 연결에는 Android가 필요합니다. 하지만 Android에서 설정을 마치면 데이터는 FitMesh 계정에 업로드되며, FitMesh iOS 앱（유럽연합（EU） 역외의 지원되는 스토어에서 이용 가능, EU 27개국 배포는 진행 중）을 통해 iPhone에서도 이미 확인할 수 있고 선택적으로 Apple Health에도 연동됩니다. iPhone만 사용 중이라면 링의 최초 페어링을 위해 Android 기기（빌린 기기도 가능）가 하나 필요합니다.",
      },
    },
    {
      q: {
