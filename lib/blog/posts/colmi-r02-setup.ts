  ...
  body: [
    ...
    },
    {
      ...
      items: {
        ...
        nl: [
          "**Installeer FitMesh Sync**: als je dat nog niet hebt gedaan, download het dan uit de Google Play Store. De betaversie is toegankelijk via een uitnodigingslink op de [/nl/beta](/nl/beta)-pagina.",
        ...
        ja: [
          "**FitMesh Sync をインストール**：まだの場合は Google Play ストアからダウンロードしてください。ベータ版は [/ja/beta](/ja/beta) ページの招待リンクからアクセスできます。",
        ...
        ko: [
          "**FitMesh Sync 설치**: 아직 설치하지 않았다면 Google Play 스토어에서 다운로드하세요. 베타 버전은 [/ko/beta](/ko/beta) 페이지의 초대 링크를 통해 이용할 수 있습니다.",
    ...
    // --- CTA ---
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile su Google Play. I primi 1000 founder (programma chiuso dal 31 luglio 2026) hanno ricevuto il Pro a vita gratis, incluso l'accesso alla funzione anello Colmi non appena rilasciata.",
        ...
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder (Programm seit dem 31. Juli 2026 geschlossen) haben lebenslang Pro kostenlos erhalten, einschließlich Zugang zur Colmi-Ring-Funktion, sobald diese verfügbar ist.",
        pt: "O FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders (programa encerrado desde 31 de julho de 2026) receberam o Pro vitalício grátis, incluindo acesso à função do anel Colmi assim que for lançada.",
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders (programme clos depuis le 31 juillet 2026) ont obtenu le Pro à vie gratuit, incluant l'accès à la fonctionnalité bague Colmi dès sa disponibilité.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów (program zamknięty od 31 lipca 2026) otrzymało dożywotnie Pro za darmo, w tym dostęp do funkcji pierścienia Colmi od razu po jej wydaniu.",
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu (program 31 Temmuz 2026 itibarıyla kapandı) ömür boyu Pro'yu ücretsiz aldı, Colmi yüzük özelliğine çıkar çıkmaz erişim dahil.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders (programma gesloten sinds 31 juli 2026) hebben levenslang Pro gratis gekregen, inclusief toegang tot de Colmi ring-functie zodra die beschikbaar is.",
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounder（2026年7月31日に終了したプログラム）は永久版Proを無料で利用でき、Colmiリング機能のリリース時のアクセスも含まれていました。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder(2026년 7월 31일에 종료된 프로그램)는 평생 Pro를 무료로 받았으며, Colmi 링 기능이 출시되는 즉시 이용할 수 있는 접근권도 포함되었습니다.",
      },
      ctaLabel: {
