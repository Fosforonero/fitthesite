  ...
  body: [
    ...
    // --- CTA ---
    {
      ...
      body: {
        ...
        nl: "FitMesh Sync is in privébeta. De eerste 1.000 gebruikers krijgen 1 jaar Pro gratis, inclusief toegang tot de Colmi ring-functie zodra die beschikbaar is. Meld je nu aan om je plek te reserveren.",
        ja: "FitMesh Sync はプライベートベータ中です。最初の1,000人のユーザーは、Colmi リング機能のリリース時のアクセスを含む1年間の Pro プランを無料で利用できます。今すぐ登録してスポットを確保しましょう。",
        ko: "FitMesh Sync는 비공개 베타 중입니다. 첫 1,000명의 사용자는 Colmi 링 기능이 출시되는 즉시 이용할 수 있는 액세스를 포함하여 1년간 Pro 플랜을 무료로 받습니다. 지금 등록하여 자리를 확보하세요.",
      },
      ctaLabel: {
