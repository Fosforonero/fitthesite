  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        de: "Colmi R02/R03 und kompatible OEM-Klone verbinden sich über direktes Bluetooth mit FitMesh Sync. Keine Hersteller-App erforderlich. Verfügbare Metriken: Schritte, Distanz, Kalorien, Herzfrequenz, Ruheherzfrequenz, SpO2, HRV, Stress (0-100), Schlaf mit Schlafphasen (Leichtschlaf, Tiefschlaf, REM, Wach), farbcodierter Batterieindikator. Die Datenzusammenführung mehrerer Geräte verhindert doppelte Zählungen zwischen dem nächtlichen Ring und dem Smartwatch am Tag.",
        pt: "O Colmi R02/R03 e os clones OEM compatíveis se conectam ao FitMesh Sync via Bluetooth direto. Nenhum app do fabricante é necessário. Métricas disponíveis: passos, distância, calorias, frequência cardíaca, frequência cardíaca em repouso, SpO2, HRV, stress (0-100), sono com fases (leve, profundo, REM, acordado), indicador de bateria colorido. A fusão de múltiplos dispositivos elimina contagens duplas entre o anel noturno e o smartwatch diurno.",
    ...
    },
    {
      ...
      items: {
        ...
        de: [
          ...
          "**Bestätige die Kopplung**. Kein PIN-Code, kein Login: Die Verbindung ist Bluetooth von Gerät zu Gerät. Ab diesem Moment synchronisiert FitMesh den Ring automatisch.",
        ],
        pt: [
          ...
          "**Confirme o pareamento**. Sem código PIN, sem login: a conexão é Bluetooth de dispositivo para dispositivo. A partir desse momento, FitMesh sincroniza o anel automaticamente.",
        ],
        fr: [
          ...
          "**Confirmez le couplage**. Pas de code PIN, pas de connexion : le lien est Bluetooth d'appareil à appareil. À partir de ce moment, FitMesh synchronise la bague automatiquement.",
        ],
        pl: [
          ...
          "**Potwierdź parowanie**. Bez kodu PIN, bez logowania: połączenie jest Bluetooth urządzenie-urządzenie. Od tej chwili FitMesh synchronizuje pierścień automatycznie.",
        ],
        tr: [
    ...
    },
    {
      ...
      text: {
        ...
        de: "Die erste Synchronisierung lädt alle historischen Daten herunter, die auf dem Ring verfügbar sind (typischerweise 7 bis 30 Tage je nach Modell). Danach erfolgt die Synchronisierung automatisch, sobald das Telefon in der Nähe ist.",
        pt: "A primeira sincronização baixa todos os dados históricos disponíveis no anel (tipicamente 7 a 30 dias, dependendo do modelo). Depois disso, a sincronização é automática sempre que o telefone estiver por perto.",
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile su Google Play. I primi 1000 founder che si registrano entro il 31 luglio 2026 e completano la prima sincronizzazione entro 14 giorni ricevono il Pro a vita gratis, incluso l'accesso alla funzione anello Colmi non appena rilasciata.",
        en: "FitMesh Sync is available on Google Play. The first 1,000 founders who register by July 31, 2026 and complete their first sync within 14 days get lifetime Pro free, including access to the Colmi ring feature as soon as it ships.",
        es: "FitMesh Sync está disponible en Google Play. Los primeros 1000 founders que se registren antes del 31 de julio de 2026 y completen su primera sincronización en un plazo de 14 días obtienen el Pro de por vida gratis, incluido el acceso a la función del anillo Colmi en cuanto esté disponible.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder, die sich bis zum 31. Juli 2026 registrieren und ihre erste Synchronisierung innerhalb von 14 Tagen abschließen, erhalten lebenslang Pro kostenlos, einschließlich Zugang zur Colmi-Ring-Funktion, sobald diese verfügbar ist.",
        pt: "O FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders que se registrarem até 31 de julho de 2026 e completarem a primeira sincronização em até 14 dias recebem o Pro vitalício grátis, incluindo acesso à função do anel Colmi assim que for lançada.",
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders qui s'inscrivent avant le 31 juillet 2026 et effectuent leur première synchronisation dans les 14 jours obtiennent le Pro à vie gratuit, incluant l'accès à la fonctionnalité bague Colmi dès sa disponibilité.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów, którzy zarejestrują się do 31 lipca 2026 i wykonają pierwszą synchronizację w ciągu 14 dni, otrzymuje dożywotnie Pro za darmo, w tym dostęp do funkcji pierścienia Colmi od razu po jej wydaniu.",
        tr: "FitMesh Sync Google Play'de mevcut. 31 Temmuz 2026'ya kadar kaydolan ve ilk senkronizasyonu 14 gün içinde tamamlayan ilk 1000 kurucu, Colmi yüzük özelliğine çıkar çıkmaz erişim dahil olmak üzere ömür boyu Pro'yu ücretsiz alır.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders die zich vóór 31 juli 2026 aanmelden en hun eerste synchronisatie binnen 14 dagen voltooien, krijgen levenslang Pro gratis, inclusief toegang tot de Colmi ring-functie zodra die beschikbaar is.",
        ja: "FitMesh SyncはGoogle Playで利用できます。2026年7月31日までに登録し、14日以内に最初の同期を完了した先着1000名のfounderは、Colmiリング機能のリリース時のアクセスも含めて永久版Proを無料で受け取れます。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 2026년 7월 31일까지 등록하고 14일 이내에 첫 동기화를 완료한 처음 1000명의 founder는 Colmi 링 기능이 출시되는 즉시 이용할 수 있는 접근권을 포함해 평생 Pro를 무료로 받습니다.",
      },
      ctaLabel: {
