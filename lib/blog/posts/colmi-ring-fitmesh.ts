  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        es: "FitMesh Sync está disponible en Google Play. Los primeros 1000 founders (programa cerrado desde el 31 de julio de 2026) obtuvieron el Pro de por vida gratis, incluido el acceso a la función del anillo Colmi en cuanto esté disponible.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder (Programm seit dem 31. Juli 2026 geschlossen) haben lebenslang Pro kostenlos erhalten, einschließlich Zugang zur Colmi-Ring-Funktion, sobald sie verfügbar ist.",
        pt: "FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders (programa encerrado desde 31 de julho de 2026) receberam o Pro vitalício grátis, incluindo acesso à funcionalidade do anel Colmi assim que for lançada.",
        ...
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu (program 31 Temmuz 2026 itibarıyla kapandı) ömür boyu Pro'yu ücretsiz aldı, Colmi yüzüğü özelliğine yayınlandığında erişim dahil.",
        ...
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounder（2026年7月31日に終了したプログラム）は永久版Proを無料で取得でき、Colmiリング機能へのアクセスも含まれていました。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder(2026년 7월 31일에 종료된 프로그램)는 평생 Pro를 무료로 받았으며, Colmi 링 기능 출시 시 접근권도 포함되었습니다.",
      },
      ctaLabel: {
