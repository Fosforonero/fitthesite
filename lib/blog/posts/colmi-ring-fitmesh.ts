...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "L'anello è specialista del sonno: di notte rileva il riposo, di giorno vince lo smartwatch. La riconciliazione multi-device assegna la priorità per fascia oraria.",
      "Batteria con indicatore colorato, stima autonomia reale e notifiche a 100%/50%/25%.",
      "I dati restano sul tuo account FitMesh, non sui server del produttore.",
    ],
    en: [
      ...
      "The ring is the sleep specialist: it tracks rest overnight, the smartwatch wins by day. Multi-device reconciliation assigns source priority per time window.",
      "Color-coded battery indicator, real runtime estimate and notifications at 100%/50%/25%.",
      "Data stays on your FitMesh account, not on the manufacturer's servers.",
    ],
    es: [
      ...
      "El anillo es el especialista del sueño: registra el descanso de noche, el smartwatch de día. La reconciliación multi-dispositivo prioriza fuentes por franja horaria.",
      "Batería con indicador de color, estimación real de autonomía y notificaciones al 100%/50%/25%.",
      "Tus datos se quedan en tu cuenta de FitMesh, no en los servidores del fabricante.",
    ],
    de: [
      ...
      "Der Ring ist der Schlafspezialist: nachts erfasst er die Ruhe, tagsüber die Smartwatch. Der Multi-Geräte-Abgleich priorisiert Quellen nach Zeitfenstern.",
      "Farbcodierter Batterieindikator, realistische Laufzeitschätzung und Benachrichtigungen bei 100%/50%/25%.",
      "Deine Daten bleiben auf deinem FitMesh-Konto, nicht auf den Servern des Herstellers.",
    ],
    pt: [
      ...
      "O anel é especialista em sono: registra o repouso à noite, o smartwatch durante o dia. A reconciliação multi-dispositivo prioriza fontes por janela de tempo.",
      "Indicador de bateria colorido, estimativa real de autonomia e notificações em 100%/50%/25%.",
      "Seus dados ficam na sua conta FitMesh, não nos servidores do fabricante.",
    ],
    fr: [
      ...
      "La bague connectée est la spécialiste du sommeil : elle suit le repos la nuit, la montre connectée le jour. La réconciliation multi-appareils priorise les sources par créneau.",
      "Indicateur de batterie à code couleur, estimation réelle de l'autonomie et notifications à 100%/50%/25%.",
      "Vos données restent sur votre compte FitMesh, pas sur les serveurs du fabricant.",
    ],
    pl: [
      ...
      "Pierścień to specjalista snu: nocą rejestruje odpoczynek, w dzień smartwatch. Uzgadnianie wielu urządzeń ustala priorytet źródeł w oknach czasowych.",
      "Bateria ze wskaźnikiem kolorowym, szacunkowy czas rzeczywisty i powiadomienia przy 100%/50%/25%.",
      "Dane pozostają na Twoim koncie FitMesh, nie na serwerach producenta.",
    ],
    tr: [
      ...
      "Yüzük uyku uzmanıdır: geceleri dinlenmeyi kaydeder, gündüz smartwatch devralır. Çoklu cihaz mutabakatı zaman dilimine göre kaynak önceliği belirler.",
      "Renkli pil göstergesi, gerçek süre tahmini ve %100/%50/%25'te bildirimler.",
      "Verileriniz FitMesh hesabınızda kalır, üreticinin sunucularında değil.",
    ],
    nl: [
  ...
  body: [
    ...
    },
    {
      ...
      level: 3,
      text: {
        it: "Riconciliazione multi-device: priorità di sorgente e finestre temporali",
        en: "Multi-device reconciliation: source priority and time windows",
        es: "Reconciliación multi-dispositivo: prioridad de fuente y franjas horarias",
        de: "Multi-Geräte-Abgleich: Quellpriorität und Zeitfenster",
        pt: "Reconciliação multi-dispositivo: prioridade de fonte e janelas de tempo",
        fr: "Réconciliation multi-appareils : priorité des sources et fenêtres temporelles",
        pl: "Uzgodnienie wielu urządzeń: priorytet źródła i okna czasowe",
        tr: "Çoklu cihaz mutabakatı: kaynak önceliği ve zaman dilimleri",
        nl: "Multi-device reconciliatie: bronprioriteit en tijdvensters",
        ja: "マルチデバイス照合：ソース優先度と時間枠",
        ko: "멀티 디바이스 조정: 소스 우선순위 및 시간대",
      },
    },
    {
      type: "paragraph",
    ...
    },
    {
      ...
      body: {
        it: "La feature anello Colmi è in fase di sviluppo attivo. Sarà disponibile a tutti gli utenti dell'app non appena rilasciata, senza bisogno di iscrizioni.",
        en: "The Colmi ring feature is in active development. It will be available to all app users as soon as it ships, no sign-up required.",
        es: "La función del anillo Colmi está en desarrollo activo. Estará disponible para todos los usuarios de la app en cuanto se publique, sin necesidad de inscripción.",
        de: "Die Colmi-Ring-Funktion befindet sich in aktiver Entwicklung. Sie wird für alle App-Nutzer verfügbar sein, sobald sie veröffentlicht wird, ohne Anmeldung.",
        pt: "A funcionalidade do anel Colmi está em desenvolvimento ativo. Estará disponível para todos os usuários do app assim que for lançada, sem necessidade de inscrição.",
        fr: "La fonctionnalité bague Colmi est en développement actif. Elle sera disponible pour tous les utilisateurs de l'application dès sa sortie, sans inscription nécessaire.",
        pl: "Funkcja pierścienia Colmi jest w aktywnym rozwoju. Będzie dostępna dla wszystkich użytkowników aplikacji natychmiast po wydaniu, bez konieczności zapisów.",
        tr: "Colmi yüzüğü özelliği aktif olarak geliştiriliyor. Yayınlandıktan hemen sonra kayıt gerektirmeden tüm uygulama kullanıcılarına sunulacak.",
        nl: "De Colmi-ringfunctie is in actieve ontwikkeling. Het zal beschikbaar zijn voor alle app-gebruikers zodra het beschikbaar is, zonder aanmelding.",
        ja: "Colmiリング機能は開発中です。リリース次第すぐに、登録不要ですべてのアプリユーザーが利用できるようになります。",
        ko: "Colmi 링 기능은 현재 개발 중입니다. 출시되는 즉시 별도 가입 없이 모든 앱 사용자가 이용할 수 있습니다.",
      },
    },
    {
      type: "cta",
      ...
      body: {
        ...
        es: "FitMesh Sync está disponible para Android e iOS. La elegibilidad Founder estaba reservada a un máximo de 1.000 cuentas registradas antes del 31 de julio de 2026 con una primera sincronización real en 14 días desde el registro.",
        de: "FitMesh Sync ist für Android und iOS verfügbar. Die Founder-Berechtigung war auf maximal 1.000 bis zum 31. Juli 2026 registrierte Konten mit einer echten ersten Synchronisierung innerhalb von 14 Tagen nach der Registrierung begrenzt.",
        ...
        ko: "FitMesh Sync는 Android 및 iOS에서 이용할 수 있습니다. Founder 자격은 2026년 7월 31일까지 등록하고 가입 후 14일 이내에 실제 첫 동기화를 완료한 최대 1,000개 계정으로 제한되었습니다.",
      },
      ctaLabel: {
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "La riconciliazione multi-device (anello di notte, smartwatch di giorno) gestisce le sovrapposizioni temporali assegnando priorità alla sorgente scelta.",
          "I dati vanno sul tuo account FitMesh, non sui server del produttore dell'anello.",
        ],
        en: [
          ...
          "Multi-device reconciliation (ring overnight, smartwatch by day) handles time overlaps by prioritizing your chosen source.",
          "Data goes to your FitMesh account, not to the ring manufacturer's servers.",
        ],
        es: [
          ...
          "La reconciliación multi-dispositivo (anillo de noche, smartwatch de día) gestiona las superposiciones temporales priorizando la fuente elegida.",
          "Tus datos van a tu cuenta de FitMesh, no a los servidores del fabricante del anillo.",
        ],
        de: [
          ...
          "Der Multi-Geräte-Abgleich (Ring nachts, Smartwatch tagsüber) löst zeitliche Überlappungen durch Quellpriorisierung.",
          "Deine Daten gehen auf dein FitMesh-Konto, nicht auf die Server des Ring-Herstellers.",
        ],
        pt: [
          ...
          "A reconciliação multi-dispositivo (anel à noite, smartwatch de dia) gerencia sobreposições temporais priorizando a fonte selecionada.",
          "Seus dados vão para sua conta FitMesh, não para os servidores do fabricante do anel.",
        ],
        fr: [
          ...
          "La réconciliation multi-appareils (bague la nuit, montre connectée le jour) gère les chevauchements temporels en priorisant la source choisie.",
          "Vos données vont sur votre compte FitMesh, pas sur les serveurs du fabricant de la bague.",
        ],
        pl: [
          ...
          "Uzgodnienie wielu urządzeń (pierścień nocą, smartwatch w ciągu dnia) zarządza nakładaniem się danych w oparciu o priorytet wybranego źródła.",
          "Twoje dane trafiają na Twoje konto FitMesh, nie na serwery producenta pierścienia.",
        ],
        tr: [
          ...
          "Çoklu cihaz mutabakatı (gece yüzük, gündüz smartwatch), seçilen kaynağa öncelik vererek zaman çakışmalarını yönetir.",
          "Verileriniz yüzük üreticisinin sunucularına değil, FitMesh hesabınıza gider.",
        ],
        nl: [
          ...
          "Multi-device reconciliatie (ring 's nachts, smartwatch overdag) lost tijdsoverlappingen op door prioriteit te geven aan de gekozen bron.",
          "Je gegevens gaan naar je FitMesh-account, niet naar de servers van de ringfabrikant.",
        ],
        ja: [
          ...
          "マルチデバイス照合（夜間リング、昼間スマートウォッチ）により、選択したソースを優先して時間的重複を管理します。",
          "データはリングメーカーのサーバーではなく、FitMeshアカウントに保存されます。",
        ],
        ko: [
          ...
          "멀티 디바이스 조정(야간 링, 주간 스마트워치)을 통해 선택된 소스에 우선순위를 부여하여 시간적 중복을 관리합니다.",
          "데이터는 링 제조사의 서버가 아닌 FitMesh 계정으로 전송됩니다.",
        ],
      },
    },
  ],
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "I dati vengono letti via Bluetooth direttamente dal telefono e inviati solo al backend Supabase del tuo account FitMesh. Non passano dai server del produttore dell'anello. Il tuo account è personale e non condivide dati con terzi senza il tuo consenso esplicito.",
        en: "Data is read via Bluetooth directly on your phone and sent only to your FitMesh account's Supabase backend. It does not pass through the ring manufacturer's servers. Your account is personal and does not share data with third parties without your explicit consent.",
        es: "Los datos se leen via Bluetooth directamente en tu teléfono y se envían únicamente al backend de tu cuenta de FitMesh. No pasan por los servidores del fabricante del anillo. Tu cuenta es personal y no comparte datos con terceros sin tu consentimiento explícito.",
        de: "Die Daten werden via Bluetooth direkt auf deinem Telefon ausgelesen und nur an das Supabase-Backend deines FitMesh-Kontos gesendet. Sie gehen nicht über die Server des Ring-Herstellers. Dein Konto ist persönlich und teilt keine Daten mit Dritten ohne deine ausdrückliche Zustimmung.",
        pt: "Os dados são lidos via Bluetooth diretamente no seu telefone e enviados apenas para o backend Supabase da sua conta FitMesh. Não passam pelos servidores do fabricante do anel. Sua conta é pessoal e não compartilha dados com terceiros sem seu consentimento explícito.",
        fr: "Les données sont lues via Bluetooth directement sur votre téléphone et envoyées uniquement au backend Supabase de votre compte FitMesh. Elles ne transitent pas par les serveurs du fabricant de la bague. Votre compte est personnel et ne partage pas de données avec des tiers sans votre consentement explicite.",
        pl: "Dane są odczytywane przez Bluetooth bezpośrednio na Twoim telefonie i wysyłane wyłącznie do backendu Supabase Twojego konta FitMesh. Nie przechodzą przez serwery producenta pierścienia. Twoje konto jest osobiste i nie udostępnia danych stronom trzecim bez Twojej wyraźnej zgody.",
        tr: "Veriler, telefonunuzda doğrudan Bluetooth üzerinden okunur ve yalnızca FitMesh hesabınızın Supabase backend'ine gönderilir. Yüzük üreticisinin sunucularından geçmez. Hesabınız kişiseldir ve açık onayınız olmadan üçüncü taraflarla veri paylaşmaz.",
        nl: "Gegevens worden via Bluetooth direct op je telefoon uitgelezen en alleen verzonden naar het Supabase-backend van je FitMesh-account. Ze gaan niet via de servers van de ringfabrikant. Je account is persoonlijk en deelt geen gegevens met derden zonder je uitdrukkelijke toestemming.",
        ja: "データはスマートフォンでBluetooth経由で直接読み取られ、FitMeshアカウントのSupabaseバックエンドにのみ送信されます。リングメーカーのサーバーを経由しません。あなたのアカウントは個人的なものであり、明示的な同意なしに第三者とデータを共有しません。",
        ko: "데이터는 스마트폰에서 블루투스를 통해 직접 읽혀 FitMesh 계정의 Supabase 백엔드로만 전송됩니다. 링 제조사의 서버를 거치지 않습니다. 귀하의 계정은 개인적이며 명시적 동의 없이 제3자와 데이터를 공유하지 않습니다.",
      },
    },
  ],
  related: [
