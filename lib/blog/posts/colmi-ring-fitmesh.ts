...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile su Google Play. Fino a 1.000 account idonei registrati entro il 31 luglio 2026 hanno ottenuto il Pro a vita gratuito. App disponibile su Google Play.",
        en: "FitMesh Sync is available on Google Play. Up to 1,000 eligible accounts registered through July 31, 2026 received lifetime Pro for free. App available on Google Play.",
        es: "FitMesh Sync está disponible en Google Play. Hasta 1.000 cuentas elegibles registradas antes del 31 de julio de 2026 obtuvieron Pro de por vida gratis. App disponible en Google Play.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Bis zu 1.000 berechtigte Konten, die sich bis zum 31. Juli 2026 registriert haben, erhielten lebenslanges Pro kostenlos. App auf Google Play verfügbar.",
        pt: "FitMesh Sync está disponível no Google Play. Até 1.000 contas qualificadas registradas até 31 de julho de 2026 receberam o Pro vitalício gratuito. App disponível no Google Play.",
        fr: "FitMesh Sync est disponible sur Google Play. Jusqu'à 1 000 comptes éligibles inscrits avant le 31 juillet 2026 ont bénéficié de l'accès Pro à vie gratuit. Application disponible sur Google Play.",
        pl: "FitMesh Sync jest dostępny w Google Play. Do 1000 kwalifikujących się kont zarejestrowanych do 31 lipca 2026 otrzymało dożywotni plan Pro bezpłatnie. Aplikacja dostępna w Google Play.",
        tr: "FitMesh Sync Google Play'de mevcut. 31 Temmuz 2026'ya kadar kaydolan 1.000'e kadar uygun hesap ömür boyu ücretsiz Pro kazandı. Uygulama Google Play'de mevcut.",
        nl: "FitMesh Sync is beschikbaar op Google Play. Tot 1.000 in aanmerking komende accounts die vóór 31 juli 2026 zijn geregistreerd, ontvingen levenslang gratis Pro. App beschikbaar op Google Play.",
        ja: "FitMesh SyncはGoogle Playで提供されています。2026年7月31日までに登録した最大1,000名の対象アカウントに永久版Proが無料で付与されました。Google Playにて提供中。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 2026년 7월 31일까지 등록된 최대 1,000개의 대상 계정이 평생 무료 Pro를 받았습니다. Google Play에서 제공 중.",
      },
      ctaLabel: {
