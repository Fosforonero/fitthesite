  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        es: "El Colmi R02/R03 y los clones OEM compatibles se conectan a FitMesh Sync via Bluetooth directo. No se necesita ninguna app companion. Métricas disponibles: pasos, distancia, calorías, frecuencia cardíaca, frecuencia cardíaca en reposo, SpO2, HRV, stress (0-100), sueño con fases (ligero, profundo, REM, vigilia), indicador de batería por color. La fusión multi-dispositivo elimina los conteos dobles entre el anillo nocturno y el smartwatch diurno.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      items: {
        ...
        es: [
          ...
          "**Confirma el emparejamiento**. Sin código PIN, sin inicio de sesión: el enlace es Bluetooth de dispositivo a dispositivo. A partir de ese momento, FitMesh sincroniza el anillo automáticamente.",
        ],
      },
    },
    {
      ...
      text: {
        ...
        es: "La primera sincronización descarga todos los datos históricos disponibles en el anillo (normalmente entre 7 y 30 días según el modelo). Después, la sincronización es automática cada vez que el teléfono está cerca.",
      },
    },
    {
      type: "callout",
    ...
    },
    {
      ...
      body: {
        ...
        es: "FitMesh Sync está en beta privada. Los primeros 1.000 usuarios obtienen 1 año de Pro gratis, incluido el acceso a la función del anillo Colmi en cuanto esté disponible. Regístrate ahora para reservar tu plaza.",
      },
      ctaLabel: {
