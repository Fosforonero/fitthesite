  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ...
        },
        {
          ...
          es: ["Datos en la nube en la UE", "Sí", "Sí"],
          de: ["Daten in der EU-Cloud", "Ja", "Ja"],
          pt: ["Dados na nuvem na UE", "Sim", "Sim"],
          fr: ["Données dans le cloud en UE", "Oui", "Oui"],
        },
      ],
    },
    ...
    },
    {
      ...
      text: {
        ...
        es: "Privacidad: tus datos en la nube en la UE",
        de: "Datenschutz: deine Daten in der EU-Cloud",
        pt: "Privacidade: seus dados na nuvem na UE",
        fr: "Confidentialité : vos données dans le cloud en UE",
      },
    },
    {
      type: "paragraph",
      text: {
        it: "I dati salute restano sul tuo account, su server nell'Unione Europea. FitMesh non li vende e non mostra pubblicità: il servizio si sostiene con un piccolo abbonamento o uno sblocco a vita, e i primi 1000 iscritti founder (entro il 31 luglio 2026) hanno ricevuto il Pro a vita gratis. Se vuoi il dettaglio: [FitMesh è gratis? prezzo e posti founder](/it/blog/fitmesh-gratis-prezzo-founder).",
        en: "Your health data stays on your account, on servers in the European Union. FitMesh doesn't sell it and shows no ads: the service is funded by a small subscription or a one-time lifetime unlock, and the first 1,000 founder sign-ups (by July 31, 2026) got lifetime Pro free. For the details: [is FitMesh free? pricing and founder spots](/en/blog/fitmesh-gratis-prezzo-founder).",
        es: "Tus datos de salud se quedan en tu cuenta, en servidores de la Unión Europea. FitMesh no los vende y no muestra publicidad: el servicio se sostiene con una pequeña suscripción o un desbloqueo de por vida, y los primeros 1000 inscritos founder (hasta el 31 de julio de 2026) obtuvieron el Pro de por vida gratis. Si quieres el detalle: [¿FitMesh es gratis? precio y plazas founder](/es/blog/fitmesh-gratis-prezzo-founder).",
  ...
  faq: [
    {
      ...
      a: {
        ...
        es: "FitMesh Sync lee los datos de tus wearables, el anillo Colmi por Bluetooth y el smartwatch a través de Health Connect en Android, los unifica con la deduplicación (sin duplicados) y los muestra en un único panel en el móvil y en la web. Tus datos se quedan en tu cuenta, en la nube en la UE.",
        de: "FitMesh Sync liest die Daten deiner Wearables, den Colmi-Ring über Bluetooth und deine Smartwatch über Health Connect unter Android, führt sie per Deduplizierung zusammen (keine Duplikate) und zeigt sie in einem einzigen Dashboard auf dem Handy und im Web. Deine Daten bleiben in deinem Konto in der EU-Cloud.",
        pt: "O FitMesh Sync lê os dados dos seus wearables, o anel Colmi por Bluetooth e o smartwatch pelo Health Connect no Android, une tudo com a deduplicação (sem duplicatas) e mostra em um único painel no celular e na web. Seus dados ficam na sua conta, na nuvem na UE.",
        fr: "FitMesh Sync lit les données de vos wearables, la bague Colmi via Bluetooth et votre montre connectée via Health Connect sur Android, les fusionne avec la déduplication (aucun doublon) et les affiche dans un seul tableau de bord sur votre téléphone et sur le web. Vos données restent sur votre compte, dans le cloud en UE.",
      },
    },
    {
      q: {
    ...
    },
    {
      ...
      a: {
        ...
        es: "En tu cuenta, en servidores de la Unión Europea. FitMesh no vende tus datos y no muestra publicidad. Puedes abrir el mismo panel desde cualquier navegador con tu cuenta.",
        de: "In deinem Konto, auf Servern in der Europäischen Union. FitMesh verkauft deine Daten nicht und zeigt keine Werbung. Du kannst dasselbe Dashboard mit deinem Konto in jedem Browser öffnen.",
        pt: "Na sua conta, em servidores na União Europeia. O FitMesh não vende seus dados e não mostra anúncios. Você pode abrir o mesmo painel de qualquer navegador com sua conta.",
        fr: "Sur votre compte, sur des serveurs situés dans l'Union européenne. FitMesh ne vend pas vos données et n'affiche aucune publicité. Vous pouvez ouvrir le même tableau de bord depuis n'importe quel navigateur avec votre compte.",
      },
    },
    {
      q: {
