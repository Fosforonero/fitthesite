...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "I dati salute restano sul tuo account, su server nell'Unione Europea. FitMesh non li vende e non mostra pubblicità: il servizio si sostiene con un piccolo abbonamento o uno sblocco a vita, e i primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ricevuto il Pro a vita gratis. Se vuoi il dettaglio: [FitMesh è gratis? prezzo e posti founder](/it/blog/fitmesh-gratis-prezzo-founder).",
        en: "Your health data stays on your account, on servers in the European Union. FitMesh doesn't sell it and shows no ads: the service is funded by a small subscription or a one-time lifetime unlock, and the first 1,000 founder sign-ups (program closed as of July 31, 2026) got lifetime Pro free. For the details: [is FitMesh free? pricing and founder spots](/en/blog/fitmesh-gratis-prezzo-founder).",
        es: "Tus datos de salud se quedan en tu cuenta, en servidores de la Unión Europea. FitMesh no los vende y no muestra publicidad: el servicio se sostiene con una pequeña suscripción o un desbloqueo de por vida, y los primeros 1000 inscritos founder (programa cerrado desde el 31 de julio de 2026) obtuvieron el Pro de por vida gratis. Si quieres el detalle: [¿FitMesh es gratis? precio y plazas founder](/es/blog/fitmesh-gratis-prezzo-founder).",
        de: "Deine Gesundheitsdaten bleiben in deinem Konto, auf Servern in der Europäischen Union. FitMesh verkauft sie nicht und zeigt keine Werbung: Der Dienst finanziert sich über ein kleines Abo oder eine einmalige lebenslange Freischaltung, und die ersten 1.000 founder-Anmeldungen (Programm seit dem 31. Juli 2026 geschlossen) haben Pro lebenslang gratis erhalten. Alle Details: [Ist FitMesh kostenlos? Preis und founder-Plätze](/de/blog/fitmesh-gratis-prezzo-founder).",
        pt: "Seus dados de saúde ficam na sua conta, em servidores na União Europeia. O FitMesh não os vende e não mostra anúncios: o serviço se mantém com uma pequena assinatura ou um desbloqueio vitalício, e os primeiros 1000 inscritos founder (programa encerrado desde 31 de julho de 2026) ganharam o Pro vitalício de graça. Para os detalhes: [o FitMesh é grátis? preço e vagas founder](/pt/blog/fitmesh-gratis-prezzo-founder).",
        fr: "Vos données de santé restent sur votre compte, sur des serveurs situés dans l'Union européenne. FitMesh ne les vend pas et n'affiche aucune publicité : le service se finance par un petit abonnement ou un déblocage à vie, et les 1000 premiers inscrits founder (programme clos depuis le 31 juillet 2026) ont obtenu Pro à vie gratuitement. Pour les détails : [FitMesh est-il gratuit ? prix et places founder](/fr/blog/fitmesh-gratis-prezzo-founder).",
      },
    },
    {
      type: "cta",
      ...
      body: {
        it: "L'app Android e la dashboard web sono disponibili ora; l'app iOS è live sull'App Store in tutti gli store supportati, incluse tutte le storefront dei 27 Paesi UE. I primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ricevuto il Pro a vita gratis: collega i tuoi wearable e l'anello Colmi e vedi tutto in un posto solo.",
        en: "The Android app and web dashboard are available now; the iOS app is live on the App Store in all supported storefronts, including all 27 EU countries. The first 1,000 founder sign-ups (program closed as of July 31, 2026) got lifetime Pro free: connect your wearables and the Colmi ring and see everything in one place.",
        es: "La app Android y el panel web están disponibles ya; la app iOS ya está disponible en todas las tiendas compatibles en la App Store, incluidos los 27 países de la UE. Los primeros 1000 inscritos founder (programa cerrado desde el 31 de julio de 2026) consiguieron el Pro de por vida gratis: conecta tus wearables y el anillo Colmi y velo todo en un solo lugar.",
        de: "Die Android-App und das Web-Dashboard sind ab sofort verfügbar; die iOS-App ist bereits im App Store in allen unterstützten Stores live, einschließlich aller 27 EU-Länder. Die ersten 1.000 founder-Anmeldungen (Programm seit dem 31. Juli 2026 geschlossen) haben Pro lebenslang gratis erhalten: Verbinde deine Wearables und den Colmi-Ring und sieh alles an einem Ort.",
        pt: "O app Android e o painel na web já estão disponíveis; o app iOS já está disponível na App Store em todas as lojas compatíveis, incluindo os 27 países da UE. Os primeiros 1000 inscritos founder (programa encerrado desde 31 de julho de 2026) ganharam o Pro vitalício de graça: conecte seus wearables e o anel Colmi e veja tudo em um só lugar.",
        fr: "L'app Android et le tableau de bord web sont disponibles maintenant ; l'app iOS est déjà disponible sur l'App Store dans toutes les boutiques prises en charge, y compris les 27 pays de l'UE. Les 1000 premiers inscrits founder (programme clos depuis le 31 juillet 2026) ont obtenu Pro à vie gratuitement : connectez vos wearables et la bague Colmi et voyez tout au même endroit.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "Non c'è un piano gratuito permanente, ma costa pochissimo: prova completa di 14 giorni, poi un abbonamento leggero (circa un caffè ogni sei mesi) o lo sblocco a vita (meno di una pizza). I primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ricevuto il Pro a vita gratis.",
        en: "There's no permanent free plan, but it costs very little: a full 14-day trial, then a light subscription (about a coffee every six months) or a one-time lifetime unlock (less than a pizza). The first 1,000 founder sign-ups (program closed as of July 31, 2026) got lifetime Pro free.",
        es: "No hay un plan gratuito permanente, pero cuesta muy poco: una prueba completa de 14 días y luego una suscripción ligera (como un café cada seis meses) o un desbloqueo de por vida (menos que una pizza). Los primeros 1000 inscritos founder (programa cerrado desde el 31 de julio de 2026) obtuvieron el Pro de por vida gratis.",
        de: "Es gibt keinen dauerhaft kostenlosen Plan, aber es kostet sehr wenig: eine vollständige 14-tägige Testphase und danach ein leichtes Abo (weniger als ein Kaffee alle sechs Monate) oder eine einmalige lebenslange Freischaltung (weniger als eine Pizza). Die ersten 1.000 founder-Anmeldungen (Programm seit dem 31. Juli 2026 geschlossen) haben Pro lebenslang gratis erhalten.",
        pt: "Não há um plano gratuito permanente, mas custa pouquíssimo: uma avaliação completa de 14 dias e depois uma assinatura leve (como um café a cada seis meses) ou um desbloqueio vitalício (menos que uma pizza). Os primeiros 1000 inscritos founder (programa encerrado desde 31 de julho de 2026) ganharam o Pro vitalício de graça.",
        fr: "Il n'y a pas de forfait gratuit permanent, mais cela coûte très peu : un essai complet de 14 jours, puis un abonnement léger (moins qu'un café tous les six mois) ou un déblocage à vie (moins qu'une pizza). Les 1000 premiers inscrits founder (programme clos depuis le 31 juillet 2026) ont obtenu Pro à vie gratuitement.",
      },
    },
    {
      q: {
