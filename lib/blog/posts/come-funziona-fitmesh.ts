...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "L'app Android e la dashboard web sono disponibili ora; l'app iOS è live sull'App Store in tutti gli store supportati, incluse tutte le storefront dei 27 Paesi UE. I primi 1000 iscritti founder ottengono il Pro a vita gratis: collega i tuoi wearable e l'anello Colmi e vedi tutto in un posto solo.",
        en: "The Android app and web dashboard are available now; the iOS app is live on the App Store in all supported storefronts, including all 27 EU countries. The first 1,000 founder sign-ups get lifetime Pro free: connect your wearables and the Colmi ring and see everything in one place.",
        es: "La app Android y el panel web están disponibles ya; la app iOS ya está disponible en todas las tiendas compatibles en la App Store, incluidos los 27 países de la UE. Los primeros 1000 inscritos founder consiguen el Pro de por vida gratis: conecta tus wearables y el anillo Colmi y velo todo en un solo lugar.",
        de: "Die Android-App und das Web-Dashboard sind ab sofort verfügbar; die iOS-App ist bereits im App Store in allen unterstützten Stores live, einschließlich aller 27 EU-Länder. Die ersten 1.000 founder-Anmeldungen erhalten Pro lebenslang gratis: Verbinde deine Wearables und den Colmi-Ring und sieh alles an einem Ort.",
        pt: "O app Android e o painel na web já estão disponíveis; o app iOS já está disponível na App Store em todas as lojas compatíveis, incluindo os 27 países da UE. Os primeiros 1000 inscritos founder ganham o Pro vitalício de graça: conecte seus wearables e o anel Colmi e veja tudo em um só lugar.",
