...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "I dati restano sul tuo account nel cloud in UE. App Android disponibile ora; app iOS già live negli store supportati fuori dall'UE (il rollout in UE è in corso).",
    ],
    en: [
      ...
      "Your data stays on your account in the EU cloud. Android app available now; the iOS app is already live in supported storefronts outside the EU (EU rollout is in progress).",
    ],
    es: [
      ...
      "Tus datos se quedan en tu cuenta, en la nube en la UE. App Android disponible ya; la app iOS ya está disponible en las tiendas compatibles fuera de la UE (el despliegue en la UE está en marcha).",
    ],
    de: [
      ...
      "Deine Daten bleiben in deinem Konto in der EU-Cloud. Android-App ab sofort verfügbar; die iOS-App ist bereits in unterstützten Stores außerhalb der EU live (der Rollout in der EU läuft).",
    ],
    pt: [
      ...
      "Seus dados ficam na sua conta, na nuvem na UE. App Android disponível agora; app iOS já disponível nas lojas compatíveis fora da UE (o lançamento na UE está em andamento).",
    ],
    fr: [
      ...
      "Vos données restent sur votre compte, dans le cloud en UE. App Android disponible maintenant ; app iOS déjà disponible dans les boutiques prises en charge hors UE (le déploiement dans l'UE est en cours).",
    ],
  },
  body: [
    {
    ...
    },
    {
      ...
      text: {
        ...
        es: "Tus datos de salud se quedan en tu cuenta, en servidores de la Unión Europea. FitMesh no los vende y no muestra publicidad: el servicio se sostiene con una pequeña suscripción o un desbloqueo de por vida, y los primeros 1000 inscritos founder tienen el Pro de por vida gratis. Si quieres el detalle: [¿FitMesh es gratis? precio y plazas founder](/es/blog/fitmesh-gratis-prezzo-founder).",
        de: "Deine Gesundheitsdaten bleiben in deinem Konto, auf Servern in der Europäischen Union. FitMesh verkauft sie nicht und zeigt keine Werbung: Der Dienst finanziert sich über ein kleines Abo oder eine einmalige lebenslange Freischaltung, und die ersten 1.000 founder-Anmeldungen erhalten Pro lebenslang gratis. Alle Details: [Ist FitMesh kostenlos? Preis und founder-Plätze](/de/blog/fitmesh-gratis-prezzo-founder).",
        pt: "Seus dados de saúde ficam na sua conta, em servidores na União Europeia. O FitMesh não os vende e não mostra anúncios: o serviço se mantém com uma pequena assinatura ou um desbloqueio vitalício, e os primeiros 1000 inscritos founder ganham o Pro vitalício de graça. Para os detalhes: [o FitMesh é grátis? preço e vagas founder](/pt/blog/fitmesh-gratis-prezzo-founder).",
        fr: "Vos données de santé restent sur votre compte, sur des serveurs situés dans l'Union européenne. FitMesh ne les vend pas et n'affiche aucune publicité : le service se finance par un petit abonnement ou un déblocage à vie, et les 1000 premiers inscrits founder obtiennent Pro à vie gratuitement. Pour les détails : [FitMesh est-il gratuit ? prix et places founder](/fr/blog/fitmesh-gratis-prezzo-founder).",
      },
    },
    {
      type: "cta",
      ...
      body: {
        it: "L'app Android e la dashboard web sono disponibili ora; l'app iOS è live sull'App Store negli store supportati fuori dall'UE (il rollout nei 27 paesi UE è in corso). I primi 1000 iscritti founder ottengono il Pro a vita gratis: collega i tuoi wearable e l'anello Colmi e vedi tutto in un posto solo.",
        en: "The Android app and web dashboard are available now; the iOS app is live on the App Store in supported storefronts outside the EU (rollout in the 27 EU countries is in progress). The first 1,000 founder sign-ups get lifetime Pro free: connect your wearables and the Colmi ring and see everything in one place.",
        es: "La app Android y el panel web están disponibles ya; la app iOS ya está disponible en las tiendas compatibles fuera de la UE en la App Store (el despliegue en los 27 países de la UE está en marcha). Los primeros 1000 inscritos founder consiguen el Pro de por vida gratis: conecta tus wearables y el anillo Colmi y velo todo en un solo lugar.",
        de: "Die Android-App und das Web-Dashboard sind ab sofort verfügbar; die iOS-App ist bereits im App Store in unterstützten Stores außerhalb der EU live (der Rollout in den 27 EU-Ländern läuft). Die ersten 1.000 founder-Anmeldungen erhalten Pro lebenslang gratis: Verbinde deine Wearables und den Colmi-Ring und sieh alles an einem Ort.",
        pt: "O app Android e o painel na web já estão disponíveis; o app iOS já está disponível na App Store nas lojas compatíveis fora da UE (o lançamento nos 27 países da UE está em andamento). Os primeiros 1000 inscritos founder ganham o Pro vitalício de graça: conecte seus wearables e o anel Colmi e veja tudo em um só lugar.",
        fr: "L'app Android et le tableau de bord web sont disponibles maintenant ; l'app iOS est déjà disponible sur l'App Store dans les boutiques prises en charge hors UE (le déploiement dans les 27 pays de l'UE est en cours). Les 1000 premiers inscrits founder obtiennent Pro à vie gratuitement : connectez vos wearables et la bague Colmi et voyez tout au même endroit.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "Su Android, con qualsiasi dispositivo che scrive su Health Connect (la maggior parte di smartwatch e band recenti), più l'anello Colmi via Bluetooth. Provider come Strava, Oura e Suunto si collegano dalla sezione provider esterni. Su iPhone l'app è già live e legge Apple Salute direttamente, oltre a connettersi all'anello Colmi via Bluetooth.",
        en: "On Android, with any device that writes to Health Connect (most recent smartwatches and bands), plus the Colmi ring over Bluetooth. Providers like Strava, Oura and Suunto connect from the external providers section. On iPhone the app is already live and reads Apple Health directly, plus connects to the Colmi ring over Bluetooth.",
        es: "En Android, con cualquier dispositivo que escriba en Health Connect (la mayoría de smartwatches y pulseras recientes), más el anillo Colmi por Bluetooth. Proveedores como Strava, Oura y Suunto se conectan desde la sección de proveedores externos. En iPhone la app ya está disponible y lee Apple Health directamente, además de conectarse al anillo Colmi por Bluetooth.",
        de: "Unter Android mit jedem Gerät, das in Health Connect schreibt (die meisten aktuellen Smartwatches und Bänder), plus dem Colmi-Ring über Bluetooth. Anbieter wie Strava, Oura und Suunto verbindest du im Bereich für externe Anbieter. Auf dem iPhone ist die App bereits live und liest Apple Health direkt aus, außerdem verbindet sie sich über Bluetooth mit dem Colmi-Ring.",
        pt: "No Android, com qualquer dispositivo que escreva no Health Connect (a maioria dos smartwatches e pulseiras recentes), além do anel Colmi por Bluetooth. Provedores como Strava, Oura e Suunto se conectam na seção de provedores externos. No iPhone o app já está disponível e lê o Apple Health diretamente, além de se conectar ao anel Colmi por Bluetooth.",
        fr: "Sur Android, avec n'importe quel appareil qui écrit dans Health Connect (la plupart des montres connectées et bracelets récents), plus la bague Colmi via Bluetooth. Des fournisseurs comme Strava, Oura et Suunto se connectent depuis la section des fournisseurs externes. Sur iPhone, l'app est déjà disponible et lit directement Apple Health, en plus de se connecter à la bague Colmi via Bluetooth.",
      },
    },
    {
      q: {
    ...
    },
    {
      ...
      a: {
        ...
        es: "No hay un plan gratuito permanente, pero cuesta muy poco: una prueba completa de 14 días y luego una suscripción ligera (como un café cada seis meses) o un desbloqueo de por vida (menos que una pizza). Los primeros 1000 inscritos founder tienen el Pro de por vida gratis.",
        de: "Es gibt keinen dauerhaft kostenlosen Plan, aber es kostet sehr wenig: eine vollständige 14-tägige Testphase und danach ein leichtes Abo (weniger als ein Kaffee alle sechs Monate) oder eine einmalige lebenslange Freischaltung (weniger als eine Pizza). Die ersten 1.000 founder-Anmeldungen erhalten Pro lebenslang gratis.",
        pt: "Não há um plano gratuito permanente, mas custa pouquíssimo: uma avaliação completa de 14 dias e depois uma assinatura leve (como um café a cada seis meses) ou um desbloqueio vitalício (menos que uma pizza). Os primeiros 1000 inscritos founder ganham o Pro vitalício de graça.",
        fr: "Il n'y a pas de forfait gratuit permanent, mais cela coûte très peu : un essai complet de 14 jours, puis un abonnement léger (moins qu'un café tous les six mois) ou un déblocage à vie (moins qu'une pizza). Les 1000 premiers inscrits founder obtiennent Pro à vie gratuitement.",
      },
    },
    {
      q: {
      ...
      a: {
        it: "Sì. L'app Android è disponibile ora e l'app iOS è già live sull'App Store negli store supportati fuori dall'UE (il rollout nei 27 paesi UE è in corso); su iPhone legge Apple Salute direttamente. La dashboard web, invece, è già accessibile da qualsiasi dispositivo con il tuo account, iPhone compreso.",
        en: "Yes. The Android app is available now and the iOS app is already live on the App Store in supported storefronts outside the EU (rollout in the 27 EU countries is in progress); on iPhone it reads Apple Health directly. The web dashboard, however, is already accessible from any device with your account, iPhone included.",
        es: "Sí. La app Android está disponible ya y la app iOS ya está disponible en las tiendas compatibles fuera de la UE en la App Store (el despliegue en los 27 países de la UE está en marcha); en iPhone lee Apple Health directamente. El panel web, en cambio, ya es accesible desde cualquier dispositivo con tu cuenta, iPhone incluido.",
        de: "Ja. Die Android-App ist ab sofort verfügbar und die iOS-App ist bereits im App Store in unterstützten Stores außerhalb der EU live (der Rollout in den 27 EU-Ländern läuft); auf dem iPhone liest sie Apple Health direkt aus. Das Web-Dashboard hingegen ist mit deinem Konto bereits von jedem Gerät aus zugänglich, auch vom iPhone.",
        pt: "Sim. O app Android já está disponível e o app iOS já está disponível na App Store nas lojas compatíveis fora da UE (o lançamento nos 27 países da UE está em andamento); no iPhone ele lê o Apple Health diretamente. Já o painel na web já é acessível de qualquer dispositivo com a sua conta, incluindo o iPhone.",
        fr: "Oui. L'app Android est disponible maintenant et l'app iOS est déjà disponible sur l'App Store dans les boutiques prises en charge hors UE (le déploiement dans les 27 pays de l'UE est en cours) ; sur iPhone, elle lit directement Apple Health. Le tableau de bord web, en revanche, est déjà accessible depuis n'importe quel appareil avec votre compte, iPhone compris.",
      },
    },
  ],
  related: [
