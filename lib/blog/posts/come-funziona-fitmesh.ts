...
export const post: BlogPost = {
  ...
  tldr: {
    ...
    es: [
      ...
      "Tus datos se quedan en tu cuenta, en la nube en la UE. App Android disponible ya, iOS en camino.",
    ],
    de: [
      ...
      "Deine Daten bleiben in deinem Konto in der EU-Cloud. Android-App ab sofort verfügbar, iOS folgt.",
    ],
    pt: [
      ...
      "Seus dados ficam na sua conta, na nuvem na UE. App Android disponível agora, iOS a caminho.",
    ],
    fr: [
      ...
      "Vos données restent sur votre compte, dans le cloud en UE. App Android disponible maintenant, iOS à venir.",
    ],
  },
  body: [
    {
      ...
      rows: [
        {
          ...
          es: ["Lee tu smartwatch (Health Connect)", "Sí", "En camino (Apple Health)"],
          de: ["Liest deine Smartwatch (Health Connect)", "Ja", "In Kürze (Apple Health)"],
          pt: ["Lê seu smartwatch (Health Connect)", "Sim", "Em breve (Apple Health)"],
          fr: ["Lit votre montre connectée (Health Connect)", "Oui", "Bientôt (Apple Health)"],
        },
        {
          it: ["Anello Colmi via Bluetooth", "Sì", "In arrivo"],
          en: ["Colmi ring over Bluetooth", "Yes", "Coming"],
          es: ["Anillo Colmi por Bluetooth", "Sí", "En camino"],
          de: ["Colmi-Ring über Bluetooth", "Ja", "In Kürze"],
          pt: ["Anel Colmi por Bluetooth", "Sim", "Em breve"],
          fr: ["Bague Colmi via Bluetooth", "Oui", "Bientôt"],
        },
        {
          it: ["Deduplicazione tra fonti", "Sì", "In arrivo"],
          en: ["Deduplication across sources", "Yes", "Coming"],
          es: ["Deduplicación entre fuentes", "Sí", "En camino"],
          de: ["Deduplizierung über alle Quellen", "Ja", "In Kürze"],
          pt: ["Deduplicação entre as fontes", "Sim", "Em breve"],
          fr: ["Déduplication entre les sources", "Oui", "Bientôt"],
        },
        {
    ...
    },
    {
      ...
      body: {
        ...
        es: "La app Android y el panel web están disponibles ya, el iPhone está en camino. Los primeros 1000 inscritos founder consiguen el Pro de por vida gratis: conecta tus wearables y el anillo Colmi y velo todo en un solo lugar.",
        de: "Die Android-App und das Web-Dashboard sind ab sofort verfügbar, das iPhone folgt. Die ersten 1.000 founder-Anmeldungen erhalten Pro lebenslang gratis: Verbinde deine Wearables und den Colmi-Ring und sieh alles an einem Ort.",
        pt: "O app Android e o painel na web já estão disponíveis, o iPhone está a caminho. Os primeiros 1000 inscritos founder ganham o Pro vitalício de graça: conecte seus wearables e o anel Colmi e veja tudo em um só lugar.",
        fr: "L'app Android et le tableau de bord web sont disponibles maintenant, l'iPhone arrive bientôt. Les 1000 premiers inscrits founder obtiennent Pro à vie gratuitement : connectez vos wearables et la bague Colmi et voyez tout au même endroit.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        es: "En Android, con cualquier dispositivo que escriba en Health Connect (la mayoría de smartwatches y pulseras recientes), más el anillo Colmi por Bluetooth. Proveedores como Strava, Oura y Suunto se conectan desde la sección de proveedores externos. La versión iPhone está en camino y usará Apple Health.",
        de: "Unter Android mit jedem Gerät, das in Health Connect schreibt (die meisten aktuellen Smartwatches und Bänder), plus dem Colmi-Ring über Bluetooth. Anbieter wie Strava, Oura und Suunto verbindest du im Bereich für externe Anbieter. Die iPhone-Version folgt und wird Apple Health nutzen.",
        pt: "No Android, com qualquer dispositivo que escreva no Health Connect (a maioria dos smartwatches e pulseiras recentes), além do anel Colmi por Bluetooth. Provedores como Strava, Oura e Suunto se conectam na seção de provedores externos. A versão iPhone está a caminho e vai usar o Apple Health.",
        fr: "Sur Android, avec n'importe quel appareil qui écrit dans Health Connect (la plupart des montres connectées et bracelets récents), plus la bague Colmi via Bluetooth. Des fournisseurs comme Strava, Oura et Suunto se connectent depuis la section des fournisseurs externes. La version iPhone arrive bientôt et utilisera Apple Health.",
      },
    },
    {
      q: {
    ...
    },
    {
      ...
      a: {
        ...
        es: "La app Android está disponible ya; la versión iPhone está en camino y escribirá en Apple Health. El panel web, en cambio, ya es accesible desde cualquier dispositivo con tu cuenta, iPhone incluido.",
        de: "Die Android-App ist ab sofort verfügbar; die iPhone-Version folgt und wird in Apple Health schreiben. Das Web-Dashboard hingegen ist mit deinem Konto bereits von jedem Gerät aus zugänglich, auch vom iPhone.",
        pt: "O app Android já está disponível; a versão iPhone está a caminho e vai gravar no Apple Health. Já o painel na web já é acessível de qualquer dispositivo com a sua conta, incluindo o iPhone.",
        fr: "L'app Android est disponible maintenant ; la version iPhone arrive bientôt et écrira dans Apple Health. Le tableau de bord web, en revanche, est déjà accessible depuis n'importe quel appareil avec votre compte, iPhone compris.",
      },
    },
  ],
  related: [
