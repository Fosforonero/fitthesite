...
export const post: BlogPost = {
  ...
  hero: {
    ...
    subtitle: {
      it: "FitMesh Sync legge i dati dei tuoi wearable, incluso l'anello Colmi via Bluetooth, li unisce senza doppioni e li mostra in un'unica dashboard nell'app. Ecco come funziona, schermata per schermata.",
      en: "FitMesh Sync reads your wearables' data, including the Colmi ring over Bluetooth, merges it without duplicates and shows it in one dashboard in the app. Here's how it works, screen by screen.",
      es: "FitMesh Sync lee los datos de tus wearables, incluido el anillo Colmi por Bluetooth, los unifica sin duplicados y los muestra en un único panel de la app. Así funciona, pantalla a pantalla.",
      de: "FitMesh Sync liest die Daten deiner Wearables, darunter den Colmi-Ring über Bluetooth, führt sie ohne Duplikate zusammen und zeigt sie in einem einzigen Dashboard in der App. So funktioniert es, Bildschirm für Bildschirm.",
      pt: "O FitMesh Sync lê os dados dos seus wearables, incluindo o anel Colmi por Bluetooth, une tudo sem duplicatas e mostra em um único painel no app. Veja como funciona, tela por tela.",
      fr: "FitMesh Sync lit les données de vos wearables, y compris la bague Colmi via Bluetooth, les fusionne sans doublons et les affiche dans un seul tableau de bord dans l'app. Voici comment ça marche, écran par écran.",
    },
  },
  metaDescription: {
    ...
    es: "Cómo funciona FitMesh Sync: lee el anillo Colmi por Bluetooth y el smartwatch mediante Health Connect, unifica los datos sin duplicados en un único panel. Guía con capturas reales.",
    de: "So funktioniert FitMesh Sync: Es liest den Colmi-Ring über Bluetooth und deine Smartwatch über Health Connect und führt die Daten ohne Duplikate in einem Dashboard zusammen. Anleitung mit echten Screenshots.",
    pt: "Como funciona o FitMesh Sync: lê o anel Colmi por Bluetooth e o smartwatch via Health Connect, une os dados sem duplicatas em um único painel. Guia com capturas de tela reais.",
    fr: "Comment fonctionne FitMesh Sync : il lit la bague Colmi via Bluetooth et votre montre connectée via Health Connect, fusionne les données sans doublons dans un seul tableau de bord. Guide avec de vraies captures d'écran.",
  },
  primaryKeyword: {
  ...
  secondaryKeywords: {
    ...
    fr: [
      ...
      "voir les données wearables dans l'application",
    ],
  },
  tldr: {
    it: [
      "FitMesh Sync è un'app che raccoglie i dati dei tuoi wearable e li mostra in un'unica dashboard, sul telefono.",
    ...
    en: [
      "FitMesh Sync is an app that gathers your wearables' data and shows it in one dashboard, on your phone.",
    ...
    es: [
      "FitMesh Sync es una app que reúne los datos de tus wearables y los muestra en un único panel, en el móvil.",
    ...
    de: [
      "FitMesh Sync ist eine App, die die Daten deiner Wearables sammelt und in einem einzigen Dashboard anzeigt, auf dem Handy.",
    ...
    pt: [
      "O FitMesh Sync é um app que reúne os dados dos seus wearables e mostra tudo em um único painel, no celular.",
    ...
    fr: [
      "FitMesh Sync est une app qui rassemble les données de vos wearables et les affiche dans un seul tableau de bord, sur votre téléphone.",
  ...
  body: [
    {
      ...
      text: {
        ...
        en: "If you're wondering how FitMesh works before trying it, the one-sentence answer is this: FitMesh Sync gathers the data from all your wearables, including an affordable smart ring, merges it without duplicates and shows it to you in one dashboard, on your phone. In this guide we go through it screen by screen, with real screenshots of the app.",
        ...
        de: "Wenn du dich fragst, wie FitMesh funktioniert, bevor du es ausprobierst, lautet die Antwort in einem Satz: FitMesh Sync sammelt die Daten all deiner Wearables, darunter ein günstiger smarter Ring, führt sie ohne Duplikate zusammen und zeigt sie dir in einem einzigen Dashboard, auf dem Handy. In diesem Leitfaden gehen wir das Bildschirm für Bildschirm durch, mit echten Screenshots der App.",
        pt: "Se você está se perguntando como o FitMesh funciona antes de experimentar, a resposta em uma frase é esta: o FitMesh Sync reúne os dados de todos os seus wearables, incluindo um anel inteligente acessível, une tudo sem duplicatas e mostra em um único painel, no celular. Neste guia, vamos ver tudo tela por tela, com imagens reais do app.",
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "Apri l'app quando vuoi: ritrovi tutto unito e deduplicato nella dashboard.",
        ],
        en: [
          ...
          "Open the app whenever you want: you find everything merged and deduplicated in the dashboard.",
        ],
        es: [
          ...
          "Abre la app cuando quieras: encuentras todo unido y deduplicado en el panel.",
        ],
        de: [
          ...
          "Öffne die App, wann immer du willst: Du findest alles zusammengeführt und dedupliziert im Dashboard.",
        ],
        pt: [
          ...
          "Abra o app quando quiser: você encontra tudo unido e deduplicado no painel.",
        ],
        fr: [
          ...
          "Ouvrez l'application quand vous voulez : vous retrouvez tout, fusionné et dédupliqué, dans le tableau de bord.",
        ],
      },
    },
    ...
    },
    {
      ...
      body: {
        it: "L'app Android è disponibile ora; l'app iOS è live sull'App Store in tutti gli store supportati, incluse tutte le storefront dei 27 Paesi UE. I primi 1000 iscritti founder (entro il 31 luglio 2026) hanno ricevuto il Pro a vita gratis: collega i tuoi wearable e l'anello Colmi e vedi tutto in un posto solo.",
        en: "The Android app is available now; the iOS app is live on the App Store in all supported storefronts, including all 27 EU countries. The first 1,000 founder sign-ups (by July 31, 2026) got lifetime Pro free: connect your wearables and the Colmi ring and see everything in one place.",
        es: "La app Android está disponible ya; la app iOS ya está disponible en todas las tiendas compatibles en la App Store, incluidos los 27 países de la UE. Los primeros 1000 inscritos founder (hasta el 31 de julio de 2026) consiguieron el Pro de por vida gratis: conecta tus wearables y el anillo Colmi y velo todo en un solo lugar.",
        de: "Die Android-App ist ab sofort verfügbar; die iOS-App ist bereits im App Store in allen unterstützten Stores live, einschließlich aller 27 EU-Länder. Die ersten 1.000 founder-Anmeldungen (bis 31. Juli 2026) haben Pro lebenslang gratis erhalten: Verbinde deine Wearables und den Colmi-Ring und sieh alles an einem Ort.",
        pt: "O app Android já está disponível; o app iOS já está disponível na App Store em todas as lojas compatíveis, incluindo os 27 países da UE. Os primeiros 1000 inscritos founder (até 31 de julho de 2026) ganharam o Pro vitalício de graça: conecte seus wearables e o anel Colmi e veja tudo em um só lugar.",
        fr: "L'app Android est disponible maintenant ; l'app iOS est déjà disponible sur l'App Store dans toutes les boutiques prises en charge, y compris les 27 pays de l'UE. Les 1000 premiers inscrits founder (jusqu'au 31 juillet 2026) ont obtenu Pro à vie gratuitement : connectez vos wearables et la bague Colmi et voyez tout au même endroit.",
      },
      ctaLabel: {
  ...
  faq: [
    {
      ...
      a: {
        it: "FitMesh Sync legge i dati dei tuoi wearable, l'anello Colmi via Bluetooth e lo smartwatch tramite Health Connect su Android, li unisce con la deduplicazione (niente doppioni) e li mostra in un'unica dashboard sul telefono. I dati restano sul tuo account.",
        en: "FitMesh Sync reads your wearables' data, the Colmi ring over Bluetooth and your smartwatch through Health Connect on Android, merges it with deduplication (no duplicates) and shows it in one dashboard on your phone. Your data stays on your account.",
        es: "FitMesh Sync lee los datos de tus wearables, el anillo Colmi por Bluetooth y el smartwatch a través de Health Connect en Android, los unifica con la deduplicación (sin duplicados) y los muestra en un único panel en el móvil. Tus datos se quedan en tu cuenta.",
        de: "FitMesh Sync liest die Daten deiner Wearables, den Colmi-Ring über Bluetooth und deine Smartwatch über Health Connect unter Android, führt sie per Deduplizierung zusammen (keine Duplikate) und zeigt sie in einem einzigen Dashboard auf dem Handy. Deine Daten bleiben in deinem Konto.",
        pt: "O FitMesh Sync lê os dados dos seus wearables, o anel Colmi por Bluetooth e o smartwatch pelo Health Connect no Android, une tudo com a deduplicação (sem duplicatas) e mostra em um único painel no celular. Seus dados ficam na sua conta.",
        fr: "FitMesh Sync lit les données de vos wearables, la bague Colmi via Bluetooth et votre montre connectée via Health Connect sur Android, les fusionne avec la déduplication (aucun doublon) et les affiche dans un seul tableau de bord sur votre téléphone. Vos données restent sur votre compte.",
      },
    },
    {
      q: {
    ...
    },
    {
      ...
      a: {
        it: "Sul tuo account. FitMesh non vende i tuoi dati e non mostra pubblicità.",
        en: "On your account. FitMesh doesn't sell your data and shows no ads.",
        es: "En tu cuenta. FitMesh no vende tus datos y no muestra publicidad.",
        de: "In deinem Konto. FitMesh verkauft deine Daten nicht und zeigt keine Werbung.",
        pt: "Na sua conta. O FitMesh não vende seus dados e não mostra anúncios.",
        fr: "Sur votre compte. FitMesh ne vend pas vos données et n'affiche aucune publicité.",
      },
    },
    {
      q: {
    ...
    },
    {
      ...
      a: {
        it: "Sì. L'app Android è disponibile ora e l'app iOS è già live sull'App Store in tutti gli store supportati, incluse tutte le storefront dei 27 Paesi UE; su iPhone legge Apple Salute direttamente.",
        en: "Yes. The Android app is available now and the iOS app is already live on the App Store in all supported storefronts, including all 27 EU countries; on iPhone it reads Apple Health directly.",
        es: "Sí. La app Android está disponible ya y la app iOS ya está disponible en todas las tiendas compatibles en la App Store, incluidos los 27 países de la UE; en iPhone lee Apple Health directamente.",
        de: "Ja. Die Android-App ist ab sofort verfügbar und die iOS-App ist bereits im App Store in allen unterstützten Stores live, einschließlich aller 27 EU-Länder; auf dem iPhone liest sie Apple Health direkt aus.",
        pt: "Sim. O app Android já está disponível e o app iOS já está disponível na App Store em todas as lojas compatíveis, incluindo os 27 países da UE; no iPhone ele lê o Apple Health diretamente.",
        fr: "Oui. L'app Android est disponible maintenant et l'app iOS est déjà disponible sur l'App Store dans toutes les boutiques prises en charge, y compris les 27 pays de l'UE ; sur iPhone, elle lit directement Apple Health.",
      },
    },
