...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      type: "callout",
      variant: "info",
      title: { it: "Nota tecnica", en: "Technical note", es: "Nota técnica" },
      body: {
    ...
    },
    {
      type: "callout",
      variant: "warning",
      title: { it: "Attenzione: permessi di default", en: "Attention: default permissions", es: "Atención: permisos por defecto" },
      body: {
    ...
    },
    {
      type: "callout",
      variant: "tip",
      title: { it: "Il problema dei permessi viene sempre prima dell'hardware", en: "The permission problem always comes before hardware", es: "El problema de los permisos siempre va antes que el hardware" },
      body: {
