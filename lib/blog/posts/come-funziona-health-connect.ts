  ...
  body: [
    {
      type: "paragraph",
      text: {
        it: "Hai un Galaxy Watch, un Pixel Watch, o un qualsiasi wearable Android, e prima o poi ti sei trovato davanti all'app Health Connect chiedendoti a cosa serve. Non è una dashboard fitness, non ha grafici accattivanti, e non registra nessun dato da sola. Eppure è il componente che tiene insieme tutto l'ecosistema salute Android. Capire come funziona ti aiuta a risolvere i problemi di sincronizzazione, a prendere il controllo dei tuoi permessi, e a capire dove finiscono davvero i tuoi dati.",
        en: "You have a Galaxy Watch, a Pixel Watch, or any Android wearable, and at some point you've found yourself looking at the Health Connect app wondering what it's for. It's not a fitness dashboard, has no fancy charts, and doesn't record any data on its own. Yet it's the component that holds together the entire Android health ecosystem. Understanding how it works helps you fix sync problems, take control of your permissions, and understand where your data actually goes.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      body: {
        it: "Health Connect è on-device. I dati non escono mai verso i server Google per via di Health Connect. Google potrebbe ricevere i tuoi dati salute solo se usi esplicitamente un'app Google (come Google Fit o Fitbit) che legge da HC e poi sincronizza sul cloud — ma Health Connect di per sé è un database locale sul tuo telefono.",
        en: "Health Connect is on-device. Data never leaves to Google's servers via Health Connect. Google could receive your health data only if you explicitly use a Google app (like Google Fit or Fitbit) that reads from HC and then syncs to the cloud — but Health Connect itself is a local database on your phone.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "Il rischio privacy, quando esiste, viene dalle app che leggono da Health Connect e poi mandano quei dati sui loro server. Un'app di coaching fitness potrebbe leggere la tua HRV e archiviarla nel suo cloud — ma questo è un comportamento dell'app, non di Health Connect. La funzione 'Cronologia accessi ai dati' ti aiuta a capire chi sta accedendo a cosa e quando, permettendoti di prendere decisioni informate su quali permessi mantenere.",
