  ...
  body: [
    ...
    },
    {
      ...
      items: {
        ...
        nl: [
          "Installeer FitMesh Sync op iPhone (nu TestFlight-beta, App Store binnenkort beschikbaar).",
        ...
        ja: [
          "iPhoneにFitMesh Syncをインストールします（現在TestFlightベータ、App Store近日公開予定）。",
        ...
        ko: [
          "iPhone에 FitMesh Sync를 설치합니다(현재 TestFlight 베타, App Store 곧 출시 예정).",
    ...
    },
    {
      ...
      title: {
        ...
        nl: "Probeer de Apple Gezondheid-brug in beta",
        ja: "Appleヘルスケアブリッジをベータで試す",
        ko: "Apple 건강 브리지를 베타에서 테스트하기",
      },
      body: {
        ...
        nl: "FitMesh iOS is nu in TestFlight-beta. Meld je aan om de Apple Gezondheid-schrijfbrug te proberen en je Android-wearablegegevens naar de iPhone Gezondheid-app te brengen.",
        ja: "FitMesh iOSは現在TestFlightベータ版です。登録してAppleヘルスケア書き込みブリッジを試し、AndroidウェアラブルのデータをiPhoneヘルスケアアプリに取り込みましょう。",
        ko: "FitMesh iOS가 현재 TestFlight 베타 중입니다. 가입하여 Apple 건강 쓰기 브리지를 시험해보고 Android 웨어러블 데이터를 iPhone 건강 앱으로 가져오세요.",
      },
      ctaLabel: {
