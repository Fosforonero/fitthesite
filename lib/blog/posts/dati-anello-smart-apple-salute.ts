...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        it: [
          "Installa FitMesh Sync su iPhone dall'App Store (disponibile negli store supportati fuori dall'UE; il rollout nei 27 paesi UE è in corso).",
        ...
        en: [
          "Install FitMesh Sync on iPhone from the App Store (available in supported storefronts outside the European Union; EU rollout in the 27 countries is in progress).",
        ...
        es: [
          "Instala FitMesh Sync en iPhone desde la App Store (disponible en las tiendas compatibles fuera de la Unión Europea; el despliegue en los 27 países de la UE está en curso).",
        ...
        de: [
          "Installiere FitMesh Sync auf dem iPhone aus dem App Store (verfügbar in unterstützten Stores außerhalb der Europäischen Union; die Einführung in den 27 EU-Ländern läuft bereits).",
        ...
        pt: [
          "Instale o FitMesh Sync no iPhone pela App Store (disponível nas lojas compatíveis fora da União Europeia; a expansão para os 27 países da UE está em andamento).",
        ...
        fr: [
          "Installez FitMesh Sync sur iPhone depuis l'App Store (disponible dans les boutiques prises en charge hors de l'Union européenne ; le déploiement dans les 27 pays de l'UE est en cours).",
        ...
        pl: [
          "Zainstaluj FitMesh Sync na iPhone z App Store (dostępny w obsługiwanych sklepach poza Unią Europejską; wdrożenie w 27 krajach UE jest w toku).",
        ...
        tr: [
          "FitMesh Sync uygulamasını iPhone'a App Store'dan kurun (Avrupa Birliği dışındaki desteklenen mağazalarda kullanılabilir; 27 AB ülkesinde kullanıma sunma süreci devam ediyor).",
        ...
        nl: [
          "Installeer FitMesh Sync op iPhone via de App Store (beschikbaar in ondersteunde stores buiten de Europese Unie; de uitrol in de 27 EU-landen is bezig).",
        ...
        ja: [
          "iPhoneにApp StoreからFitMesh Syncをインストールします(EU域外の対応ストアで配信中。EU加盟27カ国への展開は進行中です)。",
        ...
        ko: [
          "iPhone에 App Store에서 FitMesh Sync를 설치합니다(EU 역외의 지원되는 스토어에서 이용 가능하며, EU 27개국 출시는 진행 중입니다).",
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync per iOS è disponibile sull'App Store negli store supportati fuori dall'UE (il rollout nei 27 paesi UE è in corso). Scaricalo per provare il ponte di scrittura Apple Salute e portare i dati del tuo wearable Android dentro l'app Salute di iPhone.",
        en: "FitMesh Sync for iOS is live on the App Store in supported storefronts outside the European Union (EU rollout in the 27 countries is in progress). Download it to try the Apple Health write bridge and bring your Android wearable data into the iPhone Health app.",
        es: "FitMesh Sync para iOS está disponible en App Store en las tiendas compatibles fuera de la Unión Europea (el despliegue en los 27 países de la UE está en curso). Descárgala para probar el puente de escritura de Apple Salud y llevar los datos de tu wearable Android a la app Salud de iPhone.",
        de: "FitMesh Sync für iOS ist im App Store in unterstützten Stores außerhalb der Europäischen Union verfügbar (die Einführung in den 27 EU-Ländern läuft bereits). Lade die App herunter, um die Apple Health Schreibbrücke auszuprobieren und die Daten deines Android-Wearables in die iPhone Health-App zu bringen.",
        pt: "FitMesh Sync para iOS está disponível na App Store nas lojas compatíveis fora da União Europeia (a expansão para os 27 países da UE está em andamento). Baixe para experimentar a ponte de escrita do Apple Saúde e levar os dados do seu wearable Android para o app Saúde do iPhone.",
        fr: "FitMesh Sync pour iOS est disponible sur l'App Store dans les boutiques prises en charge hors de l'Union européenne (le déploiement dans les 27 pays de l'UE est en cours). Téléchargez-le pour tester le pont d'écriture Santé Apple et transférer les données de votre appareil connecté Android dans l'app Santé de l'iPhone.",
        pl: "FitMesh Sync na iOS jest dostępny w App Store w obsługiwanych sklepach poza Unią Europejską (wdrożenie w 27 krajach UE jest w toku). Pobierz go, aby wypróbować most zapisu Apple Zdrowia i przenieść dane z Twojego wearable Android do aplikacji Zdrowie na iPhonie.",
        tr: "FitMesh Sync iOS için App Store'da Avrupa Birliği dışındaki desteklenen mağazalarda yayında (27 AB ülkesinde kullanıma sunma süreci devam ediyor). Android giyilebilir cihazınızın verilerini iPhone Sağlık uygulamasına taşımak için Apple Sağlık yazma köprüsünü denemek üzere uygulamayı indirin.",
        nl: "FitMesh Sync voor iOS is live in de App Store in ondersteunde stores buiten de Europese Unie (de uitrol in de 27 EU-landen is bezig). Download de app om de Apple Gezondheid-schrijfbrug te proberen en je Android-wearablegegevens naar de iPhone Gezondheid-app te brengen.",
        ja: "FitMesh Sync(iOS版)はEU域外の対応ストアでApp Store配信中です(EU加盟27カ国への展開は進行中です)。ダウンロードしてAppleヘルスケア書き込みブリッジを試し、AndroidウェアラブルのデータをiPhoneヘルスケアアプリに取り込みましょう。",
        ko: "FitMesh Sync(iOS)는 EU 역외의 지원되는 App Store에서 이용 가능합니다(EU 27개국 출시는 진행 중입니다). 앱을 다운로드하여 Apple 건강 쓰기 브리지를 사용해보고 Android 웨어러블 데이터를 iPhone 건강 앱으로 가져오세요.",
      },
      ctaLabel: {
