  ...
  body: [
    ...
    },
    {
      ...
      items: {
        ...
        nl: [
          ...
          "**FitMesh Sync**: behoort tot de services die officiële Garmin Connect API-integratie ondersteunen, waardoor u gegevens kunt centraliseren zonder ze elke keer handmatig te exporteren.",
        ],
        ja: [
          ...
          "**FitMesh Sync**：公式 Garmin Connect API 統合をサポートするサービスの一つで、毎回手動でエクスポートすることなくデータを一元管理できます。",
        ],
        ko: [
          ...
          "**FitMesh Sync**: 공식 Garmin Connect API 통합을 지원하는 서비스 중 하나로, 매번 수동으로 내보내지 않고도 데이터를 중앙에서 관리할 수 있습니다.",
        ],
      },
    },
    {
    ...
    },
    {
      ...
      body: {
        ...
        nl: "Een van de opties die dit vereenvoudigt is FitMesh Sync: het integreert met Garmin Connect via de officiële API en brengt uw trainingen naar een via de browser toegankelijk webdashboard, zonder elke keer bestanden handmatig te exporteren.",
        ja: "これを簡単にするオプションの一つが FitMesh Sync です。公式 API を通じて Garmin Connect と統合し、毎回手動でファイルをエクスポートすることなく、ブラウザからアクセス可能なウェブダッシュボードにトレーニングを表示します。",
        ko: "이것을 간단하게 만드는 옵션 중 하나가 FitMesh Sync입니다. 공식 API를 통해 Garmin Connect와 통합하여 매번 파일을 수동으로 내보내지 않고도 브라우저에서 접근 가능한 웹 대시보드에 운동을 가져옵니다.",
      },
      ctaLabel: {
