...
export const post: BlogPost = {
  ...
  hero: {
    kicker: { it: "Annuncio", en: "Announcement", es: "Anuncio" },
    title: {
  ...
  body: [
    ...
    },
    {
      type: "callout",
      variant: "info",
      title: { it: "Come funziona il cross-device", en: "How cross-device works", es: "Cómo funciona el uso entre dispositivos" },
      body: {
