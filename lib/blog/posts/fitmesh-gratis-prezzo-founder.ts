...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "Il Pro include tutti i wearable uniti e deduplicati, storico completo e anello Colmi via Bluetooth.",
    ],
    en: [
      ...
      "Pro includes all your wearables merged and deduplicated, full history and the Colmi ring over Bluetooth.",
    ],
    es: [
      ...
      "El Pro incluye todos los wearables unidos y sin duplicados, el historial completo y el anillo Colmi por Bluetooth.",
    ],
    de: [
      ...
      "Pro umfasst alle Wearables zusammengeführt und ohne Duplikate, den vollständigen Verlauf und den Colmi-Ring über Bluetooth.",
    ],
    pt: [
      ...
      "O Pro inclui todos os wearables unidos e sem duplicatas, histórico completo e o anel Colmi via Bluetooth.",
    ],
    fr: [
      ...
      "Le Pro inclut tous les wearables réunis et dédupliqués, l'historique complet et la bague Colmi via Bluetooth.",
    ],
  },
  primaryKeyword: {
    it: "fitmesh è gratis",
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "La dashboard completa, nell'app.",
        ...
        es: [
          ...
          "El dashboard completo, en la app.",
        ...
        de: [
          ...
          "Das komplette Dashboard, in der App.",
        ...
        fr: [
          ...
          "Le tableau de bord complet, dans l'application.",
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "Ogni nuovo account ha 14 giorni di prova completa. \"Completa\" significa che durante la prova ogni funzione Pro è sbloccata, senza eccezioni. Colleghi i tuoi wearable, guardi lo storico, provi l'anello Colmi via Bluetooth: tutto attivo, senza limiti artificiali. I 14 giorni servono a farti valutare l'app sui tuoi dati veri, non su una demo preconfezionata. È il modo più giusto per capire se FitMesh fa quello che ti serve prima di decidere.",
        en: "Every new account gets a full 14-day trial. \"Full\" means every Pro feature is unlocked during the trial, with no exceptions. You connect your wearables, look at your history, try the Colmi ring over Bluetooth: everything on, no artificial limits. The 14 days let you evaluate the app on your real data, not on a canned demo. It's the fairest way to see whether FitMesh does what you need before you decide.",
        es: "Cada cuenta nueva tiene 14 días de prueba completa. \"Completa\" significa que durante la prueba todas las funciones Pro están desbloqueadas, exactamente igual que para un founder. Conectas tus wearables, miras el historial, pruebas el anillo Colmi por Bluetooth: todo activo, sin límites artificiales. Los 14 días sirven para que valores la app con tus datos reales, no con una demo prefabricada. Es la forma más justa de saber si FitMesh hace lo que necesitas antes de decidir.",
        de: "Jedes neue Konto erhält eine vollständige 14-tägige Testphase. \"Vollständig\" heißt, dass während der Testphase jede Pro-Funktion freigeschaltet ist, genau wie bei einem founder. Du verbindest deine Wearables, siehst dir den Verlauf an, testest den Colmi-Ring über Bluetooth: alles aktiv, ohne künstliche Grenzen. Die 14 Tage sind dazu da, die App mit deinen echten Daten zu bewerten, nicht mit einer vorgefertigten Demo. So findest du am fairsten heraus, ob FitMesh das tut, was du brauchst, bevor du dich entscheidest.",
        pt: "Cada nova conta tem 14 dias de teste completo. \"Completo\" significa que durante o teste cada recurso Pro está liberado, exatamente como para um founder. Você conecta os seus wearables, olha o histórico, experimenta o anel Colmi via Bluetooth: tudo ativo, sem limites artificiais. Os 14 dias servem para você avaliar o app com os seus dados reais, não com uma demonstração pronta. É a forma mais justa de entender se o FitMesh faz o que você precisa antes de decidir.",
        fr: "Chaque nouveau compte dispose de 14 jours d'essai complet. \"Complet\" veut dire que pendant l'essai chaque fonction Pro est débloquée, exactement comme pour un founder. Vous connectez vos wearables, consultez l'historique, testez la bague Colmi via Bluetooth : tout est actif, sans limites artificielles. Les 14 jours servent à évaluer l'appli sur vos vraies données, pas sur une démo préformatée. C'est la façon la plus juste de voir si FitMesh fait ce dont vous avez besoin avant de décider.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "Il Pro è tutto FitMesh, senza livelli confusi. In pratica sblocca la dashboard unificata nell'app, l'unione di tutti i wearable con la deduplica, lo storico completo e la lettura diretta dell'anello Colmi via Bluetooth. Su Android l'app legge i dati tramite Health Connect e in più legge l'anello Colmi via Bluetooth; su iPhone (già live sull'App Store) legge Apple Salute nativamente e si collega allo stesso modo via Bluetooth al Colmi Ring. Se vuoi il quadro completo sull'anello, c'è la [guida completa all'anello Colmi](/it/blog/colmi-ring-fitmesh).",
        en: "Pro is all of FitMesh, with no confusing tiers. In practice it unlocks the unified dashboard in the app, the merging of all your wearables with deduplication, the full history and the direct reading of the Colmi ring over Bluetooth. On Android the app reads data through Health Connect and also reads the Colmi ring over Bluetooth; on iPhone (already live on the App Store) it reads Apple Health natively and connects the same way over Bluetooth to the Colmi Ring. If you want the full picture on the ring, there's the [complete Colmi ring guide](/en/blog/colmi-ring-fitmesh).",
        es: "El Pro es todo FitMesh, sin niveles confusos. En la práctica desbloquea el dashboard unificado en la app, la unión de todos los wearables con la eliminación de duplicados, el historial completo y la lectura directa del anillo Colmi por Bluetooth. En Android la app lee los datos a través de Health Connect y además lee el anillo Colmi por Bluetooth; en iPhone (ya activa en la App Store) lee Apple Salud de forma nativa y se conecta del mismo modo por Bluetooth al anillo Colmi. Si quieres el panorama completo sobre el anillo, tienes la [guía completa del anillo Colmi](/es/blog/colmi-ring-fitmesh).",
        de: "Pro ist ganz FitMesh, ohne verwirrende Stufen. In der Praxis schaltet es das einheitliche Dashboard in der App frei, das Zusammenführen aller Wearables mit Duplikatentfernung, den vollständigen Verlauf und das direkte Auslesen des Colmi-Rings über Bluetooth. Unter Android liest die App die Daten über Health Connect und liest zusätzlich den Colmi-Ring über Bluetooth; auf dem iPhone (bereits live im App Store) liest sie Apple Health nativ aus und verbindet sich auf dieselbe Weise per Bluetooth mit dem Colmi-Ring. Wenn du den kompletten Überblick über den Ring willst, gibt es den [vollständigen Guide zum Colmi-Ring](/de/blog/colmi-ring-fitmesh).",
        pt: "O Pro é o FitMesh inteiro, sem níveis confusos. Na prática, ele libera o painel unificado no app, a união de todos os wearables com a remoção de duplicatas, o histórico completo e a leitura direta do anel Colmi via Bluetooth. No Android o app lê os dados através do Health Connect e ainda lê o anel Colmi via Bluetooth; no iPhone (já ativo na App Store) lê o Apple Saúde nativamente e se conecta da mesma forma por Bluetooth ao anel Colmi. Se você quer o panorama completo sobre o anel, há o [guia completo do anel Colmi](/pt/blog/colmi-ring-fitmesh).",
        fr: "Le Pro, c'est tout FitMesh, sans niveaux compliqués. Concrètement, il débloque le tableau de bord unifié dans l'application, la fusion de tous les wearables avec la déduplication, l'historique complet et la lecture directe de la bague Colmi via Bluetooth. Sous Android, l'appli lit les données via Health Connect et lit en plus la bague Colmi via Bluetooth ; sur iPhone (déjà active sur l'App Store), elle lit Apple Santé nativement et se connecte de la même façon en Bluetooth à la bague Colmi. Si vous voulez le tableau complet sur la bague, il y a le [guide complet de la bague Colmi](/fr/blog/colmi-ring-fitmesh).",
      },
    },
    {
      type: "table",
      ...
      rows: [
        {
          it: ["Dashboard nell'app", "Apri i tuoi dati nell'app con lo stesso account"],
          en: ["In-app dashboard", "Open your data in the app with the same account"],
          es: ["Dashboard en la app", "Abre tus datos en la app con la misma cuenta"],
          de: ["Dashboard in der App", "Öffne deine Daten in der App mit demselben Konto"],
          pt: ["Painel no app", "Abra os seus dados no app com a mesma conta"],
          fr: ["Tableau de bord dans l'application", "Ouvrez vos données dans l'application avec le même compte"],
        },
        {
    ...
    },
    {
      ...
      body: {
        it: "Prova FitMesh Sync gratis per 14 giorni, con ogni funzione Pro sbloccata: tutti i wearable uniti, storico completo e anello Colmi. L'app è disponibile su Play Store e App Store, nessuna carta di credito richiesta per iniziare.",
        en: "Try FitMesh Sync free for 14 days, with every Pro feature unlocked: all wearables merged, full history and the Colmi ring. The app is available on the Play Store and the App Store, no credit card needed to start.",
        es: "Prueba FitMesh Sync gratis durante 14 días, con todas las funciones Pro desbloqueadas: todos los wearables unidos, historial completo y anillo Colmi. La app ya está disponible en Play Store y en App Store, sin necesidad de tarjeta de crédito para empezar.",
        de: "Teste FitMesh Sync 14 Tage lang kostenlos, mit allen freigeschalteten Pro-Funktionen: alle Wearables zusammengeführt, vollständiger Verlauf und Colmi-Ring. Die App ist bereits im Play Store und im App Store verfügbar, keine Kreditkarte nötig, um zu starten.",
        pt: "Experimente o FitMesh Sync grátis por 14 dias, com todos os recursos Pro liberados: todos os wearables unidos, histórico completo e anel Colmi. O app já está disponível na Play Store e na App Store, sem necessidade de cartão de crédito para começar.",
        fr: "Essayez FitMesh Sync gratuitement pendant 14 jours, avec toutes les fonctions Pro débloquées : tous les wearables réunis, historique complet et bague Colmi. L'appli est déjà disponible sur le Play Store et sur l'App Store, aucune carte bancaire nécessaire pour commencer.",
      },
      ctaLabel: {
        it: "Scarica FitMesh →",
        en: "Download FitMesh →",
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "Il Pro include wearable uniti e deduplicati, storico completo e anello Colmi via Bluetooth.",
        ...
        en: [
          ...
          "Pro includes merged and deduplicated wearables, full history and the Colmi ring over Bluetooth.",
        ...
        es: [
          ...
          "El Pro incluye wearables unidos y sin duplicados, historial completo y anillo Colmi por Bluetooth.",
        ...
        de: [
          ...
          "Pro umfasst zusammengeführte und duplikatfreie Wearables, den vollständigen Verlauf und den Colmi-Ring über Bluetooth.",
        ...
        pt: [
          ...
          "O Pro inclui wearables unidos e sem duplicatas, histórico completo e anel Colmi via Bluetooth.",
        ...
        fr: [
          ...
          "Le Pro inclut les wearables réunis et dédupliqués, l'historique complet et la bague Colmi via Bluetooth.",
