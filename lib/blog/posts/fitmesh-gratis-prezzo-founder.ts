...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "Per prendere un posto founder crei un account da /it/beta: scarichi l'app Android (Play Store) o l'app iOS (App Store, disponibile negli store supportati al di fuori dell'Unione Europea; il rollout nei 27 paesi UE è in corso). Il posto è legato al tuo account: una volta founder, resti founder. Non serve la carta di credito per registrarti.",
        en: "To claim a founder spot you create an account at /en/beta: install the Android app (Play Store) or the iOS app (App Store, available in supported storefronts outside the European Union; EU rollout to the 27 member countries is in progress). The spot is tied to your account: once a founder, always a founder. No credit card needed to register.",
        es: "Para conseguir una plaza founder creas una cuenta en /es/beta: descargas la app Android (Play Store) o la app iOS (App Store, disponible en las tiendas compatibles fuera de la Unión Europea; el despliegue en los 27 países de la UE está en curso). La plaza está ligada a tu cuenta: una vez founder, sigues siendo founder. No hace falta tarjeta de crédito para registrarte.",
        de: "Um einen founder-Platz zu bekommen, erstellst du unter /de/beta ein Konto: Du lädst die Android-App herunter (Play Store) oder die iOS-App (App Store, in den unterstützten Stores außerhalb der Europäischen Union verfügbar; der Rollout in den 27 EU-Ländern läuft). Der Platz ist an dein Konto gebunden: Einmal founder, immer founder. Für die Registrierung ist keine Kreditkarte nötig.",
        pt: "Para garantir uma vaga founder você cria uma conta em /pt/beta: baixa o app Android (Play Store) ou o app iOS (App Store, disponível nas lojas compatíveis fora da União Europeia; o lançamento nos 27 países da UE está em andamento). A vaga fica ligada à sua conta: uma vez founder, você continua founder. Não é preciso cartão de crédito para se cadastrar.",
        fr: "Pour obtenir une place founder, vous créez un compte sur /fr/beta : vous téléchargez l'appli Android (Play Store) ou l'appli iOS (App Store, disponible dans les boutiques compatibles en dehors de l'Union européenne ; déploiement en cours dans les 27 pays de l'UE). La place est liée à votre compte : une fois founder, vous restez founder. Aucune carte bancaire n'est nécessaire pour vous inscrire.",
      },
    },
    {
      type: "heading",
