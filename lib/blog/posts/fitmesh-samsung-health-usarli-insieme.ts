...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "I dati che FitMesh legge (da Health Connect o dal Samsung Health Data SDK) vengono inviati al backend cloud di FitMesh per costruire la tua dashboard e mantenerla sincronizzata tra i tuoi dispositivi; non restano solo sul telefono. Samsung Health, separatamente, gestisce il proprio Samsung Cloud secondo le sue impostazioni: disattivare quello non ha effetto sul funzionamento di FitMesh, che dipende da Health Connect e, dove disponibile, dalla connessione diretta al Samsung Health Data SDK.",
        en: "The data FitMesh reads (from Health Connect or the Samsung Health Data SDK) is sent to FitMesh's cloud backend to build your dashboard and keep it in sync across your devices; it doesn't stay only on your phone. Samsung Health separately manages its own Samsung Cloud according to its own settings; turning that off has no effect on FitMesh, which depends on Health Connect and, where available, the direct Samsung Health Data SDK connection.",
        de: "Die Daten, die FitMesh liest (aus Health Connect oder dem Samsung Health Data SDK), werden an das Cloud-Backend von FitMesh gesendet, um Ihr Dashboard aufzubauen und geräteübergreifend synchron zu halten; sie bleiben nicht nur auf dem Telefon. Samsung Health verwaltet separat seine eigene Samsung Cloud gemäß seinen eigenen Einstellungen: Diese zu deaktivieren hat keine Auswirkung auf die Funktion von FitMesh, das von Health Connect und, sofern verfügbar, der direkten Verbindung zum Samsung Health Data SDK abhängt.",
        fr: "Les données que FitMesh lit (depuis Health Connect ou le Samsung Health Data SDK) sont envoyées au backend cloud de FitMesh pour construire votre tableau de bord et le maintenir synchronisé entre vos appareils ; elles ne restent pas uniquement sur le téléphone. Samsung Health gère séparément son propre Samsung Cloud selon ses propres réglages : le désactiver n'a aucun effet sur le fonctionnement de FitMesh, qui dépend de Health Connect et, lorsque disponible, de la connexion directe au Samsung Health Data SDK.",
      },
    },
    {
      type: "heading",
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        de: "FitMesh addiert sie nicht. Bei kumulativen Daten wie Schritten wird, wenn mehrere Geräte in derselben Rolle einen Wert für denselben Zeitraum melden, der höhere Wert der Quellen verwendet, nicht die Summe aus beiden.",
        fr: "FitMesh ne les additionne pas. Pour les données cumulatives comme les pas, lorsque plusieurs appareils ayant le même rôle rapportent une valeur pour le même intervalle, c'est la valeur la plus élevée entre les sources qui est retenue, pas la somme des deux.",
      },
    },
    {
      q: {
