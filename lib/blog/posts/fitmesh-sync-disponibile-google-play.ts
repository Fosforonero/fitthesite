...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "I primi 1000 a registrarsi ricevono il Pro a vita gratis. La versione iPhone arriva tra pochi giorni.",
    ],
    en: [
      ...
      "The first 1,000 to sign up get lifetime Pro free. The iPhone version arrives in a few days.",
    ],
    es: [
      ...
      "Los primeros 1000 en registrarse reciben el Pro de por vida gratis. La versión para iPhone llega en pocos días.",
    ],
    de: [
      ...
      "Die ersten 1000, die sich registrieren, erhalten lebenslang Pro kostenlos. Die iPhone-Version kommt in wenigen Tagen.",
    ],
    pt: [
      ...
      "Os primeiros 1000 a se cadastrar recebem o Pro vitalício grátis. A versão para iPhone chega em poucos dias.",
    ],
    fr: [
      ...
      "Les 1000 premiers inscrits reçoivent le Pro à vie gratuit. La version iPhone arrive dans quelques jours.",
    ],
    pl: [
      ...
      "Pierwszych 1000 osób, które się zarejestrują, otrzymuje dożywotnie Pro za darmo. Wersja na iPhone'a pojawi się za kilka dni.",
    ],
    tr: [
      ...
      "İlk 1000 kayıt olan ömür boyu ücretsiz Pro alır. iPhone sürümü birkaç gün içinde geliyor.",
    ],
    nl: [
      ...
      "De eerste 1000 die zich registreren krijgen levenslang Pro gratis. De iPhone-versie komt over een paar dagen.",
    ],
    ja: [
      ...
      "先着1000名は永久版Proを無料で取得できます。iPhone版は数日以内に登場します。",
    ],
    ko: [
      ...
      "선착순 1000명은 평생 무료 Pro를 받습니다. iPhone 버전은 며칠 내로 출시됩니다.",
    ],
  },
  hero: {
    kicker: {
  ...
  faq: [
    {
      ...
      a: {
        it: "C'è un piano gratuito che copre l'uso quotidiano. Le funzioni Pro, come lo storico illimitato, sono disponibili con un acquisto unico o un piano leggero. In più, i primi 1000 che si iscrivono ricevono il Pro a vita gratis.",
        en: "There is a free plan that covers everyday use. Pro features, like unlimited history, are available with a one-time purchase or a light plan. On top of that, the first 1000 to sign up get lifetime Pro free.",
        es: "Hay un plan gratuito que cubre el uso diario. Las funciones Pro, como el historial ilimitado, están disponibles con un pago único o un plan ligero. Además, los primeros 1000 en registrarse reciben el Pro de por vida gratis.",
        de: "Es gibt einen kostenlosen Plan, der den täglichen Gebrauch abdeckt. Pro-Funktionen wie der unbegrenzte Verlauf sind mit einem Einmalkauf oder einem leichten Plan verfügbar. Außerdem erhalten die ersten 1000 Registrierungen lebenslang Pro kostenlos.",
        pt: "Há um plano gratuito que cobre o uso diário. Os recursos Pro, como o histórico ilimitado, estão disponíveis com uma compra única ou um plano leve. Além disso, os primeiros 1000 a se cadastrar recebem o Pro vitalício grátis.",
        fr: "Il existe un plan gratuit qui couvre l'usage quotidien. Les fonctionnalités Pro, comme l'historique illimité, sont disponibles avec un achat unique ou un plan léger. De plus, les 1000 premiers inscrits reçoivent le Pro à vie gratuit.",
        pl: "Jest bezpłatny plan, który pokrywa codzienne użytkowanie. Funkcje Pro, takie jak nieograniczona historia, są dostępne za jednorazowy zakup lub lekki plan. Dodatkowo, pierwsze 1000 osób, które się zarejestrują, otrzymuje dożywotnie Pro za darmo.",
        tr: "Günlük kullanımı karşılayan ücretsiz bir plan var. Sınırsız geçmiş gibi Pro özellikler, tek seferlik satın alma veya hafif bir planla kullanılabilir. Bunun yanı sıra, ilk 1000 kayıt olan kişi ömür boyu ücretsiz Pro alır.",
        nl: "Er is een gratis plan dat het dagelijkse gebruik dekt. Pro-functies, zoals onbeperkte geschiedenis, zijn beschikbaar via een eenmalige aankoop of een licht abonnement. Bovendien ontvangen de eerste 1000 die zich registreren levenslang Pro gratis.",
        ja: "日常的な使用をカバーする無料プランがあります。無制限の履歴などのPro機能は、買い切りまたは軽量プランでご利用いただけます。さらに、先着1000名は永久版Proを無料で取得できます。",
        ko: "일상적인 사용을 커버하는 무료 플랜이 있습니다. 무제한 기록 등의 Pro 기능은 일회성 구매 또는 가벼운 플랜으로 이용할 수 있습니다. 또한 먼저 등록한 1000명은 평생 무료 Pro를 받습니다.",
      },
    },
    {
      q: {
