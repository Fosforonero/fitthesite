...
export const post: BlogPost = {
  ...
  faq: [
    ...
    {
      q: { it: "Dove sono ospitati i dati di FitnessSyncer e come vengono gestiti i trasferimenti internazionali?", en: "Where is FitnessSyncer data hosted and how are international transfers handled?" },
      a: {
        it: "In base alla privacy policy ufficiale di FitnessSyncer (fitnesssyncer.com/privacy), i dati sono raccolti e conservati su server cloud situati negli Stati Uniti (inclusi fornitori terzi come AWS, Linode e Grafana). Per i trasferimenti transfrontalieri di dati dall'Unione Europea, Regno Unito e Svizzera, l'azienda documenta la propria adesione ai framework EU-U.S. Data Privacy Framework (DPF), UK Extension e Swiss-U.S. DPF. La policy dichiara inoltre che i dati personali non vengono venduti a terzi.",
        en: "According to FitnessSyncer's official privacy policy (fitnesssyncer.com/privacy), data is collected and stored on cloud servers located in the United States (including third-party providers like AWS, Linode, and Grafana). For international data transfers from the European Union, the UK, and Switzerland, the company documents its participation in the EU-U.S. Data Privacy Framework (DPF), its UK Extension, and the Swiss-U.S. DPF. The policy also states that personal data is not sold to third parties.",
      },
    },
    {
