...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ...
        {
          it: ["FitMesh Sync", "Sì, app + dashboard web", "Server nell'Unione Europea, GDPR", "No, chiuso", "Abbonamento leggero o sblocco a vita; primi 1000 founder gratis a vita (programma chiuso dal 31 luglio 2026)"],
          en: ["FitMesh Sync", "Yes, app + web dashboard", "Servers in the European Union, GDPR", "No, closed", "Light subscription or lifetime unlock; first 1,000 founders free for life (program closed as of July 31, 2026)"],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      body: {
        it: "Dashboard web e app, server in UE, nessuna pubblicità, nessuna vendita dei dati. I primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026) hanno ottenuto il Pro a vita gratis; tutti gli altri hanno 14 giorni di prova completa.",
        en: "Web dashboard and app, EU servers, no ads, no data sold. The first 1,000 founder sign-ups (program closed as of July 31, 2026) got lifetime Pro free; everyone else gets a full 14-day trial.",
      },
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "Gadgetbridge è gratuito (sostenuto da donazioni). Health Sync ha un acquisto una tantum economico (3,99 $ confermato su iOS). FitnessSyncer ha un piano gratuito limitato e un piano a pagamento più completo. FitMesh Sync non ha un piano gratuito permanente: offre una prova completa di 14 giorni, poi un abbonamento leggero o lo sblocco a vita, con il Pro gratis a vita per i primi 1000 iscritti founder (programma chiuso dal 31 luglio 2026).",
        en: "Gadgetbridge is free (donation-supported). Health Sync has a cheap one-time purchase ($3.99 confirmed on iOS). FitnessSyncer has a limited free tier and a fuller paid tier. FitMesh Sync has no permanent free plan: it offers a full 14-day trial, then a light subscription or a lifetime unlock, with free-for-life Pro for the first 1,000 founder sign-ups (program closed as of July 31, 2026).",
      },
    },
    {
