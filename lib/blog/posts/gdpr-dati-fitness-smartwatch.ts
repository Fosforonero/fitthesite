...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge da Health Connect (on-device) e archivia su backend Supabase. Nessun ad-tech, nessun reseller di dati, accesso a un click; la procedura di cancellazione è descritta su fitmesh.fit/delete-account.",
        en: "FitMesh Sync reads from Health Connect (on-device) and stores on a Supabase backend. No ad-tech, no data reseller, one-click access; the deletion process is described at fitmesh.fit/delete-account.",
        es: "FitMesh Sync lee desde Health Connect (en el dispositivo) y almacena los datos en un backend Supabase. Sin ad-tech, sin reventa de datos, acceso en un clic; el proceso de eliminación se describe en fitmesh.fit/delete-account.",
        de: "FitMesh Sync liest von Health Connect (auf dem Gerät) und speichert auf einem Supabase-Backend. Kein Ad-Tech, kein Datenweiterverkauf, Zugriff per Klick; der Löschvorgang ist beschrieben unter fitmesh.fit/delete-account.",
        pt: "FitMesh Sync lê do Health Connect (no dispositivo) e armazena em um backend Supabase. Sem ad-tech, sem revenda de dados, acesso com um clique; o processo de exclusão está descrito em fitmesh.fit/delete-account.",
        fr: "FitMesh Sync lit depuis Health Connect (sur l'appareil) et stocke sur un backend Supabase. Pas d'ad-tech, pas de revendeur de données, accès en un clic ; le processus de suppression est décrit sur fitmesh.fit/delete-account.",
        pl: "FitMesh Sync odczytuje z Health Connect (na urządzeniu) i przechowuje na backendu Supabase. Brak ad-tech, brak sprzedawcy danych, dostęp jednym kliknięciem; procedura usuwania jest opisana na fitmesh.fit/delete-account.",
        tr: "FitMesh Sync ile Health Connect (cihazda) kurallarını okuyup, Supabase sunucusu üzerindeki backend'e kaydeder. Hiçbir ad-tex yok, hiçbir veri satıcısı olmaz, bir tıklama ile erişim; silme işlemi fitmesh.fit/delete-account adresinde açıklanmıştır.",
        nl: "FitMesh Sync leest van Health Connect (op het apparaat) en slaat op op een Supabase-backend. Geen ad-tech, geen datawederverkoper, inzage met één klik; de verwijderprocedure staat beschreven op fitmesh.fit/delete-account.",
        ja: "FitMesh SyncはHealth Connect（デバイス上）から読み取り、Supabaseバックエンドに保存します。アドテックなし、データ転売なし、ワンクリックでアクセス。削除の手順はfitmesh.fit/delete-accountに記載されています。",
        ko: "FitMesh Sync는 Health Connect(기기 내)에서 읽어 Supabase 백엔드에 저장합니다. 광고 기술 없음, 데이터 재판매 없음, 원클릭으로 열람. 삭제 절차는 fitmesh.fit/delete-account에 설명되어 있습니다.",
      },
  ...
  faq: [
    ...
    {
      q: {
        it: "Come gestisce i dati l'app FitMesh Sync rispetto al GDPR?",
        en: "How does the FitMesh Sync app handle data under GDPR?",
        es: "¿Cómo gestiona los datos la app FitMesh Sync según el GDPR?",
        de: "Wie geht die FitMesh Sync App mit Daten im Rahmen der DSGVO um?",
        pt: "Como o app FitMesh Sync lida com os dados no âmbito do GDPR?",
        fr: "Comment l'application FitMesh Sync gère-t-elle les données au regard du RGPD ?",
        pl: "Jak aplikacja FitMesh Sync traktuje dane w świetle GDPR?",
        tr: "FitMesh Sync uygulaması verileri KVKK kapsamında nasıl işliyor?",
        nl: "Hoe gaat de FitMesh Sync-app om met gegevens onder de AVG?",
        ja: "FitMesh SyncアプリはGDPRのもとでデータをどう扱っていますか？",
        ko: "FitMesh Sync 앱은 GDPR 하에서 데이터를 어떻게 처리하나요?",
      },
      a: {
        it: "Privacy policy esplicita, server backend ospitati su Supabase, consenso granulare in app, la procedura di cancellazione dati è descritta su fitmesh.fit/delete-account, nessuna condivisione con terze parti per ad-tech, nessun SDK pubblicitario o di profilazione (Firebase Crashlytics gestisce solo la diagnostica crash). Architettura privacy-by-design.",
        en: "Explicit privacy policy, backend on Supabase, granular in-app consent, the deletion process is described at fitmesh.fit/delete-account, no third-party ad-tech sharing, no advertising or behavioral-profiling SDKs (Firebase Crashlytics only handles crash diagnostics). Privacy-by-design architecture.",
        es: "Política de privacidad explícita, backend alojado en Supabase, consentimiento granular en la app, el proceso de eliminación de datos se describe en fitmesh.fit/delete-account, sin compartir datos con terceros para ad-tech y sin rastreadores de analíticas intrusivos. Arquitectura privacy-by-design.",
        de: "Explizite Datenschutzrichtlinie, Backend auf Supabase, granulare In-App-Einwilligung, der Löschvorgang ist beschrieben unter fitmesh.fit/delete-account, keine Weitergabe an Dritte für Ad-Tech, keine Werbe- oder Profiling-SDKs (Firebase Crashlytics dient nur der Absturzdiagnose). Privacy-by-Design-Architektur.",
        pt: "Política de privacidade explícita, backend hospedado no Supabase, consentimento granular no app, o processo de exclusão de dados está descrito em fitmesh.fit/delete-account, sem compartilhamento com terceiros para ad-tech, sem rastreadores de análises intrusivos. Arquitetura privacy-by-design.",
        fr: "Politique de confidentialité explicite, backend sur Supabase, consentement granulaire dans l'application, le processus de suppression des données est décrit sur fitmesh.fit/delete-account, aucun partage avec des tiers pour l'ad-tech, aucun SDK publicitaire ou de profilage (Firebase Crashlytics gère uniquement le diagnostic des plantages). Architecture privacy-by-design.",
        pl: "Polityka prywatności wyraźna, serwery backendowe gościnnie na Supabase, zgranularny zgodny w aplikacji, procedura usuwania danych jest opisana na fitmesh.fit/delete-account, brak udzielania informacji trzecim stronom dla celów ad-tech, brak SDK reklamowych lub profilujących (Firebase Crashlytics obsluguje wylacznie diagnostyke awarii). Architektura zapewniajsza prywatność od założenia.",
        tr: "Gizlilik ilkesi belirtilmiş, server backend Supabase sunucularında barındırılmış, uygulamada hassas consent, veri silme süreci fitmesh.fit/delete-account adresinde açıklanmıştır, üçüncü taraf ile reklam teknolojisi için veri paylaşımı yok, reklam veya davranışsal profilleme SDK'sı yok (Firebase Crashlytics yalnızca çökme tanılamasını yönetir). Tasarımın parçası olan gizlilik tasarımına dayalı mimari.",
        nl: "Expliciet privacybeleid, backend op Supabase, granulair toestemming in de app, de verwijderprocedure staat beschreven op fitmesh.fit/delete-account, geen deling met derde partijen voor ad-tech, geen advertentie- of profileringssdk's (Firebase Crashlytics regelt alleen crashdiagnostiek). Privacy-by-design architectuur.",
        ja: "明示的なプライバシーポリシー、Supabaseバックエンド、アプリ内の細かく分類された同意、削除の手順はfitmesh.fit/delete-accountに記載、アドテックのための第三者共有なし、侵入的な分析トラッカーなし。プライバシー・バイ・デザインのアーキテクチャ。",
        ko: "명시적 개인정보 처리방침, Supabase 백엔드, 앱 내 세분화된 동의, 삭제 절차는 fitmesh.fit/delete-account에 설명되어 있음, 광고 기술을 위한 제3자 공유 없음, 침입적 분석 추적기 없음. 프라이버시 바이 디자인 아키텍처.",
      },
    },
  ],
  related: [
