...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "**Android e iPhone**: FitMesh Sync è su Google Play e ora anche su App Store (in gran parte del mondo; nell'UE la disponibilità è in fase di rollout).",
        ],
        en: [
          ...
          "**Android and iPhone**: FitMesh Sync is on Google Play and now also on the App Store (across most of the world; EU availability is rolling out).",
        ],
        es: [
          ...
          "**Android y iPhone**: FitMesh Sync está en Google Play y ahora también en App Store (en gran parte del mundo; la disponibilidad en la UE se está desplegando).",
        ],
        de: [
          ...
          "**Android und iPhone**: FitMesh Sync ist auf Google Play und jetzt auch im App Store (in weiten Teilen der Welt; die Verfügbarkeit in der EU wird schrittweise ausgerollt).",
        ],
        pt: [
          ...
          "**Android e iPhone**: o FitMesh Sync está no Google Play e agora também na App Store (em grande parte do mundo; a disponibilidade na UE está sendo lançada gradualmente).",
        ],
        fr: [
          ...
          "**Android et iPhone**: FitMesh Sync est sur Google Play et désormais aussi sur l'App Store (dans la majeure partie du monde; le déploiement dans l'UE est en cours).",
        ],
        pl: [
          ...
          "**Android i iPhone**: FitMesh Sync jest w Google Play, a teraz także w App Store (w większości świata; dostępność w UE jest wdrażana stopniowo).",
        ],
        tr: [
          ...
          "**Android ve iPhone**: FitMesh Sync Google Play'de ve artık App Store'da da mevcut (dünyanın çoğunda; AB'de kullanılabilirlik kademeli olarak devreye alınıyor).",
        ],
        nl: [
          ...
          "**Android en iPhone**: FitMesh Sync staat op Google Play en nu ook in de App Store (in het grootste deel van de wereld; beschikbaarheid in de EU wordt geleidelijk uitgerold).",
        ],
        ja: [
          ...
          "**Android と iPhone**: FitMesh Sync は Google Play に加えて App Store でも利用可能になりました（世界の大部分で利用可能。EU では順次展開中）。",
        ],
        ko: [
          ...
          "**Android 및 iPhone**: FitMesh Sync는 Google Play에 이어 이제 App Store에서도 이용할 수 있습니다(대부분의 지역에서 이용 가능하며, EU는 단계적으로 출시 중입니다).",
        ],
      },
    },
    {
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "FitMesh Sync legge da Health Connect su Android ed è ora disponibile anche su App Store per iPhone (in gran parte del mondo; nell'UE la disponibilità è in fase di rollout), dove usa Apple Health come fonte dati.",
        en: "FitMesh Sync reads from Health Connect on Android and is now also available on the App Store for iPhone (across most of the world; EU availability is rolling out), where it uses Apple Health as the data source.",
        es: "FitMesh Sync lee de Health Connect en Android y ahora también está disponible en App Store para iPhone (en gran parte del mundo; la disponibilidad en la UE se está desplegando), donde usa Apple Health como fuente de datos.",
        de: "FitMesh Sync liest auf Android aus Health Connect und ist jetzt auch im App Store für iPhone verfügbar (in weiten Teilen der Welt; die Verfügbarkeit in der EU wird schrittweise ausgerollt), wo es Apple Health als Datenquelle nutzt.",
        pt: "O FitMesh Sync lê do Health Connect no Android e agora também está disponível na App Store para iPhone (em grande parte do mundo; a disponibilidade na UE está sendo lançada gradualmente), onde usa o Apple Health como fonte de dados.",
        fr: "FitMesh Sync lit depuis Health Connect sur Android et est désormais aussi disponible sur l'App Store pour iPhone (dans la majeure partie du monde ; le déploiement dans l'UE est en cours), où il utilise Apple Health comme source de données.",
        pl: "FitMesh Sync odczytuje dane z Health Connect na Androidzie, a teraz jest też dostępny w App Store na iPhone'a (w większości świata; dostępność w UE jest wdrażana stopniowo), gdzie korzysta z Apple Health jako źródła danych.",
        tr: "FitMesh Sync, Android'de Health Connect'ten veri okur ve artık iPhone için App Store'da da mevcuttur (dünyanın çoğunda; AB'de kullanılabilirlik kademeli olarak devreye alınıyor); iPhone'da veri kaynağı olarak Apple Health'i kullanır.",
        nl: "FitMesh Sync leest op Android uit Health Connect en is nu ook beschikbaar in de App Store voor iPhone (in het grootste deel van de wereld; beschikbaarheid in de EU wordt geleidelijk uitgerold), waar het Apple Health als gegevensbron gebruikt.",
        ja: "FitMesh Sync は Android では Health Connect からデータを読み取り、現在は iPhone 向けにも App Store で利用可能です（世界の大部分で利用可能。EU では順次展開中）。iPhone では Apple Health をデータソースとして使用します。",
        ko: "FitMesh Sync는 Android에서 Health Connect의 데이터를 읽으며, 이제 iPhone용으로도 App Store에서 이용할 수 있습니다(대부분의 지역에서 이용 가능하며, EU는 단계적으로 출시 중입니다). iPhone에서는 Apple Health를 데이터 소스로 사용합니다.",
      },
    },
    {
      type: "heading",
