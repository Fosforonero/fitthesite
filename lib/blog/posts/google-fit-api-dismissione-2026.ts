...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge i tuoi dati da Health Connect e li mostra in un pannello web unificato. Niente doppioni, fonte del dato visibile, server europei. Disponibile su Google Play.",
        en: "FitMesh Sync reads your data from Health Connect and shows it in a unified web panel. No duplicates, data source visible, European servers. Available on Google Play.",
        es: "FitMesh Sync lee tus datos de Health Connect y los muestra en un panel web unificado. Sin duplicados, fuente del dato visible, servidores europeos. Disponible en Google Play.",
        de: "FitMesh Sync liest deine Daten aus Health Connect und zeigt sie in einem einheitlichen Web-Panel an. Keine Duplikate, Datenquelle sichtbar, europäische Server. Verfügbar auf Google Play.",
        pt: "O FitMesh Sync lê seus dados do Health Connect e os exibe em um painel web unificado. Sem duplicatas, fonte do dado visível, servidores europeus. Disponível no Google Play.",
        fr: "FitMesh Sync lit vos données depuis Health Connect et les affiche dans un panneau web unifié. Pas de doublons, source des données visible, serveurs européens. Disponible sur Google Play.",
        pl: "FitMesh Sync odczytuje Twoje dane z Health Connect i wyświetla je w ujednoliconym panelu webowym. Bez duplikatów, źródło danych widoczne, serwery europejskie. Dostępne w Google Play.",
        tr: "FitMesh Sync, Health Connect'ten verilerinizi okur ve birleşik bir web panelinde gösterir. Tekrar yok, veri kaynağı görünür, Avrupa sunucuları. Google Play'de mevcut.",
        nl: "FitMesh Sync leest je gegevens van Health Connect en toont ze in een unified webpanel. Geen duplicaten, databron zichtbaar, Europese servers. Beschikbaar op Google Play.",
        ja: "FitMesh Sync は Health Connect からデータを読み取り、統合されたウェブパネルに表示します。重複なし、データソースが見える、ヨーロッパサーバー。Google Play で提供中。",
        ko: "FitMesh Sync는 Health Connect에서 데이터를 읽어 통합 웹 패널에 표시합니다. 중복 없음, 데이터 소스 표시, 유럽 서버. Google Play에서 사용 가능.",
      },
      ctaLabel: {
