  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        fr: "FitMesh Sync est gratuit au téléchargement pour tout le monde ; les 1000 premiers founders reçoivent en plus le Pro à vie gratuit. Application Android sur Google Play, tableau de bord web inclus.",
        pl: "FitMesh Sync jest bezpłatny do pobrania dla każdego; pierwsi 1000 founderów otrzymuje dodatkowo dożywotnie Pro za darmo. Aplikacja Android w Google Play, panel webowy w zestawie.",
        tr: "FitMesh Sync herkes için ücretsiz indirilebilir; ilk 1000 kurucu ayrıca ömür boyu ücretsiz Pro kazanır. Android uygulaması Google Play'de, web paneli dahil.",
        nl: "FitMesh Sync is voor iedereen gratis te downloaden; de eerste 1000 founders krijgen ook levenslang Pro gratis. Android-app op Google Play, webdashboard inbegrepen.",
        ja: "FitMesh Syncは誰でも無料でダウンロードでき、最初の1000名のfounderにはさらに永久版Proも無料で付与されます。Google PlayのAndroidアプリ、ウェブダッシュボード付き。",
        ko: "FitMesh Sync는 누구나 무료로 다운로드할 수 있으며, 처음 1000명의 founder에게는 평생 Pro도 무료로 제공됩니다. Google Play의 Android 앱, 웹 대시보드 포함.",
      },
