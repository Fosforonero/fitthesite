...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "Regola pratica del 2026: scegli la pipeline dati prima del gadget. Identificare il percorso corretto permette di verificare in anticipo i flussi supportati.",
      ...
      "Brand come Samsung, Fitbit, Garmin, Polar, Withings e Oura (Gen2 senza abbonamento; Gen3 e Ring 4 con membership attiva) supportano la scrittura su Health Connect su Android, previo supporto dell'app e dei requisiti di account (consulta la matrice su /it/fitness-data-sync). Huawei Health non documenta un percorso ufficiale verso Health Connect e FitMesh non ha un'integrazione diretta.",
    ...
    en: [
      ...
      "The 2026 practical rule: pick the data pipe before the gadget. Identifying the right route maps out supported flows across services before buying.",
      ...
      "Brands such as Samsung, Fitbit, Garmin, Polar, Withings, and Oura (Gen2 without subscription; Gen3 and Ring 4 with active membership) support writing to Health Connect on Android, subject to app and account prerequisites (see matrix at /en/fitness-data-sync). Huawei Health documents no official path to Health Connect, and FitMesh has no direct integration.",
    ...
    es: [
      ...
      "La regla práctica de 2026: elige la ruta de datos antes que el dispositivo. Identificar la vía adecuada permite comprobar de antemano los flujos compatibles.",
      ...
      "Marcas como Samsung, Fitbit, Garmin, Polar, Withings y Oura (Gen2 sin suscripción; Gen3 y Ring 4 con membresía activa) admiten la escritura en Health Connect en Android, previo soporte de la app y requisitos de cuenta (ver matriz en /es/fitness-data-sync). Huawei Health no documenta una vía oficial hacia Health Connect y FitMesh no tiene integración directa.",
    ...
    de: [
      ...
      "Die praktische Regel für 2026: Wähle die Datenpipeline vor dem Gerät. Den richtigen Pfad zu kennen hilft dabei, die unterstützten Datenflüsse vorab zu prüfen.",
      ...
      "Marken wie Samsung, Fitbit, Garmin, Polar, Withings und Oura (Gen2 ohne Abo; Gen3 und Ring 4 mit aktiver Mitgliedschaft) unterstützen das Schreiben in Health Connect unter Android, vorbehaltlich App- und Kontovoraussetzungen (siehe Matrix unter /de/fitness-data-sync). Huawei Health dokumentiert keinen offiziellen Pfad zu Health Connect und FitMesh bietet keine direkte Integration.",
    ...
    pt: [
      "A regra prática de 2026: escolha a pipeline de dados antes do dispositivo. Identificar o caminho correto permite verificar previamente os fluxos de dados suportados.",
      ...
      "Marcas como Samsung, Fitbit, Garmin, Polar, Withings e Oura (Gen2 sem assinatura; Gen3 e Ring 4 com assinatura ativa) suportam gravação no Health Connect no Android, sujeito ao suporte do app e requisitos de conta (consulte a matriz em /pt/fitness-data-sync). O Huawei Health não documenta um caminho oficial para o Health Connect e o FitMesh não tem integração direta.",
    ...
    fr: [
      "La règle pratique de 2026 : choisissez le circuit de données avant l'appareil. Identifier le bon parcours permet de vérifier à l'avance les flux pris en charge.",
      ...
      "Des marques comme Samsung, Fitbit, Garmin, Polar, Withings et Oura (Gen2 sans abonnement ; Gen3 et Ring 4 avec abonnement actif) prennent en charge l'écriture dans Health Connect sur Android, sous réserve de la compatibilité de l'application et des prérequis de compte (voir la matrice sur /fr/fitness-data-sync). Huawei Health ne documente aucun parcours officiel vers Health Connect et FitMesh ne propose pas d'intégration directe.",
    ...
    pl: [
      "Praktyczna zasada na 2026 rok: wybierz kanał danych przed urządzeniem. Wybór właściwej ścieżki pozwala wcześniej sprawdzić obsługiwane przepływy danych.",
      ...
      "Marki takie jak Samsung, Fitbit, Garmin, Polar, Withings i Oura (Gen2 bez subskrypcji; Gen3 i Ring 4 z aktywnym członkostwem) obsługują zapis do Health Connect na Androidzie, z zastrzeżeniem obsługi przez aplikację i wymagań konta (zobacz macierz na /pl/fitness-data-sync). Huawei Health nie dokumentuje oficjalnej ścieżki do Health Connect, a FitMesh nie ma bezpośredniej integracji.",
    ...
    tr: [
      "2026 pratik kuralı: gadget'tan önce veri kanalını seç. Doğru yolu belirlemek, desteklenen veri akışlarını önceden incelemeyi sağlar.",
      ...
      "Samsung, Fitbit, Garmin, Polar, Withings ve Oura (Gen2 aboneliksiz; Gen3 ve Ring 4 aktif üyelikle) gibi markalar, uygulama desteği ve hesap önkoşullarına tabi olarak Android'de Health Connect'e yazmayı destekler (/tr/fitness-data-sync adresindeki matrise bakın). Huawei Health, Health Connect'e giden resmi bir yol belgelemez ve FitMesh'in doğrudan bir entegrasyonu yoktur.",
    ...
    nl: [
      "De praktische regel van 2026: kies de datapijplijn voor het apparaat. Het juiste pad kiezen stelt je in staat om ondersteunde datastromen vooraf te controleren.",
      ...
      "Merken zoals Samsung, Fitbit, Garmin, Polar, Withings en Oura (Gen2 zonder abonnement; Gen3 en Ring 4 met actief lidmaatschap) ondersteunen schrijven naar Health Connect op Android, onder voorbehoud van app-ondersteuning en accountvereisten (zie matrix op /nl/fitness-data-sync). Huawei Health documenteert geen officieel traject naar Health Connect en FitMesh heeft geen directe integratie.",
    ...
    ja: [
      "2026年の実践的なルール：ガジェットより先にデータパイプラインを選ぶ。適切な経路を事前に把握することで、各サービスで対応しているデータフローを事前に確認できます。",
      ...
      "Samsung、Fitbit、Garmin、Polar、Withings、Oura（Gen2はサブスク不要、Gen3およびRing 4は有効なメンバーシップが必要）などのブランドは、アプリの対応およびアカウント要件を前提としてAndroidのHealth Connectへの書き込みをサポートしています（/ja/fitness-data-sync の互換性マトリクスを参照）。Huawei HealthはHealth Connectへの公式経路を公開しておらず、FitMeshとの直接連携もありません。",
      "健康データに関して、インセンティブが一致している唯一のビジネスモデルは「有料、広告なし、トラッカーなし」です。無料アプリはほぼ常に集計データを販売して収益化します。",
    ],
    ko: [
      "2026년 실용 규칙: 기기보다 데이터 파이프라인을 먼저 선택하세요. 올바른 경로를 미리 파악하면 각 서비스에서 지원하는 데이터 흐름을 사전에 확인할 수 있습니다.",
      ...
      "Samsung, Fitbit, Garmin, Polar, Withings 및 Oura(Gen2는 구독 불필요, Gen3 및 Ring 4는 활성 멤버십 필요)와 같은 브랜드는 앱 지원 및 계정 전제 조건에 따라 Android의 Health Connect 쓰기를 지원합니다(/ko/fitness-data-sync 의 매트릭스 참조). Huawei Health는 Health Connect로의 공식 경로를 문서화하지 않으며 FitMesh와의 직접 연동도 제공하지 않습니다.",
  ...
  body: [
    ...
    },
    {
      ...
      rows: [
        ...
        {
          it: ["Oura Ring", "Sì, via app Android ufficiale (Gen2 senza abbonamento; Gen3 e Ring 4 con membership attiva)", "Oura Cloud API v2 (API esterna; non integrata direttamente in FitMesh)", "Sì, da app/account cloud"],
          en: ["Oura Ring", "Yes, via official Android app (Gen2 without subscription; Gen3 and Ring 4 with active membership)", "Oura Cloud API v2 (external API; not directly integrated into FitMesh)", "Yes, from app/cloud account"],
          es: ["Oura Ring", "Sí, mediante app Android oficial (Gen2 sin suscripción; Gen3 y Ring 4 con membresía activa)", "Oura Cloud API v2 (API externa; no integrada directamente en FitMesh)", "Sí, desde app/cuenta en la nube"],
          de: ["Oura Ring", "Ja, via offizielle Android-App (Gen2 ohne Abo; Gen3 und Ring 4 mit aktiver Mitgliedschaft)", "Oura Cloud API v2 (externe API; nicht direkt in FitMesh integriert)", "Ja, aus App/Cloud-Konto"],
          pt: ["Oura Ring", "Sim, via app Android oficial (Gen2 sem assinatura; Gen3 e Ring 4 com assinatura ativa)", "Oura Cloud API v2 (API externa; não integrada diretamente no FitMesh)", "Sim, do app/conta na nuvem"],
          fr: ["Oura Ring", "Oui, via l'app Android officielle (Gen2 sans abonnement ; Gen3 et Ring 4 avec abonnement actif)", "Oura Cloud API v2 (API externe ; non intégrée directement dans FitMesh)", "Oui, depuis l'app/compte cloud"],
          pl: [
            "Oura Ring",
            "Tak, przez oficjalną aplikację Android (Gen2 bez subskrypcji; Gen3 i Ring 4 z aktywnym członkostwem)",
            "Oura Cloud API v2 (zewnętrzne API; brak bezpośredniej integracji z FitMesh)",
            "Tak, z aplikacji/konta w chmurze",
          ],
          tr: [
            "Oura Ring",
            "Evet, resmi Android uygulaması üzerinden (Gen2 aboneliksiz; Gen3 ve Ring 4 aktif üyelikle)",
            "Oura Bulut API v2 (harici API; FitMesh ile doğrudan entegre değil)",
            "Evet, uygulama/bulut hesabından",
          ],
          nl: ["Oura Ring", "Ja, via officiële Android-app (Gen2 zonder abonnement; Gen3 en Ring 4 met actief lidmaatschap)", "Oura Cloud API v2 (externe API; niet direct geïntegreerd in FitMesh)", "Ja, via app/cloudaccount"],
          ja: ["Oura Ring", "はい、公式Androidアプリ経由（Gen2はサブスク不要、Gen3およびRing 4は有効なメンバーシップが必要）", "Oura Cloud API v2（外部API；FitMeshとの直接連携はありません）", "はい、アプリ/クラウドのアカウントから"],
          ko: ["Oura Ring", "예, 공식 Android 앱 경유 (Gen2는 구독 불필요, Gen3 및 Ring 4는 활성 멤버십 필요)", "Oura Cloud API v2 (외부 API, FitMesh와 직접 연동되지 않음)", "예, 앱/클라우드 계정에서"],
        },
        {
        ...
        {
          it: ["Huawei Watch", "Nessun percorso ufficiale Health Connect (bridge terzi da valutare)", "Huawei Health Kit (non integrato direttamente in FitMesh)", "Limitato"],
          en: ["Huawei Watch", "No official Health Connect path (third-party bridges to evaluate)", "Huawei Health Kit (not directly integrated into FitMesh)", "Limited"],
          es: ["Huawei Watch", "Sin ruta oficial a Health Connect (puentes de terceros a evaluar)", "Huawei Health Kit (no integrado directamente en FitMesh)", "Limitado"],
          de: ["Huawei Watch", "Kein offizieller Health Connect-Pfad (Drittanbieter-Bridges zu prüfen)", "Huawei Health Kit (nicht direkt in FitMesh integriert)", "Eingeschränkt"],
          pt: ["Huawei Watch", "Sem caminho oficial para o Health Connect (bridges de terceiros a avaliar)", "Huawei Health Kit (não integrado diretamente no FitMesh)", "Limitado"],
          fr: ["Huawei Watch", "Aucun parcours officiel vers Health Connect (passerelles tierces à évaluer)", "Huawei Health Kit (non intégré directement dans FitMesh)", "Limité"],
          pl: [
            "Huawei Watch",
            "Brak oficjalnej ścieżki do Health Connect (zewnętrzne aplikacje bridge do oceny)",
            "Huawei Health Kit (brak bezpośredniej integracji z FitMesh)",
            "Ograniczony",
          ],
          tr: [
            "Huawei Watch",
            "Health Connect'e resmi bir yol yok (üçüncü taraf köprüler değerlendirilmeli)",
            "Huawei Health Kit (FitMesh ile doğrudan entegre değil)",
            "Sınırlı",
          ],
          nl: ["Huawei Watch", "Geen officieel Health Connect-traject (bridges van derden per geval beoordelen)", "Huawei Health Kit (niet direct geïntegreerd in FitMesh)", "Beperkt"],
          ja: ["Huawei Watch", "Health Connectへの公式経路なし（サードパーティ製ブリッジは個別検証）", "Huawei Health Kit（FitMeshとの直接連携はありません）", "限定的"],
          ko: ["Huawei Watch", "Health Connect로의 공식 경로 없음 (서드파티 브리지는 개별 검토 필요)", "Huawei Health Kit (FitMesh와 직접 연동되지 않음)", "제한적"],
        },
        {
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "[Strava](/it/sync/strava): la lettura funziona per gli account già collegati, ma l'accesso è limitato — nuove connessioni richiedono l'approvazione di Strava; l'app pubblicata non espone ancora l'autorizzazione per inviare allenamenti.",
          "[Oura Ring](/it/sync/oura): dati disponibili via app Android ufficiale + HC (Gen2 senza abbonamento; Gen3 e Ring 4 con membership attiva).",
          "[Huawei](/it/sync/huawei): nessun percorso ufficiale documentato verso HC e nessuna integrazione diretta FitMesh; eventuali bridge terzi da valutare caso per caso.",
        ],
        en: [
          ...
          "[Strava](/en/sync/strava): reading works for accounts already connected, but access is limited — new connections require Strava's approval; the published app doesn't yet expose the authorization needed to send workouts.",
          "[Oura Ring](/en/sync/oura): data available via official Android app + HC (Gen2 without subscription; Gen3 and Ring 4 with active membership).",
          "[Huawei](/en/sync/huawei): no official path documented to HC and no direct FitMesh integration; third-party bridges evaluated case-by-case.",
        ],
        es: [
          ...
          "[Strava](/es/sync/strava): la lectura funciona para las cuentas ya conectadas, pero el acceso es limitado — las nuevas conexiones requieren la aprobación de Strava; la app publicada aún no ofrece la autorización para enviar entrenamientos.",
          "[Oura Ring](/es/sync/oura): datos disponibles mediante app Android oficial + HC (Gen2 sin suscripción; Gen3 y Ring 4 con membresía activa).",
          "[Huawei](/es/sync/huawei): sin ruta oficial documentada hacia HC ni integración directa con FitMesh; puentes de terceros a evaluar caso a caso.",
        ],
        de: [
          ...
          "[Strava](/de/sync/strava): Das Lesen funktioniert für bereits verbundene Konten, der Zugang ist aber eingeschränkt — neue Verbindungen bedürfen der Freigabe durch Strava; die veröffentlichte App bietet noch keine Möglichkeit, Workouts zu senden.",
          "[Oura Ring](/de/sync/oura): Daten verfügbar über offizielle Android-App + HC (Gen2 ohne Abo; Gen3 und Ring 4 mit aktiver Mitgliedschaft).",
          "[Huawei](/de/sync/huawei): kein offiziell dokumentierter Pfad zu HC und keine direkte FitMesh-Integration; Drittanbieter-Bridges im Einzelfall zu prüfen.",
        ],
        pt: [
          ...
          "[Strava](/pt/sync/strava): a leitura funciona para contas já conectadas, mas o acesso é limitado — novas conexões dependem da aprovação da Strava; o app publicado ainda não oferece a autorização para enviar treinos.",
          "[Oura Ring](/pt/sync/oura): dados disponíveis via app Android oficial + HC (Gen2 sem assinatura; Gen3 e Ring 4 com assinatura ativa).",
          "[Huawei](/pt/sync/huawei): sem caminho oficial documentado para HC e sem integração direta FitMesh; bridges de terceiros a avaliar caso a caso.",
        ],
        fr: [
          ...
          "[Strava](/fr/sync/strava): la lecture fonctionne pour les comptes déjà connectés, mais l'accès est limité — les nouvelles connexions nécessitent l'approbation de Strava ; l'application publiée n'offre pas encore l'autorisation nécessaire pour envoyer des entraînements.",
          "[Oura Ring](/fr/sync/oura): données disponibles via l'app Android officielle + HC (Gen2 sans abonnement ; Gen3 et Ring 4 avec abonnement actif).",
          "[Huawei](/fr/sync/huawei): aucun parcours officiel documenté vers HC et aucune intégration directe FitMesh ; passerelles tierces à évaluer au cas par cas.",
        ],
        pl: [
          ...
          "[Strava](/pl/sync/strava): odczyt działa dla już połączonych kont, ale dostęp jest ograniczony — nowe połączenia wymagają zatwierdzenia przez Stravę; opublikowana aplikacja nie udostępnia jeszcze autoryzacji potrzebnej do wysyłania treningów.",
          "[Oura Ring](/pl/sync/oura): dane dostępne przez oficjalną aplikację Android + HC (Gen2 bez subskrypcji; Gen3 i Ring 4 z aktywnym członkostwem).",
          "[Huawei](/pl/sync/huawei): brak oficjalnie udokumentowanej ścieżki do HC i brak bezpośredniej integracji z FitMesh; zewnętrzne aplikacje bridge do indywidualnej oceny.",
        ],
        tr: [
          ...
          "[Strava](/tr/sync/strava): zaten bağlı hesaplar için okuma çalışır, ancak erişim sınırlıdır — yeni bağlantılar Strava'nın onayına tabidir; yayınlanan uygulama antrenman göndermek için gereken yetkilendirmeyi henüz sunmuyor.",
          "[Oura Ring](/tr/sync/oura): resmi Android uygulaması + HC üzerinden veriler mevcuttur (Gen2 aboneliksiz; Gen3 ve Ring 4 aktif üyelikle).",
          "[Huawei](/tr/sync/huawei): HC'ye belgelenmiş resmi bir yol ve doğrudan FitMesh entegrasyonu yoktur; üçüncü taraf köprüler duruma göre değerlendirilmelidir.",
        ],
        nl: [
          ...
          "[Strava](/nl/sync/strava): lezen werkt voor reeds gekoppelde accounts, maar de toegang is beperkt — nieuwe koppelingen vereisen goedkeuring van Strava; de gepubliceerde app biedt nog geen manier om trainingen te versturen.",
          "[Oura Ring](/nl/sync/oura): gegevens beschikbaar via officiële Android-app + HC (Gen2 zonder abonnement; Gen3 en Ring 4 met actief lidmaatschap).",
          "[Huawei](/nl/sync/huawei): geen officieel gedocumenteerd traject naar HC en geen directe FitMesh-integratie; bridges van derden per geval te beoordelen.",
        ],
        ja: [
          ...
          "[Oura Ring](/ja/sync/oura): 公式Androidアプリ＋HC経由で利用可能（Gen2はサブスク不要、Gen3およびRing 4は有効なメンバーシップが必要）。",
          "[Huawei](/ja/sync/huawei): HCへの公式な連携経路およびFitMeshの直接連携はありません。サードパーティ製ブリッジは個別検証が必要です。",
        ],
        ko: [
          ...
          "[Oura Ring](/ko/sync/oura): 공식 Android 앱 + HC를 통해 데이터 사용 가능(Gen2는 구독 불필요, Gen3 및 Ring 4는 활성 멤버십 필요).",
          "[Huawei](/ko/sync/huawei): HC로의 공식 경로 및 FitMesh 직접 연동이 문서화되어 있지 않으며, 서드파티 브리지는 사례별로 평가해야 합니다.",
        ],
      },
    },
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile per Android e iOS. L'idoneità Founder era riservata a un massimo di 1.000 account registrati entro il 31 luglio 2026 con prima sincronizzazione reale entro 14 giorni dalla registrazione.",
        en: "FitMesh Sync is available for Android and iOS. Founder eligibility was limited to a maximum of 1,000 accounts registered by July 31, 2026 with a first real sync within 14 days of registration.",
        es: "FitMesh Sync está disponible para Android e iOS. La elegibilidad Founder estaba reservada a un máximo de 1.000 cuentas registradas antes del 31 de julio de 2026 con una primera sincronización real en 14 días tras el registro.",
        de: "FitMesh Sync ist für Android und iOS verfügbar. Die Founder-Berechtigung war auf maximal 1.000 bis zum 31. Juli 2026 registrierte Konten mit einer echten ersten Synchronisierung innerhalb von 14 Tagen nach der Registrierung beschränkt.",
        pt: "O FitMesh Sync está disponível para Android e iOS. A elegibilidade Founder era reservada a um máximo de 1.000 contas registadas até 31 de julho de 2026 com uma primeira sincronização real em até 14 dias após o registo.",
        fr: "FitMesh Sync est disponible pour Android et iOS. L'éligibilité Founder était réservée à un maximum de 1 000 comptes enregistrés avant le 31 juillet 2026 avec une première synchronisation réelle dans les 14 jours suivant l'inscription.",
        pl: "FitMesh Sync jest dostępny na Androida i iOS. Kwalifikacja Founder była ograniczona do maksymalnie 1000 kont zarejestrowanych do 31 lipca 2026 z pierwszą rzeczywistą synchronizacją w ciągu 14 dni od rejestracji.",
        tr: "FitMesh Sync Android ve iOS için kullanılabilir. Kurucu (Founder) uygunluğu, 31 Temmuz 2026'ya kadar kaydolan ve kayıttan itibaren 14 gün içinde ilk gerçek senkronizasyonunu yapan en fazla 1.000 hesapla sınırlıydı.",
        nl: "FitMesh Sync is beschikbaar voor Android en iOS. Founder-geschiktheid was voorbehouden aan maximaal 1.000 accounts geregistreerd vóór 31 juli 2026 met een echte eerste synchronisatie binnen 14 dagen na registratie.",
        ja: "FitMesh SyncはAndroidおよびiOS向けに提供されています。Founder資格は、2026年7月31日までに登録し登録から14日以内に実際の初回同期を行った最大1,000アカウントに限定されていました。",
        ko: "FitMesh Sync는 Android 및 iOS에서 이용할 수 있습니다. Founder 자격은 2026년 7월 31일까지 가입하고 가입 후 14일 이내에 실제 첫 동기화를 완료한 최대 1,000개 계정으로 제한되었습니다.",
      },
