  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        nl: "FitMesh Sync is gratis tijdens de bèta voor de eerste 100 founders. Android-app via Play Store, webdashboard inbegrepen.",
        ja: "FitMesh Syncは最初の100人のファウンダー向けにベータ期間中は無料です。Play StoreよりAndroidアプリ、ウェブダッシュボード付き。",
        ko: "FitMesh Sync는 처음 100명의 창업자를 위해 베타 기간 동안 무료입니다. Play Store를 통한 Android 앱, 웹 대시보드 포함.",
      },
