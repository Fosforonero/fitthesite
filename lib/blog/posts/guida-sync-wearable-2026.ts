...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      type: "heading",
      level: 3,
      text: { it: "1. Health Connect (Android, dal 2024)", en: "1. Health Connect (Android, since 2024)" },
    },
    {
      type: "paragraph",
      text: {
    ...
    },
    {
      type: "heading",
      level: 3,
      text: { it: "2. OAuth API ufficiali", en: "2. Official OAuth APIs" },
    },
    {
      type: "paragraph",
      text: {
    ...
    },
    {
      type: "heading",
      level: 3,
      text: { it: "3. Esportazione manuale (CSV, GPX, FIT)", en: "3. Manual export (CSV, GPX, FIT)" },
    },
    {
      type: "paragraph",
      text: {
    ...
    },
    {
      type: "callout",
      variant: "tip",
      title: { it: "Regola pratica", en: "Practical rule" },
      body: {
    ...
    },
    {
      type: "heading",
      level: 2,
      text: { it: "Approfondimenti specifici per brand", en: "Brand-specific deep-dives" },
    },
    {
      type: "paragraph",
      text: {
    ...
    },
    {
      ...
      ctaLabel: { it: "Entra in beta", en: "Join the beta" },
      ctaHref: { it: "/it/beta", en: "/en/beta" },
    },
    {
      type: "heading",
      level: 2,
      text: { it: "Cosa cambierà nei prossimi 18 mesi", en: "What will change in the next 18 months" },
    },
    {
      type: "paragraph",
      text: {
    ...
    },
    {
      type: "heading",
      level: 2,
      text: { it: "Punto di partenza pratico", en: "Practical starting point" },
    },
    {
      type: "paragraph",
      text: {
