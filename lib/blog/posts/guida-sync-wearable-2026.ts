...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        ...
        pl: [
          ...
          "[Strava](/pl/sync/strava): tylko OAuth, w III kwartale 2026.",
        ...
        tr: [
          ...
          "[Strava](/tr/sync/strava): yalnızca OAuth, 2026 3. çeyrekte geliyor.",
        ...
        nl: [
          ...
          "[Strava](/nl/sync/strava): alleen OAuth, komt Q3 2026.",
        ...
        ja: [
          ...
          "[Strava](/ja/sync/strava): OAuthのみ、Q3 2026予定。",
        ...
        ko: [
          ...
          "[Strava](/ko/sync/strava): OAuth 전용, Q3 2026 예정.",
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è gratis per i primi 1000 founder: Pro a vita. App Android su Google Play, dashboard web inclusa.",
        en: "FitMesh Sync is free for the first 1,000 founders: lifetime Pro. Android app on Google Play, web dashboard included.",
        es: "FitMesh Sync es gratis para los primeros 1000 founders: Pro de por vida. App Android en Google Play, panel web incluido.",
        de: "FitMesh Sync ist für die ersten 1000 Founder kostenlos: lebenslang Pro. Android-App auf Google Play, Web-Dashboard inklusive.",
        pt: "FitMesh Sync é gratuito para os primeiros 1000 founders: Pro vitalício. App Android no Google Play, painel web incluído.",
        fr: "FitMesh Sync est gratuit pour les 1000 premiers founders : Pro à vie. Application Android sur Google Play, tableau de bord web inclus.",
        pl: "FitMesh Sync jest darmowy dla pierwszych 1000 founderów: dożywotnie Pro. Aplikacja Android w Google Play, panel webowy w zestawie.",
        tr: "FitMesh Sync ilk 1000 kurucu için ücretsiz: ömür boyu Pro. Android uygulaması Google Play'de, web paneli dahil.",
        nl: "FitMesh Sync is gratis voor de eerste 1000 founders: levenslang Pro. Android-app op Google Play, webdashboard inbegrepen.",
        ja: "FitMesh Syncは最初の1000名のfounderに無料：永久版Pro。Google PlayのAndroidアプリ、ウェブダッシュボード付き。",
        ko: "FitMesh Sync는 처음 1000명의 founder에게 무료: 평생 Pro. Google Play의 Android 앱, 웹 대시보드 포함.",
      },
