  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        es: "FitMesh Sync se descarga gratis para todos; los primeros 1000 founders (hasta el 31 de julio de 2026) recibieron además el Pro de por vida gratis. App Android en Google Play, panel web incluido.",
        de: "FitMesh Sync steht für alle kostenlos zum Download; die ersten 1000 Founder (bis 31. Juli 2026) haben zusätzlich lebenslanges Pro gratis erhalten. Android-App auf Google Play, Web-Dashboard inklusive.",
        pt: "FitMesh Sync é gratuito para baixar por qualquer pessoa; os primeiros 1000 founders (até 31 de julho de 2026) receberam também o Pro vitalício grátis. App Android no Google Play, painel web incluído.",
        fr: "FitMesh Sync est gratuit au téléchargement pour tout le monde ; les 1000 premiers founders (jusqu'au 31 juillet 2026) ont reçu en plus le Pro à vie gratuit. Application Android sur Google Play, tableau de bord web inclus.",
        pl: "FitMesh Sync jest bezpłatny do pobrania dla każdego; pierwsi 1000 founderów (do 31 lipca 2026) otrzymało dodatkowo dożywotnie Pro za darmo. Aplikacja Android w Google Play, panel webowy w zestawie.",
        tr: "FitMesh Sync herkes için ücretsiz indirilebilir; ilk 1000 kurucu (31 Temmuz 2026'ya kadar) ayrıca ömür boyu ücretsiz Pro kazandı. Android uygulaması Google Play'de, web paneli dahil.",
        nl: "FitMesh Sync is voor iedereen gratis te downloaden; de eerste 1000 founders (tot 31 juli 2026) hebben ook levenslang Pro gratis gekregen. Android-app op Google Play, webdashboard inbegrepen.",
