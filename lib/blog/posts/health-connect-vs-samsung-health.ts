...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge i dati Galaxy Watch via Health Connect e li mostra su una dashboard web pulita. Privacy-first, no ads, no tracker pubblicitari.",
        en: "FitMesh Sync reads Galaxy Watch data via Health Connect and shows it on a clean web dashboard. Privacy-first, no ads, no ad trackers.",
        ...
        de: "FitMesh Sync liest Galaxy Watch-Daten über Health Connect und zeigt sie in einem übersichtlichen Web-Dashboard. Datenschutz an erster Stelle, keine Werbung, keine Werbetracker.",
        ...
        pl: "FitMesh Sync odczytuje dane Galaxy Watch przez Health Connect i wyświetla je na przejrzystym panelu webowym. Prywatność na pierwszym miejscu, bez reklam, bez trackerów reklamowych.",
        ...
        nl: "FitMesh Sync leest Galaxy Watch-gegevens via Health Connect en toont ze op een overzichtelijk webdashboard. Privacy voorop, geen advertenties, geen advertentietrackers.",
