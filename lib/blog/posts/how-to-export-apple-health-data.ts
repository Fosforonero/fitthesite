...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "La via più comoda è una dashboard web senza export manuale: serve un'app che legga da HealthKit e sincronizzi in background. FitMesh iOS è live sull'App Store, disponibile in tutti i Paesi supportati, incluse le storefront UE.",
    ],
    en: [
      ...
      "The most convenient path is a web dashboard without manual exports: it needs an app that reads from HealthKit and syncs in the background. FitMesh iOS is live on the App Store, available in all supported storefronts, including the EU.",
    ],
    es: [
      ...
      "La opción más cómoda es un panel web sin exportaciones manuales: necesita una app que lea de HealthKit y sincronice en segundo plano. FitMesh iOS ya está disponible en App Store, incluidas todas las tiendas de la Unión Europea.",
    ],
    de: [
      ...
      "Der bequemste Weg ist ein Web-Dashboard ohne manuelle Exporte: dafür braucht man eine App, die HealthKit ausliest und im Hintergrund synchronisiert. FitMesh iOS ist im App Store live und verfügbar, einschließlich aller Storefronts der Europäischen Union.",
    ],
    pt: [
      ...
      "O caminho mais prático é um painel web sem exportações manuais: é necessário um app que leia do HealthKit e sincronize em segundo plano. FitMesh iOS já está disponível na App Store, incluindo todas as lojas da União Europeia.",
    ],
    fr: [
      ...
      "L'option la plus pratique est un tableau de bord web sans exports manuels: il faut une application qui lit depuis HealthKit et synchronise en arrière-plan. FitMesh iOS est disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne.",
    ],
    pl: [
      ...
      "Najwygodniejsza droga to panel webowy bez ręcznego eksportu: potrzebna jest aplikacja, która odczytuje z HealthKit i synchronizuje w tle. FitMesh iOS jest już dostępny w App Store, we wszystkich sklepach Unii Europejskiej.",
    ],
    tr: [
      ...
      "En pratik yol, manuel dışa aktarma gerektirmeyen bir web panosu: HealthKit'ten okuyan ve arka planda senkronize eden bir uygulama gerekiyor. FitMesh iOS App Store'da, Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere kullanılabilir.",
    ],
    nl: [
      ...
      "De handigste manier is een webdashboard zonder handmatige exports: daarvoor is een app nodig die HealthKit uitleest en op de achtergrond synchroniseert. FitMesh iOS is live in de App Store, beschikbaar inclusief alle winkels van de Europese Unie.",
    ],
    ja: [
    ...
    ko: [
      ...
      "가장 편리한 방법은 수동 내보내기가 필요 없는 웹 대시보드입니다: HealthKit에서 읽고 백그라운드에서 동기화하는 앱이 필요합니다. FitMesh iOS는 App Store에서 EU 지역을 포함하여 이용 가능합니다.",
    ],
  },
  primaryKeyword: {
  ...
  secondaryKeywords: {
    ...
    de: [
      "Apple Health auf PC exportieren",
      "Apple-Health-Daten herunterladen",
      "Apple Health CSV Export",
      "Apple-Health-Daten im Browser ansehen",
      "Apple Health Backup",
      "Apple-Health-Daten am Computer ansehen",
],
    es: [
      "exportar apple health a pc",
      "descargar datos de apple health",
      "exportar apple health a csv",
      "ver datos de apple health en el navegador",
      "copia de seguridad apple health",
      "ver datos de apple health en el ordenador",
],
  },
  metaDescription: {
    ...
    },
    {
      ...
      items: {
        it: [
          ...
          "La via più comoda (dashboard web senza export manuale) richiede un'app che legga da HealthKit e sincronizzi in background: FitMesh iOS è live sull'App Store, disponibile in tutti i Paesi supportati, incluse le storefront UE.",
        ],
        en: [
          ...
          "The most convenient path (web dashboard without manual exports) requires an app that reads from HealthKit and syncs in the background: FitMesh iOS is live on the App Store, available in all supported storefronts, including the EU.",
        ],
        es: [
          ...
          "Para compartir datos específicos con un médico, usa la exportación por métrica individual directamente desde el gráfico en Salud: genera un CSV limpio.",
          "El archivo XML no está cifrado: trátalo como un documento médico sensible y no lo subas a servicios en la nube públicos.",
          "La opción más cómoda (panel web sin exportaciones manuales) requiere una app que lea de HealthKit y sincronice en segundo plano: FitMesh iOS ya está disponible en App Store, incluidas todas las tiendas de la Unión Europea.",
        ],
        de: [
          ...
          "Der bequemste Weg (Web-Dashboard ohne manuelle Exporte) erfordert eine App, die HealthKit ausliest und im Hintergrund synchronisiert: FitMesh iOS ist im App Store live und verfügbar, einschließlich aller Storefronts der Europäischen Union.",
        ],
        pt: [
          ...
          "O arquivo XML não é criptografado: trate-o como um documento de saúde sensível e não o carregue em serviços de nuvem públicos.",
          "O caminho mais prático (painel web sem exportações manuais) requer um app que leia do HealthKit e sincronize em segundo plano: FitMesh iOS já está disponível na App Store, incluindo todas as lojas da União Europeia.",
        ],
        fr: [
          ...
          "Pour partager des données précises avec un médecin, utilisez l'export par métrique individuelle directement depuis le graphique dans Santé: il produit un CSV propre.",
          "Le fichier XML n'est pas chiffré: traitez-le comme un document de santé sensible et ne le téléchargez pas sur des services cloud publics.",
          "L'option la plus pratique (tableau de bord web sans exports manuels) nécessite une application qui lit depuis HealthKit et synchronise en arrière-plan: FitMesh iOS est disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne.",
        ],
        pl: [
          ...
          "Najwygodniejsza droga (panel webowy bez ręcznego eksportu) wymaga aplikacji, która odczytuje z HealthKit i synchronizuje w tle: FitMesh iOS jest już dostępny w App Store, we wszystkich sklepach Unii Europejskiej.",
        ],
        tr: [
          ...
          "En pratik yol (manuel dışa aktarma gerektirmeyen web panosu) HealthKit'ten okuyan ve arka planda senkronize eden bir uygulama gerektiriyor: FitMesh iOS App Store'da, Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere kullanılabilir.",
        ],
        nl: [
          ...
          "Om specifieke gegevens met een arts te delen, gebruik de export per statistiek direct vanuit de grafiek in Gezondheid: geeft een overzichtelijk CSV-bestand.",
          "Het XML-bestand is niet versleuteld: behandel het als een gevoelig medisch document en upload het niet naar openbare clouddiensten.",
          "De handigste manier (webdashboard zonder handmatige exports) vereist een app die HealthKit uitleest en op de achtergrond synchroniseert: FitMesh iOS is live in de App Store, beschikbaar inclusief alle winkels van de Europese Unie.",
        ],
        ja: [
        ...
        ko: [
          ...
          "특정 데이터를 의사와 공유하려면 건강 앱의 차트에서 지표별 내보내기를 사용하세요: 깔끔한 CSV 파일이 생성됩니다.",
          "XML 파일은 암호화되어 있지 않습니다: 민감한 의료 문서처럼 취급하고 공개 클라우드 서비스에 업로드하지 마세요.",
          "가장 편리한 방법(수동 내보내기가 필요 없는 웹 대시보드)에는 HealthKit에서 읽고 백그라운드에서 동기화하는 앱이 필요합니다: FitMesh iOS는 App Store에서 EU 지역을 포함하여 이용 가능합니다.",
        ],
      },
    },
    {
      ...
      body: {
        it: "FitMesh Sync è live sull'App Store per iPhone, disponibile in tutti i Paesi supportati, incluse le storefront UE. L'app legge i dati da Apple Health e li sincronizza automaticamente su web, senza export manuali. Bonus: il ponte di scrittura (opt-in) porta anche i dati dei wearable Android dentro Apple Salute.",
        en: "FitMesh Sync is live on the App Store for iPhone, available in all supported storefronts, including the EU. The app reads data from Apple Health and syncs it automatically to the web, no manual exports needed. Bonus: the write bridge (opt-in) also brings Android wearable data into Apple Health.",
        es: "FitMesh Sync ya está disponible en App Store para iPhone, incluidas todas las tiendas de la Unión Europea. La app lee los datos de Apple Health y los sincroniza automáticamente en la web, sin exportaciones manuales. Bonus: el puente de escritura (opt-in) también lleva los datos de los wearables Android a Apple Salud.",
        de: "FitMesh Sync ist live im App Store für iPhone, verfügbar, einschließlich aller Storefronts der Europäischen Union. Die App liest Daten aus Apple Health und synchronisiert sie automatisch mit dem Web, ohne manuelle Exporte. Bonus: die optionale Schreibbrücke überträgt auch Android-Wearable-Daten in Apple Gesundheit.",
        pt: "FitMesh Sync já está disponível na App Store para iPhone, incluindo todas as lojas da União Europeia. O app lê dados do Apple Health e os sincroniza automaticamente na web, sem exportações manuais. Bônus: a ponte de escrita (opt-in) também traz dados de wearables Android para o Apple Saúde.",
        fr: "FitMesh Sync est désormais disponible sur l'App Store pour iPhone, y compris dans toutes les boutiques de l'Union européenne. L'application lit les données depuis Apple Santé et les synchronise automatiquement sur le web, sans exports manuels. Bonus: le pont d'écriture (opt-in) transfère également les données des appareils connectés Android dans Apple Santé.",
        pl: "FitMesh Sync jest już dostępny w App Store na iPhone, we wszystkich sklepach Unii Europejskiej. Aplikacja odczytuje dane z Apple Health i synchronizuje je automatycznie na web, bez ręcznego eksportu. Bonus: opcjonalny most zapisu (opt-in) przenosi też dane urządzeń Android do Apple Zdrowia.",
        tr: "FitMesh Sync artık iPhone için App Store'da yayında, Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere kullanılabilir. Uygulama Apple Sağlık'tan veri okuyor ve otomatik olarak web'e senkronize ediyor, manuel dışa aktarma yok. Bonus: isteğe bağlı yazma köprüsü (opt-in) Android giyilebilir verilerini de Apple Sağlık'a aktarıyor.",
        nl: "FitMesh Sync is live in de App Store voor iPhone, beschikbaar inclusief alle winkels van de Europese Unie. De app leest gegevens van Apple Gezondheid en synchroniseert ze automatisch naar het web, zonder handmatige exports. Bonus: de schrijfbrug (opt-in) brengt ook Android-wearablegegevens in Apple Gezondheid.",
        ja: "FitMesh SyncはiPhone向けにApp Storeで配信中です。EU域内を含め利用可能です。アプリはApple Healthからデータを読み取り、手動エクスポート不要で自動的にウェブに同期します。ボーナス：書き込みブリッジ（オプトイン）もAndroidウェアラブルのデータをApple Healthに取り込みます。",
        ko: "FitMesh Sync는 iPhone용 App Store에서 이용 가능합니다. EU 지역을 포함하여 이용 가능합니다. 앱은 Apple Health에서 데이터를 읽고 수동 내보내기 없이 자동으로 웹에 동기화합니다. 보너스: 쓰기 브리지(옵트인)도 Android 웨어러블 데이터를 Apple Health에 가져옵니다.",
      },
      ctaLabel: {
