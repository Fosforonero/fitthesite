  ...
  body: [
    ...
    },
    {
      ...
      text: {
        ...
        nl: "HRV normale waarden: wat je kunt verwachten op basis van leeftijd en fitness",
        ja: "HRV正常値：年齢とフィットネスによる目安",
        ko: "HRV 정상 수치: 연령과 체력에 따라 기대할 수 있는 것",
      },
    },
    {
      type: "paragraph",
      text: {
        ...
        nl: "De meest gestelde vraag is: 'Is mijn waarde normaal?' Het eerlijke antwoord is dat de referentiebereiken voor HRV extreem breed zijn en afhangen van veel variabelen. Een sedentaire 40-jarige volwassene kan een gemiddelde HRV van 35 ms hebben; een atleet van dezelfde leeftijd kan 80-90 ms hebben. Beide zijn 'normaal' voor wie ze zijn.",
        ja: "最もよくある質問は「自分の値は正常ですか?」というものです。正直に言えば、HRVの基準範囲は非常に広く、多くの変数に依存します。座りがちな40歳の成人は平均HRVが35msかもしれません。同じ年齢のアスリートは80〜90msかもしれません。どちらも自分にとって「正常」です。",
        ko: "가장 흔한 질문은 '내 수치가 정상인가요?'입니다. 솔직한 답변은 HRV 기준 범위가 매우 넓고 많은 변수에 따라 다르다는 것입니다. 40세의 앉아서 생활하는 성인은 평균 HRV가 35ms일 수 있고, 같은 나이의 운동선수는 80~90ms일 수 있습니다. 둘 다 자신에게는 '정상'입니다.",
      },
    },
    {
      type: "table",
      caption: {
        ...
        nl: "Indicatieve HRV-bereiken per leeftijdsgroep (RMSSD, nachtmeting). Bron: algemene fysiologische literatuur. Niet gebruiken voor medische diagnose.",
        ja: "年齢グループ別HRVの目安範囲（RMSSD、夜間測定）。出典：一般的な生理学文献。医療診断には使用しないでください。",
        ko: "연령 그룹별 HRV 참고 범위(RMSSD, 야간 측정). 출처: 일반 생리학 문헌. 의학적 진단에 사용하지 마세요.",
      },
      headers: {
      ...
      rows: [
        {
          ...
          nl: ["20-29 jaar", "55-105 ms", "Hoge fysiologische variabiliteit tussen individuen"],
          ja: ["20〜29歳", "55〜105 ms", "個人間の生理的変動性が高い"],
          ko: ["20-29세", "55-105 ms", "개인 간 생리적 변동성이 높음"],
        },
        {
          ...
          tr: [
            "30-39 yaş",
            "45-90 ms",
            "20'li yaşlara göre doğal düşüş",
          ],
          nl: ["30-39 jaar", "45-90 ms", "Natuurlijke daling ten opzichte van de twintigers"],
          ja: ["30〜39歳", "45〜90 ms", "20代と比べて自然な低下"],
          ko: ["30-39세", "45-90 ms", "20대에 비해 자연스러운 감소"],
        },
        {
          ...
          tr: [
            "40-49 yaş",
            "35-75 ms",
            "Fitness düzeyi farkta daha büyük rol oynar",
          ],
          nl: ["40-49 jaar", "35-75 ms", "Fitness heeft grotere invloed op het verschil"],
          ja: ["40〜49歳", "35〜75 ms", "フィットネスが差に大きな影響を与える"],
          ko: ["40-49세", "35-75 ms", "체력이 차이에 더 큰 영향을 미침"],
        },
        {
          ...
          tr: [
            "50-59 yaş arası",
            "25-60 ms",
            "Hareketsiz kişiler ile sporcular arasındaki fark büyür",
          ],
          nl: ["50-59 jaar", "25-60 ms", "Variabiliteit tussen sedentairen en atleten vergroot"],
          ja: ["50〜59歳", "25〜60 ms", "座りがちな人とアスリートの差が広がる"],
          ko: ["50-59세", "25-60 ms", "앉아서 생활하는 사람과 운동선수 간의 변동성이 커짐"],
        },
        {
          ...
          nl: ["60+ jaar", "20-50 ms", "Lagere absolute niveaus, persoonlijke trend nog steeds geldig"],
          ja: ["60歳以上", "20〜50 ms", "絶対値は低いが、個人的なトレンドは依然有効"],
          ko: ["60세 이상", "20-50 ms", "절대값은 낮지만 개인 트렌드는 여전히 유효"],
        },
      ],
    },
    {
