...
export const post: BlogPost = {
  ...
  tldr: {
    ...
    pl: [
      "HRV mierzy zmienność odstępów między uderzeniami serca (milisekundy), a nie średnie tętno: wysoka zmienność wskazuje na zrównoważony autonomiczny układ nerwowy, a nie problem z sercem.",
      "Wartość bezwzględna mało się liczy: 40-letni sportowiec może mieć 85 ms, a osoba mało aktywna 35 ms, oba wyniki są normalne dla ich sytuacji. Ważny jest Twój indywidualny trend w okresie 2-4 tygodni.",
      "Najbardziej wiarygodny jest pomiar nocny, gdy ruch nie zakłóca działania czujnika PPG.",
      "Wartości Garmin, Oura, Samsung i Polar nie są bezpośrednio porównywalne: używają różnych algorytmów. Wybierz jedno urządzenie referencyjne i nie mieszaj liczb.",
      "Aby poprawić HRV w czasie: regularny sen, umiarkowana aktywność aerobowa, ograniczenie alkoholu. Nie ma szybkich sposobów: zmiany wymagają tygodni.",
    ],
    tr: [
      "HRV, kalp atışları arasındaki milisaniye cinsinden değişimi ölçer, ortalama kalp hızını değil: yüksek değişkenlik dengeli bir otonom sinir sistemini gösterir, kalp sorununu değil.",
      "Mutlak değer çok önemli değildir: 40 yaşındaki bir sporcunun HRV'si 85 ms, hareketsiz bir kişininki 35 ms olabilir, ikisi de kendi durumları için normaldir. Önemli olan, 2-4 hafta boyunca kişisel trendinizdir.",
      "En güvenilir ölçüm, hareketin PPG sensörünü bozmadığı gece ölçümüdür.",
      "Garmin, Oura, Samsung ve Polar değerleri doğrudan karşılaştırılamaz: farklı algoritmalar kullanırlar. Bir referans cihaz seçin ve rakamları karıştırmayın.",
      "HRV'yi zamanla iyileştirmek için: düzenli uyku, orta düzeyde aerobik aktivite, alkolün azaltılması. Hızlı bir yöntem yoktur: değişiklikler haftalar sürer.",
    ],
    nl: [
  ...
  metaDescription: {
    ...
    pl: "Czym jest HRV (zmienność rytmu serca), jak wyznacza się wartości normalne w zależności od wieku, co oznacza wysoka lub niska wartość oraz jak odczytać ją na Twoim wearable w 2026 roku.",
    tr: "HRV (kalp atış hızı değişkenliği) nedir, normal değerler yaşa göre nasıl ölçülür, yüksek veya düşük olduğunda ne anlama gelir ve 2026 yılında giyilebilir cihazınızda nasıl okunur.",
  ...
  body: [
    {
      ...
      text: {
        ...
        pl: "HRV (zmienność rytmu serca) nie mierzy, jak szybko bije serce, ale jak nieregularnie: a ta nieregularność w milisekundach między jednym uderzeniem a drugim jest bezpośrednim sygnałem stanu autonomicznego układu nerwowego. Porównywanie Twojej wartości z wartościami innych osób jest niemal zawsze bezużyteczne: liczy się Twój indywidualny trend w czasie, a nie liczba bezwzględna.",
    ...
    },
    {
      ...
      text: {
        ...
        pl: "HRV i ogólne zdrowie: często zadawane pytania",
        tr: "HRV ve genel sağlık: sık sorulan sorular",
    ...
    },
    {
      ...
      body: {
        it: "Se hai un Garmin, un Oura Ring, o un Galaxy Watch e vuoi unire la tua HRV storica in un'unica app, con trend nel tempo, confronto tra dispositivi e metriche correlate. FitMesh Sync è una delle opzioni che aggregano questi dati via API ufficiali.",
        en: "If you have a Garmin, an Oura Ring, or a Galaxy Watch and want to bring your historical HRV together in one app, with trends over time, cross-device comparison and related metrics. FitMesh Sync is one of the options that aggregate this data via official APIs.",
        es: "Si tienes un Garmin, un Oura Ring o un Galaxy Watch y quieres unir tu HRV histórica en una sola app, con tendencias en el tiempo, comparación entre dispositivos y métricas relacionadas. FitMesh Sync es una de las opciones que agregan estos datos a través de APIs oficiales.",
        de: "Wenn du ein Garmin, einen Oura Ring oder eine Galaxy Watch hast und deine HRV-Verlaufsdaten in einer einzigen App zusammenführen möchtest, mit Trends im Laufe der Zeit, geräteübergreifendem Vergleich und verwandten Metriken. FitMesh Sync ist eine der Optionen, die diese Daten über offizielle APIs zusammenführt.",
        pt: "Se você tem um Garmin, um Oura Ring ou um Galaxy Watch e quer unir o histórico da sua HRV em um único app, com tendências ao longo do tempo, comparação entre dispositivos e métricas relacionadas. FitMesh Sync é uma das opções que agrega esses dados via APIs oficiais.",
        fr: "Si vous avez un Garmin, un Oura Ring ou une Galaxy Watch et souhaitez réunir votre historique HRV dans une seule application, avec les tendances dans le temps, la comparaison entre appareils et les métriques associées. FitMesh Sync est l'une des options qui agrège ces données via des API officielles.",
        pl: "Jeśli masz Garmin, pęczek Ring lub Galaxy Watch i chcesz połączyć swoją historię HRV w jednej aplikacji, z trendami w czasie, porównywaniem urządzeń i powiązanymi metrykami, FitMesh Sync to jedna z opcji, która agreguje te dane za pomocą oficjalnych interfejsów API.",
        tr: "Eğer bir Garmin, bir Oura Ring veya bir Galaxy Watch ve tarihlisel HRVini tek bir uygulamada birleştirmek istiyorsanız, zaman içindeki eğilimleri, cihazlar arasındaki karşılaştırmaları ve ilişkili metriklerini görebilirsiniz. FitMesh Sync offisiel API'lere üzerinden bu verileri toplayan seçeneklerden biridir.",
        nl: "Als je een Garmin, een Oura Ring of een Galaxy Watch hebt en je historische HRV in één app wilt samenvoegen, met trends in de tijd, vergelijking tussen apparaten en gerelateerde statistieken. FitMesh Sync is een van de opties die deze gegevens via officiële API's samenvoegt.",
        ja: "Garmin、Oura Ring、またはGalaxy Watchをお持ちで、過去のHRVを一つのアプリにまとめたい場合、時間をかけたトレンド、デバイス間の比較、関連指標を見ることができます。FitMesh Syncは公式APIを通じてこのデータを集約するオプションの一つです。",
        ko: "Garmin, Oura Ring, 또는 Galaxy Watch를 보유하고 있고 하나의 앱에서 과거 HRV 기록을 통합하고 싶다면, 시간에 따른 트렌드, 기기 간 비교 및 관련 지표를 볼 수 있습니다. FitMesh Sync는 공식 API를 통해 이 데이터를 집계하는 옵션 중 하나입니다.",
      },
      ctaLabel: {
  ...
  faq: [
    {
      ...
      a: {
        ...
        pl: "HRV (zmienność rytmu serca) mierzy, jak bardzo zmieniają się odstępy między kolejnymi uderzeniami serca. To nie jest średnie tętno: to zmiana tego tętna z chwili na chwilę. Wysoka zmienność (bardziej 'nieregularne' odstępy między uderzeniami) zwykle oznacza, że organizm jest dobrze wypoczęty, a układ nerwowy jest w równowadze. Niska zmienność sygnalizuje stres, zmęczenie lub powrót do zdrowia.",
    ...
    },
    {
      ...
      a: {
        ...
        tr: "Evrensel bir hedef değer yoktur. HRV yaşa, cinsiyete, fitness düzeyine ve genetiğe göre büyük ölçüde değişebilir. 35 yaşındaki bir yetişkin için normal aralık 40 ile 80 ms (RMSSD) arasında olabilir, ancak bir sporcu 100 ms'nin çok üzerinde olabilir. Önemli olan mutlak değer değil, kişisel trendinizdir: 2-4 hafta boyunca benzer koşullarda ölçülen taban değerinizi anlamaya çalışın ve önemli sapmaları gözlemleyin.",
    ...
    },
    {
      q: {
        ...
        tr: "HRV'mi iyileştirebilir miyim?",
      ...
      a: {
        ...
        tr: "Evet, ancak yavaş ve dolaylı olarak. HRV'yi uzun vadede olumlu etkileyen değişkenler şunlardır: düzenli ve yeterli uyku (çoğu yetişkin için 7-8 saat), orta düzeyde ve düzenli aerobik fiziksel aktivite, stres yönetimi (farkındalık, diyafram nefesi), alkol tüketiminin azaltılması ve genel olarak istikrarlı bir yaşam rutini. Hızlı 'kısayollar' yoktur: HRV taban değerindeki önemli değişiklikler genellikle günler içinde değil, haftalar veya aylar içinde görülür.",
