...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "Scarica FitMesh, collega l'anello e inizia a raccogliere i tuoi 7 giorni di dati.",
        en: "Download FitMesh, connect the ring, and start collecting your 7 days of data.",
        es: "Descarga FitMesh, conecta el anillo y empieza a acumular tus 7 días de datos.",
        de: "Lade FitMesh herunter, verbinde den Ring und beginne, deine 7 Tage an Daten zu sammeln.",
        pt: "Baixe o FitMesh, conecte o anel e comece a acumular seus 7 dias de dados.",
        fr: "Téléchargez FitMesh, connectez la bague et commencez à accumuler vos 7 jours de données.",
        pl: "Pobierz FitMesh, podłącz pierścień i zacznij gromadzić swoje 7 dni danych.",
        tr: "FitMesh'i indirin, Colmi halkasını bağlayın ve 7 günlük verilerinizi toplamaya başlayın.",
        nl: "Download FitMesh, verbind de ring en begin je 7 dagen aan gegevens te verzamelen.",
        ja: "FitMeshをダウンロードしてリングを接続し、7日間のデータ収集を始めましょう。",
        ko: "FitMesh를 다운로드하고 링을 연결한 뒤, 7일간의 데이터 수집을 시작하세요.",
      },
      ctaLabel: {
