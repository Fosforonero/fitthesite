...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "Se indossi orologio e anello insieme, nella maggior parte dei casi i passi non vengono contati due volte.",
    ...
    en: [
      ...
      "If you wear a watch and a ring together, in most cases your steps are not counted twice.",
    ...
    es: [
      ...
      "Si llevas reloj y anillo a la vez, en la mayoría de los casos los pasos no se cuentan dos veces.",
    ...
    de: [
      ...
      "Wenn du Uhr und Ring gleichzeitig trägst, werden deine Schritte in den meisten Fällen nicht doppelt gezählt.",
    ...
    pt: [
      ...
      "Se você usa relógio e anel juntos, na maioria dos casos seus passos não são contados duas vezes.",
    ...
    fr: [
      ...
      "Si vous portez une montre et une bague connectée ensemble, dans la plupart des cas vos pas ne sont pas comptés deux fois.",
    ...
    pl: [
      ...
      "Jeśli nosisz zegarek i pierścień jednocześnie, w większości przypadków kroki nie są liczone dwa razy.",
    ...
    tr: [
      ...
      "Akıllı saat ve yüzüğü aynı anda takarsanız, çoğu durumda adımlarınız iki kez sayılmaz.",
    ...
    nl: [
      ...
      "Als je een sporthorloge en een slimme ring samen draagt, worden je stappen in de meeste gevallen niet dubbel geteld.",
    ...
    ja: [
      ...
      "スマートウォッチとスマートリングを同時に装着しても、ほとんどの場合、歩数が二重にカウントされることはありません。",
    ...
    ko: [
      ...
      "스마트워치와 스마트 링을 함께 착용해도 대부분의 경우 걸음 수가 두 번 계산되지 않습니다.",
