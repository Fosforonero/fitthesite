...
export const post: BlogPost = {
  ...
  coverAlt: {
    ...
    sv: "Illustration av en rund smartklocka med sidoknappar och en smartphone med släckt skärm bredvid en anteckningsbok med ett felsökningsflöde av punkter, pilar och kryssrutor.",
    da: "Illustration af et rundt smartwatch med sideknapper og en smartphone med slukket skærm ved siden af en notesbog med et fejlfindingsforløb af prikker, pile og afkrydsningsfelter.",
  },
  related: [
