...
export const post: BlogPost = {
  ...
  hero: {
    ...
    subtitle: {
      ...
      pl: "Twój Galaxy Watch liczy kroki na nadgarstku, ale Samsung Health lub inna aplikacja ich nie widzi? Problem ma precyzyjne przyczyny, to nie magia. Ten przewodnik prowadzi Cię od diagnozy do rozwiązania w kolejności prawdopodobieństwa, bez tracenia czasu na błędne rozwiązania.",
  ...
  body: [
    ...
    },
    {
      ...
      items: {
        ...
        pl: [
          ...
          "Samsung Health opracowuje i przechowuje dane.",
    ...
    },
    {
      ...
      text: {
        ...
        pl: "Przyczyna 6: nieaktualny firmware lub wersja aplikacji",
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        pl: "Zazwyczaj nie, nie automatycznie. Health Connect nie synchronizuje retroaktywnie danych sprzed udzielenia autoryzacji. Dane historyczne pozostają w bazie danych Samsung Health. Niektóre aplikacje pozwalają na ręczne zaimportowanie eksportu z Samsung Health (w formacie CSV lub JSON), ale zależy to od konkretnej aplikacji. Jeśli potrzebujesz danych historycznych, Samsung Health pozostaje miejscem, w którym one się znajdują.",
  ...
  // (smartwatch rotondo con pulsanti e telefono con schermo spento, taccuino con checklist a punti e frecce),
  // coerente con la visual truth, privo di marchi commerciali o loghi protetti, non foto/screenshot.
  // Copre tutte le 13 varianti indicizzabili (incluso overlay nordico sv/da).
  coverAlt: {
    it: "Illustrazione di uno smartwatch rotondo con pulsanti laterali e uno smartphone a schermo spento accanto a un taccuino con un percorso a punti, frecce e caselle di controllo.",
    en: "Illustration of a round smartwatch with physical buttons and a smartphone with screen off beside an open notebook with a checklist path of dots, arrows, and checkboxes.",
    es: "Ilustración de un smartwatch redondo con botones laterales y un smartphone con la pantalla apagada junto a un cuaderno con un diagrama de puntos, flechas y casillas de verificación.",
    de: "Illustration einer runden Smartwatch mit seitlichen Tasten und eines ausgeschalteten Smartphones neben einem Notizbuch mit einem Pfad aus Punkten, Pfeilen und Kontrollkästchen.",
    ...
    fr: "Illustration d'une montre connectée ronde avec boutons latéraux et d'un smartphone éteint à côté d'un carnet montrant un parcours de points, de flèches et de cases à cocher.",
    ...
    ko: "측면 버튼이 있는 원형 스마트워치와 화면이 꺼진 스마트폰, 점과 화살표와 체크박스로 그려진 문제 해결 경로를 보여주는 공책 일러스트.",
    sv: "Illustration av en rund smartklocka med sidoknappar och en släckt smartphone bredvid en anteckningsbok med en felsökningsväg bestående av punkter, pilar och kryssrutor.",
    da: "Illustration af et rundt smartwatch med sideknapper og en slukket smartphone ved siden af en notesbog med en fejlfindingsrute af prikker, pile og afkrydsningsfelter.",
  },
  related: [
