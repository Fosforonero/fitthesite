...
export const post: BlogPost = {
  ...
  body: [
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync legge da Health Connect (qualsiasi wearable Android compatibile, tra cui Garmin, Polar, Withings) e ha già un'integrazione OAuth attiva con Strava. L'OAuth per Oura è ancora in arrivo. Setup 30 secondi, niente ads, niente tracker.",
        en: "FitMesh Sync reads from Health Connect (any compatible Android wearable, including Garmin, Polar, Withings) and already has a live OAuth integration with Strava. OAuth for Oura is still coming. 30-second setup, no ads, no trackers.",
        ...
        de: "FitMesh Sync liest aus Health Connect (jedes kompatible Android-Wearable, darunter Garmin, Polar, Withings) und hat bereits eine aktive OAuth-Integration mit Strava. OAuth für Oura kommt noch. 30-Sekunden-Setup, keine Werbung, keine Tracker.",
        ...
        fr: "FitMesh Sync lit depuis Health Connect (tout wearable Android compatible, dont Garmin, Polar, Withings) et dispose déjà d'une intégration OAuth active avec Strava. L'OAuth pour Oura arrive bientôt. Configuration en 30 secondes, sans publicité, sans trackers.",
        pl: "FitMesh Sync odczytuje dane z Health Connect (dowolny kompatybilny wearable Android, w tym Garmin, Polar, Withings) i ma już aktywną integrację OAuth ze Strava. OAuth dla Oura jest wciąż w przygotowaniu. Konfiguracja 30 sekund, żadnych reklam, żadnych trackerów.",
        ...
        nl: "FitMesh Sync leest van Health Connect (elke compatibele Android-wearable, waaronder Garmin, Polar, Withings) en heeft al een actieve OAuth-integratie met Strava. OAuth voor Oura komt nog. Setup in 30 seconden, geen advertenties, geen trackers.",
