  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        nl: "FitMesh Sync leest van Health Connect (elke Android-wearable) en plant OAuth voor Garmin, Polar, Oura, Withings en Strava. Setup in 30 seconden, geen advertenties, geen trackers.",
        ja: "FitMesh SyncはHealth Connect（あらゆるAndroid wearable）から読み取り、Garmin、Polar、Oura、Withings、StravaのOAuthをロードマップで計画しています。30秒でセットアップ、広告なし、トラッカーなし。",
        ko: "FitMesh Sync는 Health Connect (모든 Android 웨어러블)에서 읽으며 Garmin, Polar, Oura, Withings, Strava의 OAuth를 로드맵에 추가할 예정입니다. 30초 설정, 광고 없음, 트래커 없음.",
      },
      ctaLabel: {
