  ...
  body: [
...

    {
      ...
      body: {
        ...
        es: "FitMesh Sync está disponible en Google Play. Crea tu cuenta: los primeros 1000 founders (hasta el 31 de julio de 2026) obtuvieron el Pro de por vida gratis, activado automáticamente. Lleva todos tus dispositivos a un único panel.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Erstelle dein Konto: Die ersten 1000 Founder (bis 31. Juli 2026) haben lebenslang Pro kostenlos erhalten, automatisch aktiviert. Bringe alle deine Geräte in ein einziges Dashboard.",
        pt: "FitMesh Sync está disponível no Google Play. Crie sua conta: os primeiros 1000 founders (até 31 de julho de 2026) receberam o Pro vitalício grátis, ativado automaticamente. Leve todos os seus dispositivos para um único painel.",
        fr: "FitMesh Sync est disponible sur Google Play. Créez votre compte : les 1000 premiers founders (jusqu'au 31 juillet 2026) ont obtenu le Pro à vie gratuit, activé automatiquement. Regroupez tous vos appareils dans un seul tableau de bord.",
        pl: "FitMesh Sync jest dostępny w Google Play. Utwórz konto: pierwszych 1000 founderów (do 31 lipca 2026) otrzymało dożywotnie Pro za darmo, aktywowane automatycznie. Przenieś wszystkie swoje urządzenia do jednego panelu.",
        tr: "FitMesh Sync Google Play'de mevcut. Hesabınızı oluşturun: ilk 1000 kurucu (31 Temmuz 2026'ya kadar) ömür boyu Pro'yu ücretsiz aldı, otomatik olarak etkinleşti. Tüm cihazlarınızı tek bir panelde bir araya getirin.",
        nl: "FitMesh Sync is beschikbaar op Google Play. Maak je account aan: de eerste 1000 founders (tot 31 juli 2026) hebben levenslang Pro gratis gekregen, automatisch geactiveerd. Breng al je apparaten in een enkel dashboard.",
        ja: "FitMesh SyncはGoogle Playで利用できます。アカウントを作成すると、最初の1000名のfounder（2026年7月31日まで）は永久版Proを無料で取得でき、自動的に有効化されました。すべてのデバイスを1つのダッシュボードに集めましょう。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 계정을 만들면 처음 1000명의 founder(2026년 7월 31일까지)는 평생 Pro를 무료로 받았으며, 자동으로 활성화되었습니다. 모든 기기를 하나의 대시보드로 가져오세요.",
      },
      ctaLabel: {
        it: "Diventa founder",
        en: "Become a founder",
