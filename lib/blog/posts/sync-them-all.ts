...
export const post: BlogPost = {
  ...
  tldr: {
    ...
    nl: [
      ...
      "Een FitMesh-account werkt op Android en iPhone (iOS binnenkort beschikbaar), met optionele brug naar Apple Health.",
    ...
    ja: [
      ...
      "1つのFitMeshアカウントがAndroidとiPhoneで動作します（iOS近日公開予定）、Apple Healthへのオプションブリッジ付き。",
    ...
    ko: [
      ...
      "하나의 FitMesh 계정이 Android와 iPhone에서 작동합니다(iOS 곧 출시), Apple Health 선택적 연동 포함.",
  ...
  body: [
    ...
    },
    {
      ...
      text: {
        ...
        nl: "FitMesh staat in het midden. Het leest gegevens van Health Connect (Galaxy Watch, Pixel Watch, Fitbit en elke compatibele wearable), van cloudproviders zoals Garmin en Suunto, en rechtstreeks via Bluetooth van slimme ringen zoals de Colmi R02/R03. Alles stroomt samen in **een enkel dashboard**, toegankelijk via hetzelfde account op [Android en iPhone samen](/nl/lp/due-telefoni) (de iOS-app komt binnenkort, lancering aanstaande).",
        ja: "FitMeshが中心に位置します。Health Connect（Galaxy Watch、Pixel Watch、Fitbitおよび互換性のあるすべてのウェアラブル）、GarminやSuuntoなどのクラウドプロバイダー、そしてColmi R02/R03などのスマートリングからBluetoothで直接データを読み取ります。すべてが**1つのダッシュボード**に集約され、[AndroidとiPhoneで同じアカウント](/ja/lp/due-telefoni)からアクセスできます（iOSアプリは近日公開予定）。",
        ko: "FitMesh가 중심에 자리합니다. Health Connect(Galaxy Watch, Pixel Watch, Fitbit 및 호환 웨어러블), Garmin과 Suunto 같은 클라우드 제공업체, 그리고 Colmi R02/R03 같은 스마트 링에서 Bluetooth로 직접 데이터를 읽습니다. 모든 것이 **하나의 대시보드**로 흘러들어 [Android와 iPhone에서 같은 계정](/ko/lp/due-telefoni)으로 접근할 수 있습니다(iOS 앱 곧 출시 예정).",
      },
    },
    {
      type: "table",
    ...
    },
    {
      ...
      text: {
        ...
        nl: "FitMesh Sync is beschikbaar op Android met geintegreerde Health Connect. De iPhone-app lanceert binnenkort: met hetzelfde account kun je je dashboard op beide telefoons bekijken, met een optionele brug naar Apple Health voor wie gegevens ook in het Apple-ecosysteem wil brengen. [Android en iPhone samen](/nl/lp/due-telefoni): een account, een gezondheidsgeschiedenis.",
        ja: "FitMesh SyncはHealth Connectを統合したAndroidで利用できます。iPhoneアプリは近日公開予定：同じアカウントで両方の電話でダッシュボードを表示でき、Appleエコシステムにもデータを持ち込みたい方にはApple Healthへのオプションブリッジ付き。[AndroidとiPhone一緒に](/ja/lp/due-telefoni)：1つのアカウント、1つの健康履歴。",
        ko: "FitMesh Sync는 Health Connect가 통합된 Android에서 사용 가능합니다. iPhone 앱이 곧 출시됩니다: 같은 계정으로 두 폰 모두에서 대시보드를 볼 수 있으며, Apple 생태계에도 데이터를 가져오고 싶은 분들을 위한 Apple Health 선택적 연동 포함. [Android와 iPhone 함께](/ko/lp/due-telefoni): 하나의 계정, 하나의 건강 기록.",
      },
    },
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        ...
        nl: "De iOS-app lanceert binnenkort. Met hetzelfde FitMesh-account kun je je dashboard op Android en iPhone raadplegen, met een optionele brug naar Apple Health. Meld je aan voor de beta om als eerste toegang te krijgen.",
        ja: "iOSアプリは近日公開予定です。同じFitMeshアカウントでAndroidとiPhoneでダッシュボードにアクセスでき、Apple Healthへのオプションブリッジ付き。最初にアクセスするためにベータに登録してください。",
        ko: "iOS 앱이 곧 출시됩니다. 같은 FitMesh 계정으로 Android와 iPhone에서 대시보드에 접근할 수 있으며, Apple Health 선택적 연동 포함. 처음으로 접근하려면 베타에 등록하세요.",
      },
    },
  ],
