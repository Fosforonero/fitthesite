 ...
 * cross-device (Android + iPhone, disponibile, incluse tutte le storefront dell'Unione Europea). Messaggio brand fondativo.
...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "Un account FitMesh funziona su Android e iPhone (disponibile in tutti i Paesi supportati, incluse le storefront UE), con ponte opzionale verso Apple Salute.",
      ...
      "I tuoi dati non sono mai condivisi con terzi.",
    ],
    en: [
      ...
      "One FitMesh account works on Android and iPhone (live in all supported storefronts, including the EU), with optional Apple Health bridge.",
    ...
    es: [
      ...
      "Una cuenta de FitMesh funciona en Android e iPhone (disponible en todas las tiendas compatibles, incluidas las de la Unión Europea), con puente opcional hacia Apple Salute.",
    ...
    de: [
      ...
      "Ein FitMesh-Konto funktioniert auf Android und iPhone (verfügbar in allen unterstützten Stores, einschließlich aller Storefronts der Europäischen Union), mit optionaler Brücke zu Apple Health.",
    ...
    pt: [
      ...
      "Uma conta FitMesh funciona no Android e no iPhone (disponível em todas as lojas compatíveis, incluindo todas as lojas da União Europeia), com ponte opcional para o Apple Health.",
    ...
    fr: [
      ...
      "Un compte FitMesh fonctionne sur Android et iPhone (disponible dans toutes les boutiques prises en charge, y compris dans toutes les boutiques de l'Union européenne), avec un pont optionnel vers Apple Health.",
    ...
    pl: [
      ...
      "Jedno konto FitMesh działa na Androidzie i iPhonie (dostępne we wszystkich obsługiwanych sklepach, we wszystkich sklepach Unii Europejskiej), z opcjonalnym mostem do Apple Health.",
    ...
    tr: [
      ...
      "Tek bir FitMesh hesabı Android ve iPhone'da çalışır (Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere, tüm desteklenen mağazalarda kullanılabilir), Apple Health'e isteğe bağlı köprü ile.",
    ...
    nl: [
      ...
      "Een FitMesh-account werkt op Android en iPhone (beschikbaar in alle ondersteunde stores, inclusief alle winkels van de Europese Unie), met optionele brug naar Apple Health.",
    ...
    ja: [
      ...
      "1つのFitMeshアカウントがAndroidとiPhoneで動作します（EU域内を含め、すべての対応ストアで利用可能です）、Apple Healthへのオプションブリッジ付き。",
      "スマートな統合：各指標・各時間帯で最適なソースが選ばれ、2つの合計になることはありません。",
      "デバイスを多く接続するほど、ダッシュボードが充実します：各デバイスが以前は空だったセクションを有効にします。",
      "データが第三者と共有されることはありません。",
    ],
    ko: [
      "웨어러블이 서로 다른 생태계를 사용합니다: FitMesh가 단일 기기를 강요하지 않고 하나의 대시보드로 통합합니다.",
      "하나의 FitMesh 계정이 Android와 iPhone에서 작동합니다(EU 지역을 포함하여 모든 지원 스토어에서 이용 가능합니다), Apple Health 선택적 연동 포함.",
  ...
  body: [
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "FitMesh si mette al centro. Legge i dati da Health Connect (Galaxy Watch, Pixel Watch, Fitbit e qualsiasi wearable compatibile), dai provider cloud come Garmin e Suunto, e direttamente via Bluetooth dagli anelli smart come i Colmi R02/R03. Tutto confluisce in **una dashboard sola**, accessibile dallo stesso account su [Android e iPhone insieme](/it/lp/due-telefoni) (l'app iOS e disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea).",
        en: "FitMesh sits in the middle. It reads data from Health Connect (Galaxy Watch, Pixel Watch, Fitbit and any compatible wearable), from cloud providers like Garmin and Suunto, and directly over Bluetooth from smart rings such as the Colmi R02/R03. Everything flows into **one single dashboard**, accessible from the same account on [Android and iPhone together](/en/lp/due-telefoni) (the iOS app is available on the App Store, including all European Union storefronts).",
        es: "FitMesh se sitúa en el centro. Lee los datos de Health Connect (Galaxy Watch, Pixel Watch, Fitbit y cualquier wearable compatible), de proveedores en la nube como Garmin y Suunto, y directamente por Bluetooth de anillos inteligentes como los Colmi R02/R03. Todo confluye en **un único panel**, accesible desde la misma cuenta en [Android e iPhone juntos](/es/lp/due-telefoni) (la app para iOS ya está disponible en App Store, incluidas todas las tiendas de la Unión Europea).",
        de: "FitMesh steht im Mittelpunkt. Es liest Daten aus Health Connect (Galaxy Watch, Pixel Watch, Fitbit und alle kompatiblen Wearables), von Cloud-Anbietern wie Garmin und Suunto sowie direkt per Bluetooth von Smart-Ringen wie dem Colmi R02/R03. Alles fließt in **ein einziges Dashboard**, das über dasselbe Konto auf [Android und iPhone gemeinsam](/de/lp/due-telefoni) zugänglich ist (die iOS-App ist im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union).",
        ...
        fr: "FitMesh se place au centre. Il lit les données de Health Connect (Galaxy Watch, Pixel Watch, Fitbit et tout appareil compatible), des fournisseurs cloud comme Garmin et Suunto, et directement via Bluetooth des bagues connectées comme les Colmi R02/R03. Tout converge dans **un seul tableau de bord**, accessible depuis le même compte sur [Android et iPhone ensemble](/fr/lp/due-telefoni) (l'app iOS est déjà disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne).",
        pl: "FitMesh stoi w centrum. Odczytuje dane z Health Connect (Galaxy Watch, Pixel Watch, Fitbit i każde zgodne urządzenie), od dostawców chmurowych jak Garmin i Suunto, oraz bezpośrednio przez Bluetooth z inteligentnych pierścionków, takich jak Colmi R02/R03. Wszystko trafia do **jednego panelu**, dostępnego z tego samego konta na [Androidzie i iPhonie razem](/pl/lp/due-telefoni) (aplikacja iOS jest już dostępna w App Store, we wszystkich sklepach Unii Europejskiej).",
        tr: "FitMesh ortada konumlanır. Health Connect'ten (Galaxy Watch, Pixel Watch, Fitbit ve uyumlu her cihaz), Garmin ve Suunto gibi bulut sağlayıcılardan ve Colmi R02/R03 gibi akıllı yüzüklerden doğrudan Bluetooth üzerinden veri okur. Her şey **tek bir panelde** toplanır, aynı hesapla [Android ve iPhone birlikte](/tr/lp/due-telefoni) erişilebilir (iOS uygulaması, Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere App Store'da zaten yayında).",
        nl: "FitMesh staat in het midden. Het leest gegevens van Health Connect (Galaxy Watch, Pixel Watch, Fitbit en elke compatibele wearable), van cloudproviders zoals Garmin en Suunto, en rechtstreeks via Bluetooth van slimme ringen zoals de Colmi R02/R03. Alles stroomt samen in **een enkel dashboard**, toegankelijk via hetzelfde account op [Android en iPhone samen](/nl/lp/due-telefoni) (de iOS-app is al beschikbaar in de App Store, inclusief alle winkels van de Europese Unie).",
        ja: "FitMeshが中心に位置します。Health Connect（Galaxy Watch、Pixel Watch、Fitbitおよび互換性のあるすべてのウェアラブル）、GarminやSuuntoなどのクラウドプロバイダー、そしてColmi R02/R03などのスマートリングからBluetoothで直接データを読み取ります。すべてが**1つのダッシュボード**に集約され、[AndroidとiPhoneで同じアカウント](/ja/lp/due-telefoni)からアクセスできます（iOSアプリはEU域内を含め、App Storeですでに利用可能です）。",
        ko: "FitMesh가 중심에 자리합니다. Health Connect(Galaxy Watch, Pixel Watch, Fitbit 및 호환 웨어러블), Garmin과 Suunto 같은 클라우드 제공업체, 그리고 Colmi R02/R03 같은 스마트 링에서 Bluetooth로 직접 데이터를 읽습니다. 모든 것이 **하나의 대시보드**로 흘러들어 [Android와 iPhone에서 같은 계정](/ko/lp/due-telefoni)으로 접근할 수 있습니다(iOS 앱은 EU 지역을 포함하여 App Store에서 이미 이용 가능합니다).",
      },
    },
    {
      type: "table",
      ...
      rows: [
        ...
        {
          it: ["Sportwatch (Garmin, Suunto)", "Allenamenti, GPS", "Durante gare e sessioni"],
          en: ["Sportwatch (Garmin, Suunto)", "Workouts, GPS", "During races and sessions"],
          es: ["Sportwatch (Garmin, Suunto)", "Entrenamientos, GPS", "Durante carreras y sesiones"],
          de: ["Sportuhr (Garmin, Suunto)", "Trainings, GPS", "Bei Wettkämpfen und Einheiten"],
          pt: ["Sportwatch (Garmin, Suunto)", "Treinos, GPS", "Durante corridas e sessões"],
          fr: ["Montre sport (Garmin, Suunto)", "Entraînements, GPS", "Pendant les courses et les séances"],
          pl: ["Zegarek sportowy (Garmin, Suunto)", "Treningi, GPS", "Podczas zawodów i sesji"],
          tr: ["Spor saati (Garmin, Suunto)", "Antrenmanlar, GPS", "Yarışlar ve seanslar sırasında"],
          nl: ["Sporthorloge (Garmin, Suunto)", "Trainingen, GPS", "Tijdens wedstrijden en sessies"],
          ja: ["スポーツウォッチ（Garmin, Suunto）", "ワークアウト、GPS", "レースとセッション中"],
          ko: ["스포츠워치 (Garmin, Suunto)", "운동, GPS", "경기 및 세션 중"],
        },
        {
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "FitMesh Sync e disponibile su Android con Health Connect integrato, e l'app iOS e disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea: con lo stesso account potrai vedere la tua dashboard su entrambi i telefoni, con ponte opzionale verso Apple Salute per chi vuole portare i dati anche nell'ecosistema Apple. [Android e iPhone insieme](/it/lp/due-telefoni): un solo account, una sola storia di salute.",
        en: "FitMesh Sync is available on Android with Health Connect integrated, and the iOS app is already available on the App Store, including all European Union storefronts: with the same account you'll be able to view your dashboard on both phones, with an optional bridge to Apple Health for those who want to bring data into the Apple ecosystem too. [Android and iPhone together](/en/lp/due-telefoni): one account, one health history.",
        es: "FitMesh Sync está disponible en Android con Health Connect integrado, y la app para iOS ya está disponible en App Store, incluidas todas las tiendas de la Unión Europea: con la misma cuenta podrás ver tu panel en ambos teléfonos, con un puente opcional hacia Apple Salute para quienes quieran llevar los datos también al ecosistema Apple. [Android e iPhone juntos](/es/lp/due-telefoni): una sola cuenta, una sola historia de salud.",
        de: "FitMesh Sync ist auf Android mit integriertem Health Connect verfügbar, und die iOS-App ist bereits im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union: Mit demselben Konto kannst du dein Dashboard auf beiden Telefonen aufrufen, mit einer optionalen Brücke zu Apple Health für alle, die ihre Daten auch ins Apple-Ökosystem bringen möchten. [Android und iPhone gemeinsam](/de/lp/due-telefoni): ein Konto, eine Gesundheitsgeschichte.",
        pt: "FitMesh Sync está disponível no Android com Health Connect integrado, e o app para iOS já está disponível na App Store, incluindo todas as lojas da União Europeia: com a mesma conta você poderá ver seu painel nos dois telefones, com uma ponte opcional para o Apple Health para quem quiser levar os dados também para o ecossistema Apple. [Android e iPhone juntos](/pt/lp/due-telefoni): uma conta, um histórico de saúde.",
        fr: "FitMesh Sync est disponible sur Android avec Health Connect intégré, et l'app iOS est déjà disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne : avec le même compte vous pourrez consulter votre tableau de bord sur les deux téléphones, avec un pont optionnel vers Apple Health pour ceux qui souhaitent apporter leurs données dans l'écosystème Apple également. [Android et iPhone ensemble](/fr/lp/due-telefoni): un compte, un historique de santé.",
        pl: "FitMesh Sync jest dostępny na Androidzie ze zintegrowanym Health Connect, a aplikacja iOS jest już dostępna w App Store, we wszystkich sklepach Unii Europejskiej: z tym samym kontem będziesz mógł przeglądać swój panel na obu telefonach, z opcjonalnym mostem do Apple Health dla tych, którzy chcą przenieść dane do ekosystemu Apple. [Android i iPhone razem](/pl/lp/due-telefoni): jedno konto, jedna historia zdrowia.",
        tr: "FitMesh Sync, Health Connect entegre edilmiş şekilde Android'de mevcut, iOS uygulaması ise Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere App Store'da zaten yayında: aynı hesapla her iki telefonda da panelinizi görüntüleyebileceksiniz, verilerini Apple ekosistemine de taşımak isteyenler için isteğe bağlı Apple Health köprüsüyle. [Android ve iPhone birlikte](/tr/lp/due-telefoni): bir hesap, bir sağlık geçmişi.",
        nl: "FitMesh Sync is beschikbaar op Android met geintegreerde Health Connect, en de iOS-app is al beschikbaar in de App Store, inclusief alle winkels van de Europese Unie: met hetzelfde account kun je je dashboard op beide telefoons bekijken, met een optionele brug naar Apple Health voor wie gegevens ook in het Apple-ecosysteem wil brengen. [Android en iPhone samen](/nl/lp/due-telefoni): een account, een gezondheidsgeschiedenis.",
        ja: "FitMesh SyncはHealth Connectを統合したAndroidで利用できるほか、iOSアプリはEU域内を含め、App Storeですでに利用可能です。同じアカウントで両方の電話でダッシュボードを表示でき、Appleエコシステムにもデータを持ち込みたい方にはApple Healthへのオプションブリッジ付き。[AndroidとiPhone一緒に](/ja/lp/due-telefoni)：1つのアカウント、1つの健康履歴。",
        ko: "FitMesh Sync는 Health Connect가 통합된 Android에서 사용 가능하며, iOS 앱은 EU 지역을 포함하여 App Store에서 이미 이용 가능합니다: 같은 계정으로 두 폰 모두에서 대시보드를 볼 수 있으며, Apple 생태계에도 데이터를 가져오고 싶은 분들을 위한 Apple Health 선택적 연동 포함. [Android와 iPhone 함께](/ko/lp/due-telefoni): 하나의 계정, 하나의 건강 기록.",
      },
    },
    ...
    },
    {
      type: "paragraph",
      text: {
        it: "Unire tutto in un posto solo ha senso solo se quel posto e sicuro. I dati salute di FitMesh sono accessibili solo a te tramite il tuo account, non vengono mai venduti ne condivisi con terze parti, e non c'e alcun tracker pubblicitario. La procedura di cancellazione di account e dati e descritta su fitmesh.fit/delete-account.",
        en: "Bringing everything into one place only makes sense if that place is secure. FitMesh's health data is accessible only to you through your account, is never sold or shared with third parties, and there are no ad trackers. The deletion process for accounts and data is described at fitmesh.fit/delete-account.",
        es: "Reunir todo en un solo lugar solo tiene sentido si ese lugar es seguro. Los datos de salud de FitMesh son accesibles únicamente a través de tu cuenta, nunca se venden ni se comparten con terceros, y no hay ningún rastreador publicitario. El proceso de eliminación de cuenta y datos está descrito en fitmesh.fit/delete-account.",
        de: "Alles an einem Ort zusammenzuführen macht nur Sinn, wenn dieser Ort sicher ist. Die Gesundheitsdaten von FitMesh sind nur über dein Konto für dich zugänglich, werden niemals verkauft oder an Dritte weitergegeben, und es gibt keine Werbe-Tracker. Der Ablauf der Konto- und Datenlöschung ist auf fitmesh.fit/delete-account beschrieben.",
        pt: "Reunir tudo em um só lugar só faz sentido se esse lugar for seguro. Os dados de saúde do FitMesh são acessíveis apenas por você através da sua conta, nunca são vendidos nem compartilhados com terceiros, e não há rastreadores publicitários. O processo de exclusão de conta e dados está descrito em fitmesh.fit/delete-account.",
        fr: "Tout regrouper en un seul endroit n'a de sens que si cet endroit est sécurisé. Les données de santé de FitMesh ne sont accessibles qu'à vous via votre compte, ne sont jamais vendues ni partagées avec des tiers, et il n'y a aucun traceur publicitaire. La procédure de suppression du compte et des données est décrite sur fitmesh.fit/delete-account.",
        pl: "Zebranie wszystkiego w jednym miejscu ma sens tylko wtedy, gdy to miejsce jest bezpieczne. Dane zdrowotne FitMesh są dostępne tylko dla Ciebie przez Twoje konto, nigdy nie są sprzedawane ani udostępniane osobom trzecim, i nie ma żadnych trackerów reklamowych. Procedura usuwania konta i danych jest opisana na fitmesh.fit/delete-account.",
        tr: "Her şeyi tek bir yerde toplamak yalnızca o yer güvenli olduğunda anlam ifade eder. FitMesh sağlık verileri hesabınız aracılığıyla yalnızca size erişilebilir, asla satılmaz veya üçüncü taraflarla paylaşılmaz ve hiçbir reklam takipçisi yoktur. Hesap ve veri silme süreci fitmesh.fit/delete-account adresinde açıklanmıştır.",
        nl: "Alles op een plek samenvoegen heeft alleen zin als die plek veilig is. De gezondheidsgegevens van FitMesh zijn alleen via je account voor jou toegankelijk, worden nooit verkocht of gedeeld met derden, en er zijn geen advertentietrackers. De procedure voor account- en gegevensverwijdering staat beschreven op fitmesh.fit/delete-account.",
        ja: "すべてを一か所にまとめることは、その場所が安全である場合にのみ意味があります。FitMeshの健康データはあなたのアカウントを通じてのみアクセス可能で、第三者に販売・共有されることはなく、広告トラッカーもありません。アカウントとデータの削除手順はfitmesh.fit/delete-accountに記載されています。",
        ko: "모든 것을 한 곳에 모으는 것은 그곳이 안전할 때만 의미가 있습니다. FitMesh의 건강 데이터는 계정을 통해서만 접근 가능하고, 제3자에게 판매하거나 공유하지 않으며, 광고 추적기도 없습니다. 계정 및 데이터 삭제 절차는 fitmesh.fit/delete-account에 안내되어 있습니다.",
      },
    },

    {
      type: "cta",
      title: {
        it: "Porta tutti i tuoi dispositivi in un'unica dashboard",
        en: "Bring all your devices into one dashboard",
        es: "Lleva todos tus dispositivos a un único panel",
        de: "Bringe alle deine Geräte in ein einziges Dashboard",
        pt: "Leve todos os seus dispositivos para um único painel",
        fr: "Regroupez tous vos appareils dans un seul tableau de bord",
        pl: "Przenieś wszystkie swoje urządzenia do jednego panelu",
        tr: "Tüm cihazlarınızı tek bir panelde bir araya getirin",
        nl: "Breng al je apparaten in een enkel dashboard",
        ja: "すべてのデバイスを1つのダッシュボードに集めましょう",
        ko: "모든 기기를 하나의 대시보드로 가져오세요",
      },
      body: {
        it: "FitMesh Sync è disponibile su Google Play. Crea l'account e porta tutti i tuoi dispositivi in un'unica dashboard, senza doppioni.",
        en: "FitMesh Sync is available on Google Play. Create your account and bring all your devices into one dashboard, with no duplicates.",
        es: "FitMesh Sync está disponible en Google Play. Crea tu cuenta y lleva todos tus dispositivos a un único panel, sin duplicados.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Erstelle dein Konto und bringe alle deine Geräte in ein einziges Dashboard, ohne Duplikate.",
        pt: "FitMesh Sync está disponível no Google Play. Crie sua conta e leve todos os seus dispositivos para um único painel, sem duplicatas.",
        fr: "FitMesh Sync est disponible sur Google Play. Créez votre compte et regroupez tous vos appareils dans un seul tableau de bord, sans doublons.",
        pl: "FitMesh Sync jest dostępny w Google Play. Utwórz konto i przenieś wszystkie swoje urządzenia do jednego panelu, bez duplikatów.",
        tr: "FitMesh Sync Google Play'de mevcut. Hesabınızı oluşturun ve tüm cihazlarınızı, tekrar olmadan, tek bir panelde bir araya getirin.",
        nl: "FitMesh Sync is beschikbaar op Google Play. Maak je account aan en breng al je apparaten in een enkel dashboard, zonder duplicaten.",
        ja: "FitMesh SyncはGoogle Playで利用できます。アカウントを作成し、重複なしですべてのデバイスを1つのダッシュボードに集めましょう。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 계정을 만들고 중복 없이 모든 기기를 하나의 대시보드로 가져오세요.",
      },
      ctaLabel: {
  ...
  faq: [
    ...
    },
    {
      ...
      a: {
        it: "Si. L'app iOS e disponibile sull'App Store, incluse tutte le storefront dell'Unione Europea. Con lo stesso account FitMesh potrai accedere alla tua dashboard su Android e iPhone, con ponte opzionale verso Apple Salute.",
        en: "Yes. The iOS app is already available on the App Store, including all European Union storefronts. With the same FitMesh account you'll be able to access your dashboard on Android and iPhone, with an optional bridge to Apple Health.",
        es: "Sí. La app para iOS ya está disponible en App Store, incluidas todas las tiendas de la Unión Europea. Con la misma cuenta de FitMesh podrás acceder a tu panel en Android e iPhone, con un puente opcional hacia Apple Salute.",
        de: "Ja. Die iOS-App ist bereits im App Store verfügbar, einschließlich aller Storefronts der Europäischen Union. Mit demselben FitMesh-Konto kannst du auf dein Dashboard auf Android und iPhone zugreifen, mit einer optionalen Brücke zu Apple Health.",
        pt: "Sim. O app para iOS já está disponível na App Store, incluindo todas as lojas da União Europeia. Com a mesma conta FitMesh você poderá acessar seu painel no Android e no iPhone, com uma ponte opcional para o Apple Health.",
        fr: "Oui. L'app iOS est déjà disponible sur l'App Store, y compris dans toutes les boutiques de l'Union européenne. Avec le même compte FitMesh vous pourrez accéder à votre tableau de bord sur Android et iPhone, avec un pont optionnel vers Apple Health.",
        pl: "Tak. Aplikacja iOS jest już dostępna w App Store, we wszystkich sklepach Unii Europejskiej. Z tym samym kontem FitMesh będziesz mógł uzyskać dostęp do swojego panelu na Androidzie i iPhonie, z opcjonalnym mostem do Apple Health.",
        tr: "Evet. iOS uygulaması, Avrupa Birliği'ndeki tüm mağazalar dahil olmak üzere App Store'da zaten yayında. Aynı FitMesh hesabıyla Android ve iPhone'da panelinize erişebileceksiniz, Apple Health'e isteğe bağlı köprüyle.",
        nl: "Ja. De iOS-app is al beschikbaar in de App Store, inclusief alle winkels van de Europese Unie. Met hetzelfde FitMesh-account kun je je dashboard op Android en iPhone raadplegen, met een optionele brug naar Apple Health.",
        ja: "はい。iOSアプリはEU域内を含め、App Storeですでに利用可能です。同じFitMeshアカウントでAndroidとiPhoneでダッシュボードにアクセスでき、Apple Healthへのオプションブリッジ付きです。",
        ko: "네. iOS 앱은 EU 지역을 포함하여 App Store에서 이미 이용 가능합니다. 같은 FitMesh 계정으로 Android와 iPhone에서 대시보드에 접근할 수 있으며, Apple Health 선택적 연동도 포함됩니다.",
      },
    },
  ],
