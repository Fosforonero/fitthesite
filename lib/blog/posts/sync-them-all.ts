  ...
  body: [
...

    {
      ...
      body: {
        ...
        nl: "FitMesh Sync is in private beta. Maak je account aan en het eerste jaar Pro is gratis van ons, het wordt automatisch geactiveerd. Breng al je apparaten in een enkel dashboard.",
        ja: "FitMesh Syncはプライベートベータ中です。アカウントを作成するとProの最初の1年が無料でプレゼント、自動的に有効化されます。すべてのデバイスを1つのダッシュボードに集めましょう。",
        ko: "FitMesh Sync는 비공개 베타 중입니다. 계정을 만들면 Pro 첫 1년이 무료로 제공되며, 자동으로 활성화됩니다. 모든 기기를 하나의 대시보드로 가져오세요.",
      },
      ctaLabel: {
        it: "Diventa founder",
        en: "Become a founder",
