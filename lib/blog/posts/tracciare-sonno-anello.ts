...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "Su iPhone: con un account FitMesh i dati di sonno sono visibili anche da iOS (l'app e live sull'App Store negli store supportati fuori dall'UE, il rollout nell'UE è in corso) e possono confluire in Apple Salute.",
    ],
    en: [
      ...
      "On iPhone: with a FitMesh account your sleep data is visible on iOS too (the app is live on the App Store in supported storefronts outside the EU, with EU rollout in progress) and can flow into Apple Health.",
    ],
    es: [
      ...
      "En iPhone: con una cuenta de FitMesh tus datos de sueño también son visibles en iOS (la app ya está disponible en App Store en las tiendas compatibles fuera de la UE; el despliegue en la UE está en curso) y pueden integrarse en Apple Salud.",
    ],
    de: [
      ...
      "Auf iPhone: Mit einem FitMesh-Konto sind Ihre Schlafdaten auch unter iOS sichtbar (die App ist bereits live im App Store in unterstützten Stores außerhalb der EU, der Rollout in der EU läuft) und können in Apple Health einfließen.",
    ],
    pt: [
      ...
      "No iPhone: com uma conta FitMesh seus dados de sono ficam visíveis também no iOS (o app já está disponível na App Store nas lojas compatíveis fora da UE; o lançamento na UE está em andamento) e podem fluir para o Apple Health.",
    ],
    fr: [
      ...
      "Sur iPhone: avec un compte FitMesh vos données de sommeil sont aussi visibles sur iOS (l'application est disponible sur l'App Store dans les boutiques prises en charge hors de l'UE; le déploiement dans l'UE est en cours) et peuvent être transférées dans Apple Santé.",
    ],
    pl: [
      ...
      "Na iPhonie: z kontem FitMesh dane snu są widoczne również na iOS (aplikacja jest już dostępna w App Store w obsługiwanych sklepach poza UE; wdrożenie w UE jest w toku) i mogą trafiać do Apple Zdrowie.",
    ],
    tr: [
      ...
      "iPhone'da: FitMesh hesabıyla uyku verileriniz iOS'ta da görüntülenebilir (uygulama AB dışındaki desteklenen mağazalarda App Store'da yayında; AB'de kullanıma sunma süreci devam ediyor) ve Apple Sağlık'a aktarılabilir.",
    ],
    nl: [
      ...
      "Op iPhone: met een FitMesh-account zijn uw slaapgegevens ook zichtbaar op iOS (de app is live in de App Store in ondersteunde stores buiten de EU; de uitrol in de EU is bezig) en kunnen ze naar Apple Gezondheid stromen.",
    ],
    ja: [
      ...
      "iPhoneでは：FitMeshアカウントがあれば、睡眠データはiOSでも確認でき（アプリはEU域外の対応ストアでApp Storeにて配信中、EUでの展開は準備中）、Apple ヘルスに連携することもできます。",
    ],
    ko: [
      ...
      "iPhone에서: FitMesh 계정이 있으면 수면 데이터를 iOS에서도 확인할 수 있고(앱은 EU 외 지원되는 스토어에서 App Store에 출시되어 있으며, EU 출시는 진행 중입니다), Apple 건강 앱으로 연동할 수도 있습니다.",
    ],
  },
  body: [
    {
    ...
    },
    {
      ...
      body: {
        it: "L'anello Colmi rileva le fasi del sonno via Bluetooth su Android. Con un account FitMesh i dati di sonno sono visibili anche su iPhone (l'app iOS e live sull'App Store negli store supportati fuori dall'UE; il rollout nei 27 paesi UE è in corso) e possono confluire in Apple Salute tramite il ponte opzionale.",
        en: "The Colmi ring detects sleep stages over Bluetooth on Android. With a FitMesh account your sleep data is also visible on iPhone (the iOS app is live on the App Store in supported storefronts outside the EU; rollout in the 27 EU countries is in progress) and can flow into Apple Health via the optional bridge.",
        es: "El anillo Colmi detecta las fases del sueño por Bluetooth en Android. Con una cuenta de FitMesh tus datos de sueño también son visibles en iPhone (la app iOS ya está disponible en App Store en las tiendas compatibles fuera de la UE; el despliegue en los 27 países de la UE está en curso) y pueden integrarse en Apple Salud mediante el puente opcional.",
        de: "Der Colmi Ring erkennt Schlafphasen über Bluetooth auf Android. Mit einem FitMesh-Konto sind Ihre Schlafdaten auch auf iPhone sichtbar (die iOS-App ist bereits live im App Store in unterstützten Stores außerhalb der EU; der Rollout in den 27 EU-Ländern läuft) und können über die optionale Brücke in Apple Health einfließen.",
        pt: "O anel Colmi detecta as fases do sono via Bluetooth no Android. Com uma conta FitMesh seus dados de sono ficam visíveis também no iPhone (o app iOS já está disponível na App Store nas lojas compatíveis fora da UE; o lançamento nos 27 países da UE está em andamento) e podem fluir para o Apple Health pela ponte opcional.",
        fr: "La bague Colmi détecte les phases du sommeil via Bluetooth sur Android. Avec un compte FitMesh vos données de sommeil sont aussi visibles sur iPhone (l'application iOS est disponible sur l'App Store dans les boutiques prises en charge hors de l'UE; dans les 27 pays de l'UE, le déploiement est en cours) et peuvent être transférées dans Apple Santé via le pont optionnel.",
        pl: "Pierścień Colmi wykrywa fazy snu przez Bluetooth na Androidzie. Z kontem FitMesh dane snu są widoczne również na iPhonie (aplikacja iOS jest już dostępna w App Store w obsługiwanych sklepach poza UE; wdrożenie w 27 krajach UE jest w toku) i mogą trafiać do Apple Zdrowie przez opcjonalny mostek.",
        tr: "Colmi yüzük, Android'de Bluetooth üzerinden uyku fazlarını algılar. FitMesh hesabıyla uyku verileriniz iPhone'da da görüntülenebilir (iOS uygulaması AB dışındaki desteklenen mağazalarda App Store'da yayında; 27 AB ülkesinde kullanıma sunma süreci devam ediyor) ve isteğe bağlı köprü aracılığıyla Apple Sağlık'a aktarılabilir.",
        nl: "De Colmi ring detecteert slaapfasen via Bluetooth op Android. Met een FitMesh-account zijn uw slaapgegevens ook zichtbaar op iPhone (de iOS-app is al live in de App Store in ondersteunde stores buiten de EU; de uitrol in de 27 EU-landen is bezig) en kunnen via de optionele brug naar Apple Gezondheid stromen.",
        ja: "Colmiリングは、AndroidでBluetoothを通じて睡眠ステージを検出します。FitMeshアカウントがあれば、睡眠データはiPhoneでも確認でき（iOSアプリはEU域外の対応ストアでApp Storeにて配信中、EU27カ国での展開は準備中）、オプションのブリッジを通じてApple ヘルスに連携できます。",
        ko: "Colmi 링은 Android에서 블루투스를 통해 수면 단계를 감지합니다. FitMesh 계정이 있으면 수면 데이터를 iPhone에서도 확인할 수 있고(iOS 앱은 EU 외 지원되는 스토어에서 App Store에 출시되어 있으며, EU 27개국 출시는 진행 중입니다), 선택적 브리지를 통해 Apple 건강 앱으로 연동할 수 있습니다.",
      },
    },
    {
      type: "heading",
