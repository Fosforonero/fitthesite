...
export const post: BlogPost = {
  ...
  tldr: {
    it: [
      ...
      "Su iPhone: con un account FitMesh i dati di sonno sono visibili anche da iOS (l'app e live sull'App Store) e possono confluire in Apple Salute.",
    ],
    en: [
      ...
      "On iPhone: with a FitMesh account your sleep data is visible on iOS too (the app is live on the App Store) and can flow into Apple Health.",
    ],
    es: [
      ...
      "En iPhone: con una cuenta de FitMesh tus datos de sueño también son visibles en iOS (la app ya está disponible en App Store) y pueden integrarse en Apple Salud.",
    ],
    de: [
      ...
      "Auf iPhone: Mit einem FitMesh-Konto sind Ihre Schlafdaten auch unter iOS sichtbar (die App ist bereits live im App Store) und können in Apple Health einfließen.",
    ],
    pt: [
      ...
      "No iPhone: com uma conta FitMesh seus dados de sono ficam visíveis também no iOS (o app já está disponível na App Store) e podem fluir para o Apple Health.",
    ],
    fr: [
      ...
      "Sur iPhone: avec un compte FitMesh vos données de sommeil sont aussi visibles sur iOS (l'application est disponible sur l'App Store) et peuvent être transférées dans Apple Santé.",
    ],
    pl: [
      ...
      "Na iPhonie: z kontem FitMesh dane snu są widoczne również na iOS (aplikacja jest już dostępna w App Store) i mogą trafiać do Apple Zdrowie.",
    ],
    tr: [
      ...
      "iPhone'da: FitMesh hesabıyla uyku verileriniz iOS'ta da görüntülenebilir (uygulama App Store'da yayında) ve Apple Sağlık'a aktarılabilir.",
    ],
    nl: [
      ...
      "Op iPhone: met een FitMesh-account zijn uw slaapgegevens ook zichtbaar op iOS (de app is live in de App Store) en kunnen ze naar Apple Gezondheid stromen.",
    ],
    ja: [
      ...
      "iPhoneでは：FitMeshアカウントがあれば、睡眠データはiOSでも確認でき（アプリはApp Storeにて配信中）、Apple ヘルスに連携することもできます。",
    ],
    ko: [
      ...
      "iPhone에서: FitMesh 계정이 있으면 수면 데이터를 iOS에서도 확인할 수 있고(앱은 App Store에 출시되어 있습니다), Apple 건강 앱으로 연동할 수도 있습니다.",
    ],
  },
  body: [
    {
    ...
    },
    {
      ...
      variant: "info",
      title: {
        it: "FitMesh su iPhone: app iOS live sull'App Store",
        en: "FitMesh on iPhone: iOS app live on the App Store",
        es: "FitMesh en iPhone: app iOS disponible en App Store",
        de: "FitMesh auf iPhone: iOS-App live im App Store",
        pt: "FitMesh no iPhone: app iOS disponível na App Store",
        fr: "FitMesh sur iPhone: application iOS disponible sur l'App Store",
        pl: "FitMesh na iPhone: aplikacja iOS dostępna w App Store",
        tr: "FitMesh iPhone'da: iOS uygulaması App Store'da yayında",
        nl: "FitMesh op iPhone: iOS-app live in de App Store",
        ja: "iPhoneのFitMesh：iOSアプリはApp Storeで配信中",
        ko: "iPhone의 FitMesh: iOS 앱 App Store 출시",
      },
      body: {
        it: "L'anello Colmi rileva le fasi del sonno via Bluetooth su Android. Con un account FitMesh i dati di sonno sono visibili anche su iPhone (l'app iOS e live sull'App Store) e possono confluire in Apple Salute tramite il ponte opzionale.",
        en: "The Colmi ring detects sleep stages over Bluetooth on Android. With a FitMesh account your sleep data is also visible on iPhone (the iOS app is live on the App Store) and can flow into Apple Health via the optional bridge.",
        es: "El anillo Colmi detecta las fases del sueño por Bluetooth en Android. Con una cuenta de FitMesh tus datos de sueño también son visibles en iPhone (la app iOS ya está disponible en App Store) y pueden integrarse en Apple Salud mediante el puente opcional.",
        de: "Der Colmi Ring erkennt Schlafphasen über Bluetooth auf Android. Mit einem FitMesh-Konto sind Ihre Schlafdaten auch auf iPhone sichtbar (die iOS-App ist bereits live im App Store) und können über die optionale Brücke in Apple Health einfließen.",
        pt: "O anel Colmi detecta as fases do sono via Bluetooth no Android. Com uma conta FitMesh seus dados de sono ficam visíveis também no iPhone (o app iOS já está disponível na App Store) e podem fluir para o Apple Health pela ponte opcional.",
        fr: "La bague Colmi détecte les phases du sommeil via Bluetooth sur Android. Avec un compte FitMesh vos données de sommeil sont aussi visibles sur iPhone (l'application iOS est disponible sur l'App Store) et peuvent être transférées dans Apple Santé via le pont optionnel.",
        pl: "Pierścień Colmi wykrywa fazy snu przez Bluetooth na Androidzie. Z kontem FitMesh dane snu są widoczne również na iPhonie (aplikacja iOS jest już dostępna w App Store) i mogą trafiać do Apple Zdrowie przez opcjonalny mostek.",
        tr: "Colmi yüzük, Android'de Bluetooth üzerinden uyku fazlarını algılar. FitMesh hesabıyla uyku verileriniz iPhone'da da görüntülenebilir (iOS uygulaması App Store'da yayında) ve isteğe bağlı köprü aracılığıyla Apple Sağlık'a aktarılabilir.",
        nl: "De Colmi ring detecteert slaapfasen via Bluetooth op Android. Met een FitMesh-account zijn uw slaapgegevens ook zichtbaar op iPhone (de iOS-app is al live in de App Store) en kunnen via de optionele brug naar Apple Gezondheid stromen.",
        ja: "Colmiリングは、AndroidでBluetoothを通じて睡眠ステージを検出します。FitMeshアカウントがあれば、睡眠データはiPhoneでも確認でき（iOSアプリはApp Storeにて配信中）、オプションのブリッジを通じてApple ヘルスに連携できます。",
        ko: "Colmi 링은 Android에서 블루투스를 통해 수면 단계를 감지합니다. FitMesh 계정이 있으면 수면 데이터를 iPhone에서도 확인할 수 있고(iOS 앱은 App Store에 출시되어 있습니다), 선택적 브리지를 통해 Apple 건강 앱으로 연동할 수 있습니다.",
      },
    },
    {
      type: "heading",
    ...
    },
    {
      ...
      body: {
        it: "FitMesh Sync è disponibile su Google Play. I primi 1000 founder (fino al 31 luglio 2026) hanno ricevuto il Pro a vita gratis, incluso l'accesso alla dashboard unificata anello + smartwatch non appena disponibile.",
        en: "FitMesh Sync is available on Google Play. The first 1,000 founders (through July 31, 2026) got lifetime Pro free, including access to the unified ring and smartwatch dashboard as soon as it ships.",
        es: "FitMesh Sync está disponible en Google Play. Los primeros 1000 founders (hasta el 31 de julio de 2026) obtuvieron el Pro de por vida gratis, incluido el acceso al panel unificado de anillo y smartwatch en cuanto esté disponible.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder (bis 31. Juli 2026) haben lebenslang Pro kostenlos erhalten, einschließlich Zugang zum einheitlichen Ring- und Smartwatch-Dashboard, sobald es verfügbar ist.",
        pt: "FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders (até 31 de julho de 2026) receberam o Pro vitalício grátis, incluindo acesso ao painel unificado de anel e smartwatch assim que estiver disponível.",
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders (jusqu'au 31 juillet 2026) ont obtenu le Pro à vie gratuit, avec accès au tableau de bord unifié bague et montre connectée dès sa disponibilité.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów (do 31 lipca 2026) otrzymało dożywotnie Pro za darmo, w tym dostęp do ujednoliconego panelu pierścień i smartwatch, gdy tylko będzie dostępny.",
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu (31 Temmuz 2026'ya kadar) ömür boyu Pro'yu ücretsiz aldı, yüzük ve smartwatch birleşik panosuna erişim dahil.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders (tot 31 juli 2026) hebben levenslang Pro gratis gekregen, inclusief toegang tot het gecombineerde ring- en smartwatchdashboard zodra het beschikbaar is.",
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounder（2026年7月31日まで）は永久版Proを無料で利用でき、リングとスマートウォッチの統合ダッシュボードへのアクセスも含まれていました。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder(2026년 7월 31일까지)는 평생 Pro를 무료로 이용했으며, 링과 스마트워치 통합 대시보드 이용도 포함되었습니다.",
      },
      ctaLabel: {
