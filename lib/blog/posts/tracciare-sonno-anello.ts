  ...
  body: [
    ...
    },
    {
      ...
      body: {
        ...
        es: "FitMesh Sync está disponible en Google Play. Los primeros 1000 founders (programa cerrado desde el 31 de julio de 2026) obtuvieron el Pro de por vida gratis, incluido el acceso al panel unificado de anillo y smartwatch en cuanto esté disponible.",
        de: "FitMesh Sync ist auf Google Play verfügbar. Die ersten 1000 Founder (Programm seit dem 31. Juli 2026 geschlossen) haben lebenslang Pro kostenlos erhalten, einschließlich Zugang zum einheitlichen Ring- und Smartwatch-Dashboard, sobald es verfügbar ist.",
        pt: "FitMesh Sync está disponível no Google Play. Os primeiros 1000 founders (programa encerrado desde 31 de julho de 2026) receberam o Pro vitalício grátis, incluindo acesso ao painel unificado de anel e smartwatch assim que estiver disponível.",
        fr: "FitMesh Sync est disponible sur Google Play. Les 1000 premiers founders (programme clos depuis le 31 juillet 2026) ont obtenu le Pro à vie gratuit, avec accès au tableau de bord unifié bague et montre connectée dès sa disponibilité.",
        pl: "FitMesh Sync jest dostępny w Google Play. Pierwszych 1000 founderów (program zamknięty od 31 lipca 2026) otrzymało dożywotnie Pro za darmo, w tym dostęp do ujednoliconego panelu pierścień i smartwatch, gdy tylko będzie dostępny.",
        tr: "FitMesh Sync Google Play'de mevcut. İlk 1000 kurucu (program 31 Temmuz 2026 itibarıyla kapandı) ömür boyu Pro'yu ücretsiz aldı, yüzük ve smartwatch birleşik panosuna erişim dahil.",
        nl: "FitMesh Sync is beschikbaar op Google Play. De eerste 1000 founders (programma gesloten sinds 31 juli 2026) hebben levenslang Pro gratis gekregen, inclusief toegang tot het gecombineerde ring- en smartwatchdashboard zodra het beschikbaar is.",
        ja: "FitMesh SyncはGoogle Playで利用できます。最初の1000名のfounder（2026年7月31日に終了したプログラム）は永久版Proを無料で利用でき、リングとスマートウォッチの統合ダッシュボードへのアクセスも含まれていました。",
        ko: "FitMesh Sync는 Google Play에서 이용할 수 있습니다. 처음 1000명의 founder(2026년 7월 31일에 종료된 프로그램)는 평생 Pro를 무료로 이용했으며, 링과 스마트워치 통합 대시보드 이용도 포함되었습니다.",
      },
      ctaLabel: {
