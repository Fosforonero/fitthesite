...
export const ABOUT_COPY = {
  ...
  privacyBody1: {
    it: "I tuoi dati di salute non sono un prodotto. FitMesh non vende, non condivide, non profila. Nessuna integrazione con Google Analytics, Meta SDK, o ad network.",
    en: "Your health data is not a product. FitMesh does not sell, share, or profile. No Google Analytics, no Meta SDK, no ad networks.",
    es: "Tus datos de salud no son un producto. FitMesh no vende, no comparte ni crea perfiles. Sin Google Analytics, sin Meta SDK, sin redes publicitarias.",
    de: "Deine Gesundheitsdaten sind kein Produkt. FitMesh verkauft, teilt und profiliert nicht. Kein Google Analytics, kein Meta SDK, keine Werbenetzwerke.",
    pt: "Seus dados de saúde não são um produto. FitMesh não vende, não compartilha e não cria perfis. Sem Google Analytics, sem Meta SDK, sem redes de publicidade.",
    fr: "Vos données de santé ne sont pas un produit. FitMesh ne vend pas, ne partage pas et ne profile pas. Pas de Google Analytics, pas de Meta SDK, pas de réseaux publicitaires.",
    pl: "Twoje dane zdrowotne nie są produktem. FitMesh ich nie sprzedaje, nie udostępnia i nie profiluje. Żadnego Google Analytics, żadnego SDK Meta, żadnych sieci reklamowych.",
    tr: "Sağlık verileriniz bir ürün değildir. FitMesh verilerinizi satmaz, paylaşmaz ve profillemez. Google Analytics yok, Meta SDK yok, reklam ağı yok.",
    nl: "Jouw gezondheidsgegevens zijn geen product. FitMesh verkoopt ze niet, deelt ze niet en gebruikt ze niet voor profilering. Geen Google Analytics, geen Meta SDK, geen advertentienetwerken.",
    ja: "あなたの健康データは商品ではありません。FitMeshはデータを販売せず、共有せず、プロファイリングもしません。Google Analyticsも、Meta SDKも、広告ネットワークも一切使用していません。",
    ko: "당신의 건강 데이터는 상품이 아닙니다. FitMesh는 데이터를 판매하거나 공유하거나 프로파일링하지 않습니다. Google Analytics도, Meta SDK도, 광고 네트워크도 없습니다.",
    sv: "Din hälsodata är ingen produkt. FitMesh säljer inte, delar inte och profilerar inte. Ingen Google Analytics, ingen Meta SDK, inga annonsnätverk.",
    da: "Dine sundhedsdata er ikke et produkt. FitMesh sælger, deler eller profilerer ikke dig. Ingen Google Analytics, intet Meta SDK, ingen annoncenetværk.",
    no: "Helsedataene dine er ikke et produkt. FitMesh selger dem ikke, deler dem ikke og profilerer dem ikke. Ingen Google Analytics, ingen Meta SDK, ingen annonsenettverk.",
    fi: "Terveystietosi eivät ole tuote. FitMesh ei myy, jaa eikä profiloi niitä. Ei Google Analyticsia, ei Meta SDK:ta, ei mainosverkostoja.",
  } satisfies Localized,
