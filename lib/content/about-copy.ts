...
export const ABOUT_COPY = {
  ...
  heroDescription: {
    it: "FitMesh Sync è un'app Android che legge i dati salute del tuo smartwatch (Galaxy Watch, Wear OS, Mi Band, e qualunque dispositivo che scriva su Health Connect) e li mostra su una dashboard web premium. Nessun account social. Nessun tracker pubblicitario. Nessun cloud opaco che decide cosa fare dei tuoi dati.",
    en: "FitMesh Sync is an Android app that reads health data from your smartwatch (Galaxy Watch, Wear OS, Mi Band, and any device that writes to Health Connect) and surfaces it on a premium web dashboard. No social accounts. No ad trackers. No opaque cloud deciding what to do with your data.",
    es: "FitMesh Sync es una app para Android que lee los datos de salud de tu smartwatch (Galaxy Watch, Wear OS, Mi Band y cualquier dispositivo que escriba en Health Connect) y los muestra en un panel web premium. Sin cuentas sociales. Sin rastreadores publicitarios. Sin nubes opacas que decidan qué hacer con tus datos.",
    de: "FitMesh Sync ist eine Android-App, die Gesundheitsdaten deiner Smartwatch (Galaxy Watch, Wear OS, Mi Band und alle Geräte, die Daten in Health Connect schreiben) liest und auf einem Premium-Web-Dashboard anzeigt. Keine Social-Konten. Keine Werbe-Tracker. Keine intransparente Cloud, die entscheidet, was mit deinen Daten passiert.",
    pt: "FitMesh Sync é um app para Android que lê os dados de saúde do seu smartwatch (Galaxy Watch, Wear OS, Mi Band e qualquer dispositivo que grave dados no Health Connect) e os exibe em um painel web premium. Sem contas sociais. Sem rastreadores de anúncios. Sem nuvens opacas decidindo o que fazer com seus dados.",
    fr: "FitMesh Sync est une application Android qui lit les données de santé de votre montre connectée (Galaxy Watch, Wear OS, Mi Band et tout appareil écrivant dans Health Connect) et les affiche sur un tableau de bord web premium. Aucun compte social. Aucun traceur publicitaire. Aucun nuage opaque décidant de l'utilisation de vos données.",
    pl: "FitMesh Sync to aplikacja na Androida, która odczytuje dane zdrowotne z Twojego smartwatcha (Galaxy Watch, Wear OS, Mi Band i dowolnego urządzenia zapisującego dane w Health Connect) i prezentuje je na eleganckim panelu internetowym. Bez kont społecznościowych. Bez trackerów reklamowych. Bez nieprzejrzystej chmury decydującej, co zrobić z Twoimi danymi.",
    tr: "FitMesh Sync, akıllı saatinizden (Galaxy Watch, Wear OS, Mi Band ve Health Connect'e veri yazan diğer her cihaz) sağlık verilerini okuyup premium bir web panelinde sunan bir Android uygulamasıdır. Sosyal hesap yok. Reklam izleyicileri yok. Verilerinizle ne yapılacağına karar veren opak bir bulut sistemi yok.",
    nl: "FitMesh Sync is een Android-app die gezondheidsgegevens van je smartwatch uitleest (Galaxy Watch, Wear OS, Mi Band en elk apparaat dat naar Health Connect schrijft) en ze toont in een premium webdashboard. Geen social accounts. Geen advertentietrackers. Geen ondoorzichtige cloud die bepaalt wat er met jouw gegevens gebeurt.",
    ja: "FitMesh Syncは、スマートウォッチ(Galaxy Watch、Wear OS、Mi Band、Health Connectに対応するあらゆるデバイス)から健康データを読み取り、洗練されたWebダッシュボードに表示するAndroidアプリです。ソーシャルアカウント連携は不要。広告トラッカーもありません。あなたのデータの扱いを勝手に決める不透明なクラウドも存在しません。",
    ko: "FitMesh Sync는 스마트워치(Galaxy Watch, Wear OS, Mi Band 등 Health Connect에 데이터를 기록하는 모든 기기)의 건강 데이터를 읽어와 프리미엄 웹 대시보드에서 보여주는 안드로이드 앱입니다. 소셜 계정 없음. 광고 트래커 없음. 당신의 데이터를 마음대로 처리하는 불투명한 클라우드도 없음.",
    sv: "FitMesh Sync är en Android-app som läser hälsodata från din smartklocka (Galaxy Watch, Wear OS, Mi Band och alla enheter som skriver till Health Connect) och visar den i en premium webbdashboard. Inga sociala konton. Inga annonsspårare. Inget ogenomskinligt moln som bestämmer vad som händer med din data.",
    da: "FitMesh Sync er en Android-app, der læser sundhedsdata fra dit smartwatch (Galaxy Watch, Wear OS, Mi Band og enhver enhed, der skriver til Health Connect) og viser dem i et premium webdashboard. Ingen sociale konti. Ingen annoncetrackere. Ingen uigennemsigtig cloud-tjeneste, der bestemmer, hvad der skal ske med dine data.",
    no: "FitMesh Sync er en Android-app som leser helsedata fra smartklokken din (Galaxy Watch, Wear OS, Mi Band og alle enheter som skriver til Health Connect), og viser dem på et premium webdashbord. Ingen sosiale kontoer. Ingen annonsesporere. Ingen ugjennomsiktig sky som bestemmer hva som skjer med dataene dine.",
    fi: "FitMesh Sync on Android-sovellus, joka lukee terveystietoja älykellostasi (Galaxy Watch, Wear OS, Mi Band ja mikä tahansa laite, joka kirjoittaa Health Connectiin) ja näyttää ne premium-tasoisella verkkodashboardilla. Ei sosiaalisia tilejä. Ei mainosseurantaa. Ei läpinäkymätöntä pilvipalvelua päättämässä, mitä tiedoillesi tehdään.",
  } satisfies Localized,
  ...
  featuresIntro: {
    it: "Ogni 15-30 minuti FitMesh legge in background le metriche che il tuo wearable ha sincronizzato con Health Connect:",
    en: "Every 15-30 minutes FitMesh reads in background the metrics your wearable has synced with Health Connect:",
    es: "Cada 15-30 minutos FitMesh lee en segundo plano las métricas que tu wearable ha sincronizado con Health Connect:",
    de: "Alle 15-30 Minuten liest FitMesh im Hintergrund die Metriken, die dein Wearable mit Health Connect synchronisiert hat:",
    pt: "A cada 15-30 minutos, o FitMesh lê em segundo plano as métricas que seu wearable sincronizou com o Health Connect:",
    fr: "Toutes les 15 à 30 minutes, FitMesh lit en arrière-plan les métriques que votre appareil connecté a synchronisées avec Health Connect:",
    pl: "Co 15-30 minut FitMesh w tle odczytuje metryki, które Twoje urządzenie zsynchronizowało z Health Connect:",
    tr: "FitMesh, akıllı saatinizin Health Connect ile senkronize ettiği verileri her 15-30 dakikada bir arka planda okur:",
    nl: "Elke 15 tot 30 minuten leest FitMesh op de achtergrond de gegevens uit die je wearable met Health Connect heeft gesynchroniseerd:",
    ja: "FitMeshは15〜30分ごとに、バックグラウンドでウェアラブルがHealth Connectに同期したデータを読み取ります:",
    ko: "FitMesh는 15~30분마다 백그라운드에서 웨어러블 기기가 Health Connect에 동기화한 지표를 읽어옵니다:",
    sv: "Var 15–30:e minut läser FitMesh i bakgrunden in de mätvärden som din enhet har synkroniserat med Health Connect:",
    da: "Hvert 15.-30. minut læser FitMesh i baggrunden de målinger, dit wearable har synkroniseret med Health Connect:",
    no: "Hvert 15.–30. minutt leser FitMesh i bakgrunnen målingene smartklokken din har synkronisert med Health Connect:",
    fi: "FitMesh lukee taustalla 15–30 minuutin välein mittarit, jotka puettava laitteesi on synkronoinut Health Connectiin:",
  } satisfies Localized,
  ...
  featureItems: [
    ...
    {
      it: "VO₂ max e SpO₂ (se supportati)", en: "VO₂ max and SpO₂ (when supported)", es: "VO₂ max y SpO₂ (si son compatibles)",
      de: "VO₂ max und SpO₂ (wenn unterstützt)", pt: "VO₂ max e SpO₂ (quando disponíveis)", fr: "VO₂ max et SpO₂ (si pris en charge)",
      pl: "VO₂ max i SpO₂ (jeśli obsługiwane)", tr: "VO₂ maks ve SpO₂ (destekleniyorsa)", nl: "VO₂ max en SpO₂ (indien ondersteund)",
      ja: "VO₂ maxとSpO₂(対応時)", ko: "VO₂ max와 SpO₂(지원되는 경우)", sv: "VO₂max och SpO₂ (när det stöds)",
      da: "VO₂ max og SpO₂ (når understøttet)", no: "VO₂ maks og SpO₂ (der det støttes)", fi: "VO₂max ja SpO₂ (jos tuettu)",
    } satisfies Localized,
    {
