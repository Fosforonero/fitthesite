...
export const ABOUT_COPY = {
  ...
  metaDescription: {
    it: "FitMesh Sync sincronizza i dati del tuo smartwatch su una dashboard premium tutta tua. Privacy-first, acquisto unico da €3,99, niente cloud opachi.",
    en: "FitMesh Sync mirrors your smartwatch data to a premium dashboard that's all yours. Privacy-first, one-time from €3.99, no opaque clouds.",
    es: "FitMesh Sync sincroniza los datos de tu smartwatch en un panel premium que es solo tuyo. Privacidad total, pago único desde €3,99, sin nubes opacas.",
    de: "FitMesh Sync überträgt deine Smartwatch-Daten auf ein Premium-Dashboard, das nur dir gehört. Datenschutz zuerst, Einmalkauf ab €3,99, keine intransparente Cloud.",
    pt: "FitMesh Sync sincroniza os dados do seu smartwatch em um painel premium que é só seu. Privacidade total, compra única a partir de €3,99, sem nuvens opacas.",
    fr: "FitMesh Sync synchronise les données de votre montre connectée vers un tableau de bord premium qui vous appartient. Confidentialité totale, achat unique à partir de €3,99, sans nuage opaque.",
    pl: "FitMesh Sync synchronizuje dane z Twojego smartwatcha na Twoim własnym, premium panelu. Prywatność na pierwszym miejscu, jednorazowy zakup od €3,99, żadnych nieprzejrzystych chmur.",
    tr: "FitMesh Sync, akıllı saatinizin verilerini yalnızca size ait premium bir panele senkronize eder. Gizlilik öncelikli, €3,99'dan itibaren tek seferlik satın alma, opak bulut sistemleri yok.",
    nl: "FitMesh Sync synchroniseert de gegevens van je smartwatch naar een premium dashboard dat helemaal van jou is. Privacy-first, eenmalige aankoop vanaf €3,99, geen ondoorzichtige clouds.",
    ja: "FitMesh Syncはあなたのスマートウォッチのデータを、あなただけのプレミアムダッシュボードに同期します。プライバシー重視、買い切り€3.99から、不透明なクラウドはありません。",
    ko: "FitMesh Sync는 당신의 스마트워치 데이터를 오직 당신만의 프리미엄 대시보드로 동기화합니다. 프라이버시 우선, €3.99부터 일회성 구매, 불투명한 클라우드 없음.",
    sv: "FitMesh Sync synkar din smartklockas data till en premium-dashboard som är helt din egen. Integritet i fokus, engångsköp från €3,99, inga ogenomskinliga moln.",
    da: "FitMesh Sync synkroniserer dit smartwatchs data til et premium dashboard, der er helt dit eget. Privatliv i fokus, engangskøb fra €3,99, ingen uigennemsigtige skyer.",
    no: "FitMesh Sync synkroniserer smartklokkens data til et premium-dashbord som er helt ditt eget. Personvern i fokus, engangskjøp fra €3,99, ingen ugjennomsiktige skytjenester.",
    fi: "FitMesh Sync synkronoi älykellosi tiedot omalle premium-hallintapaneelillesi. Yksityisyys edellä, kertaostos alkaen €3,99, ei läpinäkymättömiä pilvipalveluita.",
  } satisfies Localized,
  ...
  heroDescription: {
    it: "FitMesh Sync riunisce in un'unica dashboard web premium i dati salute dei wearable Android (Galaxy Watch, Wear OS, Mi Band, e qualunque dispositivo che scriva su Health Connect) e, su iPhone, i dati di Apple Salute e degli anelli supportati via Bluetooth diretto. Nessun account social. Nessun tracker pubblicitario. Nessun cloud opaco che decide cosa fare dei tuoi dati.",
    en: "FitMesh Sync brings health data from Android wearables (Galaxy Watch, Wear OS, Mi Band, and any device that writes to Health Connect) and, on iPhone, from Apple Health and supported rings via direct Bluetooth, into one premium web dashboard. No social accounts. No ad trackers. No opaque cloud deciding what to do with your data.",
    es: "FitMesh Sync reúne en un único panel web premium los datos de salud de los wearables Android (Galaxy Watch, Wear OS, Mi Band y cualquier dispositivo que escriba en Health Connect) y, en iPhone, los datos de Apple Salud y de los anillos compatibles vía Bluetooth directo. Sin cuentas sociales. Sin rastreadores publicitarios. Sin nubes opacas que decidan qué hacer con tus datos.",
    de: "FitMesh Sync bringt Gesundheitsdaten von Android-Wearables (Galaxy Watch, Wear OS, Mi Band und alle Geräte, die Daten in Health Connect schreiben) und, auf dem iPhone, von Apple Health und unterstützten Ringen per direkter Bluetooth-Verbindung in ein Premium-Web-Dashboard. Keine Social-Konten. Keine Werbe-Tracker. Keine intransparente Cloud, die entscheidet, was mit deinen Daten passiert.",
    pt: "FitMesh Sync reúne em um único painel web premium os dados de saúde dos wearables Android (Galaxy Watch, Wear OS, Mi Band e qualquer dispositivo que grave dados no Health Connect) e, no iPhone, os dados do Apple Saúde e dos anéis compatíveis via Bluetooth direto. Sem contas sociais. Sem rastreadores de anúncios. Sem nuvens opacas decidindo o que fazer com seus dados.",
    fr: "FitMesh Sync réunit dans un seul tableau de bord web premium les données de santé des wearables Android (Galaxy Watch, Wear OS, Mi Band et tout appareil écrivant dans Health Connect) et, sur iPhone, les données d'Apple Santé et des bagues compatibles via Bluetooth direct. Aucun compte social. Aucun traceur publicitaire. Aucun nuage opaque décidant de l'utilisation de vos données.",
    pl: "FitMesh Sync gromadzi w jednym premium panelu internetowym dane zdrowotne z wearables na Androidzie (Galaxy Watch, Wear OS, Mi Band i dowolnego urządzenia zapisującego dane w Health Connect) oraz, na iPhonie, dane z Apple Zdrowie i obsługiwanych pierścieni przez bezpośrednie połączenie Bluetooth. Bez kont społecznościowych. Bez trackerów reklamowych. Bez nieprzejrzystej chmury decydującej, co zrobić z Twoimi danymi.",
    tr: "FitMesh Sync, Android giyilebilir cihazlardan (Galaxy Watch, Wear OS, Mi Band ve Health Connect'e veri yazan diğer her cihaz) ve iPhone'da Apple Sağlık ile desteklenen yüzüklerden doğrudan Bluetooth üzerinden gelen sağlık verilerini tek bir premium web panelinde birleştirir. Sosyal hesap yok. Reklam izleyicileri yok. Verilerinizle ne yapılacağına karar veren opak bir bulut sistemi yok.",
    nl: "FitMesh Sync brengt gezondheidsgegevens van Android-wearables (Galaxy Watch, Wear OS, Mi Band en elk apparaat dat naar Health Connect schrijft) en, op iPhone, van Apple Gezondheid en ondersteunde ringen via directe Bluetooth samen in één premium webdashboard. Geen social accounts. Geen advertentietrackers. Geen ondoorzichtige cloud die bepaalt wat er met jouw gegevens gebeurt.",
    ja: "FitMesh Syncは、Androidウェアラブル（Galaxy Watch、Wear OS、Mi Band、Health Connectに対応するあらゆるデバイス）の健康データと、iPhoneではApple ヘルスケアおよび対応するリングからBluetooth直接接続で得られるデータを、ひとつのプレミアムWebダッシュボードにまとめます。ソーシャルアカウント連携は不要。広告トラッカーもありません。あなたのデータの扱いを勝手に決める不透明なクラウドも存在しません。",
    ko: "FitMesh Sync는 Android 웨어러블(Galaxy Watch, Wear OS, Mi Band, Health Connect에 데이터를 기록하는 모든 기기)의 건강 데이터와, iPhone에서는 Apple 건강 및 지원되는 반지의 데이터를 Bluetooth 직접 연결로 가져와 하나의 프리미엄 웹 대시보드에 모아줍니다. 소셜 계정 없음. 광고 트래커 없음. 당신의 데이터를 마음대로 처리하는 불투명한 클라우드도 없음.",
    sv: "FitMesh Sync samlar hälsodata från Android-wearables (Galaxy Watch, Wear OS, Mi Band och alla enheter som skriver till Health Connect) och, på iPhone, från Apple Hälsa och kompatibla ringar via direkt Bluetooth, i en premium webbdashboard. Inga sociala konton. Inga annonsspårare. Inget ogenomskinligt moln som bestämmer vad som händer med din data.",
    da: "FitMesh Sync samler sundhedsdata fra Android-wearables (Galaxy Watch, Wear OS, Mi Band og enhver enhed, der skriver til Health Connect) og, på iPhone, fra Apple Sundhed og understøttede ringe via direkte Bluetooth, i ét premium webdashboard. Ingen sociale konti. Ingen annoncetrackere. Ingen uigennemsigtig cloud-tjeneste, der bestemmer, hvad der skal ske med dine data.",
    no: "FitMesh Sync samler helsedata fra Android-wearables (Galaxy Watch, Wear OS, Mi Band og alle enheter som skriver til Health Connect) og, på iPhone, fra Apple Helse og støttede ringer via direkte Bluetooth, i ett premium webdashbord. Ingen sosiale kontoer. Ingen annonsesporere. Ingen ugjennomsiktig sky som bestemmer hva som skjer med dataene dine.",
    fi: "FitMesh Sync kokoaa terveystiedot Android-puettavista laitteista (Galaxy Watch, Wear OS, Mi Band ja mikä tahansa laite, joka kirjoittaa Health Connectiin) ja, iPhonessa, Apple Terveydestä ja tuetuista sormuksista suoran Bluetooth-yhteyden kautta, yhteen premium-verkkohallintapaneeliin. Ei sosiaalisia tilejä. Ei mainosseurantaa. Ei läpinäkymätöntä pilvipalvelua päättämässä, mitä tiedoillesi tehdään.",
  } satisfies Localized,
  ...
  serverChoice: {
    it: "I dati vengono inviati al server che configuri tu: il nostro endpoint condiviso (default), una tua VPS, un NAS di casa o qualsiasi server FitMesh che può girare in self-hosting. Tu decidi dove vivono i tuoi dati di salute.",
    en: "Data is sent to the server you configure: our shared endpoint (default), your VPS, a home NAS, or any FitMesh-compatible server you self-host. You decide where your health data lives.",
    es: "Los datos se envían al servidor que tú configures: nuestro endpoint compartido (por defecto), tu VPS, un NAS doméstico o cualquier servidor compatible con FitMesh que puedas alojar tú mismo. Tú decides dónde viven tus datos de salud.",
    de: "Die Daten werden an den Server gesendet, den du konfigurierst: unseren gemeinsamen Endpunkt (Standard), deine eigene VPS, ein Heim-NAS oder jeden FitMesh-kompatiblen Server, den du selbst betreibst. Du entscheidest, wo deine Gesundheitsdaten gespeichert werden.",
    pt: "Os dados são enviados para o servidor que você configurar: nosso endpoint compartilhado (padrão), sua própria VPS, um NAS doméstico ou qualquer servidor compatível com FitMesh que você mesmo hospede. Você decide onde seus dados de saúde ficam armazenados.",
    fr: "Les données sont envoyées vers le serveur que vous configurez: notre point d'accès partagé (par défaut), votre propre VPS, un NAS domestique ou tout serveur compatible FitMesh que vous hébergez vous-même. Vous décidez où vivent vos données de santé.",
    pl: "Dane są wysyłane na serwer, który sam skonfigurujesz: nasz współdzielony endpoint (domyślnie), Twój VPS, domowy NAS lub dowolny kompatybilny z FitMesh serwer, który hostujesz samodzielnie. To Ty decydujesz, gdzie przechowywane są Twoje dane zdrowotne.",
    tr: "Veriler, yapılandırdığınız sunucuya gönderilir: paylaşımlı uç noktamız (varsayılan), kendi VPS'iniz, ev NAS'ınız veya kendi barındırdığınız FitMesh uyumlu herhangi bir sunucu. Sağlık verilerinizin nerede saklanacağına siz karar verirsiniz.",
    nl: "Gegevens worden verstuurd naar de server die jij instelt: ons gedeelde endpoint (standaard), je eigen VPS, een NAS thuis, of elke FitMesh-compatibele server die je zelf host. Jij bepaalt waar je gezondheidsgegevens staan.",
    ja: "データは、あなたが設定したサーバーに送信されます。共有エンドポイント(デフォルト)、あなたのVPS、自宅のNAS、あるいは自前でホストするFitMesh対応サーバーのいずれかです。健康データをどこに置くかは、あなた自身が決められます。",
    ko: "데이터는 당신이 설정한 서버로 전송됩니다: FitMesh 공용 엔드포인트(기본값), 개인 VPS, 홈 NAS, 또는 직접 운영하는 FitMesh 호환 서버까지 무엇이든 가능합니다. 당신의 건강 데이터가 어디에 저장될지는 당신이 결정합니다.",
    sv: "Data skickas till den server du konfigurerar: vår delade endpoint (standard), din egen VPS, en hemma-NAS eller valfri FitMesh-kompatibel server som du själv driftar. Du bestämmer var din hälsodata finns.",
    da: "Data sendes til den server, du konfigurerer: vores fælles endpoint (standard), din VPS, et NAS derhjemme, eller en hvilken som helst FitMesh-kompatibel server, du selv hoster. Du bestemmer, hvor dine sundhedsdata ligger.",
    no: "Dataene sendes til serveren du velger: vårt delte endepunkt (standard), din egen VPS, en NAS hjemme eller en hvilken som helst FitMesh-kompatibel server du drifter selv. Du bestemmer hvor helsedataene dine skal ligge.",
    fi: "Tiedot lähetetään palvelimelle, jonka itse määrität: jaettu oletuspalvelimemme, oma VPS, kotona oleva NAS tai mikä tahansa FitMesh-yhteensopiva palvelin, jota ylläpidät itse. Sinä päätät, missä terveystietosi sijaitsevat.",
  } satisfies Localized,
  ...
  privacyHeading: {
    it: "Privacy: nessun compromesso", en: "Privacy: no compromise", es: "Privacidad: sin compromisos",
    de: "Datenschutz: ohne Kompromisse", pt: "Privacidade: sem concessões", fr: "Confidentialité: sans compromis",
    pl: "Prywatność: bez kompromisów", tr: "Gizlilik: taviz yok", nl: "Privacy: geen compromissen",
    ja: "プライバシー:妥協なし", ko: "개인정보: 타협은 없습니다", sv: "Integritet: inga kompromisser",
    da: "Privatliv: ingen kompromisser", no: "Personvern: ingen kompromisser", fi: "Yksityisyys: ei kompromisseja",
  } satisfies Localized,

  privacyBody1: {
    it: "I tuoi dati di salute non sono un prodotto. FitMesh non vende, non condivide, non profila. Nessuna integrazione con Google Analytics, Meta SDK, o ad network. L'app stessa è verificata Google Play Data Safety: nessuna raccolta di dati personali identificativi (PII).",
    en: "Your health data is not a product. FitMesh does not sell, share, or profile. No Google Analytics, no Meta SDK, no ad networks. The app itself is verified via Google Play Data Safety: no personally identifiable information (PII) collected.",
    es: "Tus datos de salud no son un producto. FitMesh no vende, no comparte ni crea perfiles. Sin Google Analytics, sin Meta SDK, sin redes publicitarias. La app está verificada en Google Play Data Safety: no se recopila ningún dato personal identificable (PII).",
    de: "Deine Gesundheitsdaten sind kein Produkt. FitMesh verkauft, teilt und profiliert nicht. Kein Google Analytics, kein Meta SDK, keine Werbenetzwerke. Die App ist über Google Play Data Safety verifiziert: Es werden keine personenbezogenen Daten (PII) erfasst.",
    pt: "Seus dados de saúde não são um produto. FitMesh não vende, não compartilha e não cria perfis. Sem Google Analytics, sem Meta SDK, sem redes de publicidade. O app é verificado pelo Google Play Data Safety: nenhuma informação pessoal identificável (PII) é coletada.",
    fr: "Vos données de santé ne sont pas un produit. FitMesh ne vend pas, ne partage pas et ne profile pas. Pas de Google Analytics, pas de Meta SDK, pas de réseaux publicitaires. L'application est vérifiée via Google Play Data Safety: aucune information personnelle identifiable (PII) n'est collectée.",
    ...
    tr: "Sağlık verileriniz bir ürün değildir. FitMesh verilerinizi satmaz, paylaşmaz ve profillemez. Google Analytics yok, Meta SDK yok, reklam ağı yok. Uygulamanın kendisi Google Play Veri Güvenliği üzerinden doğrulanmıştır: kişisel olarak tanımlanabilir bilgi (PII) toplanmaz.",
    nl: "Jouw gezondheidsgegevens zijn geen product. FitMesh verkoopt ze niet, deelt ze niet en gebruikt ze niet voor profilering. Geen Google Analytics, geen Meta SDK, geen advertentienetwerken. De app zelf is geverifieerd via Google Play Data Safety: er wordt geen persoonlijk identificeerbare informatie (PII) verzameld.",
    ja: "あなたの健康データは商品ではありません。FitMeshはデータを販売せず、共有せず、プロファイリングもしません。Google Analyticsも、Meta SDKも、広告ネットワークも一切使用していません。アプリ自体もGoogle PlayのデータセーフティでPII(個人を特定できる情報)を収集していないことを検証済みです。",
    ko: "당신의 건강 데이터는 상품이 아닙니다. FitMesh는 데이터를 판매하거나 공유하거나 프로파일링하지 않습니다. Google Analytics도, Meta SDK도, 광고 네트워크도 없습니다. 앱 자체도 Google Play 데이터 보안 섹션을 통해 검증되었습니다: 개인 식별 정보(PII) 수집 없음.",
    sv: "Din hälsodata är ingen produkt. FitMesh säljer inte, delar inte och profilerar inte. Ingen Google Analytics, ingen Meta SDK, inga annonsnätverk. Appen är verifierad via Google Play Data Safety: ingen personligt identifierbar information (PII) samlas in.",
    da: "Dine sundhedsdata er ikke et produkt. FitMesh sælger, deler eller profilerer ikke dig. Ingen Google Analytics, intet Meta SDK, ingen annoncenetværk. Selve appen er verificeret via Google Play Data Safety: ingen personligt identificerbare oplysninger (PII) indsamles.",
    no: "Helsedataene dine er ikke et produkt. FitMesh selger dem ikke, deler dem ikke og profilerer dem ikke. Ingen Google Analytics, ingen Meta SDK, ingen annonsenettverk. Selve appen er verifisert gjennom Google Plays Data Safety-erklæring: ingen personlig identifiserbar informasjon (PII) samles inn.",
    fi: "Terveystietosi eivät ole tuote. FitMesh ei myy, jaa eikä profiloi niitä. Ei Google Analyticsia, ei Meta SDK:ta, ei mainosverkostoja. Sovellus on itse vahvistettu Google Playn Data Safety -osiossa: henkilötietoja (PII) ei kerätä.",
  } satisfies Localized,
  ...
  deleteAccountPrefix: {
    it: "Vuoi cancellare l'account? Una mail a ", en: "Want to delete your account? One email to ", es: "¿Quieres eliminar tu cuenta? Un correo a ",
    de: "Möchtest du dein Konto löschen? Eine E-Mail an ", pt: "Quer excluir sua conta? Um e-mail para ", fr: "Vous souhaitez supprimer votre compte? Un e-mail à ",
    pl: "Chcesz usunąć konto? Wystarczy e-mail na adres ", tr: "Hesabınızı silmek mi istiyorsunuz? Tek bir e-posta ile ", nl: "Wil je je account verwijderen? Eén e-mail naar ",
    ja: "アカウントを削除したい場合は、", ko: "계정을 삭제하고 싶으신가요? 이메일 한 통이면 충분합니다: ", sv: "Vill du ta bort ditt konto? Ett mejl till ",
    da: "Vil du slette din konto? Send en e-mail til ", no: "Vil du slette kontoen din? Én e-post til ", fi: "Haluatko poistaa tilisi? Yksi sähköposti osoitteeseen ",
  } satisfies Localized,

  deleteAccountSuffix: {
    it: " e in 7 giorni tutto è eliminato (anche i backup). Conformità GDPR completa: vedi ",
    en: " and within 7 days everything is gone (backups included). Full GDPR compliance: see ",
    es: " y en 7 días todo queda eliminado (incluidas las copias de seguridad). Cumplimiento total del RGPD: consulta la ",
    de: " und innerhalb von 7 Tagen ist alles gelöscht (einschließlich Backups). Vollständige DSGVO-Konformität: siehe ",
    pt: " e em 7 dias tudo será excluído (incluindo os backups). Conformidade total com o RGPD: consulte a ",
    fr: " et dans les 7 jours tout est supprimé (sauvegardes incluses). Conformité RGPD complète: consultez la ",
    pl: " a w ciągu 7 dni wszystko zniknie (łącznie z kopiami zapasowymi). Pełna zgodność z RODO: zobacz ",
    tr: " ve 7 gün içinde her şey silinir (yedekler dahil). Tam KVKK uyumluluğu: bkz. ",
    nl: " en binnen 7 dagen is alles verwijderd (back-ups inbegrepen). Volledig AVG-conform: zie ",
    ja: "宛てにメールを1通送るだけです。7日以内に、バックアップも含めてすべてのデータが削除されます。GDPRに完全準拠:詳しくは",
    ko: ". 7일 이내에 백업을 포함한 모든 데이터가 완전히 삭제됩니다. GDPR을 완벽히 준수합니다. 자세한 내용은 ",
    sv: " och inom 7 dagar är allt borta (inklusive säkerhetskopior). Fullständig efterlevnad av GDPR: se ",
    da: " så er alt væk inden for 7 dage (inklusive backups). Fuld overholdelse af GDPR: se ",
    no: " og innen 7 dager er alt borte (sikkerhetskopier inkludert). Fullt samsvar med GDPR (personvernforordningen): se ",
    fi: " ja 7 päivän kuluessa kaikki poistetaan (mukaan lukien varmuuskopiot). Täysi GDPR-yhteensopivuus: katso ",
  } satisfies Localized,
  ...
  familyBody: {
    ...
    pl: "Family Mesh pozwala stworzyć grupę z dowolnie wybranymi osobami (rodzicami, partnerem, dziećmi): każdy członek grupy dzieli się z pozostałymi krokami, snem i tętnem — wszystko w jednym panelu. Wyraźna zgodność z RODO: każdy członek grupy samodzielnie decyduje, czym się dzieli, i wyraża pisemną zgodę w aplikacji, zanim to zrobi.",
    tr: "Aile Mesh, istediğiniz kişilerle (ebeveynler, eş, çocuklar) bir grup oluşturmanızı sağlar: her üye adım sayısını, uykusunu ve kalp atış hızını diğerleriyle tek bir panelde paylaşır. Açık KVKK uyumluluğu: her grup üyesi neyi paylaşacağına bağımsız olarak karar verir ve bunu yapmadan önce uygulama içinde yazılı onay verir.",
    nl: "Met Family Mesh maak je een groep met wie je maar wilt (ouders, partner, kinderen): elk lid deelt stappen, slaap en hartslag met de anderen, in één dashboard. Expliciet AVG-conform: elk groepslid kiest zelf wat het deelt en geeft daarvoor vooraf schriftelijk toestemming in de app.",
    ja: "Family Meshを使えば、好きな相手(親、パートナー、子どもなど)とグループを作成できます。メンバー全員が、歩数・睡眠・心拍数を互いに共有し、ひとつのダッシュボードで確認できます。GDPRに明確に準拠:各メンバーは何を共有するかを個別に選択し、共有する前にアプリ内で書面による同意を行います。",
    ko: "Family Mesh를 이용하면 원하는 사람과 자유롭게 그룹을 만들 수 있습니다(부모님, 배우자, 자녀 등). 그룹의 모든 구성원은 걸음 수, 수면, 심박수를 하나의 대시보드에서 서로 공유합니다. GDPR을 명확히 준수합니다: 각 구성원은 무엇을 공유할지 개별적으로 선택하고, 공유하기 전에 앱 내에서 서면 동의를 제공합니다.",
    sv: "Med Family Mesh kan du skapa en grupp med vem du vill (föräldrar, partner, barn): varje medlem delar steg, sömn och puls med de andra, i en gemensam dashboard. Fullständig GDPR-efterlevnad: varje gruppmedlem väljer själv vad som ska delas och ger ett skriftligt samtycke i appen innan det sker.",
    da: "Med Family Mesh kan du oprette en gruppe med dem, du vil (forældre, partner, børn): alle medlemmer deler skridt, søvn og puls med hinanden i ét fælles dashboard. Fuld overholdelse af GDPR: hvert gruppemedlem vælger selv, hvad der skal deles, og giver skriftligt samtykke i appen, før det sker.",
    no: "Med Family Mesh kan du opprette en gruppe med hvem du vil (foreldre, partner, barn): alle medlemmer deler skritt, søvn og puls med de andre, i ett felles dashbord. Eksplisitt GDPR-etterlevelse: hvert gruppemedlem velger selv og uavhengig hva de vil dele, og gir skriftlig samtykke i appen før de gjør det.",
    fi: "Family Meshin avulla voit perustaa ryhmän kenen tahansa kanssa haluat (vanhemmat, puoliso, lapset): jokainen jäsen jakaa askeleensa, unensa ja sykkeensä muiden kanssa, samassa näkymässä. Nimenomainen GDPR-vaatimustenmukaisuus: jokainen ryhmän jäsen päättää itsenäisesti, mitä jakaa, ja antaa siihen kirjallisen suostumuksen sovelluksessa ennen jakamisen aloittamista.",
  } satisfies Localized,
