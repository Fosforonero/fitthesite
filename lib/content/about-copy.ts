...
export const ABOUT_COPY = {
  ...
  metaTitle: {
    ...
    ja: "FitMesh Syncとは: プライバシー重視のスマートウォッチデータ同期",
    ko: "FitMesh Sync란: 프라이버시 우선 스마트워치 데이터 동기화",
    sv: "Vad är FitMesh Sync: integritetsfokuserad synk av smartklockans data",
    da: "Hvad er FitMesh Sync: privatlivsvenlig synkronisering af smartwatch-data",
    no: "Hva er FitMesh Sync: personvernvennlig synkronisering av smartklokkedata",
    fi: "Mikä on FitMesh Sync: yksityisyyttä kunnioittava älykellon tietojen synkronointi",
  } satisfies Localized,
  ...
  metaDescription: {
    ...
    fr: "FitMesh Sync synchronise les données de votre montre connectée vers un tableau de bord premium dans l'application qui vous appartient. Confidentialité totale.",
    pl: "FitMesh Sync synchronizuje dane z Twojego smartwatcha na Twoim własnym, premium panelu w aplikacji. Prywatność na pierwszym miejscu.",
    tr: "FitMesh Sync, akıllı saatinizin verilerini uygulamadaki, yalnızca size ait premium bir panele senkronize eder. Gizlilik öncelikli.",
    nl: "FitMesh Sync synchroniseert de gegevens van je smartwatch naar een premium dashboard in de app dat helemaal van jou is. Privacy-first.",
    ja: "FitMesh Syncはあなたのスマートウォッチのデータを、アプリ内のあなただけのプレミアムダッシュボードに同期します。プライバシー重視。",
    ko: "FitMesh Sync는 당신의 스마트워치 데이터를 앱 안의 오직 당신만의 프리미엄 대시보드로 동기화합니다. 프라이버시 우선.",
    sv: "FitMesh Sync synkar din smartklockas data till en premium-dashboard i appen som är helt din egen. Integritet i fokus.",
    da: "FitMesh Sync synkroniserer dit smartwatchs data til et premium dashboard i appen, der er helt dit eget. Privatliv i fokus.",
    no: "FitMesh Sync synkroniserer smartklokkens data til et premium-dashbord i appen som er helt ditt eget. Personvern i fokus.",
    fi: "FitMesh Sync synkronoi älykellosi tiedot sovelluksen omalle premium-hallintapaneelillesi. Yksityisyys edellä.",
  } satisfies Localized,
  ...
  heroDescription: {
    ...
    fr: "FitMesh Sync réunit dans un seul tableau de bord premium dans l'application les données de santé des wearables Android (Galaxy Watch, Wear OS, Mi Band et tout appareil écrivant dans Health Connect) et, sur iPhone, les données d'Apple Santé et des bagues compatibles via Bluetooth direct. Aucun compte social. Aucun traceur publicitaire. Nous ne vendons jamais vos données à des tiers.",
    pl: "FitMesh Sync gromadzi w jednym premium panelu w aplikacji dane zdrowotne z wearables na Androidzie (Galaxy Watch, Wear OS, Mi Band i dowolnego urządzenia zapisującego dane w Health Connect) oraz, na iPhonie, dane z Apple Zdrowie i obsługiwanych pierścieni przez bezpośrednie połączenie Bluetooth. Bez kont społecznościowych. Bez trackerów reklamowych. Nigdy nie sprzedajemy Twoich danych stronom trzecim.",
    tr: "FitMesh Sync, Android giyilebilir cihazlardan (Galaxy Watch, Wear OS, Mi Band ve Health Connect'e veri yazan diğer her cihaz) ve iPhone'da Apple Sağlık ile desteklenen yüzüklerden doğrudan Bluetooth üzerinden gelen sağlık verilerini tek bir premium uygulama içi panelde birleştirir. Sosyal hesap yok. Reklam izleyicileri yok. Verilerinizi asla üçüncü taraflara satmayız.",
    nl: "FitMesh Sync brengt gezondheidsgegevens van Android-wearables (Galaxy Watch, Wear OS, Mi Band en elk apparaat dat naar Health Connect schrijft) en, op iPhone, van Apple Gezondheid en ondersteunde ringen via directe Bluetooth samen in één premium dashboard in de app. Geen social accounts. Geen advertentietrackers. We verkopen je gegevens nooit aan derden.",
    ja: "FitMesh Syncは、Androidウェアラブル（Galaxy Watch、Wear OS、Mi Band、Health Connectに対応するあらゆるデバイス）の健康データと、iPhoneではApple ヘルスケアおよび対応するリングからBluetooth直接接続で得られるデータを、ひとつのプレミアムアプリ内ダッシュボードにまとめます。ソーシャルアカウント連携は不要。広告トラッカーもありません。あなたのデータを第三者に販売することは一切ありません。",
    ko: "FitMesh Sync는 Android 웨어러블(Galaxy Watch, Wear OS, Mi Band, Health Connect에 데이터를 기록하는 모든 기기)의 건강 데이터와, iPhone에서는 Apple 건강 및 지원되는 반지의 데이터를 Bluetooth 직접 연결로 가져와 하나의 프리미엄 앱 내 대시보드에 모아줍니다. 소셜 계정 없음. 광고 트래커 없음. 당신의 데이터를 제3자에게 판매하지 않습니다.",
    sv: "FitMesh Sync samlar hälsodata från Android-wearables (Galaxy Watch, Wear OS, Mi Band och alla enheter som skriver till Health Connect) och, på iPhone, från Apple Hälsa och kompatibla ringar via direkt Bluetooth, i en premium-dashboard i appen. Inga sociala konton. Inga annonsspårare. Vi säljer aldrig din data till tredje part.",
    da: "FitMesh Sync samler sundhedsdata fra Android-wearables (Galaxy Watch, Wear OS, Mi Band og enhver enhed, der skriver til Health Connect) og, på iPhone, fra Apple Sundhed og understøttede ringe via direkte Bluetooth, i ét premium dashboard i appen. Ingen sociale konti. Ingen annoncetrackere. Vi sælger aldrig dine data til tredjepart.",
    no: "FitMesh Sync samler helsedata fra Android-wearables (Galaxy Watch, Wear OS, Mi Band og alle enheter som skriver til Health Connect) og, på iPhone, fra Apple Helse og støttede ringer via direkte Bluetooth, i ett premium dashbord i appen. Ingen sosiale kontoer. Ingen annonsesporere. Vi selger aldri dataene dine til tredjeparter.",
    fi: "FitMesh Sync kokoaa terveystiedot Android-puettavista laitteista (Galaxy Watch, Wear OS, Mi Band ja mikä tahansa laite, joka kirjoittaa Health Connectiin) ja, iPhonessa, Apple Terveydestä ja tuetuista sormuksista suoran Bluetooth-yhteyden kautta, yhteen premium-hallintapaneeliin sovelluksessa. Ei sosiaalisia tilejä. Ei mainosseurantaa. Emme koskaan myy tietojasi kolmansille osapuolille.",
  } satisfies Localized,
  ...
  teamBody1: {
    ...
    fr: "FitMesh Sync est un projet indépendant développé par Matteo Pizzi, développeur de logiciels italien. Il est né pour combler le \"chaînon manquant\" entre la montre connectée et le tableau de bord personnel de l'application: de nombreuses applications collectent des données de santé, mais très peu vous les restituent de manière vraiment lisible et qui vous appartient.",
    pl: "FitMesh Sync to niezależny projekt stworzony przez Matteo Pizziego, włoskiego programistę. Powstał, by wypełnić „brakującą warstwę” między smartwatchem a osobistym panelem w aplikacji: wiele aplikacji zbiera dane zdrowotne, ale bardzo niewiele oddaje je z powrotem w sposób naprawdę czytelny i naprawdę Twój.",
    tr: "FitMesh Sync, İtalyan bir yazılım geliştiricisi olan Matteo Pizzi tarafından geliştirilen bağımsız bir projedir. Akıllı saat ile uygulamadaki kişisel panel arasındaki \"eksik katmanı\" doldurmak için başladı: birçok uygulama sağlık verisi topluyor, ama çok azı bu verileri gerçekten okunabilir ve size ait bir biçimde geri veriyor.",
    nl: "FitMesh Sync is een onafhankelijk project, gebouwd door Matteo Pizzi, een Italiaanse softwareontwikkelaar. Het ontstond om de \"ontbrekende laag\" tussen smartwatch en persoonlijk dashboard in de app in te vullen: veel apps verzamelen gezondheidsgegevens, maar maar weinige geven ze op een écht leesbare en eigen manier aan jou terug.",
    ja: "FitMesh Syncは、イタリア人ソフトウェア開発者のMatteo Pizziによる個人プロジェクトです。スマートウォッチとアプリの個人用ダッシュボードの間にある「欠けている層」を埋めるために始まりました。多くのアプリが健康データを収集しますが、それを本当に読みやすく、自分のものとして返してくれるアプリはほとんどありません。",
    ko: "FitMesh Sync는 이탈리아 소프트웨어 개발자 Matteo Pizzi가 만든 독립 프로젝트입니다. 스마트워치와 앱의 개인 대시보드 사이에 존재하는 '빠진 연결 고리'를 채우기 위해 시작되었습니다. 많은 앱이 건강 데이터를 수집하지만, 그것을 정말로 읽기 쉽고 온전히 당신의 것이 되는 형태로 돌려주는 앱은 거의 없습니다.",
    sv: "FitMesh Sync är ett fristående projekt byggt av Matteo Pizzi, en italiensk mjukvaruutvecklare. Det startade för att fylla det \"saknade lagret\" mellan smartklocka och personlig dashboard i appen: många appar samlar in hälsodata, men väldigt få lämnar tillbaka den till dig på ett sätt som verkligen är läsbart och ditt eget.",
    da: "FitMesh Sync er et uafhængigt projekt udviklet af Matteo Pizzi, en italiensk softwareudvikler. Det opstod for at udfylde det \"manglende lag\" mellem smartwatch og personligt dashboard i appen: mange apps indsamler sundhedsdata, men meget få giver dem tilbage til dig på en måde, der virkelig er læsbar og din egen.",
    no: "FitMesh Sync er et uavhengig prosjekt bygget av Matteo Pizzi, en italiensk programvareutvikler. Det startet for å fylle det «manglende laget» mellom smartklokke og personlig dashbord i appen: mange apper samler inn helsedata, men svært få gir dem tilbake til deg på en måte som er virkelig lesbar og din egen.",
    fi: "FitMesh Sync on itsenäinen projekti, jonka on rakentanut italialainen ohjelmistokehittäjä Matteo Pizzi. Se sai alkunsa täyttämään \"puuttuvan kerroksen\" älykellon ja sovelluksen henkilökohtaisen dashboardin välillä: monet sovellukset keräävät terveystietoja, mutta hyvin harvat antavat niitä takaisin sinulle tavalla, joka on aidosti luettava ja omasi.",
  } satisfies Localized,
