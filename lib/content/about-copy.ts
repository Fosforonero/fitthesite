...
export const ABOUT_COPY = {
  ...
  deleteAccountSuffix: {
    it: ": la cancellazione è automatica entro 24 ore, backup inclusi. Conformità GDPR completa: vedi ",
    en: ": deletion is automatic within 24 hours, backups included. Full GDPR compliance: see ",
    es: ": la eliminación es automática en un plazo de 24 horas, incluidas las copias de seguridad. Cumplimiento total del RGPD: consulta la ",
    de: ": die Löschung erfolgt automatisch innerhalb von 24 Stunden, einschließlich Backups. Vollständige DSGVO-Konformität: siehe ",
    pt: ": a exclusão é automática em até 24 horas, incluindo os backups. Conformidade total com o RGPD: consulte a ",
    fr: " : la suppression est automatique sous 24 heures, sauvegardes incluses. Conformité RGPD complète: consultez la ",
    pl: ": usunięcie następuje automatycznie w ciągu 24 godzin, łącznie z kopiami zapasowymi. Pełna zgodność z RODO: zobacz ",
    tr: ": silme işlemi yedekler dahil 24 saat içinde otomatik olarak gerçekleşir. Tam KVKK uyumluluğu: bkz. ",
    nl: ": verwijdering gebeurt automatisch binnen 24 uur, back-ups inbegrepen. Volledig AVG-conform: zie ",
    ja: "。バックアップも含め、24時間以内に自動的に削除されます。GDPRに完全準拠:詳しくは",
    ko: ". 백업을 포함한 모든 데이터가 24시간 이내에 자동으로 삭제됩니다. GDPR을 완벽히 준수합니다. 자세한 내용은 ",
    sv: ": raderingen sker automatiskt inom 24 timmar, inklusive säkerhetskopior. Fullständig efterlevnad av GDPR: se ",
    da: ": sletningen sker automatisk inden for 24 timer, inklusive backups. Fuld overholdelse af GDPR: se ",
    no: ": slettingen skjer automatisk innen 24 timer, sikkerhetskopier inkludert. Fullt samsvar med GDPR (personvernforordningen): se ",
    fi: ": poisto tapahtuu automaattisesti 24 tunnin kuluessa, mukaan lukien varmuuskopiot. Täysi GDPR-yhteensopivuus: katso ",
  } satisfies Localized,
