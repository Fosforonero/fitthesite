...
export const ABOUT_COPY = {
  ...
  metaDescription: {
    it: "FitMesh Sync sincronizza i dati del tuo smartwatch su una dashboard premium tutta tua. Privacy-first, acquisto unico da €3,99, server UE.",
    en: "FitMesh Sync mirrors your smartwatch data to a premium dashboard that's all yours. Privacy-first, one-time from €3.99, EU servers.",
    es: "FitMesh Sync sincroniza los datos de tu smartwatch en un panel premium que es solo tuyo. Privacidad total, pago único desde €3,99, servidores UE.",
    de: "FitMesh Sync überträgt deine Smartwatch-Daten auf ein Premium-Dashboard, das nur dir gehört. Datenschutz zuerst, Einmalkauf ab €3,99, EU-Server.",
    pt: "FitMesh Sync sincroniza os dados do seu smartwatch em um painel premium que é só seu. Privacidade total, compra única a partir de €3,99, servidores UE.",
    fr: "FitMesh Sync synchronise les données de votre montre connectée vers un tableau de bord premium qui vous appartient. Confidentialité totale, achat unique à partir de €3,99, serveurs UE.",
    pl: "FitMesh Sync synchronizuje dane z Twojego smartwatcha na Twoim własnym, premium panelu. Prywatność na pierwszym miejscu, jednorazowy zakup od €3,99, serwery UE.",
    tr: "FitMesh Sync, akıllı saatinizin verilerini yalnızca size ait premium bir panele senkronize eder. Gizlilik öncelikli, €3,99'dan itibaren tek seferlik satın alma, AB sunucuları.",
    nl: "FitMesh Sync synchroniseert de gegevens van je smartwatch naar een premium dashboard dat helemaal van jou is. Privacy-first, eenmalige aankoop vanaf €3,99, EU-servers.",
    ja: "FitMesh Syncはあなたのスマートウォッチのデータを、あなただけのプレミアムダッシュボードに同期します。プライバシー重視、買い切り€3.99から、EUサーバー。",
    ko: "FitMesh Sync는 당신의 스마트워치 데이터를 오직 당신만의 프리미엄 대시보드로 동기화합니다. 프라이버시 우선, €3.99부터 일회성 구매, EU 서버.",
    sv: "FitMesh Sync synkar din smartklockas data till en premium-dashboard som är helt din egen. Integritet i fokus, engångsköp från €3,99, EU-servrar.",
    da: "FitMesh Sync synkroniserer dit smartwatchs data til et premium dashboard, der er helt dit eget. Privatliv i fokus, engangskøb fra €3,99, EU-servere.",
    no: "FitMesh Sync synkroniserer smartklokkens data til et premium-dashbord som er helt ditt eget. Personvern i fokus, engangskjøp fra €3,99, EU-servere.",
    fi: "FitMesh Sync synkronoi älykellosi tiedot omalle premium-hallintapaneelillesi. Yksityisyys edellä, kertaostos alkaen €3,99, EU-palvelimet.",
  } satisfies Localized,
