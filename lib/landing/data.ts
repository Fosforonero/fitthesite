...
const LANDING_PAGES_RAW: LandingPage[] = [
  ...
  // ── 4. Health Sync Alternative ────────────────────────────────────────
  {
    slug: "health-sync-alternative",
    publishedAt: "2026-05-21",
    updatedAt: "2026-05-21",
    primaryKeyword: {
      it: "alternativa health sync",
      en: "health sync alternative",
    },
    secondaryKeywords: {
      it: ["app come health sync", "ponte dati salute", "sync wearable android"],
      en: ["apps like health sync", "health data bridge", "android wearable sync"],
    },
    metaDescription: {
      it: "Cerchi un'alternativa a Health Sync nel 2026? FitMesh Sync legge da Health Connect e mostra tutto su dashboard web pulita. One-time payment, no ads, no tracker.",
      en: "Looking for a Health Sync alternative in 2026? FitMesh Sync reads from Health Connect and shows everything on a clean web dashboard. One-time payment, no ads, no trackers.",
    },
    hero: {
      kicker: { it: "Alternativa Health Sync", en: "Health Sync alternative" },
      title: {
        it: "Cerchi un'alternativa a Health Sync? Ecco la nostra proposta",
        en: "Looking for a Health Sync alternative? Here's our take",
      },
      subtitle: {
        it: "Health Sync è solido per cloud-to-cloud sync. Se invece vuoi una dashboard unificata che legga via Health Connect e ti mostri tutto in un posto, prova FitMesh Sync.",
        en: "Health Sync is solid for cloud-to-cloud syncs. If instead you want a unified dashboard reading via Health Connect and showing everything in one place, try FitMesh Sync.",
      },
      primaryCta: {
        label: { it: "Entra in beta gratis", en: "Join the free beta" },
        href: { it: "/it/beta", en: "/en/beta" },
      ...
      secondaryCta: {
        label: { it: "Leggi il confronto completo", en: "Read the full comparison" },
        href: {
          it: "/it/blog/alternative-health-sync-2026",
          en: "/en/blog/alternative-health-sync-2026",
        },
      },
    },
    body: [
      {
        type: "paragraph",
        text: {
          it: "Health Sync è un'app eccellente nella sua nicchia: sync background tra cloud diversi su Android, quando i tipi di dati non passano via Health Connect. Per gli utenti che vogliono altro — soprattutto una dashboard unificata cross-source con visualizzazione web — FitMesh Sync risolve un caso diverso.",
          en: "Health Sync is an excellent app in its niche: background sync between different clouds on Android, when data types don't pass through Health Connect. For users wanting something else — especially a unified cross-source dashboard with web visualization — FitMesh Sync solves a different case.",
        },
      },
      {
        type: "heading",
        level: 2,
        text: { it: "Quando scegliere FitMesh Sync", en: "When to pick FitMesh Sync" },
      },
      {
        type: "list",
        items: {
          it: [
            "Hai un Galaxy Watch, Pixel Watch, Fitbit, Mi Band, Polar, Garmin e vuoi una dashboard web pulita.",
            "Vuoi vedere i dati cross-source (es. Garmin per allenamenti + Oura per il sonno) in un posto unico.",
            "Vuoi privacy strutturale: dati on-device via Health Connect, archivio su backend EU (Frankfurt), no ad-tech.",
            "Preferisci pricing one-shot (no subscription).",
          ],
          en: [
            "You have a Galaxy Watch, Pixel Watch, Fitbit, Mi Band, Polar, Garmin and want a clean web dashboard.",
            "You want cross-source data view (e.g. Garmin for workouts + Oura for sleep) in a single place.",
            "You want structural privacy: on-device data via Health Connect, archive on EU backend (Frankfurt), no ad-tech.",
            "You prefer one-shot pricing (no subscription).",
          ],
        },
      },
      {
        type: "heading",
        level: 2,
        text: { it: "Quando preferire Health Sync", en: "When to prefer Health Sync" },
      },
      {
        type: "list",
        items: {
          it: [
            "Vuoi sync background tra due app specifiche (es. Withings → Garmin Connect, MyFitnessPal → Samsung Health) e il path Health Connect non basta.",
            "Ti serve cloud-to-cloud OAuth sync.",
            "Non hai bisogno di una dashboard ma di un motore di replication.",
          ],
          en: [
            "You want background sync between two specific apps (e.g. Withings → Garmin Connect, MyFitnessPal → Samsung Health) and the Health Connect path doesn't suffice.",
            "You need cloud-to-cloud OAuth sync.",
            "You don't need a dashboard but a replication engine.",
          ],
        },
      },
      {
        type: "callout",
        variant: "info",
        title: { it: "Non sono concorrenti", en: "Not competitors" },
        body: {
          it: "Health Sync e FitMesh Sync risolvono problemi diversi. Spesso ha senso usarli insieme: Health Sync per replicare dati che non passano via HC, FitMesh per la dashboard. Entrambi possono coesistere sullo stesso telefono senza conflitti.",
          en: "Health Sync and FitMesh Sync solve different problems. Often makes sense to use them together: Health Sync to replicate data not flowing via HC, FitMesh for the dashboard. Both can coexist on the same phone without conflicts.",
        },
      },
      {
        type: "cta",
        title: {
          it: "Prova FitMesh Sync gratis in beta",
          en: "Try FitMesh Sync free in beta",
        },
        body: {
          it: "100 posti founder gratuiti. Setup di 30 secondi via Health Connect.",
          en: "100 free founder seats. 30-second setup via Health Connect.",
        },
        ctaLabel: { it: "Entra in beta →", en: "Join beta →" },
        ctaHref: { it: "/it/beta", en: "/en/beta" },
      },
    ...
    faq: [
      {
        q: {
          it: "FitMesh fa sync background come Health Sync?",
          en: "Does FitMesh do background sync like Health Sync?",
        },
        a: {
          it: "Solo nella direzione Health Connect → dashboard FitMesh, non tra due app terze. Per scenari come 'replica dati Withings su Garmin Connect' resta Health Sync la scelta giusta.",
          en: "Only in the direction Health Connect → FitMesh dashboard, not between two third-party apps. For scenarios like 'replicate Withings data to Garmin Connect' Health Sync remains the right choice.",
        },
      },
      {
        q: {
          it: "Le due app possono confliggere?",
          en: "Can the two apps conflict?",
        },
        a: {
          it: "No. Funzionano su livelli diversi (Health Sync scrive su app terze, FitMesh legge da Health Connect). Possono convivere senza problemi sullo stesso telefono.",
          en: "No. They operate at different levels (Health Sync writes to third-party apps, FitMesh reads from Health Connect). They can coexist on the same phone without issues.",
        },
      },
      {
        q: {
          it: "FitMesh Sync è gratis?",
          en: "Is FitMesh Sync free?",
        },
        a: {
          it: "Durante la beta sì, per i primi 100 founder. Modello finale: acquisto una tantum, no subscription, no ads.",
          en: "During beta yes, for the first 100 founders. Final model: one-time purchase, no subscription, no ads.",
        },
      },
    ],
    brandsMentioned: ["Samsung", "Garmin", "Withings", "Fitbit", "Oura", "Polar", "Xiaomi"],
  },
];
