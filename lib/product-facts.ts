...
export const APP_DESCRIPTIONS_ANDROID: Record<Locale, string> = {
  it: "Sincronizza Galaxy Watch e Wear OS con una dashboard premium: passi, battito, sonno, calorie.",
  en: "Mirror Galaxy Watch and Wear OS data to a premium personal dashboard: steps, heart rate, sleep, calories.",
  es: "Sincroniza Galaxy Watch y Wear OS con un panel premium: pasos, frecuencia cardíaca, sueño, calorías.",
  de: "Synchronisiert Galaxy Watch und Wear OS mit einem Premium-Dashboard: Schritte, Herzfrequenz, Schlaf, Kalorien.",
  pt: "Sincroniza Galaxy Watch e Wear OS com um painel premium: passos, frequência cardíaca, sono, calorias.",
  fr: "Synchronise Galaxy Watch et Wear OS avec un tableau de bord premium : pas, fréquence cardiaque, sommeil, calories.",
  pl: "Synchronizuje Galaxy Watch i Wear OS z panelem premium: kroki, tętno, sen, kalorie.",
  tr: "Galaxy Watch ve Wear OS verilerini premium bir kişisel panele yansıtır: adımlar, kalp atışı, uyku, kalori.",
  nl: "Spiegelt Galaxy Watch en Wear OS data naar een premium persoonlijk dashboard: stappen, hartslag, slaap, calorieën.",
  ...
  sv: "Speglar data från Galaxy Watch och Wear OS till en premium personlig dashboard: steg, puls, sömn, kalorier.",
  da: "Spejler data fra Galaxy Watch og Wear OS til et premium personligt dashboard: skridt, puls, søvn, kalorier.",
  no: "Speiler data fra Galaxy Watch og Wear OS til et premium personlig dashbord: skritt, puls, søvn, kalorier.",
  fi: "Peilaa Galaxy Watchin ja Wear OS:n tiedot premium-koontinäyttöön: askeleet, syke, uni, kalorit.",
};

export const APP_DESCRIPTIONS_IOS: Record<Locale, string> = {
  it: "Sincronizza Apple Salute e il Colmi Ring con una dashboard premium: passi, battito, sonno, calorie.",
  en: "Mirror Apple Health and Colmi Ring data to a premium personal dashboard: steps, heart rate, sleep, calories.",
  es: "Sincroniza Apple Salud y el anillo Colmi con un panel premium: pasos, frecuencia cardíaca, sueño, calorías.",
  de: "Synchronisiert Apple Health und den Colmi Ring mit einem Premium-Dashboard: Schritte, Herzfrequenz, Schlaf, Kalorien.",
  pt: "Sincroniza o Apple Saúde e o anel Colmi com um painel premium: passos, frequência cardíaca, sono, calorias.",
  fr: "Synchronise Apple Santé et la bague Colmi avec un tableau de bord premium : pas, fréquence cardiaque, sommeil, calories.",
  pl: "Synchronizuje Apple Zdrowie i pierścień Colmi z panelem premium: kroki, tętno, sen, kalorie.",
  tr: "Apple Sağlık ve Colmi Ring verilerini premium bir kişisel panele yansıtır: adımlar, kalp atışı, uyku, kalori.",
  nl: "Spiegelt Apple Gezondheid en Colmi Ring-data naar een premium persoonlijk dashboard: stappen, hartslag, slaap, calorieën.",
  ...
  sv: "Speglar data från Apple Hälsa och Colmi Ring till en premium personlig dashboard: steg, puls, sömn, kalorier.",
  da: "Spejler data fra Apple Sundhed og Colmi Ring til et premium personligt dashboard: skridt, puls, søvn, kalorier.",
  no: "Speiler data fra Apple Helse og Colmi Ring til et premium personlig dashbord: skritt, puls, søvn, kalorier.",
  fi: "Peilaa Apple Terveys- ja Colmi Ring -tiedot premium-koontinäyttöön: askeleet, syke, uni, kalorit.",
};
