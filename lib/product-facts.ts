...
export const APP_DESCRIPTIONS_ANDROID: Record<Locale, string> = {
  it: "Sincronizza Galaxy Watch e Wear OS con una dashboard premium: passi, battito, sonno, calorie. Server UE.",
  en: "Mirror Galaxy Watch and Wear OS data to a premium personal dashboard: steps, heart rate, sleep, calories. EU servers.",
  es: "Sincroniza Galaxy Watch y Wear OS con un panel premium: pasos, frecuencia cardíaca, sueño, calorías. Servidores UE.",
  de: "Synchronisiert Galaxy Watch und Wear OS mit einem Premium-Dashboard: Schritte, Herzfrequenz, Schlaf, Kalorien. EU-Server.",
  pt: "Sincroniza Galaxy Watch e Wear OS com um painel premium: passos, frequência cardíaca, sono, calorias. Servidores UE.",
  fr: "Synchronise Galaxy Watch et Wear OS avec un tableau de bord premium : pas, fréquence cardiaque, sommeil, calories. Serveurs UE.",
  pl: "Synchronizuje Galaxy Watch i Wear OS z panelem premium: kroki, tętno, sen, kalorie. Serwery UE.",
  tr: "Galaxy Watch ve Wear OS verilerini premium bir kişisel panele yansıtır: adımlar, kalp atışı, uyku, kalori. AB sunucuları.",
  nl: "Spiegelt Galaxy Watch en Wear OS data naar een premium persoonlijk dashboard: stappen, hartslag, slaap, calorieën. EU-servers.",
  ...
  sv: "Speglar data från Galaxy Watch och Wear OS till en premium personlig dashboard: steg, puls, sömn, kalorier. EU-servrar.",
  da: "Spejler data fra Galaxy Watch og Wear OS til et premium personligt dashboard: skridt, puls, søvn, kalorier. EU-servere.",
  no: "Speiler data fra Galaxy Watch og Wear OS til et premium personlig dashbord: skritt, puls, søvn, kalorier. EU-servere.",
  fi: "Peilaa Galaxy Watchin ja Wear OS:n tiedot premium-koontinäyttöön: askeleet, syke, uni, kalorit. EU-palvelimet.",
};

export const APP_DESCRIPTIONS_IOS: Record<Locale, string> = {
  it: "Sincronizza Apple Salute e il Colmi Ring con una dashboard premium: passi, battito, sonno, calorie. Server UE.",
  en: "Mirror Apple Health and Colmi Ring data to a premium personal dashboard: steps, heart rate, sleep, calories. EU servers.",
  es: "Sincroniza Apple Salud y el anillo Colmi con un panel premium: pasos, frecuencia cardíaca, sueño, calorías. Servidores UE.",
  de: "Synchronisiert Apple Health und den Colmi Ring mit einem Premium-Dashboard: Schritte, Herzfrequenz, Schlaf, Kalorien. EU-Server.",
  pt: "Sincroniza o Apple Saúde e o anel Colmi com um painel premium: passos, frequência cardíaca, sono, calorias. Servidores UE.",
  fr: "Synchronise Apple Santé et la bague Colmi avec un tableau de bord premium : pas, fréquence cardiaque, sommeil, calories. Serveurs UE.",
  pl: "Synchronizuje Apple Zdrowie i pierścień Colmi z panelem premium: kroki, tętno, sen, kalorie. Serwery UE.",
  tr: "Apple Sağlık ve Colmi Ring verilerini premium bir kişisel panele yansıtır: adımlar, kalp atışı, uyku, kalori. AB sunucuları.",
  nl: "Spiegelt Apple Gezondheid en Colmi Ring-data naar een premium persoonlijk dashboard: stappen, hartslag, slaap, calorieën. EU-servers.",
  ...
  sv: "Speglar data från Apple Hälsa och Colmi Ring till en premium personlig dashboard: steg, puls, sömn, kalorier. EU-servrar.",
  da: "Spejler data fra Apple Sundhed og Colmi Ring til et premium personligt dashboard: skridt, puls, søvn, kalorier. EU-servere.",
  no: "Speiler data fra Apple Helse og Colmi Ring til et premium personlig dashbord: skritt, puls, søvn, kalorier. EU-servere.",
  fi: "Peilaa Apple Terveys- ja Colmi Ring -tiedot premium-koontinäyttöön: askeleet, syke, uni, kalorit. EU-palvelimet.",
};
...
export const APP_FEATURE_LIST_ANDROID: Record<Locale, string[]> = {
  it: [
    ...
    "Privacy-first: server EU, GDPR, zero tracker pubblicitari",
  ...
  en: [
    ...
    "Privacy-first: EU servers, GDPR, no ad trackers",
  ...
  es: [
    ...
    "Privacidad ante todo: servidores UE, RGPD, sin rastreadores publicitarios",
  ...
  de: [
    ...
    "Datenschutz zuerst: EU-Server, DSGVO, keine Werbetracker",
  ...
  pt: [
    ...
    "Privacidade em primeiro lugar: servidores UE, RGPD, sem rastreadores publicitários",
  ...
  fr: [
    ...
    "Confidentialité avant tout : serveurs UE, RGPD, aucun traceur publicitaire",
  ...
  pl: [
    ...
    "Prywatność przede wszystkim: serwery UE, RODO, brak trackerów reklamowych",
  ...
  tr: [
    ...
    "Gizlilik öncelikli: AB sunucuları, GDPR, reklam izleyicisi yok",
  ...
  nl: [
    ...
    "Privacy-first: EU-servers, AVG, geen advertentietrackers",
  ...
  ja: [
    ...
    "プライバシーファースト：EUサーバー、GDPR準拠、広告トラッカーなし",
  ...
  ko: [
    ...
    "개인정보 보호 최우선: EU 서버, GDPR, 광고 트래커 없음",
  ...
  sv: [
    ...
    "Integritet först: EU-servrar, GDPR, inga annonsspårare",
  ...
  da: [
    ...
    "Privatliv først: EU-servere, GDPR, ingen annoncetrackere",
  ...
  no: [
    ...
    "Personvern først: EU-servere, GDPR, ingen annonsesporere",
    ...
    "Yksityisyys edellä: EU-palvelimet, GDPR, ei mainosseurantaa",
