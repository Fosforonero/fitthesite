...
-- Revoca esplicita ad anon: la funzione è interna alla policy, non va esposta
-- via PostgREST RPC pubblico.
REVOKE EXECUTE ON FUNCTION public.user_shares_metric_with_caller(
  uuid, boolean, boolean, boolean, boolean, boolean
) FROM anon;
